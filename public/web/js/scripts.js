    ...
    if (tabCarousel.length) {
      tabCarousel.each(function () {
        ...
        thisCarousel.slick({
          ...
          prevArrow: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-chevron-left common-fill-hover slider-prev" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0z"/></svg>',
          nextArrow: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-right common-fill-hover slider-next" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z"/></svg>',
          //rtl:true,
          speed: 300,
          slidesToShow: item || 4,
          slidesToScroll: item || 1,
...
jQuery(document).ready(function () {
  ...
  jQuery('.navigation-mobile-toggler-12').on('click', function () {
    jQuery('#navigation-mobiles').toggleClass('navigation-active');
    jQuery('.mobile-overlay').addClass('active'); //put this when popup opens, to stop body scrolling
    //bodyScrollLock.disableBodyScroll(targetElement);

    jQuery('.navigation-active').addClass('mobilemenu-active');
    jQuery('html').addClass('mobilemenubg-active');
    jQuery('.header-overlap-35').css('z-index','auto');
    jQuery('.header-overlap-30').css('z-index','auto');
    jQuery('.header-overlap').css('z-index','auto');
    jQuery('.closed-header-overlap-35').css('z-index','auto');
    jQuery('.closed-header-overlap').css('z-index','auto');

    
  });
  jQuery('.mobile-overlay').on('click', function () {
    jQuery('#navigation-mobiles').removeClass('navigation-active');
    jQuery('.mobile-overlay').removeClass('active'); //put this when close popup and show scrollbar in body
    // bodyScrollLock.enableBodyScroll(targetElement);
    jQuery('#navigation-mobiles').removeClass('mobilemenu-active');
    jQuery('html').removeClass('mobilemenubg-active');
    jQuery('.header-overlap-35').css('z-index','1');
    jQuery('.header-overlap-30').css('z-index','1');
    jQuery('.header-overlap').css('z-index','1');
    jQuery('.closed-header-overlap-35').css('z-index','1');
    jQuery('.closed-header-overlap').css('z-index','1');
