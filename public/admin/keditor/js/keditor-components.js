	...
	return function(t) {
		...
		i.a.components.form = {
			...
			initSettingForm: function(t, o) {
				...
				n.on("click", (function(t) {
					...
					if (/image/.test(n.type)) {
						...
						i.addEventListener("load", (function(n) {
							...
							i.attr("src", n.target.result),i.attr("href", ''), i.css({
								width: "",
								height: ""
							}), i.load((function() {
                ...
                t.find("#photo-url").keyup(function() {
					o.getSettingComponent().find(".photo-hreflink").attr("href", this.value)
			...
			showSettingForm: function(t, o, e) {
				var n = this,
					...
					p = c.find("img"),
					u = c.css("text-align");
				"right" === u && "center" === u || (u = "left"), p.hasClass("img-rounded") ? d.val("img-rounded") : p.hasClass("img-circle") ? d.val("img-circle") : p.hasClass("img-thumbnail") ? d.val("img-thumbnail") : d.val(""), i.val(u), a.prop("checked", p.hasClass("img-responsive")), l.val(p.width()), s.val(p.height()), r()("<img />").attr("href", hr.attr("href")).attr("src", p.attr("src")).load((function() {
