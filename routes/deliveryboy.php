...
Route::group(['namespace' => 'DeliveryBoy'], function () {
	...
	Route::post('/processlogout', 'DeliveryBoyController@processlogout');
	Route::post('/floatingCash', 'DeliveryBoyController@floatingCash');
	Route::post('/settlementAmount', 'DeliveryBoyController@settlementAmount');
	Route::post('/balanceAmount', 'DeliveryBoyController@balanceAmount');
	...
	Route::post('/ordersByID', 'OrdersController@ordersByID');	
