...
<div class="form-tab">
    ...
    <div id="Login" class="tabcontent" style="display:block !important">
        ...
        <!-- <div id="loadermodallog5" class="lds-dual-ringlog5 hidden overlaylog5"></div> -->
        <form  class="form-validate-login">
            ...
            <div class="form-footer">
                <button  type="button" class="btn btn-outline-primary-2 plogin2">
...
document.getElementById("defaultOpen").style.display = "block";
    ...
    jQuery(document).on('click', '.plogin2', function(e){
  ...
  var password = $('#password-login').val();
    ...
    //    complete: function(){
    //     $('#loadermodallog5').addClass('hidden')
    //    },
     });
