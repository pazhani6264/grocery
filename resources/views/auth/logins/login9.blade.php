...
.form-tab1 .form-footer .forgot-link {
    order: 2;
    width: auto;
    margin-bottom: 0;
    margin-left: auto;
...
<div class="ptb12" style="background-image:url('login-bg.jpg')">
<div class="form-tab1">
    ...
    <ul class="nav nav-pills nav-fill" role="tablist">
        ...
        <button class="tablink active" onclick="openCity9(event, 'Login9')" id="defaultOpen">Sign In</button>
        <button class="tablink" onclick="openCity9(event, 'Singup9')">Register</button>

    </ul>

    <div id="Login9" class="tabcontent" style="display:block !important">
		...
		{{csrf_field()}}
            <div class="form-group">
                ...
                <input type="email" name="email" id="email" placeholder="@lang('website.Please enter your valid email address')" class="form-control email-validate-login field-validate1" required>
            ...
            <div class="form-group">
                ...
                <input type="password" name="password" id="password-login" placeholder="Please Enter Password" class="form-control password-login field-validate1" required>
    ...
    <div id="Singup9" class="tabcontent">
    ...
    <div class="col-12" style="margin-bottom:20px">
        ...
        {{csrf_field()}}
            ...
            <div class="form-group">
                <label for="ccode">@lang('website.Phone Number') *</label>
