							...
							{{csrf_field()}}
								...
								<div class="from-group mb-3">
									...
									<div class="col-12 col-sm-12">
										<button type="button" class="btn btn-secondary plogin1">@lang('website.Login')</button>
...
?>
				...
				<div class="col-12 col-sm-12 col-md-6">
						...
						<div class="registration-process">
							...
							<form name="signup" id="ajaxForm" action="{{ URL::to('/signupProcess')}}" enctype="multipart/form-data" class="form-validate"  method="post">
								{{csrf_field()}}
								<input type="hidden" id="appname" name="appname" value="{{ $result['commonContent']['setting'][18]->value }} ">
								<div class="from-group mb-3">
									...
									<div class="from-group mb-3">
										...
										<div class="from-group mb-3">
											...
											<div class="from-group mb-3">
												...
												<div class="input-group col-12">
													<select class="form-control field-validate" name="gender" id="gender">
