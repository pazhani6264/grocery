...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ URL::to('admin/webpages')}}"><i class="fa fa-gears"></i> {{ trans('labels.ListingAllPages') }}</a></li>
            ...
            <div class="row">
              <div class="col-xs-12">
                    ...
                    @endif
                            ...
                            {!! Form::open(array('url' =>'admin/addnewpagebuilder', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}

                             <div class="form-group">
							  <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.PageSlug') }} <span style="color:red;">*</span></label>
                            ...
                            @foreach($result['languages'] as $languages)
                                ...
                                <div class="form-group">
                                      <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.PageName') }} ({{ $languages->name }}) <span style="color:red;">*</span></label>
                                      <div class="col-sm-10 col-md-4">
