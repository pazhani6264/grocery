                    ...
                    @endif
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="slug" class="form-control field-validate" id="slug" value="{{ $result['editPage'][0]->slug }}" @if($result['editPage'][0]->page_id ==5 || $result['editPage'][0]->page_id ==6 ||$result['editPage'][0]->page_id ==7 ||$result['editPage'][0]->page_id ==8) readonly="" @endif>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                @if($result['editPage'][0]->page_id ==5 || $result['editPage'][0]->page_id ==6 ||$result['editPage'][0]->page_id ==7 ||$result['editPage'][0]->page_id ==8) 
