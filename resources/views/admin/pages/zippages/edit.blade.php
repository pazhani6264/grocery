...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> Edit Page <small>Edit Page...</small> </h1>
            <ol class="breadcrumb">
          ...
          <p>@lang('labels.Loading')..</p>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" id="name" value="{{ $zip->name }}" name="name" class="form-control field-validate form-clear">
