                ...
                <div class="col-md-12">
                    ...
                    @endif
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="slug" class="form-control field-validate" id="slug" value="{{ $result['editPage'][0]->slug }}" @if($result['editPage'][0]->page_id ==1 || $result['editPage'][0]->page_id ==2 ||$result['editPage'][0]->page_id ==3 ||$result['editPage'][0]->page_id ==4) readonly="" @endif>
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if($result['editPage'][0]->page_id ==1 || $result['editPage'][0]->page_id ==2 ||$result['editPage'][0]->page_id ==3 ||$result['editPage'][0]->page_id ==4) 
                                                
                                                <input type="hidden" name="status" class="form-control field-validate" id="status" value="1" readonly="">

                                                <input type="text" name="" class="form-control field-validate" id="" value="Active" readonly="">
