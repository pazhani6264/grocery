                                    ...
                                    <div class="box-body">
                                        <form enctype="multipart/form-data" class='form-validate'
                                                 ...
                                                 @if($res->type != 1)
                                                    ...
                                                    @if($res->keyname == 'paystackcallbackurl')
                                                        <div class="col-xs-6" style="margin-bottom: 10px;">
                                                            <div class="form-group">
                                                                <label for="name"
                                                                    class="col-sm-2 col-md-4 control-label">{{ trans('labels.'.$res->keyname) }} <span style="color:red;">*</span></label>
                                                    ...
                                                    <div class="col-xs-6" style="margin-bottom: 10px;">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10 col-md-8">
                                                                ...
                                                                <input type="text" name="<?php echo 'field_' .$res->key; ?>"
                                                                    id="braintree_merchant_id" value="{{$res->value}}"
                                                                    class="form-control field-validate" @if($res->key=='wallet_code') readonly @endif >
                                                                @endif
                                                    ...
                                                    <div class="col-xs-6" style="margin-bottom: 10px;">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-10 col-md-8">  
                                                                    ...
                                                                    $ccode = (json_decode($ccode));?>                 
                                                                         <select name="<?php echo 'field_' .$res->key; ?>[]"class="form-control  ccode_output" multiple="multiple" multiple multiselect-search="true" >
                                                                            @foreach($result['currencies'] as $currency)
                                                                            <option value="{{$currency->code}}"
                                                                                <?php if($ccode !=''){
                                                                                  foreach($ccode as $ccodes) 
                                                                                  if($ccodes == $currency->code)
                                                                                  {  
                                                                                   ?> selected
                                                                                   <?php }}?>
                                            ...
                                            <div class="row">
                                                    <div class="col-xs-6">
                                                        <div class="form-group ">
                                                            <label for="name" class="col-sm-2 col-md-4 control-label">Choose Country</label>
                                                            <div class="col-sm-10 col-md-8 content-remove">
                                                                <select name="ccode_output[]"class="form-control  ccode_output" multiple="multiple" data-live-search="true">
                                                                    @foreach($result['currencies'] as $currency)
                                                ...
                                                <div class="col-xs-6">
                                                    <div class="form-group">
                                                        <label for="name"
                                                            ...
                                                            ({{ $detail['language_name'] }})  <span style="color:red;">*</span></label>
                                                            <div class="col-sm-10 col-md-8">
