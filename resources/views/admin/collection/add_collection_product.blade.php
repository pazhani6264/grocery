...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> {{ trans('labels.collection') }} <small>{{ trans('labels.product_collection') }}...</small> </h1>
        <ol class="breadcrumb">
            <li><a href="{{ URL::to('admin/dashboard/this_month') }}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
            <li><a href="{{ URL::to('admin/collection/view')}}"><i class="fa fa-database"></i>{{ trans('labels.collection') }}</a></li>
            <li class="active">{{ trans('labels.product_collection') }}</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">{{ trans('labels.product_collection') }} </h3>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    {!! Form::open(array('url' =>'admin/collection/add_product', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                          ...
                                          <div class="col-sm-10 col-md-4">
                                            <select class="form-control field-validate" name="collection_id">
                                                ...
                                                @foreach($collection as $jescollection)
                                                  <option value="{{ $jescollection->id }}">{{ $jescollection->name }}</option>
                                                @endforeach
                                                @endif 
                                            </select>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-10 col-md-4">
                                            ...
                                            @foreach($category as $jescategory)
                                                <option value="{{ $jescategory->categories_id }}">{{ $jescategory->categories_name }}</option>
                                            @endforeach
                                            @endif    
                                            </select>
                                          <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                         ...
                                         <div class="form-group">
                                          ...
                                          <div class="col-sm-10 col-md-4">
                                            <select class="form-control field-validate zoneContent" name="product_id[]" multiple>
