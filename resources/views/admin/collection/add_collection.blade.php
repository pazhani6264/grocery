...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> {{ trans('labels.collection') }} <small>{{ trans('labels.AddNewcollection') }}...</small> </h1>
        <ol class="breadcrumb">
            <li><a href="{{ URL::to('admin/dashboard/this_month') }}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
            <li><a href="{{ URL::to('admin/collection/view')}}"><i class="fa fa-database"></i>{{ trans('labels.collection') }}</a></li>
            <li class="active">{{ trans('labels.AddNewcollection') }}</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">{{ trans('labels.AddNewcollection') }} </h3>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    {!! Form::open(array('url' =>'admin/collection/add_action', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
