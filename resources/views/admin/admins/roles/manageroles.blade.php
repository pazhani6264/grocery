                                ...
                                <ul class="nav table-nav">
                                  <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li role="presentation"><a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Delete') }}" id="deleteRoleFrom" user_types_id="{{ $adminType->user_types_id }}">{{ trans('labels.Delete') }}</a></li>
                                    </ul>
                                  </li>
                              </ul>
								</td> -->
