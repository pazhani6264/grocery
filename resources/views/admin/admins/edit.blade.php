              		...
              		<div class="box box-info">
                        ...
                        <!-- form start -->
                         <div class="box-body">
                            ...
                            {!! Form::hidden('oldImage', $result['admins'][0]->avatar , array('id'=>'oldImage')) !!}
                            ...
                            <hr>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <select class="form-control" name="outlet_id">
                                        ...
                                        <option  @if( $outlet_data->id == $result['admins'][0]->outlet)
                                                                    selected
                                                                    @endif value="{{ $outlet_data->id }}">{{ $outlet_data->name }}</option>
                                      @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                        ...
                                        @if(!empty($result['admins'][0]->avatar))
                                         <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label"></label>
                                            <div class="col-sm-10 col-md-4">
                                              <span class="help-block " style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.OldImage') }}</span>
                                              <br>
                                              <img src="{{$result['admins'][0]->avatar}}" alt="" width=" 100px">
                                            </div>
                                        </div>
                                      @endif
                                ...
                                <hr>
                                 <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                     <input type="text" class="form-control" id="taxid" placeholder="Enter Your Tax ID" name="taxid" value="@if(!empty($cash)){{$cash->taxid}}@endif">
                                     <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <input type="text" class="form-control" id="posid" placeholder="Enter Your POS ID" name="posid" value="@if(!empty($cash)){{$cash->posid}}@endif">
                                     <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <input type="text" class="form-control" id="branch" placeholder="Enter Your Branch Name" name="branch" value="@if(!empty($cash)){{$cash->branch}}@endif">
                                     <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <input type="text" class="form-control" id="posno" placeholder="Enter Your POS Number" name="posno" value="@if(!empty($cash)){{$cash->posno}}@endif">
                                     <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <input type="text" class="form-control" id="opening" placeholder="Enter Your Opening Time" name="opening" value="@if(!empty($cash)){{$cash->opening}}@endif">
                                     <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <input type="text" class="form-control" id="closeing" placeholder="Enter Your Closeing Time" name="closeing" value="@if(!empty($cash)){{$cash->closeing}}@endif">
                                     <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                ...
                                <div class="form-group">
                                          <label class="col-sm-2 col-md-3 control-label" style="">Allow Notification<span style="color:red;">*</span></label>
                                            <div class="col-sm-10 col-md-4">
                                                <label class=" control-label">
                                                    <input type="radio" name="notification" value="1" class="flat-red" @if(!empty($cash)) @if($cash->notification == '1') checked @endif @endif> &nbsp;{{ trans('labels.Enabled') }}
                                                </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                                <label class=" control-label">
                                                    <input type="radio" name="notification" value="0" class="flat-red" @if(!empty($cash)) @if($cash->notification == '0') checked @endif @endif>  &nbsp;{{ trans('labels.Disabled') }}
                                                </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            </div>
                                    </div>
                                   ...
                                   <div class="form-group">
                                          <label class="col-sm-2 col-md-3 control-label" style="">Access Control<span style="color:red;">*</span></label>
                                            <div class="col-sm-10 col-md-4">
                                                <label class=" control-label">
                                                    <input type="radio" name="access_control" value="1" class="flat-red" @if(!empty($cash)) @if($cash->access_control == '1') checked @endif @endif> &nbsp;Full
                                                </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                                <label class=" control-label">
                                                    <input type="radio" name="access_control" value="0" class="flat-red" @if(!empty($cash)) @if($cash->access_control == '0') checked @endif @endif>  &nbsp;Half
                                                </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            </div>
                                    </div>
