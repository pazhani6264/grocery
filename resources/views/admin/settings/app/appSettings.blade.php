                                ...
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select name="home_style" class="form-control">
                                                        ...
                                                        <option @if($result['commonContent']['setting']['home_style'] == '11')
                                                                selected
                                                                @endif
                                                                value="11"> {{ trans('labels.Style 11') }}</option>
                                                        <option @if($result['commonContent']['setting']['home_style'] == '12')
                                                                selected
                                                                @endif
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">Menu Style
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select name="menu_style" class="form-control">
                                                        ...
                                                        <option @if($result['commonContent']['setting']['menu_style'] == '1')
                                                                selected
                                                                @endif
                                                                value="1"> {{ trans('labels.Style1') }}</option>
                                                        <option @if($result['commonContent']['setting']['menu_style'] == '2')
                                                                selected
                                                                @endif
                                                                value="2"> {{ trans('labels.Style2') }}</option>
                                                        <option @if($result['commonContent']['setting']['menu_style'] == '3')
                                                                selected
                                                                @endif
                                                                value="3"> {{ trans('labels.Style3') }}</option>
                                                        <option @if($result['commonContent']['setting']['menu_style'] == '4')
                                                                selected
                                                                @endif
                                                                value="4"> {{ trans('labels.Style4') }}</option>
                                                        <option @if($result['commonContent']['setting']['menu_style'] == '5')
                                                                selected
                                                                @endif
                                                                value="5"> {{ trans('labels.Style5') }}</option>
                                                    </select>

                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">Please choose menu style</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">Banner One Style
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <select name="banner_style" class="form-control">
                                                        ...
                                                        <option @if($result['commonContent']['setting']['banner_style'] == '6')
                                                                ...
                                                                @endif
                                                                value="6"> {{ trans('labels.Style6') }}</option>
                                                        <option @if($result['commonContent']['setting']['banner_style'] == '7')
                                                                selected
                                                                @endif
                                                                value="7"> {{ trans('labels.Style7') }}</option>
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">Banner Two Style
                                                </label>
                                                <div class="col-sm-10 col-md-4">
                                                
                                                    <select name="banner_style_2" class="form-control">
                                                        <option @if($result['commonContent']['setting']['banner_style_2'] == '1')
                                                                selected
                                                                @endif
                                                                value="1"> {{ trans('labels.Style1') }}</option>
                                                        <option @if($result['commonContent']['setting']['banner_style_2'] == '2')
                                                                selected
                                                                @endif
                                                                value="2"> {{ trans('labels.Style2') }}</option>
                                                        <option @if($result['commonContent']['setting']['banner_style_2'] == '3')
                                                                selected
                                                                @endif
                                                                value="3"> {{ trans('labels.Style3') }}</option>
                                                        <option @if($result['commonContent']['setting']['banner_style_2'] == '4')
                                                                selected
                                                                @endif
                                                                value="4"> {{ trans('labels.Style4') }}</option>
                                                        <option @if($result['commonContent']['setting']['banner_style_2'] == '5')
                                                                selected
                                                                @endif
                                                                value="5"> {{ trans('labels.Style5') }}</option>
                                                        <option @if($result['commonContent']['setting']['banner_style_2'] == '6')
                                                                selected
                                                                @endif
                                                                value="6"> {{ trans('labels.Style6') }}</option>
                                                        <option @if($result['commonContent']['setting']['banner_style_2'] == '7')
                                                                selected
                                                                @endif
                                                                value="7"> {{ trans('labels.Style7') }}</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control field-validate" id="app_color_code" name="app_color_code" type="color" value="{{ $result['commonContent']['setting']['app_color_code'] }}">

                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">Please select app color code</span>
                                                </div>
                                            </div>
