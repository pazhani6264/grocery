      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><strong>{{ trans('labels.Type') }}:</strong> {{$result['adminType'][0]->first_name}} {{$result['adminType'][0]->last_name}}</h3>
          </div>
              ...
              <div class="col-xs-12">
              		<div class="box box-info">
                        ...
                        @endif
                            ...
                            {!! Form::open(array('url' =>'admin/addnewcashierroles', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
                           ...
                           <div class="row">
                            ...
                            <div class="box-footer ">
                              <a style="float:right;"href="{{ URL::to('admin/cashierrole')}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
