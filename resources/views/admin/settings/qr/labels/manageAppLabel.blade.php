                                ...
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        ...
                                        <div class="box-tools pull-right">
                                            <a href="{{ URL::to('admin/addtablekey')}}" type="button" class="btn btn-block btn-primary">{{ trans('labels.AddNewKey') }}</a>
                                        </div><br>
                                        ...
                                        <div class="box-body">
                                            @foreach ($result['labels'] as $key=>$data)
                                                ...
                                                {!! Form::open(array('url' =>'admin/updateTableLabel', 'name'=>'form', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
