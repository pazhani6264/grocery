...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ URL::to('admin/listingtableLabels')}}"><i class="fa fa-bars"></i> List All Labels</a></li>
                       ...
                       @if (count($errors) > 0)
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            ...
                            {!! Form::open(array('url' =>'admin/updateTableLabel', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                            ...
                            <div class="form-group">
                              ...
                              <div class="box-footer text-center">
                                ...
                                <a href="{{ URL::to('admin/listingTableLabels')}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                              </div>
                              <!-- /.box-footer -->
                            {!! Form::close() !!}
                        </div>
