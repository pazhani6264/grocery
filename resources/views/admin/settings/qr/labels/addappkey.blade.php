    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ URL::to('admin/tablelabel')}}"><i class="fa fa-bars"></i> {{ trans('labels.ManageAppLabels') }}</a></li>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <!-- form start -->
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'admin/addNewTableLabel', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                            ...
                                            <div class="box-footer text-center">
                                                ...
                                                <a href="{{ URL::to('admin/tablelabel')}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                                            </div>
                                            <!-- /.box-footer -->
                                            {!! Form::close() !!}
                                        </div>
