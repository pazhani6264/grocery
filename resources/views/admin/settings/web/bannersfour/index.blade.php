        ...
        <div class="box">
          <div class="box-header">
            {{-- <div class="box-tools pull-right">
            	 <a href="{{ URL::to('admin/addconstantbannerfour') }}" type="button" class="btn btn-block btn-primary">{{ trans('labels.AddNewBanner') }}</a>
            </div> --}}
                  ...
                  <div class="input-group-form search-panel ">
                      ...
                      <option value="" selected disabled hidden>{{trans('labels.ChooseSliderType')}}</option>
                         ...
                         @if($current_theme->multibanner_two == 1)
                          ...
                          <option value="banner38" selected>Demo-35 Style</option>
                          @endif
                      ...
                      @if(request()->get('bannerType'))  <a class="btn btn-danger " href="{{url('admin/constantbannersfour')}}"><i class="fa fa-ban" aria-hidden="true"></i> </a>@endif
                  </div>
              </form>
                  ...
                  @if(count($result['banners'])>0)
                    @foreach ($result['banners'] as $key=>$banners)
                        <tr>
                            ...
                            <td><a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Edit') }}" href="editconstantbannerfour/{{ $banners->banners_id }}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
	...
	<div class="modal fade" id="deleteBannerModal" tabindex="-1" role="dialog" aria-labelledby="deleteBannerModalLabel">
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  {!! Form::open(array('url' =>'admin/deleteconstantBannerfour', 'name'=>'deleteBanner', 'id'=>'deleteBanner', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
