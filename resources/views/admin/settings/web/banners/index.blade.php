          ...
          <div class="box-header">
            ...
            <?php $current_theme = DB::table('current_theme')->where('id', '=', '1')->first(); ?>
                      ...
                      <select id="parameter" type="button" class="btn btn-default dropdown-toggle form-control input-group-form " data-toggle="dropdown" name="bannerType">
                          ...
                          @if($current_theme->template == 0)
                            ...
                            @if($current_theme->carousel == 3)
                              <option value="rightsliderbanner" @if(request()->get('bannerType') == 'rightsliderbanner') selected @endif>carousel Style 3</option>
                            @endif
                            @if($current_theme->carousel == 5)
                              <option value="leftsliderbanner" @if(request()->get('bannerType') == 'leftsliderbanner') selected @endif>carousel Style 5</option>
                            @endif
                            @if($current_theme->carousel == 7)
                            <option value="sliderbanner2thumbs" @if(request()->get('bannerType') == 'sliderbanner2thumbs') selected @endif>carousel Style 7 (demo-2)</option>
                            @endif
                            @if($current_theme->carousel == 8)
                            <option value="sliderbanner3thumbs" @if(request()->get('bannerType') == 'sliderbanner3thumbs') selected @endif>carousel Style 8 (Demo-3)</option>
                            @endif
                            @if($current_theme->carousel == 15)
                            <option value="sliderbanner3bottomthumbs1" @if(request()->get('bannerType') == 'sliderbanner3bottomthumbs1') selected @endif>carousel Style 15 (Demo-21)</option>
                            @endif
                            @if($current_theme->carousel == 16)
                            <option value="sliderbanner1thumbs" @if(request()->get('bannerType') == 'sliderbanner1thumbs') selected @endif>carousel Style 16 (Demo-26)</option>
                            @endif
                            @if($current_theme->carousel == 17)
                            <option value="sliderbanner3bottomthumbs" @if(request()->get('bannerType') == 'sliderbanner3bottomthumbs') selected @endif>carousel Style 17 (Demo-28) </option>
                            @endif
                            
                            @if($current_theme->carousel == 18)
                            
                            <option value="sliderbanner2thumbs" @if(request()->get('bannerType') == 'sliderbanner2thumbs') selected @endif>carousel Style 18 (demo-34)</option>
                            @endif
                            @if($current_theme->carousel == 29)
                            <option value="sliderbanner3thumbs" @if(request()->get('bannerType') == 'sliderbanner3thumbs') selected @endif>carousel Style 29 (Demo-22)</option>
                            @endif
                            @if($current_theme->carousel == 20)
                              <option value="carousal19rightthumbs" @if(request()->get('bannerType') == 'carousal19rightthumbs') selected @endif>carousel Style 20</option>
                            @endif
                            @if($current_theme->carousel == 35)
                            <option value="banner66" @if(request()->get('bannerType') == 'banner66') selected @endif>Demo-27 style</option>
                            <option value="tpdemo27" @if(request()->get('bannerType') == 'tpdemo27') selected @endif>Trending Product (Demo-27)</option>
                            <option value="topdemo27" @if(request()->get('bannerType') == 'topdemo27') selected @endif>Top Selling (Demo-27)</option>
                            @endif
                            ...
                            @if($current_theme->special_pro == 3)
                              <option value="sp1" @if(request()->get('bannerType') == 'sp1') selected @endif> Special Banner (Demo-5)</option>
                            @endif
                            @if($current_theme->special_pro == 5)
                              <option value="spdemo9" @if(request()->get('bannerType') == 'spdemo9') selected @endif> Special Banner (Demo-9)</option>
                            @endif
                            @if($current_theme->special_pro == 7)
                              <option value="spdemo15" @if(request()->get('bannerType') == 'spdemo15') selected @endif>Special Banner (Demo-15)</option>
                            @endif
                            @if($current_theme->special_pro == 9)
                              <option value="spdemo21" @if(request()->get('bannerType') == 'spdemo21') selected @endif>special Banner (Demo-21)</option>
                            @endif
                            @if($current_theme->special_pro == 10)
                              <option value="spdemo23" @if(request()->get('bannerType') == 'spdemo23') selected @endif>Special Banner (Demo-23)</option>
                            @endif
                            @if($current_theme->special_pro == 11)
                              <option value="spdemo25" @if(request()->get('bannerType') == 'spdemo25') selected @endif>Special Banner (Demo-25)</option>
                            @endif
                            @if($current_theme->special_pro == 15)
                              <option value="spoffdemo14" @if(request()->get('bannerType') == 'spoffdemo14') selected @endif>Sepcial Banner (Demo-14 image 1)</option>
                              <option value="nademo14" @if(request()->get('bannerType') == 'nademo14') selected @endif>Sepcial Banner (Demo-14 image 2)</option>
                              <option value="banner74" @if(request()->get('bannerType') == 'banner74') selected @endif>Sepcial Banner (Demo-14 banner)</option>
                            @endif


                             <!-- flash Banner style -->

                            @if($current_theme->flash == 1)
                              <option value="flash1" @if(request()->get('bannerType') == 'flash1') selected @endif>Flash Sale Banner (Demo-1) </option>
                            @endif


                             <!-- tab Banner style -->

                             @if($current_theme->tab_section == 8)
                              <option value="tabdemo22" @if(request()->get('bannerType') == 'tabdemo22') selected @endif>Tab Section Banner (Demo-22)</option>
                            @endif

                            <!-- new arrival Banner style -->

                            @if($current_theme->recent_arrival == 10)
                              <option value="rademo9" @if(request()->get('bannerType') == 'rademo9') selected @endif>New Arrival Banner (demo-9) </option>
                            @endif
                            @if($current_theme->recent_arrival == 15)
                              <option value="rademo15" @if(request()->get('bannerType') == 'rademo15') selected @endif>New Arrival Banner (Demo-15)</option>
                            @endif
                            @if($current_theme->recent_arrival == 16)
                              <option value="recent16banner" @if(request()->get('bannerType') == 'recent16banner') selected @endif>New Arrival Banner (Demo-18)</option>
                            @endif
                           
                            @if($current_theme->recent_arrival == 18)
                              <option value="recent18banner" @if(request()->get('bannerType') == 'recent18banner') selected @endif>New Arrival Banner (Demo-20)</option>
                            @endif
                            @if($current_theme->recent_arrival == 20)
                              <option value="nademo23" @if(request()->get('bannerType') == 'nademo23') selected @endif>New Arrival Banner (Demo-23)</option>
                            @endif

                            <!-- Trending Banner style -->

                            @if($current_theme->trend_pro == 15)
                              <option value="spdemo14" @if(request()->get('bannerType') == 'spdemo14') selected @endif>Trending Banner (Demo-14 image 1)</option>
                              <option value="topdemo14" @if(request()->get('bannerType') == 'topdemo14') selected @endif>Trending Banner (Demo-14 image 2)</option>
                              <option value="tpdemo14" @if(request()->get('bannerType') == 'tpdemo14') selected @endif>Trending Banner (Demo-14 image 3)</option>
                            @endif
                            @if($current_theme->trend_pro == 1)
                              <option value="tp1" @if(request()->get('bannerType') == 'tp1') selected @endif>Trending Banner (demo-3) </option>
                            @endif
                            @if($current_theme->trend_pro == 2)
                              <option value="tp1" @if(request()->get('bannerType') == 'tp1') selected @endif>Trending Banner (demo-4) </option>
                            @endif
                            @if($current_theme->trend_pro == 8)
                              <option value="tpdemo15" @if(request()->get('bannerType') == 'tpdemo15') selected @endif>Tending Banner (Demo-15)</option>
                            @endif
                            @if($current_theme->trend_pro == 13)
                              <option value="tpdemo26" @if(request()->get('bannerType') == 'tpdemo26') selected @endif>Trending Banner (Demo-26)</option>
                            @endif


                            <!-- Top Selling Banner style -->

                            @if($current_theme->top_sell == 6)
                              <option value="topselldemo15" @if(request()->get('bannerType') == 'topselldemo15') selected @endif>Top Sell Banner (Demo-15)</option>
                            @endif
                            @if($current_theme->top_sell == 7)
                              <option value="topsell7_banner1" @if(request()->get('bannerType') == 'topsell7_banner1') selected @endif>Top Sell Banner (Demo-16 image 1)</option>
                              <option value="topsell7_banner2" @if(request()->get('bannerType') == 'topsell7_banner2') selected @endif>Top Sell Banner (Demo-16 image 2)</option>
                            @endif
                            @if($current_theme->top_sell == 12)
                            <option value="topdemo26" @if(request()->get('bannerType') == 'topdemo26') selected @endif>Top Sell Banner (Demo-26)</option>
                            @endif
                          ...
                          <option value="banner20" @if(request()->get('bannerType') == 'banner20') selected @endif>Demo-1 Style</option>
                          <option value="flash1" @if(request()->get('bannerType') == 'flash1') selected @endif>Flash Sale Banner (Demo-1) </option>
                          @endif

                          @if($current_theme->template == 2)
                          <option value="banner39" @if(request()->get('bannerType') == 'banner39') selected @endif >Demo-2 Style</option>
                          <option value="sliderbanner2thumbs" @if(request()->get('bannerType') == 'sliderbanner2thumbs') selected @endif>carousel Style 7 (demo-2)</option>
                          @endif

                          @if($current_theme->template == 3)
                          <option value="tp1" @if(request()->get('bannerType') == 'tp1') selected @endif>Trending Product Banner (demo-3) </option>
                          <option value="sliderbanner3thumbs" @if(request()->get('bannerType') == 'sliderbanner3thumbs') selected @endif>Slider with 3 Thumbs (Demo-22) </option>
                          @endif

                          @if($current_theme->template == 4)
                          <option value="banner40" selected >Demo-4 Style</option>
                          <option value="tp1" @if(request()->get('bannerType') == 'tp1') selected @endif>Trending Product Banner (demo-4) </option>
                          @endif

                          @if($current_theme->template == 5)
                          <option value="banner22" @if(request()->get('bannerType') == 'banner22') selected @endif >Demo-5 Style</option>
                          <option value="sp1" @if(request()->get('bannerType') == 'sp1') selected @endif>Special Product ( Demo-5)</option>
                          @endif

                          @if($current_theme->template == 6)
                          <option value="banner23" selected >Demo-6 Style</option>
                          @endif

                          @if($current_theme->template == 7)
                          <option value="banner24" selected >Demo-7 Style</option>
                          @endif

                          @if($current_theme->template == 8)
                          <option value="banner25" selected >Demo-8 Style</option>
                          @endif

                          @if($current_theme->template == 9)
                          <option value="banner26" @if(request()->get('bannerType') == 'banner26') selected @endif >Demo-9 Style</option>
                          <option value="rademo9" @if(request()->get('bannerType') == 'rademo9') selected @endif>Trending Product Banner (demo-9) </option>
                          <option value="spdemo9" @if(request()->get('bannerType') == 'spdemo9') selected @endif>Special Product ( Demo-9)</option>
                          @endif

                          @if($current_theme->template == 10)
                          <option value="banner27" selected >Demo-10 Style</option>
                          @endif

                          @if($current_theme->template == 12)
                          <option value="banner28" selected >Demo-12 Style</option>
                          @endif

                          @if($current_theme->template == 13)
                          <option value="banner51" selected >Demo-13 Style</option>
                          @endif

                          @if($current_theme->template == 14)
                          <option value="banner73" @if(request()->get('bannerType') == 'banner73') selected @endif >Demo-14 Style banner 1</option>
                          <option value="banner74" @if(request()->get('bannerType') == 'banner74') selected @endif>Demo-14 Style banner 2</option>
                          <option value="spoffdemo14" @if(request()->get('bannerType') == 'spoffdemo14') selected @endif>Sepcial Offer (Demo-14)</option>
                          <option value="nademo14" @if(request()->get('bannerType') == 'nademo14') selected @endif>New Arrival (Demo-14)</option>
                          <option value="topdemo14" @if(request()->get('bannerType') == 'topdemo14') selected @endif>Top selling (Demo-14)</option>
                          <option value="spdemo14" @if(request()->get('bannerType') == 'spdemo14') selected @endif>Sepcial Product (Demo-14)</option>
                          <option value="tpdemo14" @if(request()->get('bannerType') == 'tpdemo14') selected @endif>Top Product (Demo-14)</option>
                          @endif

                          @if($current_theme->template == 15)
                          <option value="banner53" @if(request()->get('bannerType') == 'banner53') selected @endif>Demo-15 Style</option>
                          <option value="tpdemo15" @if(request()->get('bannerType') == 'tpdemo15') selected @endif>Tending Product (Demo-15)</option>
                          <option value="spdemo15" @if(request()->get('bannerType') == 'spdemo15') selected @endif>Special Product (Demo-15)</option>
                          <option value="rademo15" @if(request()->get('bannerType') == 'rademo15') selected @endif>Recent Arrival (Demo-15)</option>
                          <option value="topselldemo15" @if(request()->get('bannerType') == 'topselldemo15') selected @endif>Top Sell (Demo-15)</option>
                          @endif

                          @if($current_theme->template == 16)
                          <option value="banner53" @if(request()->get('bannerType') == 'banner53') selected @endif>Demo-16 Style</option>
                          <option value="topsell7_banner1" @if(request()->get('bannerType') == 'topsell7_banner1') selected @endif>Top Sell 7 Banner1 (Demo-16)</option>
                          <option value="topsell7_banner2" @if(request()->get('bannerType') == 'topsell7_banner2') selected @endif>Top Sell 7 Banner2 (Demo-16)</option>
                         
                          @endif

                          @if($current_theme->template == 17)
                          <option value="banner54" selected>Demo-17 Style</option>
                          @endif

                          @if($current_theme->template == 18)
                          <option value="banner30" @if(request()->get('bannerType') == 'banner30') selected @endif>Demo-18 Style</option>
                          <option value="recent16banner" @if(request()->get('bannerType') == 'recent16banner') selected @endif>Recent 18 banner (Demo-18)</option>
                          @endif

                          @if($current_theme->template == 19)
                          <option value="banner55" selected>Demo-19 Style</option>
                          @endif

                          @if($current_theme->template == 20)
                          <option value="banner57" @if(request()->get('bannerType') == 'banner57') selected @endif>Demo-20 Style</option>
                          <option value="recent18banner" @if(request()->get('bannerType') == 'recent18banner') selected @endif>Recent 18 Banner (Demo-20)</option>
                          @endif

                          @if($current_theme->template == 21)
                          <option value="spdemo21" @if(request()->get('bannerType') == 'spdemo21') selected @endif>special Product (Demo-21)</option>
                          <option value="sliderbanner3bottomthumbs1" @if(request()->get('bannerType') == 'sliderbanner3bottomthumbs1') selected @endif>Slider with 3 Bottom Thumbs1 (Demo-21) </option>
                          @endif

                          @if($current_theme->template == 22)
                          <option value="banner59" @if(request()->get('bannerType') == 'banner59') selected @endif>Demo-22 Style</option>
                          <option value="sliderbanner3thumbs" @if(request()->get('bannerType') == 'sliderbanner3thumbs') selected @endif>Slider with 3 Thumbs (Demo-22) </option>
                          @endif

                          @if($current_theme->template == 23)
                          <option value="banner60" @if(request()->get('bannerType') == 'banner60') selected @endif>Demo-23 Style</option>
                          <option value="spdemo23" @if(request()->get('bannerType') == 'spdemo23') selected @endif>Special Product (Demo-23)</option>
                          <option value="nademo23" @if(request()->get('bannerType') == 'nademo23') selected @endif>New Arrival (Demo-23)</option>
                          @endif

                          @if($current_theme->template == 24)
                          <option value="banner61" selected>Demo-24 Style</option>
                          @endif

                          @if($current_theme->template == 25)
                          <option value="banner63" @if(request()->get('bannerType') == 'banner63') selected @endif>Demo-25 Style</option>
                          <option value="spdemo25" @if(request()->get('bannerType') == 'spdemo25') selected @endif>Special Product (Demo-25)</option>
                          @endif

                          @if($current_theme->template == 26)
                          <option value="banner31" @if(request()->get('bannerType') == 'banner31') selected @endif>Demo-26 Style</option> 
                          <option value="sliderbanner1thumbs" @if(request()->get('bannerType') == 'sliderbanner1thumbs') selected @endif>Carousal right thumb (Demo-26) </option>
                          <option value="topdemo26" @if(request()->get('bannerType') == 'topdemo26') selected @endif>Top Selling (Demo-26)</option>
                          <option value="tpdemo26" @if(request()->get('bannerType') == 'tpdemo26') selected @endif>Trending Product (Demo-26)</option>
                          @endif
                          ...
                          <option value="banner67" @if(request()->get('bannerType') == 'banner67') selected @endif>Demo-28 style</option>
                          <option value="sliderbanner3bottomthumbs" @if(request()->get('bannerType') == 'sliderbanner3bottomthumbs') selected @endif>Slider with 3 Bottom Thumbs (Demo-28) </option>
                          @endif

                          @if($current_theme->template == 29)
                          <option value="banner32" selected>Demo-29 Style</option>
                          @endif

                          @if($current_theme->template == 30)
                          <option value="banner68" selected >Demo-30 Style</option>
                          @endif

                          @if($current_theme->template == 31)
                          <option value="banner33" selected >Demo-31 Style</option>
                          @endif

                          @if($current_theme->template == 32)
                          <option value="banner49" selected >Demo-32 Style</option>
                          @endif

                          @if($current_theme->template == 33)
                          <option value="banner45" selected >Demo-33 Style</option>
                          @endif

                          @if($current_theme->template == 34)
                        
                          <option value="banner1" @if(request()->get('bannerType') == 'banner1') selected @endif>Demo-34 Style</option>
                            <option value="sliderbanner2thumbs" @if(request()->get('bannerType') == 'sliderbanner2thumbs') selected @endif>carousel Style 18 (demo-34)</option>
                           
                          @endif

                          @if($current_theme->template == 35)
                          <option value="banner34" @if(request()->get('bannerType') == 'banner34') selected @endif>Demo-35 Style type 1</option>
                          <option value="banner35" @if(request()->get('bannerType') == 'banner35') selected @endif>Demo-35 Style type 2</option>
                          <option value="banner36" @if(request()->get('bannerType') == 'banner36') selected @endif>Demo-35 Style type 3</option>
                          @endif
              ...
              @elseif(request()->get('bannerType')  == 'flash1')
                ...
                <p>Note: image resolution = (280 × 500) </p>

              @elseif(request()->get('bannerType')  == 'tp1')
                <br>
                <img src="{{asset('https://platinum-24bucket.s3.ap-southeast-1.amazonaws.com/common/images/prototypes/trend1.png')}}" alt=""  width=100%>
              ...
              @elseif(request()->get('bannerType')  == 'sliderbanner3bottomthumbs1')
                ...
                @elseif(request()->get('bannerType')  == 'spdemo9')
                <br>
                <img src="{{asset('https://platinum-24bucket.s3.ap-southeast-1.amazonaws.com/common/images/prototypes/spdemo9.png')}}" alt=""  width=100%>

                <p>Note:  image resolution = (277 × 530) </p>
                ...
                <p>Note:image resolution = (830 × 700) </p>
                ...
                @elseif(request()->get('bannerType')  == 'rademo9')
                <br>
                <img src="{{asset('https://platinum-24bucket.s3.ap-southeast-1.amazonaws.com/common/images/prototypes/rademo9.png')}}" alt=""  width=100%>
                ...
                <br>
                <img src="{{asset('https://platinum-24bucket.s3.ap-southeast-1.amazonaws.com/common/images/prototypes/top6.png')}}" alt=""  width=100%>
                ...
                <br>
                <img src="{{asset('https://platinum-24bucket.s3.ap-southeast-1.amazonaws.com/common/images/prototypes/top7.png')}}" alt=""  width=100%>
                ...
                <br>
                <img src="{{asset('https://platinum-24bucket.s3.ap-southeast-1.amazonaws.com/common/images/prototypes/newest_product16.png')}}" alt=""  width=100%>
                ...
                <br>
                <img src="{{asset('https://platinum-24bucket.s3.ap-southeast-1.amazonaws.com/common/images/prototypes/newest_product20.png')}}" alt=""  width=100%>
                ...
                <br>
                <img src="{{asset('https://platinum-24bucket.s3.ap-southeast-1.amazonaws.com/common/images/prototypes/top12.png')}}" alt=""  width=100%>

                <p>Note:1st  image resolution = (232 × 680) </p>

                @elseif(request()->get('bannerType')  == 'tpdemo26')
                <br>
                <img src="{{asset('https://platinum-24bucket.s3.ap-southeast-1.amazonaws.com/common/images/prototypes/trend13.png')}}" alt=""  width=100%>
                ...
                <br>
                <img src="{{asset('https://platinum-24bucket.s3.ap-southeast-1.amazonaws.com/common/images/prototypes/special15.png')}}" alt=""  width=100%>
                ...
                <br>
                <img src="{{asset('https://platinum-24bucket.s3.ap-southeast-1.amazonaws.com/common/images/prototypes/trend15.png')}}" alt=""  width=100%>
