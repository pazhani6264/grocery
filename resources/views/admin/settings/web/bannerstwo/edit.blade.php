...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ URL::to('admin/constantbannerstwo')}}"><i class="fa fa-bars"></i> {{ trans('labels.ListingConstantBanners') }}</a></li>
                    ...
                    <br>
                        ...
                        <!-- form start -->
                         <div class="box-body">
                            ...
                            {!! Form::open(array('url' =>'admin/updateconstantBannertwo', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
                              ...
                              <div class="box-footer text-center">
                                ...
                                <a href="{{ URL::to('admin/constantbannerstwo')}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                              </div>
                              <!-- /.box-footer -->
                            {!! Form::close() !!}
                        </div>
