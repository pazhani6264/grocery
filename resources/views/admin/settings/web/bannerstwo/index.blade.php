        ...
        <div class="box">
          <div class="box-header">
            {{-- <div class="box-tools pull-right">
            	 <a href="{{ URL::to('admin/addconstantbannertwo') }}" type="button" class="btn btn-block btn-primary">{{ trans('labels.AddNewBanner') }}</a>
            </div> --}}
                  ...
                  <div class="input-group-form search-panel ">
                      <select id="parameter" type="button" class="btn btn-default dropdown-toggle form-control input-group-form " data-toggle="dropdown" name="bannerType">
                         ...
                         @if($current_theme->multibanner == 1)
                          ...
                          <option value="banner41" selected >Demo-5 Style</option>
                          @endif
                          @if($current_theme->template == 8)
                          <option value="banner43" selected >Demo-8 Style</option>
                          @endif
                          @if($current_theme->template == 10)
                          <option value="banner48" selected >Demo-10 Style</option>
                          @endif
                          @if($current_theme->template == 13)
                          <option value="banner52" selected >Demo-13 Style</option>
                          @endif
                          @if($current_theme->template == 19)
                          <option value="banner56" selected>Demo-19 Style</option>
                          @endif
                          @if($current_theme->template == 20)
                          <option value="banner58" selected>Demo-20 Style</option>
                          @endif
                          @if($current_theme->template == 24)
                          <option value="banner62" selected>Demo-24 Style</option>
                          @endif
                          @if($current_theme->template == 25)
                          <option value="banner64"selected>Demo-25 Style</option>
                          @endif
                          @if($current_theme->template == 26)
                          <option value="banner65" selected>Demo-26 Style</option>     
                          @endif
                          @if($current_theme->template == 30)
                          <option value="banner69" selected >Demo-30 Style</option>
                          @endif
                          @if($current_theme->template == 31)
                          <option value="banner71" selected >Demo-31 Style</option>
                          @endif
                          @if($current_theme->template == 32)
                          <option value="banner50" selected >Demo-32 Style</option>
                          @endif
                          @if($current_theme->template == 33)
                          <option value="banner47" selected >Demo-33 Style</option>
                          @endif
                      ...
                      @if(request()->get('bannerType'))  <a class="btn btn-danger " href="{{url('admin/constantbannerstwo')}}"><i class="fa fa-ban" aria-hidden="true"></i> </a>@endif
                  </div>
              </form>
                  ...
                  @if(count($result['banners'])>0)
                    @foreach ($result['banners'] as $key=>$banners)
                        <tr>
                            ...
                            <td><a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Edit') }}" href="editconstantbannertwo/{{ $banners->banners_id }}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
	...
	<div class="modal fade" id="deleteBannerModal" tabindex="-1" role="dialog" aria-labelledby="deleteBannerModalLabel">
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  {!! Form::open(array('url' =>'admin/deleteconstantBannertwo', 'name'=>'deleteBanner', 'id'=>'deleteBanner', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
