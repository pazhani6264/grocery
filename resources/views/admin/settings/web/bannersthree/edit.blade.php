...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ URL::to('admin/constantbannersthree')}}"><i class="fa fa-bars"></i> {{ trans('labels.ListingConstantBanners') }}</a></li>
                    ...
                    <br>
                        ...
                        <!-- form start -->
                         <div class="box-body">
                            ...
                            {!! Form::open(array('url' =>'admin/updateconstantBannerthree', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
                                ...
                                <div class="form-group hidden">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                      ...
                                      <option value="1" @if($result['banners'][0]->type==1) selected @endif>{{ trans('labels.Right And Left Carousel Side Banner 1') }}</option>
                                          ...
                                          <option value="253" @if($result['banners'][0]->type==253) selected @endif>Banner 54</option> <option value="254" @if($result['banners'][0]->type==254) selected @endif>Banner 54</option>
                                          ...
                                          <option value="317" @if($result['banners'][0]->type==317) selected @endif>Banner 73</option>
                                          <option value="318" @if($result['banners'][0]->type==318) selected @endif>Banner 73</option>
                                          <option value="319" @if($result['banners'][0]->type==319) selected @endif>Banner 73</option>

                                          <option value="320" @if($result['banners'][0]->type==320) selected @endif>Banner 74</option>
                                          <option value="321" @if($result['banners'][0]->type==321) selected @endif>Banner 74</option>
                                ...
                                @if($result['banners'][0]->type==225 || $result['banners'][0]->type==283 || $result['banners'][0]->type==315 )
                              ...
                              <div class="box-footer text-center">
                                ...
                                <a href="{{ URL::to('admin/constantbannersthree')}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                              </div>
                              <!-- /.box-footer -->
                            {!! Form::close() !!}
                        </div>
