                  ...
                  {!! Form::open(array('url' =>'admin/homebanners/insert', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                    ...
                    @endphp
                      ...
                      <div style="margin-top: 15px;" class="tab-pane @if($i==0) active @endif" id="banners_<?=$key?>">
                        ...
                        @if($banner['banner_name'] == 'banners_3')
                        <div class="">     
                          
                          <div class="row">
                            <div class="col-xs-12">
                            <div class="form-group">
                                <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Banner') }} Three  (1170x500)</label>
                          ...
                          <div class="col-xs-12">
                            <div class="form-group">
                              ...
                              <div class="col-sm-10 col-md-8">
                                  <textarea id="editor_<?=$banner['language_id']?>_<?=$banner['banner_name']?>" name="text_<?=$banner['language_id']?>_<?=$banner['banner_name']?>" class="form-control"
...
@foreach($result['banners'] as $banner_content)
@foreach($banner_content as $banner)
    // Replace the <textarea id="editor1"> with a CKEditor
    // instance, using default configuration.
    CKEDITOR.replace('editor_<?=$banner['language_id']?>_<?=$banner['banner_name']?>',   
    {
