                                    ...
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="onesignal_content" >
                                                ...
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.OnesignalAuthid') }}</label>
                                                    <div class="col-sm-10 col-md-4">
                                                        {!! Form::text('onesignal_auth_id', $result['commonContent']['setting']['onesignal_auth_id'] , array('class'=>'form-control', 'id'=>'onesignal_auth_id')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">{{ trans('labels.OnesignalAuthidText') }}</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="onesignal_content" >
                                                ...
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.OnesignalAppid') }}</label>
                                                    <div class="col-sm-10 col-md-4">
                                                        {!! Form::text('deliveryboy_app_id', $result['commonContent']['setting']['deliveryboy_app_id'] , array('class'=>'form-control', 'id'=>'deliveryboy_app_id')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">{{ trans('labels.OnesignalAppidText') }}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.OnesignalAuthid') }}</label>
                                                    <div class="col-sm-10 col-md-4">
                                                        {!! Form::text('deliveryboy_auth_id', $result['commonContent']['setting']['deliveryboy_auth_id'] , array('class'=>'form-control', 'id'=>'deliveryboy_auth_id')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">{{ trans('labels.OnesignalAuthidText') }}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.OnesignalSenderid') }}</label>
                                                    <div class="col-sm-10 col-md-4">
                                                        {!! Form::text('deliveryboy_sender_id',  $result['commonContent']['setting']['deliveryboy_sender_id'], array('class'=>'form-control', 'id'=>'deliveryboy_sender_id')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">{{ trans('labels.OnesignalSenderidText') }}</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="onesignal_content" >
                                                ...
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.OnesignalAppid') }}</label>
                                                    <div class="col-sm-10 col-md-4">
                                                        {!! Form::text('merchant_app_id', $result['commonContent']['setting']['merchant_app_id'] , array('class'=>'form-control', 'id'=>'merchant_app_id')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">{{ trans('labels.OnesignalAppidText') }}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.OnesignalAuthid') }}</label>
                                                    <div class="col-sm-10 col-md-4">
                                                        {!! Form::text('merchant_auth_id', $result['commonContent']['setting']['merchant_auth_id'] , array('class'=>'form-control', 'id'=>'merchant_auth_id')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">{{ trans('labels.OnesignalAuthidText') }}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.OnesignalSenderid') }}</label>
                                                    <div class="col-sm-10 col-md-4">
                                                        {!! Form::text('merchant_sender_id',  $result['commonContent']['setting']['merchant_sender_id'], array('class'=>'form-control', 'id'=>'merchant_sender_id')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">{{ trans('labels.OnesignalSenderidText') }}</span>
                                                    </div>
                                                </div>
