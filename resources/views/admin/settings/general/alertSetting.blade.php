                                 ...
                                 <!--            <div class="form-group">
                                      ...
                                      <!--       <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label for="shippingEnvironment" class="col-sm-2 col-md-3 control-label" style="">Notify Me Email</label>
                                                    <div class="col-sm-10 col-md-4">
                                                        <label class=" control-label">
                                                            <input type="radio" name="notify_email" value="1" class="flat-red" @if($result['setting'][0]->notify_email==1) checked @endif > &nbsp;{{ trans('labels.Yes') }}
                                                        </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                                        <label class=" control-label">
                                                            <input type="radio" name="notify_email" value="0" class="flat-red" @if($result['setting'][0]->notify_email==0) checked @endif >  &nbsp;{{ trans('labels.No') }}
                                                        </label>
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.newsnotificationtext') }}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="shippingEnvironment" class="col-sm-2 col-md-3 control-label" style="">Subscription Email</label>
                                                    <div class="col-sm-10 col-md-4">
                                                        <label class=" control-label">
                                                            <input type="radio" name="subscribe_email" value="1" class="flat-red" @if($result['setting'][0]->subscribe_email==1) checked @endif > &nbsp;{{ trans('labels.Yes') }}
                                                        </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                                        <label class=" control-label">
                                                            <input type="radio" name="subscribe_email" value="0" class="flat-red" @if($result['setting'][0]->subscribe_email==0) checked @endif >  &nbsp;{{ trans('labels.No') }}
                                                        </label>
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.newsnotificationtext') }}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="shippingEnvironment" class="col-sm-2 col-md-3 control-label" style="">Order Point Email</label>
                                                    <div class="col-sm-10 col-md-4">
                                                        <label class=" control-label">
                                                            <input type="radio" name="balance_point_email" value="1" class="flat-red" @if($result['setting'][0]->balance_point_email==1) checked @endif > &nbsp;{{ trans('labels.Yes') }}
                                                        </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                                        <label class=" control-label">
                                                            <input type="radio" name="balance_point_email" value="0" class="flat-red" @if($result['setting'][0]->balance_point_email==0) checked @endif >  &nbsp;{{ trans('labels.No') }}
                                                        </label>
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.newsnotificationtext') }}</span>
                                                    </div>
                                                </div>
