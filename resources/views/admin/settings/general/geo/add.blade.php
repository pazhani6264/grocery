...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> {{ trans('labels.add-geo-fencing') }} <small>{{ trans('labels.add-geo-fencing') }} ...</small> </h1>
            <ol class="breadcrumb">
                <li><a href="{{ URL::to('admin/dashboard/this_month') }}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
                <li><a href="{{ URL::to('admin/geo-fencing')}}"><i class="fa fa-dashboard"></i> {{ trans('labels.ListingAllgeo') }}</a></li>
                <li class="active">{{ trans('labels.add-geo-fencing') }} </li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">{{ trans('labels.add-geo-fencing') }}  </h3>
                        </div>
                                ...
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'admin/addgeofencingaction', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                            ...
                                            <div class="col-sm-10 col-md-6">
                                              <textarea id="editor" name="pincode" class="form-control" rows="10" cols="80"></textarea>
