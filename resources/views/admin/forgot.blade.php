...
<div class="login-box">
  <div class="login-logo">
  	...
  	@if(empty($web_setting[15]->value))
    	...
    	@endif
    @else
    	<img style="width: 60%" src="{{asset('images/PlatinumCode_Logo.png')}}">
    @endif
...
"><b> {{ trans('labels.welcome_message') }}</b>{{ trans('labels.welcome_message_to') }}</div>
  ...
  <div class="login-box-body">
    ...
    {!! Form::open(array('url' =>'admin/checkforgot', 'method'=>'post', 'class'=>'form-validate')) !!}
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          {!! Form::submit('send', array('id'=>'login', 'class'=>'btn btn-primary btn-block btn-flat' )) !!}
        </div>
        <!-- /.col -->
      </div>
    {!! Form::close() !!}
