...
<div class="modal-body">
    ...
    <div class="form-group selectstate" @if(!is_numeric($data['customer_addresses'][0]->entry_state)) style="display: none" @endif>
        ...
        <div class="col-sm-10 col-md-8">
            <select class="form-control zoneContent" name="entry_state_box" id="entry_zone_id">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10 col-md-8">
            {!! Form::text('entry_phone', $data['customer_addresses'][0]->entry_phone, array('class'=>'form-control entry_phone', 'id'=>'entry_phone')) !!}
        </div>
    </div>
