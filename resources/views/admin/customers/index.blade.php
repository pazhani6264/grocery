                                                    ...
                                                    <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li role="presentation" class="divider"></li>
                                                             ...
                                                             <li role="presentation"><a role="menuitem" tabindex="-1" href="{{url('admin/customers/view') }}/{{$listingCustomers->id}}">{{ trans('labels.View') }}</a></li>
                                                            <li role="presentation" class="divider"></li>

                                                            <?php
                                                                $cus_order = DB::table('orders')->where('customers_id', $listingCustomers->id)->get();
                                                                if(count($cus_order) > 0)
                                                                {
                                                                }
                                                                else{
                                                                ?>
