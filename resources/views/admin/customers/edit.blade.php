                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="input-group-prepend col-sm-3 col-md-2">
                                                <select class="form-control field-validate select2" name="ccode" id="ccode">
                                                
                                                    @if(!empty($code))
                                                    @if($data['customers']->country_code=="")
                                                        @php
                                                        $check_code='60';
                                                        @endphp
                                                    @else
                                                        @php
                                                        $check_code=$data['customers']->country_code;
                                                        @endphp
                                                    @endif
                                        ...
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">Required phone verification ? <span style="color:red;">*</span></label>
                                            <div class="col-sm-10 col-md-4">
                                            <input type="radio" name="phone_verified" value="0" @if($data['customers']->phone_verified == 0) checked @endif> Yes &nbsp;&nbsp;&nbsp;
                                            <input type="radio" name="phone_verified" value="1" @if($data['customers']->phone_verified == 1) checked @endif> No
                                            </div>
                                        </div>
