...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> Add Appointment Services</h1>
            <ol class="breadcrumb">
                ...
                <li class="active">Add Appointment Services</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Add Appointment Services</h3>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <!-- /.box-header -->
                                        <!-- form start -->
                                        <div class="box-body">
                                            {!! Form::open(array('url' =>'admin/appointment/add_appointment_services_action', 'method'=>'post', 'class' => 'form-horizontal form-validate ', 'enctype'=>'multipart/form-data')) !!}
