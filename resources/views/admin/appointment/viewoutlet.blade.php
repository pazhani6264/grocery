                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-lg-6 form-inline">
                                <form  name='registration' id="registration" class="registration" method="get" action="{{url('admin/appointment/outlet_filter')}}">
                                    ...
                                    <div class="input-group-form search-panel ">
                                        ...
                                        @if(isset($param,$name))  <a class="btn btn-danger " href="{{url('admin/appointment/outlet')}}"><i class="fa fa-ban" aria-hidden="true"></i> </a>@endif
                                    </div>
                                </form>
                            ...
                            <div class="col-lg-3 pull-right">
                                <?php if( $result['commonContent']['roles'] != null and $result['commonContent']['roles']->add_outlet_view == 1){ ?>
                                    <a href="{{url('admin/appointment/add_outlet')}}" type="button" class="btn btn-block btn-primary">Add Outlet</a>
                                <?php } ?>
                            </div>
                            <br><br>
                                <div class="col-xs-12">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        @if(count($result['outlet'])>0)
                                            @foreach ($result['outlet'] as $key=>$resultdata)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if( $result['commonContent']['roles'] != null and $result['commonContent']['roles']->edit_outlet_view == 1){ ?>
                                                            <a data-toggle="tooltip" data-placement="bottom" title="Edit Outlet"  href="edit_outlet/{{ $resultdata->id }}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                                        <?php } ?>
                                                        <?php if( $result['commonContent']['roles'] != null and $result['commonContent']['roles']->slot_view == 1){ ?>
                                                            <a data-toggle="tooltip" data-placement="bottom" title="Add slot"  href="view_slot/{{ $resultdata->id }}" class="badge bg-light-blue"><i class="fa fa-plus" aria-hidden="true"></i></a>
                                                        <?php } ?>
                                    ...
                                    <div class="col-xs-12 text-right">
                                        ...
                                        {!! $result['outlet']->appends(\Request::except('page'))->render() !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="deleteModalLabel">Delete Outlet</h4>
                        </div>
                        {!! Form::open(array('url' =>'admin/appointment/delete_outlet', 'name'=>'deleteOrder', 'id'=>'deleteOrder', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
