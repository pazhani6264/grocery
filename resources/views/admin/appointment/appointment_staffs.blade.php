...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> Appointment Staffs</h1>
            <ol class="breadcrumb">
                <li><a href="{{ URL::to('admin/dashboard/this_month') }}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
                <li class="active">Appointment Staffs</li>
            </ol>
        </section>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-lg-6 form-inline">
                                <form  name='registration' id="registration" class="registration" method="get" action="{{url('admin/appointment/filter_appointment_staffs')}}">
                            ...
                            <div class="col-lg-3 pull-right">
                                <?php if( $result['commonContent']['roles'] != null and $result['commonContent']['roles']->add_outlet_view == 1){ ?>
                                    <a href="{{url('admin/appointment/add_appointment_staffs')}}" type="button" class="btn btn-block btn-primary">Add Appointment Staffs</a>
                                <?php } ?>
                            </div>
                            <br><br>
                                <div class="col-xs-12">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        @if(count($result['appstaffs'])>0)
                                            @foreach ($result['appstaffs'] as $key=>$resultdata)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if( $result['commonContent']['roles'] != null and $result['commonContent']['roles']->edit_outlet_view == 1){ ?>
                                                            <a href="{{url('admin/appointment/edit_appointment_staffs')}}/{{ $resultdata->id }}"  class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                                        <?php } ?>
                                                        <?php if( $result['commonContent']['roles'] != null and $result['commonContent']['roles']->delete_outlet_view == 1){ ?>
                                                            <a data-toggle="tooltip" data-placement="bottom" title="Delete Appointment Staffs" id="deleteOrdersId" orders_id ="{{ $resultdata->id }}" class="badge bg-red"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                            @endforeach
                                    ...
                                    <div class="col-xs-12 text-right">
                                        ...
                                        {!! $result['appstaffs']->appends(\Request::except('page'))->render() !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="deleteModalLabel">Delete Appointment staffs</h4>
                        </div>
                        {!! Form::open(array('url' =>'admin/appointment/delete_appointment_staffs', 'name'=>'deleteOrder', 'id'=>'deleteOrder', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
                        {!! Form::hidden('action',  'delete', array('class'=>'form-control')) !!}
                        {!! Form::hidden('orders_id',  '', array('class'=>'form-control', 'id'=>'orders_id')) !!}
                        <div class="modal-body">
                            <p>Are You Sure You want to Appointment Staffs</p>
                        </div>
