...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Appointment Report <small>Appointment Report...</small> </h1>
    <ol class="breadcrumb">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-success">
            ...
            <div class="box-body no-padding">
              <form  name='registration' method="get" action="{{url('admin/appointment/appointment_report')}}">
              ...
              <div class="box-body">
                ...
                <div class="col-xs-2" style="padding-top: 25px">                  
                  <div class="form-group">
                    ...
                    @if(app('request')->input('type') and app('request')->input('type') == 'all')  <a class="btn btn-danger " href="{{url('admin/appointment/appointment_report')}}"><i class="fa fa-ban" aria-hidden="true"></i> </a>@endif
                  </div>
                </div>       
            </div>
              <!-- /.box-body -->
        ...
        <div class="box">
          <div class="box-header">
                <div class="col-lg-9 form-inline" id="contact-form">
                    ...
                    <form method="get" action="{{url('admin/appointment/appointment_report')}}">
                        ...
                        <div class="input-group-form search-panel ">
                            ...
                            <button class="btn btn-primary " id="submit" type="submit"><span class="glyphicon glyphicon-search"></span></button>
                            @if(app('request')->input('type') and app('request')->input('type') == 'id')   <a class="btn btn-danger " href="{{url('admin/appointment/appointment_report')}}"><i class="fa fa-ban" aria-hidden="true"></i> </a>@endif
                        </div>
                    </form>

                  </div>
                  <div class="box-tools pull-right">
                    <form action="{{ URL::to('admin/appointment/appointment-print')}}" target="_blank">
          ...
          <div class="box-body">
            ...
            <div class="row">
              ...
              <div class="box-tools pull-right">
                 ...
                 <h2><small>{{trans('labels.Total Sale Price')}}:</small>@if(!empty($result['commonContent']['currency']->symbol_left)) {{$result['commonContent']['currency']->symbol_left}} @endif {{ $tt }}  @if(!empty($result['commonContent']['currency']->symbol_right)) {{$result['commonContent']['currency']->symbol_right}} @endif  </h2>
              </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @if(count($result['reports']['orders']) > 0)
                    ...
                    <tr>
                        ...
                        <td>
                            <a data-toggle="tooltip" target="_blank" data-placement="bottom" title="{{ trans('labels.View Invoice') }}" href="{{url('admin/appointment/appinvoiceprint/'.$orderData->id)}}" class="badge bg-light-blue"><i class="fa fa-eye" aria-hidden="true"></i>{{ trans('labels.View Invoice') }}</a>
                        </td>
