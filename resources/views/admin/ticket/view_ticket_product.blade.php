...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> {{ trans('labels.ticket_products') }} <small>{{ trans('labels.ListingAllticket_products') }}...</small> </h1>
            <ol class="breadcrumb">
                <li><a href="{{ URL::to('admin/dashboard/this_month')}}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
                <li class="active">{{ trans('labels.ticket_products') }}</li>
            </ol>
        </section>
                        ...
                        <div class="box-header">
                           {{--  <div class="col-lg-6 form-inline">
                             ...
                             <div class="box-tools pull-right">
                                <a href="{{ URL::to('admin/ticket/add_product')}}" type="button" class="btn btn-block btn-primary">{{ trans('labels.AddNewCategory') }}</a>
                            </div> 
                        </div><br>
                                ...
                                <div class="col-xs-12">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ ++$key }}</td>
                                                <td>{{ $jesproduct->product_name }}</td>
                                                <td>{{ $jesproduct->created_at }}</td>
                                                <td>@if($jesproduct->status == 1) {{ trans('labels.Active') }} @else {{ trans('labels.Inactive') }} @endif</td>
                                                <td>
                                                    <a data-toggle="tooltip" data-placement="bottom" title="Edit" href="{{url('admin/ticket/edit_product/'. $jesproduct->id) }}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                                       
                                                             @if($jesproduct->id >0 )<a id="deleteTicketprouct"  data-toggle="tooltip" data-placement="bottom" title="Delete" membertype_id="{{$jesproduct->id}}" href="#" class="badge bg-red " ><i class="fa fa-trash" aria-hidden="true"></i></a>@endif
