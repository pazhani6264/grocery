                                            ...
                                            <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10 col-md-4">
                                                            <select class="form-control field-validate" name="options_required">
                                                                <option value="0" class="field-validate">Required</option>
                                                                <option value="1" class="field-validate">Optional</option>
                                                            </select>
                                            ...
                                            <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10 col-md-4">
                                                            <select class="form-control  field-validate" name="options_select_type">
                                                                <option value="0" class="field-validate">Single</option>
                                                                <option value="1" class="field-validate">Multiple</option>
                                                            </select>
