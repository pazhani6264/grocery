                                        ...
                                        @if(count($result['attributes'])>0)
                                            @foreach($result['attributes'] as $data)
                                                <tr>
                                                    ...
                                                    <td><a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Delete') }}" option_id="{{$data->products_options_id}}" 
                                                    id="deleteOptionId"
                                                    class="badge bg-red"><i class="fa fa-trash " aria-hidden="true"></i></a></td>
                                                </tr>
            ...
            <div class="modal fade" id="deleteattributeModal" tabindex="-1" role="dialog" aria-labelledby="deleteAttributeModalLabel">
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-content">
                        ...
                        {!! Form::open(array('url' =>'admin/products/attributes/delete', 'name'=>'deleteAttribute', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" id="">{{ trans('labels.DeleteOption') }}</button>
