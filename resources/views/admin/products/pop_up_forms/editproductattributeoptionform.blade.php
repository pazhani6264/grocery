...
<div class="modal-body">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
	...
	<?php if($result['data']['is_special'] == 'yes') {?>
	<div class="form-group">
		<label for="name" class="col-sm-2 col-md-4 control-label">Special Type</label>
		<div class="col-sm-10 col-md-4" style="padding-left: 0;">
			<select class="form-control" name="special_type">
				
				<option value="1" @if($result['products_attributes'][0]->special_type=='1') selected @endif>Discount (RM)</option>
				<option value="2" @if($result['products_attributes'][0]->special_type=='2') selected @endif>Discount (%)</option>
				
			</select>
		</div>
		<div class="col-sm-10 col-md-4">
		
           <input type="text" name="special_price"  value="<?php if(!empty($result['products_attributes'][0]->special_discount)){ echo $result['products_attributes'][0]->special_discount; } else { echo 0;}?>"  class="form-control" id="special_price">
		</div>	
	</div>
	<?php }?>
	 ...
	 <div class="form-group">
      <label for="name" class="col-sm-2 col-md-4 control-label">Product Quantity</label>
          ...
          <div class="col-sm-10 col-md-4">
            {!! Form::text('addqunt_count', $result['products_attributes'][0]->quantity_count, array('class'=>'form-control number-validate', 'id'=>'addqunt_count')) !!}
          </div>
        </div>
