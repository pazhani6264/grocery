...
<script type="text/javascript">
    ...
    $("#addPack").click(function(){
        ...
        $("#packageTable").append('<tr><td><select id="packService_'+i+'" class="form-control mob-td-width packmul['+i+']"name="cate[]"><?php foreach($category as $cate){ ?><option  value="<?php echo $cate->categories_id; ?>"><?php echo $cate->categories_name; ?></option><?php } ?></select></td><td><select id="packArea_'+i+'" class="form-control mob-td-width packmul['+i+']" name="product[]"><?php foreach($product as $pro){ ?><option  value="<?php echo $pro->products_id; ?>"><?php echo $pro->products_name; ?></option><?php } ?></select></td><?php if($pro->products_type == 1) { ?><td id="packSqft_'+i+'"><select class="form-control desk-td-width mob-td-width packmul['+i+']" name="attr[]"><?php foreach($attribute as $attr){ ?><option  value="<?php echo $attr->products_options_id; ?>"><?php echo $attr->products_options_name; ?></option><?php } ?></select></td><?php } else { ?><td id="packSqft_'+i+'"><input class="form-control desk-td-width mob-td-width packmul['+i+']" name="attr[]"></td><?php } ?><td><select id="attrbValue_'+i+'" class="form-control desk-td-width mob-td-width packmul['+i+']" name="attrValue[]"><?php foreach($attributeValue as $attrValue){ ?><option  value="<?php echo $attrValue->products_options_values_id; ?>"><?php echo $attrValue->products_options_values_name; ?></option><?php } ?></select></td><td><input class="form-control mob-td-width1 packinputs_'+i+' packvalues2_'+i+' packmul['+i+'] amountdata'+i+'" name="qty[]" value="1"  placeholder="Price"></td><td><button type="button" class="btn btn-danger remove-tr">Remove</button></td></tr>');
            ...
            $("#packArea_"+i).change(function() {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if(result.length != ''){
                            var k;
                            showData1 +="<select class='form-control desk-td-width mob-td-width' name='attr[]'><option value=''>Select</option>";
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if(result.length != ''){
                            ...
                            for (k = 0; k < result.length; ++k) {
                                showData2 +="<option value='"+result[k].products_options_id+"'>"+result[k].products_options_values_name+"</option>";
                            }
                            $("#attrbValue_"+i).show();
...
<script type="text/javascript">
    ...
    $("#addPackGetX").click(function(){
        ...
        $("#getxTable").append('<tr><td><select id="packServicegetx_'+i+'" class="form-control mob-td-width packmul['+i+']"name="cate_get_x[]"><?php foreach($category as $cate){ ?><option  value="<?php echo $cate->categories_id; ?>"><?php echo $cate->categories_name; ?></option><?php } ?></select></td><td><select id="packAreagetx_'+i+'" class="form-control mob-td-width packmul['+i+']" name="product_get_x[]"><?php foreach($product as $pro){ ?><option  value="<?php echo $pro->products_id; ?>"><?php echo $pro->products_name; ?></option><?php } ?></select></td><td><select id="packSqftgetx_'+i+'" class="form-control desk-td-width mob-td-width packmul['+i+']" name="attr_get_x[]"><?php foreach($attribute as $attr){ ?><option  value="<?php echo $attr->products_options_id; ?>"><?php echo $attr->products_options_name; ?></option><?php } ?></select></td><td><select id="attrbValuegetx_'+i+'" class="form-control desk-td-width mob-td-width packmul['+i+']" name="attrValue_get_x[]"><?php foreach($attributeValue as $attrValue){ ?><option  value="<?php echo $attrValue->products_options_values_id; ?>"><?php echo $attrValue->products_options_values_name; ?></option><?php } ?></select></td><td><input class="form-control mob-td-width1 packinputsgetx_'+i+' packvalues2getx_'+i+' packmul['+i+'] amountdata'+i+'" name="qty_get_x[]" value="1"  placeholder="Price"></td><td><button type="button" class="btn btn-danger remove-tr">Remove</button></td></tr>');
