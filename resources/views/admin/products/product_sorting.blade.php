   ...
   #page_list li.ui-state-highlight
   {
                ...
                <div class="col-md-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="container box">  
                                ...
                                @if(count($result['products'])>0)
                                    @foreach ($result['products'] as $key=>$product)
                                        <li data-id="{{ $product->products_id }}">
                            ...
                            <a href="{{ URL::to('admin/products/category_list')}}" type="button" class="btn btn-primary">Back</a>
                        </div>
                        <!-- /.box-body -->
                    </div>
                    <!-- /.box -->
    ...
    <script>
      $(document).ready(function(){
        ...
        $.ajax({
            url:"{{url('admin/products/updateorderproduct')}}",  
            method:"POST",
