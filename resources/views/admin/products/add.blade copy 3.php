                                            ...
                                            <h4 id="title"></h4>
                                                <table  style="margin-bottom:0px" class="table table-bordered" id="packageTable">  
                                                    ...
                                                    <tr>  
                                                        ...
                                                        <td><button type="button" name="addPack" id="addPackSubmit" class="btn btn-success">Submit</button></td>  
                                                    </tr>  
                                                </table> 
                                            </div>
                                        </div>
        ...
        $.ajax({
			...
			success: function (data) {
				...
				if(result.length != ''){
					var k;
                    for (k = 0; k < result.length; ++k) {
                        if(result[k].options_required == '0'){
                            var x = '<span style="color:red"> *</span>';
                        } else {
                            var x = '';
                        }
                        showData1 +="<select  id='packSqft_0' class='form-control desk-td-width mob-td-width packmul[0]' name='attr[]'>";
                            showData1 +="<option value=''>Select"+x+"</option>";
                            showData1 +="<option value='"+result[k].products_options_id+"'>"+result[k].products_options_name+"</option>";
                        showData1 +="</select><br>";
                    }
                    $("#attrBute").show();
					$("#attrBute").html(showData1);
				}else{
                    $("#attrBute").hide();
                    $("#attrbValue_0").hide();
                    showData1 +="<option value='0'></option>";
