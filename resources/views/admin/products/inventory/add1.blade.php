                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                    <div class="col-md-12">
                                    {!! Form::open(array('url' =>'admin/products/inventory/addnewstocknew', 'name'=>'inventoryfrom', 'id'=>'addewinventoryfrom', 'method'=>'post', 'class' => 'form-horizontal form-validate',
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <select class="form-control select2 field-validate product-type" name="products_id">
                                                ...
                                                @if($pro->stock_status == 1)
                                                    @if($pro->products_type != 3 && $pro->products_type != 4 )
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="box box-danger">
                                                            ...
                                                            <div class="box-footer text-center">
                                                                <button type="submit" id="attribute-btn-two"  class="btn btn-primary pull-right">{{ trans('labels.Submit') }}</button>
                                                            </div>
...
function updateActiveClass(event,id,attrid,type,options_id,a_id){
	
	if (type === 'radio') 
	{
        $('.new-' + a_id).removeClass('active');
	...
	currentstock_check(options_id,attrid);
}
...
function currentstock_check(options_id,attrid)
{
//ajax call for add option value
	...
	$.ajax({
		url: '{{ URL::to("admin/products/attach/attribute/default/options/currentstock_new")}}',
		type: "POST",
		data: formData,
		dataType: "json",
