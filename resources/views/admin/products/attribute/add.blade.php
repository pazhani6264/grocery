                                            ...
                                            @foreach($result['products_attributes'] as $key=>$products_attributes)
                                                @if($products_attributes->is_default == '1')
                                                    <tr>
                                                        ...
                                                        <td>{{ $products_attributes->weight }}{{ $products_attributes->weight_unit }}</td>
                                  ...
                                  {{ trans('labels.AddOptionValueText') }}</span>
                                                ...
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-4 control-label">SKU</label>
                                                     <div class="col-sm-10 col-md-8">
                                                        {!! Form::text('option_sku', '', array('class'=>'form-control number-validate', 'id'=>'option_sku')) !!}
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        {!! Form::text('dequnt_count', '1', array('class'=>'form-control number-validate', 'id'=>'dequnt_count')) !!}
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                                 $is_special = DB::table('products')->where([
                                                    'products_id' => $products_attributes->products_id
                                                ])->first();
                                               
                                                
                                                if($is_special->is_special == 'yes') {?>
                                            <th>Special price</th>
                                            <?php } ?>
                                            @endif
                                            <th>{{ trans('labels.Action') }}</th>
                                        ...
                                        @if(count($result['products_attributes']) > 0)
                                            @foreach($result['products_attributes'] as $key=>$products_attributes)
                                                ...
                                                <td>{{ $products_attributes->special_price }}</td>
                                                <?php } ?>
                                                        <td>
                                                            ...
                                                            <a products_id = '{{ $products_attributes->products_id }}' products_attributes_id = "{{ $products_attributes->products_attributes_id }}" class="badge bg-red deleteproductattributemodal"><i class="fa fa-trash " aria-hidden="true"></i></a>
                                                        </td>
                                                    </tr>
                                                @endif
                                            @endforeach
                                  ...
                                  {{ trans('labels.OptionValuesText') }}</span>
                                                ...
                                                if($is_special->is_special == 'yes') {?>
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-4 control-label">Special Type</label>
                                                    <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="special_price" value="0" class="form-control" id="special_price">
                                                ...
                                                @endif
                                                  ...
                                                  <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-4 control-label">SKU</label>
                                                     <div class="col-sm-10 col-md-8">
                                                        {!! Form::text('addoption_sku', '', array('class'=>'form-control number-validate', 'id'=>'addoption_sku')) !!}
                                                 ...
                                                 <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-4 control-label">Product Quantity</label>
                                                     <div class="col-sm-10 col-md-4">
                                                        <select class="form-control" name="addqut_type">
                                                            <option value="0">Single</option>
                                                            <option value="1">Multiple</option>   
                                                        </select>
                                                    </div>
                                                    <div class="col-sm-10 col-md-4">
                                                        {!! Form::text('addqunt_count', '1', array('class'=>'form-control number-validate', 'id'=>'addqunt_count')) !!}
                            ...
                            <div class="box-footer text-center">
                                <a href="{{ Session::get('furl') }}" class="btn btn-default pull-left"><i class="fa fa-angle-left"></i> {{ trans('labels.back') }} </a>
