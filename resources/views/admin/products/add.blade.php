                                            ...
                                            <h4 id="title"></h4>
                                                <table  style="margin-bottom:0px" class="table table-bordered" id="packageTable">  
                                                    <tr>
                                                        <th>Category Name</th>
                                                        <th>Product Name</th>
                                                        <th class="simple-product-show">Qty</th>
                                                        <th class="simple-product-show">Action</th>
                                                    </tr>
                                                    <tr>  
                                                        <td>
                                                ...
                                                <table  style="margin-bottom:0px" class="table table-bordered">  
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>1</td>
                                                        <td><i id="admincombodelete" combodeleteID="1" style="cursor:pointer" class="fa fa-trash"></i></td>
                                                    </tr>
...
<script>
    ...
    jQuery(".simple-product-show").hide();
    $('#packArea_0').change(function() {
        var products_id = $('#packArea_0').val();
        jQuery("#products-detail2").html('');
        jQuery(function ($) {
        jQuery.ajax({
            url: '{{ URL::to("admin/products/admin_modal_show")}}',
            headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
                type: "Post",
                data: '&products_id='+products_id,
                success: function (res) {
                    // if(res.products_type == '1'){
                    //     jQuery(".simple-product-show").show();
                    // }else {
...
<script>
    ...
    $('#admincombodelete').click(function() {
        alert('Are you Sure You Want to Delete');
        var id = $('#admincombodelete').attr('combodeleteID');
        $.ajax({
            url: '{{ URL::to("admin/products/ajax_attribute_value")}}',
			type: "POST",
			data: '&id='+id,
