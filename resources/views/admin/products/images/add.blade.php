                                ...
                                <div class="col-xs-12">
                                          ...
                                          <div class="form-group" id="imageIcone">
                                              ...
                                              <div class="col-sm-10 col-md-4">
                                                      ...
                                                      <div class="modal-dialog" role="document">
                                                          <div class="modal-content">
                                                              ...
                                                              <div class="modal-footer">
                                                                  ...
                                                                  <button type="button" class="btn btn-success" id="selectedICONEMulit" data-dismiss="modal">{{ trans('labels.Done') }}</button>
                                                              </div>
                                                          </div>
                                                      </div>
                                                  </div>
                                                  <div id="imageselected">
                                                    ...
                                                    <br>
                                                    <div>
                                                    <div id="selectedthumbnailIcon" class="selectedthumbnail"> </div>
                                                  </div>
                                                    <div class="closimage">
							     ...
							     {{ trans('labels.ImageDescription') }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-primary float-right" >{{ trans('labels.submit') }}</button>
                                        </div>
                                            <br><br><br><br><br>
