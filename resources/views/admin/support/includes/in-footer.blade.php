            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__logo">
                            ...
                            <a href="{{ URL::to('/')}}"><img src="{{asset('').$result['commonContent']['settings']['website_logo']}}" width="220"></a>
                             @endif
                        </div>
                ...
                <div class="col-lg-2 col-md-3 col-sm-6">
                    <div class="footer__widget">
                        ...
                        <div class="footer__widget footer__widget--social">
                            <ul>
                                <li><a href="{{url('admin/support/tickets')}}">{{__('My tickets')}}</a></li>
                                <li><a href="{{url('admin/support/open-ticket')}}">{{__('Open ticket')}}</a></li>
                                <li><a href="{{url('admin/support/notifications')}}">{{__('Notifications')}}</a></li>
                ...
                <div class="col-lg-3 offset-lg-1 col-md-6 col-sm-6">
                    <div class="footer__widget footer__widget--address">
                        ...
                        <ul>
                            <li><i class="fa fa-user"></i> {{__('Full name :')}} {{auth()->user()->first_name.' '.auth()->user()->last_name}}</li>
