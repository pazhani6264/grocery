  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-white">
    <div class="container">
      <a class="navbar-brand" href="{{url('/')}}">
        ...
        <img src="{{asset('').$result['commonContent']['settings']['website_logo']}}" alt="<?=stripslashes($result['commonContent']['settings']['website_name'])?>" width="200px">
         @endif
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav m-auto edit-nav">
          <li class="nav-item">
            <a class="nav-link" data-toggle="tooltip" data-placement="bottom" title="Dashboard" href="{{url('admin/support/tickets')}}">
            <img src="{{ asset('images/tickets/dashboard.svg') }}" width="40" height="40"></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-toggle="tooltip" data-placement="bottom" title="My tickets" href="{{url('admin/support/view_tickets')}}">
            <img src="{{ asset('images/tickets/tickets.svg') }}" width="40" height="40"></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-toggle="tooltip" data-placement="bottom" title="New ticket" href="{{url('admin/support/open-ticket')}}">
            <img src="{{ asset('images/tickets/new.svg') }}" width="40" height="40"></a>
          </li>

          @php
             $notice = DB::connection('mysql2')->table('tickets')
         ...
         <li class="nav-item notice">
            <a class="nav-link" data-toggle="tooltip" data-placement="bottom" title="Notifications" href="{{url('admin/support/notifications')}}">
