    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ URL::to('admin/banners_two')}}"><i class="fa fa-bars"></i> List All Banners</a></li>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <!-- form start -->
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'admin/banners_two/insert_two', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select class="form-control" name="type" id="bannerType" onchange="bannerstypes()">
                                                        <option value="category">Show Categories</option>
