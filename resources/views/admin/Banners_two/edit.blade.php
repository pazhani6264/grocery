                        ...
                        <div class="box-body">
                          ...
                          <h3 class="box-title">Edit category</h3>
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'admin/banners_two/update_two', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select class="form-control" name="categories_id" id="categories_id">
                                                        @foreach($result['categories'] as $category)
                                                            <option @if($result['banners'][0]->banners_url == $category->id) selected @endif value="{{ $category->id}}">{{ $category->name}}</option>
                                                        @endforeach
                                                    </select>
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select class="form-control" name="products_id" id="products_id">
                                                        @foreach($result['products'] as $products_data)
                                                            <option @if($result['banners'][0]->banners_url == $products_data->products_id) selected @endif value="{{ $products_data->products_id }}">{{ $products_data->products_name }}</option>
                                                        @endforeach
                                                    </select>
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                    ...
                                    {{ trans('labels.ExpiryDateBanner') }}</span>
                                      ...
                                      {{ trans('labels.StatusBannerText') }}</span>
                                            ...
                                            <div class="box-footer text-center">
                                                ...
                                                <a href="{{ URL::to('admin/banners_two')}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                                            </div>
                                            <!-- /.box-footer -->
                                            {!! Form::close() !!}
                                        </div>
