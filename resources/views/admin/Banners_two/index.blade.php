                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="col-lg-6 form-inline" id="contact-form">
                                ...
                                <form  name='registration' id="registration" class="registration" method="get" action="{{url('admin/banners_two/filter_two')}}">
                                    ...
                                    <div class="input-group-form search-panel ">
                                        ...
                                        @if(isset($param,$name))  <a class="btn btn-danger " href="{{url('admin/banners_two')}}"><i class="fa fa-ban" aria-hidden="true"></i> </a>@endif
                                        {{--</span>--}}
                                    </div>
                                </form>
                            ...
                            <div class="box-tools pull-right">
                                <a href="{{url('admin/banners_two/add_two')}}" type="button" class="btn btn-block btn-primary">{{ trans('labels.AddNewBanner') }}</a>
                            </div>
                        </div>
                                        ...
                                        @if(count($result['banners'])>0)
                                            ...
                                            @foreach ($resultitems['banners'] as $key=>$banners)
                                                <tr>
                                                    ...
                                                    <td><a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Edit') }}" href="{{url('admin/banners_two/edit_two')}}/{{ $banners->banners_id }}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
            ...
            <div class="modal fade" id="deleteBannerModal" tabindex="-1" role="dialog" aria-labelledby="deleteBannerModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        {!! Form::open(array('url' =>'admin/banners_two/delete_two', 'name'=>'deleteBanner', 'id'=>'deleteBanner', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
