...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> {{ trans('labels.shoppinginfo') }} <small>{{ trans('labels.AddNewshoppinginfo') }}...</small> </h1>
        <ol class="breadcrumb">
            <li><a href="{{ URL::to('admin/dashboard/this_month') }}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
            <li><a href="{{ URL::to('admin/shoppinginfo/view')}}"><i class="fa fa-database"></i>{{ trans('labels.shoppinginfo') }}</a></li>
            <li class="active">{{ trans('labels.AddNewshoppinginfo') }}</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">{{ trans('labels.AddNewshoppinginfo') }} </h3>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    {!! Form::open(array('url' =>'admin/shoppinginfo/add_action', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                              ...
                              <!--           
                                        <div class="form-group" id="imageselected">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Image') }} (30 * 30) <span style="color:red;">*</span></label>
                                            <div class="col-sm-10 col-md-4">
