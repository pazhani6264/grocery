                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <form enctype="multipart/form-data" class="form-horizontal form-validate"  action="{{url('admin/inventory/vendorupdate')}}" method="post">
                                         {!! csrf_field() !!}
                                         {!! Form::hidden('id', $result['vendor']->id, array('class'=>'form-control', 'id'=>'id')) !!}
                                        <div class="row">
                                            <div class="col-xs-12">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        {!! Form::text('vendor_name', $result['vendor']->name, array('class'=>'form-control field-validate', 'id'=>'vendor_name')) !!}
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        {!! Form::text('vendor_email', $result['vendor']->email, array('class'=>'form-control email-validate', 'id'=>'vendor_email')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3 col-md-3">
                                                        <select class="form-control select2 field-validate" name="ccode" id="ccode">
                                                            @if(!empty($result['countries']))
                                                                    <?php $check_code=$result['vendor']->cc_code; ?>
                                                    ...
                                                    <div class="col-sm-8 col-md-5">
                                                        {!! Form::text('vendor_phone', $result['vendor']->phone, array('class'=>'form-control number-validate', 'id'=>'vendor_phone')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group" id="tax-class">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        {!! Form::text('contact_name', $result['vendor']->contact_name, array('class'=>'form-control field-validate', 'id'=>'contact_name')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        <input type="text" value="{{$result['vendor']->street_1}}" id="street_1" name="street_1" class="form-control field-validate">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                         <input type="text" id="street_2" value="{{$result['vendor']->street_2}}" name="street_2" class="form-control field-validate">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        <select class="form-control select2 field-validate" id="entry_country_id" name="country">
                                                            ...
                                                            @if(!empty($result['countries']))
                                                            <?php $check_country=$result['vendor']->country; ?>
                                                                @foreach($result['countries'] as $jescode)
                                                                    <option value="{{$jescode->countries_id}}" @if($jescode->countries_id==$check_country) selected @endif>{{$jescode->countries_name}}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        <select class="form-control select2 field-validate zoneContent" id="entry_zone_id" name="state">
                                                            ...
                                                            @if(!empty($result['state']))
                                                                <?php $check_state=$result['vendor']->state; ?>
                                                            @foreach($result['state'] as $jesstate)
                                                                <option value="{{$jesstate->zone_id}}" @if($jesstate->zone_id==$check_state) selected @endif>{{$jesstate->zone_name}}</option>
                                                            @endforeach
                                                            @endif
                                                        </select>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        <input type="text" id="city" value="{{$result['vendor']->city}}"  name="city" class="form-control field-validate">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        <input type="text" id="zipcode" value="{{$result['vendor']->post_code}}" name="zipcode" class="form-control number-validate">
                                                    </div>
                                                </div>
                                            </div> 
