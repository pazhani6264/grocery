...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> Stock Out <small>Stock Out...</small> </h1>
            <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-md-12">
                 ...
                 <div class="col-md-4" style="padding-top: 25px">
                               ...
                               <div class="col-md-2" style="padding-top: 25px">
                                <a href="{{ URL::to('admin/inventory/stockout')}}" type="button" class="btn btn-block btn-primary">New Stock-Out</a>
                                </div>
                            </div> 
                        </div>
                                ...
                                <div class="col-xs-12">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th>Receiver Invoice No.</th>
                                            <th>Receiver Invoice Amount</th>
                                            <th>Receiver Name</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                             @if(count($result['stock'])>0)
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="javascript:;" onclick="loadModalStockIn({{$jrestock->id}},'out')">{{$jrestock->ref_no}}</a></td>
                                                    <td>
