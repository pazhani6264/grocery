                    ...
                    <select type="button" required class="btn btn-default select2 form-control product_type" data-toggle="dropdown" name="products_id" id="products_id"  >
                        ...
                        @foreach($result['products'] as $product)
                          @if($product->stock_status == 1)
                            @if($product->products_type != 3 && $product->products_type != 4 )
                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                   ...
                   <tbody>
                    ...
                    @php
                      $language_id      =   '1';
                      $attributes = DB::table('orders_products_attributes')->where('orders_id', $report->reference_code)->where('orders_products_id', $report->orders_products_id)->where('products_id', $report->products_id)->get();
                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              @else
                                ...
                                @if(!empty($attributes))
                                  @foreach($attributes as $key1=>$jesattributes)
