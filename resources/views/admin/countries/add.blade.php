                                    ...
                                    <div class="box box-info"><br>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.CountryName') }} <span style="color:red;">*</span>
                                                </label>
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.ISOCode2') }} <span style="color:red;">*</span>
                                                </label>
                                                <div class="col-sm-10 col-md-4">
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.ISOCode3') }} <span style="color:red;">*</span>
                                                </label>
                                                <div class="col-sm-10 col-md-4">
