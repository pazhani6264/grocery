                                    ...
                                    <!-- form start -->
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select name="tax_zone_id" class="form-control select2">
                                                        @foreach($result['zones'] as $zones)
                                                            <option
                                                                    @if($result['taxrate']->tax_zone_id == $zones->countries_id)
                                                                    selected
                                                                    @endif
                                                                    value="{{ $zones->countries_id }}"> {{ $zones->countries_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.AddTaxRatePercentage') }} <span style="color:red;">*</span>
                                                </label>
                                                <div class="col-sm-10 col-md-4">
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Description') }} <span style="color:red;">*</span>
                                                </label>
                                                <div class="col-sm-10 col-md-4">
