...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> {{ trans('labels.Editshippingbykm') }} <small>{{ trans('labels.EditNewscurrentCategories') }}...</small> </h1>
            <ol class="breadcrumb">
                <li><a href="{{ URL::to('admin/dashboard/this_month') }}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
                <li><a href="{{ URL::to('admin/shippingmethods/shippingbykm/display')}}"><i class="fa fa-database"></i> {{ trans('labels.shippingbykm') }}</a></li>
                <li class="active">{{ trans('labels.Editshippingbykm') }}</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">{{ trans('labels.Editshippingbykm') }} </h3>
                        </div>
                        ...
                        <div class="box-body">
                          ...
                          <h3 class="box-title">Edit category</h3>
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'admin/shippingmethods/shippingbykm/update', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}

                                            {!! Form::hidden('km_id',  $result['km'][0]->km_id , array('class'=>'form-control', 'id'=>'km_id')) !!}
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <input type="text" name="kmfrom" value="{{$result['km'][0]->km_from}}" class="form-control field-validate">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <input type="text" name="kmto" value="{{$result['km'][0]->km_to}}" class="form-control field-validate">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <input type="text" name="kmprice" value="{{$result['km'][0]->km_price}}" class="form-control field-validate">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <input type="text" name="kmcommission" value="{{$result['km'][0]->km_commission}}" class="form-control field-validate">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select class="form-control" name="kmstatus">
                                                        <option value="1" @if($result['km'][0]->km_status==1) selected @endif>{{ trans('labels.Active') }}</option>
                                                        <option value="0" @if($result['km'][0]->km_status==0) selected @endif>{{ trans('labels.Inactive') }}</option>
                                                    </select>
