              		...
              		<div class="box box-info">
                        ...
                        <!-- form start -->
                         <div class="box-body">
                            ...
                            {!! Form::open(array('url' =>'admin/shippingmethods/shippingbyweightandkm/insert_km', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                            
                                <div class="form-group">
                                  <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.kmfrom') }} <span style="color:red;">*</span></label>
                                  <div class="col-sm-10 col-md-4">
                                    <input type="text" name="from_km" class="form-control field-validate">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <input type="text" name="to_km" class="form-control field-validate">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <input type="text" name="price_km" class="form-control field-validate">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <input type="text" name="commission_km" class="form-control field-validate">
