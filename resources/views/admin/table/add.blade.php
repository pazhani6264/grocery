...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> Table <small>Add Table...</small> </h1>
        <ol class="breadcrumb">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    {!! Form::open(array('url' =>'admin/table/addNew', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-10 col-md-4">
                                            <select class="form-control field-validate" name="outlet_id">
                                                ...
                                                @foreach($outlet as $jesoutlet)
                                                  <option value="{{ $jesoutlet->id }}">{{ $jesoutlet->name }}</option>
                                                @endforeach
                                                @endif 
                                            </select>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                <input type="text" name="tname" class="form-control field-validate">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                <input type="number" name="nperson" class="form-control field-validate">
                                            </div>
                                        </div>
