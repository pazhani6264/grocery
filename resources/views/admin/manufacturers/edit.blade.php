    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ URL::to('admin/manufacturers/display')}}"><i class="fa fa-industry"></i> {{ trans('labels.Brand') }}</a></li>
                                    ...
                                    <!-- /.box-header -->
                                        ...
                                        <div class="box-body">
                                            ...
                                            <input type="hidden" name="old_slug" value="{{$editManufacturer->slug}}">
                                                    <input type="hidden" name="slug" class="form-control field-validate" value="{{$editManufacturer->slug}}">

                                            <!-- <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.slug') }} <span style="color:red;">*</span></label>
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="hidden" name="old_slug" value="{{$editManufacturer->slug}}">
                                                    <input type="hidden" name="slug" class="form-control field-validate" value="{{$editManufacturer->slug}}">
                                           ...
                                           <!--  <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.BrandURL') }}</label>
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::url('manufacturers_url',  $editManufacturer->url , array('class'=>'form-control', 'id'=>'manufacturers_url'), value(old('manufacturers_url')))  !!}
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.BrandURLText') }}</span>
                                                </div>
                                            </div> -->
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Logo') }} (100 * 100)</label>
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <!-- Modal -->
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        ...
                                                                        <h3 class="modal-title text-primary" id="myModalLabel">{{ trans('labels.chooselogo') }} </h3>
                                                                    </div>
                                                        ...
                                                        <div id ="imageselected">
                                                            ...
                                                            <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 3px;">{{ trans('labels.selectlogo') }}</span>
                                                            <div class="closimage">
