    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ URL::to('admin/gallery/add_gallery')}}"><i class="fa fa-industry"></i> Gallery Image</a></li>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <!-- /.box-header -->
                                        <!-- form start -->
                                        <div class="box-body">
                                            {!! Form::open(array('url' =>'admin/gallery/add_galleryimage_action', 'method'=>'post', 'class' => 'form-horizontal form-validate ', 'enctype'=>'multipart/form-data')) !!}
                                            ...
                                            <div class="box-footer text-center">
                                                ...
                                                <a href="{{ URL::to('admin/gallery/viewgalleryimage')}}/{{ $result['gallery']->id }}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                                            </div>
                                            <!-- /.box-footer -->
                                            {!! Form::close() !!}
                                        </div>
