                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label for="name"
                                                class="col-sm-2 col-md-3 control-label">{{ trans('labels.title') }} <span style="color:red;">*</span>
                                            </label>
                                        ...
                                        <div class="form-group">
                                            <label for="name"
                                                class="col-sm-2 col-md-3 control-label">{{ trans('labels.symbol') }} <span style="color:red;">*</span>
                                            </label>
                                            <div class="col-sm-10 col-md-4">
                                        ...
                                        <div class="form-group" style="display: none">
                                            <label for="name"
                                                class="col-sm-2 col-md-3 control-label">{{ trans('labels.decimal_point') }} <span style="color:red;">*</span>
                                            </label>
                                            <div class="col-sm-10 col-md-4">
                                        ...
                                        <div class="form-group" style="display: none">
                                            <label for="name"
                                                class="col-sm-2 col-md-3 control-label">{{ trans('labels.thousands_point') }} <span style="color:red;">*</span>
                                            </label>
                                            <div class="col-sm-10 col-md-4">
                                        ...
                                        <div class="form-group">
                                            <label for="name"
                                                class="col-sm-2 col-md-3 control-label">{{ trans('labels.decimal_places') }} <span style="color:red;">*</span>
                                            </label>
                                            <div class="col-sm-10 col-md-4">
                                        ...
                                        <div class="form-group">
                                            <label for="name"
                                                class="col-sm-2 col-md-3 control-label">{{ trans('labels.value') }} <span style="color:red;">*</span>
                                            </label>
                                            <div class="col-sm-10 col-md-4">
