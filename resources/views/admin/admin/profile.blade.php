                   ...
                   {!! Form::open(array('url' =>'admin/admin/update', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
                      ...
                      <div class="form-group">
                        <label for="inputSkills" class="col-sm-2 control-label">{{ trans('labels.State') }}</label>
    					             <div class="col-sm-10">
                           <select class="form-control zoneContent" name="state" id="entry_zone_id">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                        <input type="text" name="zip" value="{{$result['admin']->entry_postcode}}"  class="form-control" id="zip" onkeydown="return ( event.ctrlKey || event.altKey
                 ...
                 {!! Form::open(array('url' =>'admin/admin/updatepassword', 'onSubmit'=>'return validatePasswordForm()', 'id'=>'updateAdminPassword', 'name'=>'updateAdminPassword' , 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
                  ...
                  <div class="form-group">
                    <label for="password" class="col-sm-2 control-label">{{ trans('labels.NewPassword') }}</label>
                      ...
                      <span class="help-block error-content" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.AdminPasswordRestriction') }}</span>
                      <span style="display: none" class="help-block"></span>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label for="re-password" class="col-sm-2 control-label">{{ trans('labels.Re-EnterPassword') }}</label>
					          <div class="col-sm-10">
                      <input type="password" class="form-control repass" id="re_password" name="re_password" placeholder="Re-Enter Password">
                      <span class="help-block error-content" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.AdminPasswordRestriction') }}</span>
                      <span style="display: none" class="help-block error2" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">@lang('website.Password does not match the confirm password')</span>
