                                ...
                                <div class="box box-info">
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-xs-12 col-sm-6">
                                            <div class="form-group" id="imageIcone">
                                                  <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Avatar') }} <span style="color:red;">*</span></label>
                                                  <div class="col-sm-10 col-md-8">
                                                      <!-- Modal -->
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-xs-12 col-sm-6">
                                                <div class="form-group">
                                                  <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.ZipCode') }} <span style="color:red;">*</span></label>
                                                  <div class="col-sm-10 col-md-8">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-6">
                                                  <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                      <select class="form-control zoneContent field-validate select2" name="state_id" id="entry_zone_id">
                                            ...
                                            <div class="row">
                                              <div class="col-xs-12 col-sm-6">
                                                <div class="form-group">
                                                  <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Vehicle_name') }} <span style="color:red;">*</span></label>
                                                  <div class="col-sm-10 col-md-8">
                                              ...
                                              <div class="col-xs-12 col-sm-6">
                                                <div class="form-group">
                                                  <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.owner_name') }} <span style="color:red;">*</span></label>
                                                  <div class="col-sm-10 col-md-8">
                                            ...
                                            <div class="row">
                                              <div class="col-xs-12 col-sm-6">
                                                ...
                                                <div class="form-group">
                                                  <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Vehicle_color') }} <span style="color:red;">*</span></label>
                                                  <div class="col-sm-10 col-md-8">
                                              ...
                                              <div class="col-xs-12 col-sm-6">
                                                <div class="form-group">
                                                  <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.vehicle_registration_number') }} <span style="color:red;">*</span></label>
                                                  <div class="col-sm-10 col-md-8">
                                            ...
                                            <div class="row">
                                              <div class="col-xs-12 col-sm-6">
                                                <div class="form-group">
                                                  <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Vehicle_details') }} <span style="color:red;">*</span></label>
                                                  <div class="col-sm-10 col-md-8">
                                              ...
                                              <div class="col-xs-12 col-sm-6">
                                                ...
                                                <div class="form-group image-content" id='image-content-3'>
                                                  <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.driving_license_image') }} <span style="color:red;">*</span></label>
                                                  <div class="col-sm-10 col-md-8" >
                                                      <!-- Modal -->
                                            ...
                                            <div class="row">
                                              <div class="col-xs-12 col-sm-6">
                                                <div class="form-group image-content" id='image-content-1'>
                                                  <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.vehicle_rc_book_image') }} <span style="color:red;">*</span></label>
                                                  <div class="col-sm-10 col-md-8" >
                                                      <!-- Modal -->
                                                      <div class="modal fade embed-images" id="imagemodel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                          <div class="modal-dialog" role="document">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group">
                                                <label for="name"
                                                    class="col-sm-2 col-md-3 control-label">{{ trans('labels.Account Title') }} <span style="color:red;">*</span>
                                                </label>
                                                <div class="col-sm-10 col-md-8">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group">
                                                <label for="name"
                                                    class="col-sm-2 col-md-3 control-label">{{ trans('labels.Account Number') }} <span style="color:red;">*</span>
                                                </label>
                                                <div class="col-sm-10 col-md-8">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group">
                                                <label for="name"
                                                    class="col-sm-2 col-md-3 control-label">{{ trans('labels.Routing Number') }} <span style="color:red;">*</span>
                                                </label>
                                                <div class="col-sm-10 col-md-8">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group">
                                                <label for="name"
                                                    class="col-sm-2 col-md-3 control-label">{{ trans('labels.Bank Address') }} <span style="color:red;">*</span>
                                                </label>
                                                <div class="col-sm-10 col-md-8">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group">
                                                <label for="name"
                                                    class="col-sm-2 col-md-3 control-label">{{ trans('labels.IBAN') }} <span style="color:red;">*</span>
                                                </label>
                                                <div class="col-sm-10 col-md-8">
                                                    {!! Form::text('bank_iban', '',
                                                    array('class'=>'form-control field-validate',
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group">
                                                <label for="name"
                                                    class="col-sm-2 col-md-3 control-label">{{ trans('labels.Swift') }} <span style="color:red;">*</span>
                                                </label>
                                                <div class="col-sm-10 col-md-8">
