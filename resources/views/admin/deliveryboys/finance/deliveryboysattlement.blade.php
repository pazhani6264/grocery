                    ...
                    <div class="col-xs-12 col-md-3">
                            ...
                            <div class="col-xs-12">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td> {{ date('d/m/Y',strtotime($monthlyearning->updated_at)) }}</td>
                                            <td>
                                                @if($monthlyearning->payment_method == 'Cash on Delivery')
                                                {{$result['commonContent']['currency']->symbol_left}}{{ $monthlyearning->amount }}{{$result['commonContent']['currency']->symbol_right}}
                                                @else
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                @if (count($result['withdraw']) > 0)
                                <div class="col-xs-12 text-right">
                                    {!! $result['withdraw']->appends(\Request::except('page'))->render() !!}
                                </div>
                                @endif
