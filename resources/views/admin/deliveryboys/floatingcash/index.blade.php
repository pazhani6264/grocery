                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody id="customers-table">
                                        ...
                                        <tr>
                                            ...
                                            <td width="20%">
                                            @if($users->status==0)
                                                <a class="btn btn-warning payment-recieved" id="paymentModalbtn" orders_id = "{{ $users->orders_id }}" style="width: 100%; margin-bottom: 5px;" href="#">{{ trans('labels.Recieved Payment') }}</a>
                                            @else
