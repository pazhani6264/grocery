                                ...
                                <div class="col-xs-12">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th>{{ trans('labels.cancel_status') }}</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <label class=" control-label">
                                                      <input type="radio" name="cancal{{ $OrderStatus->orders_status_id }}" value="1" class="form-check-input set_cancel" status_id="{{$OrderStatus->orders_status_id}}" @if($OrderStatus->cancel_flag == '1') checked @endif > &nbsp;{{ trans('labels.Yes') }}
                                                </label>
                                                <label class=" control-label">
                                                <input type="radio" name="cancal{{ $OrderStatus->orders_status_id }}" value="0" class="form-check-input set_cancel" status_id="{{$OrderStatus->orders_status_id}}" @if($OrderStatus->cancel_flag == '0') checked @endif > &nbsp;{{ trans('labels.No') }}
                                                </label>
                                                </td>
