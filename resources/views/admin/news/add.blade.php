...
@section('content')
                                    ...
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">News style <span style="color:red;">*</span></label>
                                                <div class="col-sm-10 col-md-4">
                                                <select class="form-control field-validate" id="blog_style" name="blog_style">
                                                        <option value="1">News Style 1</option>
                                                        <option value="2">News Style 2</option>
                                                    </select>
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">Choose news style</span>
                                            ...
                                            @foreach($result['languages'] as $languages)
                                                ...
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.TitleNews') }} ({{ $languages->name }}) <span style="color:red;">*</span></label>
                                                    <div class="col-sm-10 col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Description') }} ({{ $languages->name }}) <span style="color:red;">*</span></label>
                                            ...
                                            <div class="form-group blog-image-main-outer" id="imageselected">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">Image <span class="blog_main_image">(376 x 250)</span> <span style="color:red;">*</span></label>
                                            <div class="col-sm-10 col-md-4">
                                        ...
                                        <div class="form-group" id="imageIcone">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">Thumnail Image<span id="mobilescreenSize"> <span class="blog_thumb_image"> (180 x 180) </span> <span style="color:red;">*</span></label>
                                            <div class="col-sm-10 col-md-4">
                                                <!-- Modal -->
    ...
    <script>
         //$('#imageIcone').hide();
	$(function() {
		$('#blog_style').change(function(){
            
			if($('#blog_style').val() == '1') {
                //$('#imageIcone').hide();
                $('.blog_main_image').html('(375 * 250)');
				
			} else if($('#blog_style').val() == '2') {
                //$('#imageIcone').show();
                $('.blog_main_image').html('(900 * 900)');
			}
		});
	});
</script>
    ...
    <script type="text/javascript">
        ...
        jQuery.ajax({
            ...
            url: "{{url('/admin/newsNotificationCron')}}",
            type: "GET",
            data: "",
