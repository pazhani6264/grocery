                                ...
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::hidden('oldImage',  $result['news'][0]->news_thumb_image , array('id'=>'oldImage2')) !!}


                                            <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">Image (376 * 250) <span id="desktopscreenSize"></span> </label>
                                            <div class="col-sm-10 col-md-4">
                                                <!-- Modal -->
                                        ...
                                        @if($result['news'][0]->news_type == 2)
                                        
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">Thumb Image (180 *180)<span id="mobilescreenSize"></span></label>
                                            <div class="col-sm-10 col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.OldImage') }}</span>
                                                <br>
                                                <img src="{{asset($result['news'][0]->thumb_path)}}" alt="" width=" 100px">
