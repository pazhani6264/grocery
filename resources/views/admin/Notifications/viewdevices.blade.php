                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="push-notification">
                            ...
                            <div class="alert alert-warning alert-dismissible callout hide empty-push">
                                <button type="button" class="close" data-dismiss="alert"
                                    aria-hidden="true">&times;</button>
                                User Was Inactive can not able to send notification.
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::text('title', '', array('class'=>'form-control field-validate form-clear',
                                    'required', 'id'=>'title')) !!}
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::textarea('message', '', array('class'=>'form-control form-clear', 'required',
                                    'rows'=>'5', 'id'=>'message')) !!}
                                    <span class="help-block"
