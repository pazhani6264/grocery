...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> {{ trans('labels.member_type') }} <small>{{ trans('labels.add_new_member_type') }}...</small> </h1>
        <ol class="breadcrumb">
            ...
            <li class="active">{{ trans('labels.add_new_member_type') }}</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">{{ trans('labels.add_new_member_type') }} </h3>
                    </div>
                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        {!! Form::open(array('url' =>'admin/loyalty/add_member_type_action', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                    ...
                    || (event.keyCode==46) )" maxlength="5">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                <input name="rate_others" id="rate_others" class="form-control field-validate" onkeypress="return isNumberKey(event)" type='text'  maxlength="5">
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.rate_wallet') }}<span style="color:red;">*</span></label>
                                            <div class="col-sm-10 col-md-4">
                                                <input name="rate_wallet" id="rate_wallet" class="form-control field-validate" type='text' maxlength="5" onkeypress="return isNumberKey(event)">
                                            </div>
                                        </div>


                                        <div class="form-group" id="imageselected">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.member_card') }}<span style="color:red;">*</span></label>
                                            <div class="col-sm-10 col-md-4">
                                        ...
                                        <div class="form-group" id="imageIcone">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.member_icon') }}<span style="color:red;">*</span></label>
                                            <div class="col-sm-10 col-md-4">
                                                <!-- Modal -->
