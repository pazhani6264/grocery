...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> {{ trans('labels.loyalty') }} <small>{{ trans('labels.add_new_earn_points') }}...</small> </h1>
        <ol class="breadcrumb">
            <li><a href="{{ URL::to('admin/dashboard/this_month') }}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
            <li><a href="{{ URL::to('admin/loyalty/earn_points_view')}}"><i class="fa fa-database"></i>{{ trans('labels.loyalty') }}</a></li>
            <li class="active">{{ trans('labels.add_new_earn_points') }}</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">{{ trans('labels.add_new_earn_points') }} </h3>
                    </div>
                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        {!! Form::open(array('url' =>'admin/loyalty/add_earn_points_action', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
