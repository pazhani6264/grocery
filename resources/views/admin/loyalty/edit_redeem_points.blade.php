...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> {{ trans('labels.loyalty') }} <small>{{ trans('labels.edit_redeem_points') }}...</small> </h1>
        <ol class="breadcrumb">
            ...
            <li class="active">{{ trans('labels.edit_redeem_points') }}</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">{{ trans('labels.edit_redeem_points') }} </h3>
                    </div>
                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        {!! Form::open(array('url' =>'admin/loyalty/update_redeem_points', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}

                                        {!! Form::hidden('id', $result['editredeempoints'][0]->id , array('class'=>'form-control', 'id'=>'id')) !!}

                                        {!! Form::hidden('oldImage', $result['editredeempoints'][0]->image , array('id'=>'oldImage')) !!}
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select name="discount_type" class='form-control' id="discount_type">
                                                         <option value="fixed_cart" @if($result['editredeempoints'][0]->discount_type == 'fixed_cart') selected @endif>Cart {{$result['commonContent']['currency']->symbol_left}} Discount</option>
                                                        <option value="percent" @if($result['editredeempoints'][0]->discount_type == 'percent') selected @endif>Cart % Discount</option>
                                                        <option value="product" @if($result['editredeempoints'][0]->discount_type == 'product') selected @endif>Product</option>
                                                    </select>
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                    {{ trans('labels.DiscounttypeText') }}</span>
                                        ...
                                        <div class="col-sm-10 col-md-4">
                                            <select class="form-control select2 product-type" name="products_id" id="products_id">
                                                ...
                                                <option  @if( $pro->products_id == $result['editredeempoints'][0]->products_id)
                                                                    selected
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                            <input name="point" id="point" class="form-control field-validate" type="number" min="1" value="{{$result['editredeempoints'][0]->points}}">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                <input type="number" name="amount" id="amount" class="form-control field-validate" min="1" value="{{$result['editredeempoints'][0]->no_rm}}">
                                            </div>
                                        </div>
                                @if($result['editredeempoints'][0]->discount_type == 'percent')
                                <div id="editrpoint">
                                         <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.cap_amount') }}<span style="color:red;"></span></label>
                                            <div class="col-sm-10 col-md-4">
                                                <input type="number" name="cap_amount" id="cap_amount" class="form-control" value="{{$result['editredeempoints'][0]->cap_amount}}" min="1">
                                            </div>
                                        </div>
                    </div>
                    @else
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                              ...
                                              <br>
                                              <img src="{{asset($result['editredeempoints'][0]->imgpath)}}" alt="" width=" 100px">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-10 col-md-4">
                                            <select class="form-control" name="categories_status">
                                             <option value="1" @if($result['editredeempoints'][0]->status=='1') selected @endif>{{ trans('labels.Active') }}</option>
                                             <option value="0" @if($result['editredeempoints'][0]->status=='0') selected @endif>{{ trans('labels.Inactive') }}</option>
                                            </select>
                                          <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
