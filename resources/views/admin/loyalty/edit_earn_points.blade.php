...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> {{ trans('labels.loyalty') }} <small>{{ trans('labels.edit_new_earn_points') }}...</small> </h1>
        <ol class="breadcrumb">
            <li><a href="{{ URL::to('admin/dashboard/this_month') }}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
            <li><a href="{{ URL::to('admin/loyalty/earn_points_view')}}"><i class="fa fa-database"></i>{{ trans('labels.loyalty') }}</a></li>
            <li class="active">{{ trans('labels.edit_new_earn_points') }}</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">{{ trans('labels.edit_new_earn_points') }} </h3>
                    </div>
                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        {!! Form::open(array('url' =>'admin/loyalty/update_earn_points', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}

                                        {!! Form::hidden('id', $result['editearnpoints'][0]->id , array('class'=>'form-control', 'id'=>'id')) !!}

                                        {!! Form::hidden('oldImage', $result['editearnpoints'][0]->image , array('id'=>'oldImage')) !!}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="point" id="point" class="form-control field-validate" onkeydown="return ( event.ctrlKey || event.altKey
                                                    ...
                                                    || (event.keyCode==46) )" maxlength="5" value="{{$result['editearnpoints'][0]->points}}">
                                            </div>
                                        </div>
                                         <div class="form-group">
                    ...
                    || (event.keyCode==8) || (event.keyCode==9)
                    || (event.keyCode>34 && event.keyCode<40)
                    || (event.keyCode==46) )" maxlength="5" value="{{$result['editearnpoints'][0]->no_rm}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                              ...
                                              <br>
                                              <img src="{{asset($result['editearnpoints'][0]->imgpath)}}" alt="" width=" 100px">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-10 col-md-4">
                                            <select class="form-control" name="categories_status">
                                             <option value="1" @if($result['editearnpoints'][0]->status=='1') selected @endif>{{ trans('labels.Active') }}</option>
                                             <option value="0" @if($result['editearnpoints'][0]->status=='0') selected @endif>{{ trans('labels.Inactive') }}</option>
                                            </select>
                                          <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                        ...
                                        <div class="box-footer text-center">
                                            ...
                                            <a href="{{ URL::to('admin/loyalty/earn_points_view')}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                                        </div>
                                        <!-- /.box-footer -->
                                        {!! Form::close() !!}
                                    </div>
