            ...
            @if( $result['commonContent']['roles'] != null and $result['commonContent']['roles']->dashboard_view == 1)
                ...
                <div class="col-lg-4 col-xs-6">
                    ...
                    <div class="small-box bg-light-blue">
                      ...
                      <a href="{{ URL::to('admin/orders/filter?FilterBy=Status&parameter=&parameter2=2')}}" class="small-box-footer" data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.viewAllOrders') }}">{{ trans('labels.viewAllOrders') }} <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                <!-- ./col -->
              ...
              <div class="row">
                <div class="col-lg-4 col-xs-6">
                  ...
                  <div class="small-box bg-aqua">
                    ...
                    <a href="{{ URL::to('admin/orders/filter?FilterBy=Status&parameter=&parameter2=1')}}" class="small-box-footer" data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.NewOrders') }}">{{ trans('labels.NewOrders') }} <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                <!-- ./col -->
                <!-- ./col -->
                  ...
                  <div class="small-box bg-teal">
                    <div class="inner">
                      ...
                      <b>@if(count($result['total_sales_currency_wise']) > 0)
                            ...
                            @if(!empty($result['commonContent']['currency']->symbol_left)) {{$result['commonContent']['currency']->symbol_left}} @endif {{ number_format($sales->sale,2) }}  @if(!empty($result['commonContent']['currency']->symbol_right)) {{$result['commonContent']['currency']->symbol_right}} @endif
                    ...
                    <a href="{{ URL::to('admin/salesreport')}}" class="small-box-footer" data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.viewAllOrders') }}">View All Sales <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                <!-- ./col -->
