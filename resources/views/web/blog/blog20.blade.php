...
.blog-thumbnail img{
  ...
  .banners-content .blog14 .container-fluid [class^=col] {
    padding-right: 10px;
    padding-left: 10px;
}
  .pro-blog3 {
...
@media and (min-width: 700px) and (max-width: 800px){
  .blog14 .blog-padding .slick-slide {
    padding: 0px 10px !important;
}
...
function getnewseventslick20(){
jQuery(document).ready(function () {
  (function (jQuery) {
    var tabCarousel = jQuery('.blog-carousel-js20');
