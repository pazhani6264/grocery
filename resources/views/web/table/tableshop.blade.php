    ...
    <nav aria-label="breadcrumb">
        <div class="container">
            <ol class="breadcrumb">
              ...
              <li  class="breadcrumb-item"><a href="{{ URL::to('/ordershop')}}">@lang('website.Shop')</a></li>
             <li  class="breadcrumb-item"><a href="{{ URL::to('/ordershop?category='.$result['category_slug'])}}">{{$result['category_name']}}</a></li>
             ...
             <li class="breadcrumb-item"><a href="{{ URL::to('/ordershop')}}">@lang('website.Home')</a></li>
             <li  class="breadcrumb-item active"><a href="{{ URL::to('/ordershop')}}">@lang('website.Shop')</a></li>
          ...
          <section class="shop-content shop-two">
            ...
            <div id="profile-description" class="right-menu-categories">
                    ...
                    <ul id="accordion" class="accordion">
                       ...
                       @include('web.table.shopCategories')
               ...
               ?>
                   <a href="{{ URL::to('/ordershop')}}" class="btn btn-dark btn-fixed-inner" id="apply_options"> @lang('website.Reset') </a>
                      @if(app('request')->input('filters_applied')==1)
