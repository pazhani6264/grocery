   ...
   margin: 0 !important;
    ...
    <body>
        ...
        ?>
                    ...
                    <form name="attributes" id="edit-Product-form" method="post" >
                      ...
                      <input type="hidden" name="customers_basket_id" class="customers_basket_id_new" value="{{$customers_basket_id}}">
            ...
            @if(count($result['detail']['product_data'][0]->attributes)>0)
                    ...
                    ?>
                      ...
                      <div class="prd-size swatches">
                        ...
                        @if($attributes_data['option']['options_select_type'] == 0)
                          ...
                          <ul class="size-list js-size-list" data-select-id="SingleOptionSelector-<?=$index?>">
                            ...
                            <?php
                          $att_empty_check = DB::table('customers_basket_attributes')->where('customers_basket_id', $customers_basket_id)->where('products_options_values_id', $values_data['id'])->first();

                          
                      ?>
                              <li class="pc-category-variable-item-main var-{{$values_data['id']}} new-{{ $attributes_data['option']['id'] }}  @if($att_empty_check !='') active @endif">

                                <input type="hidden" value="{{ $values_data['price'] }}" prefix="{{ $values_data['price_prefix'] }}" class="radio_get var-{{$values_data['id']}} new-{{ $attributes_data['option']['id'] }} @if($att_empty_check !='') active @endif" >

                                <input type="hidden" value="{{ $attributes_data['option']['name'] }}" class="option_name var-{{$values_data['id']}} new-{{ $attributes_data['option']['id'] }} @if($att_empty_check !='') active @endif">

                                <input type="hidden" value="{{ $attributes_data['option']['id'] }}" class="option_id var-{{$values_data['id']}} new-{{ $attributes_data['option']['id'] }} @if($att_empty_check !='') active @endif">

                                
                                <input type="hidden" value="{{ $values_data['products_attributes_id'] }}" class="attributes_id var-{{$values_data['id']}} new-{{ $attributes_data['option']['id'] }} @if($att_empty_check !='') active @endif">

                                <input type="hidden" value="{{$values_data['id']}}" class="function_id var-{{$values_data['id']}} new-{{ $attributes_data['option']['id'] }} @if($att_empty_check !='') active @endif">
                      ...
                      ?>
                                <li class="pc-category-variable-item-main var-{{$values_data['id']}} new-{{ $attributes_data['option']['id'] }} @if($att_empty_check !='') active @endif">
                                <input type="hidden" value="{{ $values_data['price'] }}" prefix="{{ $values_data['price_prefix'] }}" class="check_get var-{{$values_data['id']}} new-{{ $attributes_data['option']['id'] }} @if($att_empty_check !='') active @endif">
                    ...
                    <div class="pc-review-order-bottom-main">
                      <input type="hidden" value="{{ number_format($result['detail']['product_data'][0]->products_filter_price,$decimal_places) }}" id="total_org_price">
                        ...
                        <div class="">
                            <div class="quantity">
                                ...
                                @if($result['detail']['product_data'][0]->products_type == 0)
                                    ...
                                    <input type="text" readonly name="quantity" class="quantity__input qty" value="{{$customers_basket_quantity}}" min="{{$result['detail']['product_data'][0]->products_min_order}}" max="{{$result['detail']['product_data'][0]->products_max_stock}}">    <span class="input-group-btn">

                               
                                @else

                                    <input type="text" readonly name="quantity" class="quantity__input qty" value="{{$customers_basket_quantity}}" min="{{$result['detail']['product_data'][0]->products_min_order}}" max="{{$result['detail']['product_data'][0]->defaultStock}}">    <span class="input-group-btn">

                                @endif

                                @elseif($result['detail']['product_data'][0]->products_type == 1)

                                    <input type="text" style="background: #f7f7f8;" readonly name="quantity" class="quantity__input qty type_one" value="{{$customers_basket_quantity}}" min="{{$result['detail']['product_data'][0]->products_min_order}}" max="{{$result['detail']['product_data'][0]->products_max_stock}}">    <span class="input-group-btn">

                                @elseif($result['detail']['product_data'][0]->products_type == 3 || $result['detail']['product_data'][0]->products_type == 4 )

                                    <input type="text" readonly name="quantity" class="quantity__input qty" value="{{$customers_basket_quantity}}" 
                        ...
                        @if($inv->value == 1)
                          ...
                          @else
                            <button type="submit" class="pc-review-order-button modal-toggle edit-to-Cart-table">Confirm</button>
                          @endif
                        @else
                          <button type="submit" class="pc-review-order-button modal-toggle edit-to-Cart-table">Confirm</button>
                        @endif   
...
$(document).ready(function(){
	$('.edit-to-Cart-table').on('click', function() {
  ...
  return value !== 0;
    ...
    var customers_basket_id = $('.customers_basket_id_new').val();
    var final_price = $('#total_dis_price').html();
    ...
    if(sumcheck == true)
      {
		...
		data: data,
          ...
          alert("Product Added Successfully!", "success",{button: window.location.href = 'http://grocery.platinum24.net/qrcodecart'});
				}
