...
<link rel="stylesheet" type="text/css" href="{{asset('web/css').'/'.$result['commonContent']['setting'][153]->value}}.css"> -->
...
<script src="https://common.platinum24.net/web/js/app.js"></script>

<script type="text/javascript" src="https://common.platinum24.net/web/js/lazy/jquery.lazy.min.js"></script>
  <script type="text/javascript" src="https://common.platinum24.net/web/js/lazy/jquery.lazy.plugins.min.js"></script> 
...
@if(Request::path() == 'checkout')
	...
	<link rel="stylesheet" type="text/css" href="https://common.platinum24.net/web/css/stripe.css" data-rel-css="" />
