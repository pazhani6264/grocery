...
<div class="product-molla ajax_product_20 product-molla-20 product product9 product4 border-20" style="background-color:{{ $result['commonContent']['settings']['card_background'] }}">
  <article>
  @if($result['commonContent']['settings']['product_column'] == 1)
     ...
     <?php if(auth()->guard('customer')->check() &&  auth()->guard('customer')->user()->phone_verified== '1')
        ...
        { ?>
          <a id="wish_molla_show_{{$products->products_id}}" class="wish_molla_show wishlist-style-20 btn-expandable-20  active is_liked_molla_1" products_id="<?= $products->products_id ?>"><spans>add to wishlist</spans><i class="fa fa-heart-o font-size-1-1rem"></i></a>

          <a style="display:none;" id="wish_molla_hide_{{$products->products_id}}" class="wish_molla_hide wishlist-style-20 btn-expandable-20  active "  href="{{url('wishlist')}}"><spans>go to wishlist</spans><i class="fa fa-heart font-size-1-1rem"></i></a>
    <?php } else { ?>
          <a class="wishlist-style-20 btn-expandable-20  active" href="{{url('wishlist')}}"><spans>go to wishlist</spans><i class="fa fa-heart font-size-1-1rem"></i></a>
    <?php } } else { ?>
          <a class="wishlist-style-20 btn-expandable-20  active is_liked_molla_1" products_id="<?= $products->products_id ?>"><spans>add to wishlist</spans><i class="fa fa-heart-o font-size-1-1rem"></i></a>
    <?php } ?>

     <!--    <a class="wishlist-style-20 btn-expandable-20 active  is_liked" products_id="<?= $products->products_id ?>" data-toggle="" data-placement="bottom" title="@lang('website.Wishlist')">
                ...
                <div class="card-style-second">
                      ...
                      <a href="{{ URL::to('/product-detail/'.$products->products_slug)}}">
                        <?php if($products_images->image_path_type == 'aws') { ?>
                          <img class="img-fluid lazy_img_load" data-src="{{$products_images->image_path}}"   alt="{{$products->products_name}}">
                        <?php }else{?>
                          <img class="img-fluid lazy_img_load" data-src="{{asset('').$products_images->image_path}}"   alt="{{$products->products_name}}">
                        <?php }?>
                      </a>
     ...
     <div class="product-action">
          ...
          <div class="btns btn-blocks bg-dark hover-20  icon swipe-to-top padding-3" >
          <?php
              ...
              if($ck == 0){
            ?>
              <div class="right-20 color-fill-white">
                    ...
                    @if(!in_array($products->products_id,$result['cartArray']))
                        ...
                        @if($products->stock_status == 1)
                            @if($products->defaultStock<=0)
                              <button type="button" style="font-size:1.2rem" class="btn padding-0 text-white active swipe-to-top hover-20-right padding0px" products_id="{{$products->products_id}}" data-toggle="tooltip" data-placement="bottom" title="@lang('website.Out of Stock')"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 50.948 44.099">
                         <path id="cart_plus" d="M30.728,37.537a6.564,6.564,0,0,1,4.949-6.361H19.219a6.561,6.561,0,1,1-3.226,0H13.216l-.4-1.44L5.589,3.938H0V0H8.575l.4,1.439,7.224,25.8H39.28L46.6,9.93h4.345L41.889,31.176H38.9a6.562,6.562,0,1,1-8.175,6.361Zm3.281,0a3.281,3.281,0,1,0,3.28-3.28A3.284,3.284,0,0,0,34.009,37.537Zm-19.684,0a3.281,3.281,0,1,0,3.281-3.28A3.284,3.284,0,0,0,14.325,37.537Zm12.659-18.3v-6.76H20.19V8.919h6.794V2.125h3.547V8.919H37.29v3.563H30.531v6.76Z" />
                            ...
                            @else
                            <button type="button" id="add-to-cart-d-hide{{$products->products_id}}" style="font-size:1.2rem" class="btn padding-0 text-white  hover-20-right padding0px swipe-to-top cart-icon-sb add-to-cart-d-hide add-to-cart-d-hide{{$products->products_id}}" products_id="{{$products->products_id}}" data-toggle="tooltip" data-placement="bottom" title="@lang('website.Add to Cart')"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 50.948 44.099">
                         <path id="cart_plus" d="M30.728,37.537a6.564,6.564,0,0,1,4.949-6.361H19.219a6.561,6.561,0,1,1-3.226,0H13.216l-.4-1.44L5.589,3.938H0V0H8.575l.4,1.439,7.224,25.8H39.28L46.6,9.93h4.345L41.889,31.176H38.9a6.562,6.562,0,1,1-8.175,6.361Zm3.281,0a3.281,3.281,0,1,0,3.28-3.28A3.284,3.284,0,0,0,34.009,37.537Zm-19.684,0a3.281,3.281,0,1,0,3.281-3.28A3.284,3.284,0,0,0,14.325,37.537Zm12.659-18.3v-6.76H20.19V8.919h6.794V2.125h3.547V8.919H37.29v3.563H30.531v6.76Z" />
                       </svg></button>

                            <button type="button" id="added-to-cart-d-hide{{$products->products_id}}" style="font-size:1.2rem" class="btn padding-0 text-white  hover-20-right padding0px active swipe-to-top added-to-cart-d-hide added-to-cart-d-hide{{$products->products_id}}" data-toggle="tooltip" data-placement="bottom" title="@lang('website.Added')"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 50.948 44.099">
                         <path id="cart_plus" d="M30.728,37.537a6.564,6.564,0,0,1,4.949-6.361H19.219a6.561,6.561,0,1,1-3.226,0H13.216l-.4-1.44L5.589,3.938H0V0H8.575l.4,1.439,7.224,25.8H39.28L46.6,9.93h4.345L41.889,31.176H38.9a6.562,6.562,0,1,1-8.175,6.361Zm3.281,0a3.281,3.281,0,1,0,3.28-3.28A3.284,3.284,0,0,0,34.009,37.537Zm-19.684,0a3.281,3.281,0,1,0,3.281-3.28A3.284,3.284,0,0,0,14.325,37.537Zm12.659-18.3v-6.76H20.19V8.919h6.794V2.125h3.547V8.919H37.29v3.563H30.531v6.76Z" />
                       </svg></button>
                         ...
                         <path id="cart_plus" d="M30.728,37.537a6.564,6.564,0,0,1,4.949-6.361H19.219a6.561,6.561,0,1,1-3.226,0H13.216l-.4-1.44L5.589,3.938H0V0H8.575l.4,1.439,7.224,25.8H39.28L46.6,9.93h4.345L41.889,31.176H38.9a6.562,6.562,0,1,1-8.175,6.361Zm3.281,0a3.281,3.281,0,1,0,3.28-3.28A3.284,3.284,0,0,0,34.009,37.537Zm-19.684,0a3.281,3.281,0,1,0,3.281-3.28A3.284,3.284,0,0,0,14.325,37.537Zm12.659-18.3v-6.76H20.19V8.919h6.794V2.125h3.547V8.919H37.29v3.563H30.531v6.76Z" />
                          ...
                          @endif
                      @else
                      <button type="button" style="font-size:1.2rem;padding:0px !important" class="btn padding-0 text-white active swipe-to-top hover-20-right" data-toggle="tooltip" data-placement="bottom" title="@lang('website.Added')"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 50.948 44.099">
                         <path id="cart_plus" d="M30.728,37.537a6.564,6.564,0,0,1,4.949-6.361H19.219a6.561,6.561,0,1,1-3.226,0H13.216l-.4-1.44L5.589,3.938H0V0H8.575l.4,1.439,7.224,25.8H39.28L46.6,9.93h4.345L41.889,31.176H38.9a6.562,6.562,0,1,1-8.175,6.361Zm3.281,0a3.281,3.281,0,1,0,3.28-3.28A3.284,3.284,0,0,0,34.009,37.537Zm-19.684,0a3.281,3.281,0,1,0,3.281-3.28A3.284,3.284,0,0,0,14.325,37.537Zm12.659-18.3v-6.76H20.19V8.919h6.794V2.125h3.547V8.919H37.29v3.563H30.531v6.76Z" />
                       </svg></button>
                      @endif
                    @elseif($products->products_type==1)
                        <a style="font-size:1.2rem" class="btn padding-0 text-white swipe-to-top hover-20-right" href="{{ URL::to('/product-detail/'.$products->products_slug)}}" data-toggle="tooltip" data-placement="bottom" title="@lang('website.View Detail')"> </a>
                    @elseif($products->products_type==2)
                        <a style="font-size:1.2rem" href="{{$products->products_url}}" target="_blank" class="btn padding-0 text-white swipe-to-top hover-20-right" data-toggle="tooltip" data-placement="bottom" title="@lang('website.External Link')"></a>
          ...
          <button type="button" style="padding:0.3rem 10px" class="btn text-white common-hover swipe-to-top modal_show3" products_id="{{$products->products_id}}" products_name="{{$products->products_name}}">Book</button>
    @elseif($products->button_type == 4)
      <a style="font-size:1.2rem" class="btn padding-0 text-white swipe-to-top hover-20-right" href="{{ URL::to('/product-detail/'.$products->products_slug)}}" data-toggle="tooltip" data-placement="bottom" title="@lang('website.View Detail')"> </a>
    @endif 
              </div>
              <?php } ?>
              <div class="left-20 quickmodal_show3 color-fill-white" products_id ="{{$products->products_id}}" data-toggle="tooltip" data-placement="bottom" title="Quick View"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 39.356 27.497">
   ...
   <div class="content  padd-10">
     ...
     <!-- <p class="product-description-20">
       <?php
