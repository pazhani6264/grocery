...
<?php } ?>
    ...
    <?php if(auth()->guard('customer')->check() &&  auth()->guard('customer')->user()->phone_verified== '1')
        ...
        { ?>
          <button type="button" id="wish_molla_show_{{$products->products_id}}" class="wish_molla_show btn btn-blocks demo-20-wish wislist-hover-33 swipe-to-top is_liked_molla_1" products_id="{{$products->products_id}}" title="" style="padding:10px 0;color:#777;"><i style="margin-right:10px;" class="fa fa-heart-o heart_show"></i><i style="display:none;margin-right:10px;" class="fa fa-heart heart_hide"></i>Add to wishlist</button>

          <a href="{{url('wishlist')}}" ><button type="button" id="wish_molla_hide_{{$products->products_id}}" class="wish_molla_hide btn btn-blocks wislist-hover-33 swipe-to-top" style="padding:10px 0;color:#777;display:none;"><i style="margin-right:10px;" class="fa fa-heart"></i>Go to wishlist</button></a>
    <?php } else { ?>
        <a href="{{url('wishlist')}}" ><button type="button"  class="btn btn-blocks wislist-hover-33 swipe-to-top" style="padding:10px 0;color:#777;"><i style="margin-right:10px;" class="fa fa-heart"></i>Go to wishlist</button></a>        
    <?php } } else { ?>
        <button type="button" class="btn demo-20-wish btn-blocks wislist-hover-33 swipe-to-top is_liked_molla_1" products_id="{{$products->products_id}}" title="" style="padding:10px 0;color:#777;"><i style="margin-right:10px;" class="fa fa-heart-o heart_show"></i><i style="display:none;margin-right:10px;" class="fa fa-heart heart_hide"></i>Add to wishlist</button>
    <?php } ?>
