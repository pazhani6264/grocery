...
<div class="product-molla ajax_product_40 product-molla-40 product product9 product4 box-shadow" style="background-color:#fafafa;">
  <article>
  @if($result['commonContent']['settings']['product_column'] == 1)
      ...
      @endif
     <div class="badges" style="top:0px !important;left:0px !important">
      <?php 
    ...
    <!--  <a class="wishlist-style-22 btn-expandable active  is_liked" products_id="<?= $products->products_id ?>" data-toggle="" data-placement="bottom" title="@lang('website.Wishlist')">
      ...
      <div class="icon border-radius-50 wishlist-22  modal_show2 common-fill cursor-pointer fill-white-hover"  products_id="{{$products->products_id}}" data-toggle="" data-placement="bottom" title="Quick View"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 39.356 27.497">
     ...
     <?php
              ...
              if($ck == 0){
            ?>
          <div class="icon40 btn-blocks  swipe-to-top padding-0" >
          @if($products->button_type == 1 || $products->button_type == 3)
                      ...
                      @if(!in_array($products->products_id,$result['cartArray']))
                        ...
                        @if($products->stock_status == 1)
                          @if($products->defaultStock<=0)
                            <button type="button" class="btn-blocks  btn-40-danger swipe-to-top" products_id="{{$products->products_id}}" ><span>@lang('website.Out of Stock')</span></button>
                          @else
                              <button type="button" class="btn-blocks button-two  btn-40 cart swipe-to-top" products_id="{{$products->products_id}}" ><span>@lang('website.Add to Cart')</span></button>
                          @endif
                          @else
                              <button type="button" class="btn-blocks button-two  btn-40 cart swipe-to-top" products_id="{{$products->products_id}}" ><span>@lang('website.Add to Cart')</span></button>
                          @endif
                        ...
                        @endif
                      @else
                          <button type="button" class="btn-40 active swipe-to-top" >@lang('website.Added')</button>
                      @endif
                  @elseif($products->products_type==1)
                      <a class="btn-blocks  btn-40 swipe-to-top" href="{{ URL::to('/product-detail/'.$products->products_slug)}}" ><span>@lang('website.View Detail')</span></a>
                  @elseif($products->products_type==2)
                      <a href="{{$products->products_url}}" target="_blank" class="btn-blocks  btn-40  swipe-to-top" ><span>@lang('website.External Link')</span></a>
            ...
            <button type="button"  class="btn-blocks button-two btn-40 swipe-to-top modal_show3" products_id="{{$products->products_id}}" products_name="{{$products->products_name}}">Book</button>
   ...
   <div class="content  padd-10" style="background-color:#fff;">
