...
<div class="product product5 ajax_product_5">
...
$string = substr($created_date->created_at, 0, strpos($created_date->created_at, ' '));        $date=date_create($string);
   ...
   <div class="content text-center">
     ...
     <?php 
      ...
      ?>
        <p class="grid-none-des title w-100" style="text-align:left;"><?php echo $desc; ?></p>
     <div class="price">                     
        @if(!empty($products->discount_price))
     ...
     @if($products->button_type == 1 || $products->button_type == 3)
          ...
          @if(!in_array($products->products_id,$result['cartArray']))
            ...
            @if($products->stock_status == 1)
              @if($products->defaultStock<=0)
                <button type="button" class="btn btn-fs12 btn-pro-5 btn-danger swipe-to-top" products_id="{{$products->products_id}}" ><i class="fas fa-shopping-bag"></i> @lang('website.Out of Stock')</button>
              @else
                  <button type="button" class="btn btn-fs12 btn-pro-5 btn-secondary cart swipe-to-top" products_id="{{$products->products_id}}" ><i class="fas fa-shopping-bag"></i> @lang('website.Add to Cart')</button>
              @endif
              @else
                  <button type="button" class="btn btn-fs12 btn-pro-5 btn-secondary cart swipe-to-top" products_id="{{$products->products_id}}" ><i class="fas fa-shopping-bag"></i> @lang('website.Add to Cart')</button>
              @endif
            ...
            @endif
          @else
              <button type="button" class="btn btn-fs12 btn-pro-5 btn-secondary active swipe-to-top" ><i class="fas fa-shopping-bag"></i> @lang('website.Added')</button>
          @endif
      @elseif($products->products_type==1)
          <a class="btn btn-fs12 btn-pro-5 btn-secondary swipe-to-top" href="{{ URL::to('/product-detail/'.$products->products_slug)}}" ><i class="fas fa-shopping-bag"></i> @lang('website.View Detail')</a>
      @elseif($products->products_type==2)
          <a href="{{$products->products_url}}" target="_blank" class="btn btn-fs12  btn-pro-5 btn-secondary  swipe-to-top" ><i class="fas fa-shopping-bag"></i>@lang('website.External Link')</a>
      ...
      <button type="button"  class="btn btn-fs12  btn-pro-5 btn-secondary swipe-to-top modal_show3" products_id="{{$products->products_id}}" products_name="{{$products->products_name}}">Book</button>
