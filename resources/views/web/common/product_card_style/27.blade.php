...
.listing article:hover .footer-27-hover-trans {
    visibility: visible;
...
<div class="product-molla ajax_product_27 product-molla-27 product product9 product4 tabletall" style="background-color:{{ $result['commonContent']['settings']['card_background'] }}">
  <article>
      ...
      <?php if(auth()->guard('customer')->check() &&  auth()->guard('customer')->user()->phone_verified== '1')
                  {
                    ...
                    { ?>
                      <a id="wish_molla_show_{{$products->products_id}}" class="wish_molla_show wishlist-style-27 btn-expandable  active is_liked_molla_1" products_id="<?= $products->products_id ?>"><spans>add to wishlist</spans><i class="fa fa-heart-o"></i></a>

                      <a style="display:none;" id="wish_molla_hide_{{$products->products_id}}" class="wish_molla_hide wishlist-style-27 btn-expandable  active "  href="{{url('wishlist')}}"><spans>go to wishlist</spans><i class="fa fa-heart"></i></a>
                <?php } else { ?>
                      <a class="wishlist-style-27 btn-expandable  active" href="{{url('wishlist')}}"><spans>go to wishlist</spans><i class="fa fa-heart"></i></a>
                <?php } } else { ?>
                      <a class="wishlist-style-27 btn-expandable  active is_liked_molla_1" products_id="<?= $products->products_id ?>"><spans>add to wishlist</spans><i class="fa fa-heart-o"></i></a>
                <?php } ?>

     <!--    <a class="wishlist-style-27 btn-expandable active is_liked" products_id="<?= $products->products_id ?>" data-toggle="" data-placement="bottom" title="@lang('website.Wishlist')">
      ...
      <?php 
              ...
              <div class="content  up-27-hover-trans" style="padding-bottom:10px;background:#fff">
               
                <p class="text-center width-100 product-description-20">
                <?php
...
<?php 
        ...
        'products_filter_price' => $orignal_price,
          ...
          @endif                        
              ...
              <div class="product-action footer-27-hover-trans mobileshow-all">
                ...
                <div class="pro-rating" style="background-color:#fff">
              ...
              <div class="btns btn-blocks hover-27 swipe-to-top padding-3" >
              <?php
              ...
              @if($products->button_type == 1 || $products->button_type == 3)
                    ...
                    @if($products->products_type==0)
                      ...
                      @if(!in_array($products->products_id,$result['cartArray']))
                        ...
                        @if($products->stock_status == 1)
                            @if($products->defaultStock<=0)
                            <div style="width:100% !important;padding:5px 0px !important;text-transform:initial !important;cursor:pointer" class="btn padding-0 btn-27 modal_show2 common-fill" data-toggle="" products_id ="{{$products->products_id}}" data-placement="bottom" title="Quick View"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 39.356 27.497" style="margin-right:10px;">
                            ...
                            @else
                            <button style="padding:5px 0px !important" type="button"  class="left-27 btn padding-0 btn-27 cart common-fill" products_id="{{$products->products_id}}" data-toggle="" data-placement="bottom" title="@lang('website.Add to Cart')"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 50.948 44.099" style="margin-right:10px;">
                    ...
                    <div class="left-35">
                      @if(!in_array($products->products_id,$result['cartArray']))
                        ...
                        @if($products->stock_status == 1)
                            ...
                            @else
                            <button type="button"  class="btn padding-0 btn-27 cart" products_id="{{$products->products_id}}" data-toggle="" data-placement="bottom" title="@lang('website.Add to Cart')"><i class="fa fa-shopping-cart mr-10"></i></button>
                            @endif
                            @else
                            <button type="button"  class="btn padding-0 btn-27 cart" products_id="{{$products->products_id}}" data-toggle="" data-placement="bottom" title="@lang('website.Add to Cart')"><i class="fa fa-shopping-cart mr-10"></i></button>
                            @endif
    ...
    @elseif($products->button_type == 4)
      <a style="width:100% !important;padding:5px 0px !important" class="btn padding-0 btn-27" href="{{ URL::to('/product-detail/'.$products->products_slug)}}" data-toggle="" data-placement="bottom" title="@lang('website.View Detail')"><i class="fa fa-shopping-cart mr-10"></i>@lang('website.View Detail')</a>
    @endif 
              ...
              @if($products->defaultStock<=0)
                ...
                @endif
              @else
                <div class="right-35 btn-27 modal_show2" products_id ="{{$products->products_id}}"><i class="fa fa-eye mr-10"></i></div>
              @endif
  </div>
<?php } ?>
