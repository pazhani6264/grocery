...
<div class="product product9 ajax_product_9">
...
$string = substr($created_date->created_at, 0, strpos($created_date->created_at, ' '));        $date=date_create($string);
      ...
      @if($products->products_type==0)
       @if(!in_array($products->products_id,$result['cartArray']))
           ...
           @if($products->stock_status == 1)
              ...
              @else
              <button type="button" id="add-to-cart-d-hide{{$products->products_id}}" class="btn icon cart-icon-sb swipe-to-top add-to-cart-d-hide add-to-cart-d-hide{{$products->products_id}}" products_id="{{$products->products_id}}" data-toggle="tooltip" data-placement="bottom" title="@lang('website.Add to Cart')"><i class="fas fa-shopping-bag"></i></button>
              <button type="button" id="added-to-cart-d-hide{{$products->products_id}}" class="btn icon active swipe-to-top added-to-cart-d-hide added-to-cart-d-hide{{$products->products_id}}" data-toggle="tooltip" data-placement="bottom" title="@lang('website.Added')"><i class="fas fa-shopping-bag"></i></button>
              @endif
              @else
              <button type="button" id="add-to-cart-d-hide{{$products->products_id}}" class="btn icon cart-icon-sb swipe-to-top add-to-cart-d-hide add-to-cart-d-hide{{$products->products_id}}" products_id="{{$products->products_id}}" data-toggle="tooltip" data-placement="bottom" title="@lang('website.Add to Cart')"><i class="fas fa-shopping-bag"></i></button>
              <button type="button" id="added-to-cart-d-hide{{$products->products_id}}" class="btn icon active swipe-to-top added-to-cart-d-hide added-to-cart-d-hide{{$products->products_id}}" data-toggle="tooltip" data-placement="bottom" title="@lang('website.Added')"><i class="fas fa-shopping-bag"></i></button>
   ...
   <?php } ?>
     ...
     <div class="product-action">
          ...
          <div class="btn btn-block btn-secondary icon swipe-to-top modal_show" products_id ="{{$products->products_id}}" >
...
<style>
  .product9 .pricetag .price {
    font-size: 1rem !important;
}
.product9 .pricetag .price span {
    font-size: 1rem !important;
}
  ...
  @media only screen and (max-width: 1024px)
{
  ...
  .product9 article .content .title {
    font-size: 14px;
}
.form-inline {
    flex-flow: unset;
...
.griding4 .product9 .pricetag .price {
    font-size: 0.8rem !important;
}
.griding4 .product9 .pricetag .price span {
    font-size: 0.7rem !important; 
}
.griding4 .product9 .pricetag .icon {
