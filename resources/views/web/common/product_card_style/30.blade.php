...
<div class="product-molla ajax_product_30 product-molla-30 product product9  box-shadow product4" style="background-color:{{ $result['commonContent']['settings']['card_background'] }}">
  <article>
...
@endif -->
    ...
    <!--     <a class="icon border-radius-50 wishlist-21 active swipe-to-top is_liked" products_id="<?= $products->products_id ?>" data-toggle="" data-placement="bottom" title="@lang('website.Wishlist')"><i class="fa fa-heart-o"></i></a> -->
        ...
        <div class="icon border-radius-50 wishlist-demo-13 modal_show2 quick-fill cursor-pointer common-fill"  products_id="{{$products->products_id}}" data-toggle="" data-placement="bottom" title="Quick View"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 39.356 27.497">
     ...
     <div class="product-action">
        ...
        <div class="btns btn-blockss swipe-to-top padding-0 w-100" >
        <?php
        ...
        @if($products->button_type == 1 || $products->button_type == 3)
                ...
                @if($products->products_type==0)
                      @if(!in_array($products->products_id,$result['cartArray']))
                        ...
                        @if($products->stock_status == 1)
                          @if($products->defaultStock<=0)
                            <button style="display:none;"  type="button" class="btn btn-blockss  btn-danger swipe-to-top" products_id="{{$products->products_id}}" >@lang('website.Out of Stock')</button>
                          @else
                              <button type="button" class="btn btn-blockss quick-fill common-fill  btn-30 cart swipe-to-top" products_id="{{$products->products_id}}" ><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 50.948 44.099">
                        ...
                        @endif
                      @else
                          <button type="button" class="btn btn-30 active swipe-to-top" >@lang('website.Added')</button>
                      @endif
                  @elseif($products->products_type==1)
                      <a class="btn btn-30 swipe-to-top" href="{{ URL::to('/product-detail/'.$products->products_slug)}}" >&nbsp;&nbsp; @lang('website.View Detail')</a>
                  @elseif($products->products_type==2)
                      <a href="{{$products->products_url}}" target="_blank" class="btn btn-30  swipe-to-top" >&nbsp;&nbsp; @lang('website.External Link')</a>
            ...
            <button type="button" class="btn btn-blockss  btn-30 cart swipe-to-top modal_show3" products_id="{{$products->products_id}}" products_name="{{$products->products_name}}">Book</button>
