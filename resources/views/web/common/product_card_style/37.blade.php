...
<div class="product-molla ajax_product_37 product-molla-37 product product9 product4" style="border:1px solid transparent;background-color:{{ $result['commonContent']['settings']['card_background'] }}">
  <article>
  @if($result['commonContent']['settings']['product_column'] == 1)
     ...
     <?php if(auth()->guard('customer')->check() &&  auth()->guard('customer')->user()->phone_verified== '1')
        ...
        { ?>
          <a id="wish_molla_show_{{$products->products_id}}" class="wish_molla_show icon border-radius-50 wishlist-demo-13 active cursor-pointer is_liked_molla_1" products_id="<?= $products->products_id ?>" data-toggle="" data-placement="bottom" title="Add to wishlist"><i class="fa fa-heart-o"></i></a>

          <a style="display:none;" id="wish_molla_hide_{{$products->products_id}}" class="wish_molla_hide icon border-radius-50 wishlist-demo-13 active cursor-pointer"  href="{{url('wishlist')}}" data-toggle="" data-placement="bottom" title="Go to wishlist"><i class="fa fa-heart"></i></a>
    <?php } else { ?>
          <a class="icon border-radius-50 wishlist-demo-13 active cursor-pointer" href="{{url('wishlist')}}"  data-toggle="" data-placement="bottom" title="Go to wishlist"><i class="fa fa-heart "></i></a>
    <?php } } else { ?>
          <a class="icon border-radius-50 wishlist-demo-13 active cursor-pointer is_liked_molla_1" products_id="<?= $products->products_id ?>" data-toggle="" data-placement="bottom" title="Add to wishlist"><i class="fa fa-heart-o "></i></a>
    <?php } ?>
 ...
 -->
        <div class="icon border-radius-50 wishlist-21 swipe-to-top common-fill demo-25-add-fill cursor-pointer modal_show2"  products_id="{{$products->products_id}}" data-toggle="" data-placement="bottom" title="Quick View"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 39.356 27.497">
...
<?php 
     ...
     <div class="btn-hover-28">
            ...
            <div class="pro-rating" style="margin-top:10px;margin-bottom:20px">
            ...
            ?>
                      ...
                      @if(!in_array($products->products_id,$result['cartArray']))
                        ...
                        @if($products->stock_status == 1)
                          @if($products->defaultStock<=0)
                            <button style="padding:10px 0px" type="button" class="btn btn-blockss  btn-37-danger swipe-to-top" products_id="{{$products->products_id}}" >@lang('website.Out of Stock')</button>
                          @else
                              <button style="padding:10px 0px" type="button" class="btn btn-blockss demo-25-add-fill common-fill btn-37 cart swipe-to-top" products_id="{{$products->products_id}}" ><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 50.948 44.099">
                         ...
                         <path id="cart_plus" d="M30.728,37.537a6.564,6.564,0,0,1,4.949-6.361H19.219a6.561,6.561,0,1,1-3.226,0H13.216l-.4-1.44L5.589,3.938H0V0H8.575l.4,1.439,7.224,25.8H39.28L46.6,9.93h4.345L41.889,31.176H38.9a6.562,6.562,0,1,1-8.175,6.361Zm3.281,0a3.281,3.281,0,1,0,3.28-3.28A3.284,3.284,0,0,0,34.009,37.537Zm-19.684,0a3.281,3.281,0,1,0,3.281-3.28A3.284,3.284,0,0,0,14.325,37.537Zm12.659-18.3v-6.76H20.19V8.919h6.794V2.125h3.547V8.919H37.29v3.563H30.531v6.76Z"/>
                          ...
                          @endif
                        @else
                            <button style="padding:15px 0px" type="button" class="btn btn-blockss demo-25-add-fill common-fill btn-37 cart swipe-to-top" products_id="{{$products->products_id}}" ><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 50.948 44.099">
                         <path id="cart_plus" d="M30.728,37.537a6.564,6.564,0,0,1,4.949-6.361H19.219a6.561,6.561,0,1,1-3.226,0H13.216l-.4-1.44L5.589,3.938H0V0H8.575l.4,1.439,7.224,25.8H39.28L46.6,9.93h4.345L41.889,31.176H38.9a6.562,6.562,0,1,1-8.175,6.361Zm3.281,0a3.281,3.281,0,1,0,3.28-3.28A3.284,3.284,0,0,0,34.009,37.537Zm-19.684,0a3.281,3.281,0,1,0,3.281-3.28A3.284,3.284,0,0,0,14.325,37.537Zm12.659-18.3v-6.76H20.19V8.919h6.794V2.125h3.547V8.919H37.29v3.563H30.531v6.76Z"/>
                       </svg> &nbsp;&nbsp;@lang('website.Add to Cart')</button>
                        @endif
                      @else
                          <button style="padding:10px 0px" type="button" class="btn btn-blockss btn-37 active swipe-to-top" >@lang('website.Added')</button>
                      @endif
                  @elseif($products->products_type==1)
                      <a style="padding:10px 0px" class="btn btn-blockss btn-37 swipe-to-top" href="{{ URL::to('/product-detail/'.$products->products_slug)}}" >&nbsp;&nbsp; @lang('website.View Detail')</a>
                  @elseif($products->products_type==2)
                      <a  style="padding:10px 0px" href="{{$products->products_url}}" target="_blank" class="btn btn-blockss btn-37  swipe-to-top" >&nbsp;&nbsp; @lang('website.External Link')</a>
              ...
              <button type="button" class="btn btn-blockss btn-37  swipe-to-top modal_show3" products_id="{{$products->products_id}}" products_name="{{$products->products_name}}">Book</button>
