...
<div class="product-molla ajax_product_23 product-molla-23 product product9 product4 box-shadow" style="background-color:#fafafa !important;">
  <article>
  @if($result['commonContent']['settings']['product_column'] == 1)
     ...
     <!--    <a class="wishlist-style-22 btn-expandable active  is_liked" products_id="<?= $products->products_id ?>" data-toggle="" data-placement="bottom" title="@lang('website.Wishlist')">
      ...
      <div class="icon wishlist-22 border-radius-50 quick-fill common-fill swipe-to-top cursor-pointer modal_show2"  products_id="{{$products->products_id}}" data-toggle="" data-placement="bottom" title="Quick View"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 39.356 27.497">
     ...
     <?php
          ...
          <div class="btns btn-blocks  hover-22   swipe-to-top padding-0" >
              @if($products->button_type == 1 || $products->button_type == 3)
                  ...
                  @if($products->products_type==0)
                      @if(!in_array($products->products_id,$result['cartArray']))
                        ...
                        @if($products->stock_status == 1)
                          ...
                          @else
                              <button type="button" class="btn btn-blocks quick-fill common-fill mob-font-sizes btn-23 cart swipe-to-top" products_id="{{$products->products_id}}" ><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 50.948 44.099">
                        ...
                        @endif
                      @else
                          <button type="button" class="btn btn-23 mob-font-sizes active swipe-to-top" >@lang('website.Added')</button>
                      @endif
                  @elseif($products->products_type==1)
                      <a class="btn btn-23 mob-font-sizes swipe-to-top" href="{{ URL::to('/product-detail/'.$products->products_slug)}}" >&nbsp;&nbsp; @lang('website.View Detail')</a>
                  @elseif($products->products_type==2)
                      <a href="{{$products->products_url}}" target="_blank" class="btn btn-23 mob-font-sizes swipe-to-top" >&nbsp;&nbsp; @lang('website.External Link')</a>
                  ...
                  <button type="button"  class="btn btn-23 mob-font-sizes  swipe-to-top modal_show3" products_id="{{$products->products_id}}" products_name="{{$products->products_name}}">Book</button>
