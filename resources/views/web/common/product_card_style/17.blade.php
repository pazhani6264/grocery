...
<style>
 ...
 .product17 article .content .title {
text-align: center !important;
}
.listing .product17 article .content .title {
...
<div class="product  product17 ajax_product_17">
...
$string = substr($created_date->created_at, 0, strpos($created_date->created_at, ' '));        $date=date_create($string);
      ...
      ?>
        ...
        <div class="pro-counter" style="text-align:center;">
              <div class="input-group item-quantity" style="display: -webkit-inline-flex;">
