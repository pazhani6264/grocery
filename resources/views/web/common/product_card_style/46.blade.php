...
.listing .product9.product article:hover .product-action {
    visibility: visible;
    opacity: 1;
    transform: translateY(250px);
    background: #fff;
}
p.grid-none-des.title {
    padding: 0 20px;
}
h5.title.titles.text-center {
    padding: 0 20px;
}
...
@endif -->
      ...
      <div class="icon border-radius-50 wishlist-21 swipe-to-top modal_show2 quick-fill cursor-pointer common-fill"  products_id ="{{$products->products_id}}" data-toggle="" data-placement="bottom" title="Quick View"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 39.356 27.497">
      ...
      <?php 
              ...
              <div class="content  up-27-hover-trans" style="padding-bottom:10px;background:#fff;padding-left:0px;padding-right:0px">

              <div class="" style="position:relative;" >
              <div class="product-action mobileshow-all color-white-above cursor-pointer common-bg-hover  btns btn-blocks hover-27 padding-3" >
              <?php
            ...
            ?>
              @if($products->button_type == 1 || $products->button_type == 3)
                    ...
                    @if($products->products_type==0)
                      ...
                      @if(!in_array($products->products_id,$result['cartArray']))
                        ...
                        @if($products->stock_status == 1)
                            ...
                            <a style="width:100% !important;padding:5px 0px !important" class="btn padding-0 btn-27 color-white " href="{{ URL::to('/product-detail/'.$products->products_slug)}}" data-toggle="" data-placement="bottom" title="@lang('website.View Detail')">@lang('website.View Detail')</a>
                            
                              
                            @else
                            <button style="padding:5px 0px !important" type="button"  class=" btn padding-0 btn-27 color-white  cart common-fill" products_id="{{$products->products_id}}" data-toggle="" data-placement="bottom" title="@lang('website.Add to Cart')"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 50.948 44.099" style="margin-right:10px;">
                      ...
                      <path id="cart_plus" d="M30.728,37.537a6.564,6.564,0,0,1,4.949-6.361H19.219a6.561,6.561,0,1,1-3.226,0H13.216l-.4-1.44L5.589,3.938H0V0H8.575l.4,1.439,7.224,25.8H39.28L46.6,9.93h4.345L41.889,31.176H38.9a6.562,6.562,0,1,1-8.175,6.361Zm3.281,0a3.281,3.281,0,1,0,3.28-3.28A3.284,3.284,0,0,0,34.009,37.537Zm-19.684,0a3.281,3.281,0,1,0,3.281-3.28A3.284,3.284,0,0,0,14.325,37.537Zm12.659-18.3v-6.76H20.19V8.919h6.794V2.125h3.547V8.919H37.29v3.563H30.531v6.76Z"/>
                          ...
                          @endif
                      @else
                          <button style="padding:5px 0px !important" type="button"  class=" btn padding-0 btn-27 color-white  active" data-toggle="" data-placement="bottom" title="@lang('website.Added')">@lang('website.Added')</button>
                      @endif

                    @elseif($products->products_type==1)
                        <a style="width:100% !important;padding:5px 0px !important" class="btn padding-0 btn-27 color-white " href="{{ URL::to('/product-detail/'.$products->products_slug)}}" data-toggle="" data-placement="bottom" title="@lang('website.View Detail')">@lang('website.View Detail')</a>
                    @elseif($products->products_type==2)
                        <a style="width:100% !important;padding:5px 0px !important" href="{{$products->products_url}}" target="_blank" class="btn padding-0 btn-27 color-white   swipe-to-top" data-toggle="" data-placement="bottom" title="@lang('website.External Link')"> @lang('website.External Link')</a>
                    ...
                    <button type="button"  class=" btn padding-0 btn-27 color-white  swipe-to-top modal_show3" products_id="{{$products->products_id}}" products_name="{{$products->products_name}}">Book</button>
...
<div class="text-center product-description-20" style="padding-left:20px;padding-right:20px">
                <?php 
                $str2=''; 
                foreach ($products->categories as $key => $category) 
                { 
...
<?php 
      ...
      ?>
        ...
        <div class="price" style="padding-left:20px;padding-right:20px">                     
          @if(!empty($products->discount_price))
        ...
        <div class="product-action footer-27-hover-trans mobileshow-all" style="padding-left:20px;padding-right:20px">
