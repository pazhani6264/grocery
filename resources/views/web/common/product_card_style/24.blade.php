...
<div class="product-molla ajax_product_24 product-molla-24 product product9 product4 box-shadow" style="background-color:{{ $result['commonContent']['settings']['card_background'] }}">
  <article>
...
@endif -->
     ...
     <?php if(auth()->guard('customer')->check() &&  auth()->guard('customer')->user()->phone_verified== '1')
      ...
      <div class="icon border-radius-50 wishlist-24 cursor-pointer  modal_show2 quick-fill"  products_id="<?= $products->products_id ?>" data-toggle="" data-placement="bottom" title="Quick View"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 39.356 27.497">
     ...
     <div class="product-action">
          ...
          @if($products->button_type == 1 || $products->button_type == 3)
                      ...
                      @if(!in_array($products->products_id,$result['cartArray']))
                        ...
                        @if($products->stock_status == 1)
                          @if($products->defaultStock<=0)
                            <button type="button" class="btn btn-blocks mob-font-sizes btn-danger swipe-to-top" products_id="{{$products->products_id}}" >@lang('website.Out of Stock')</button>
                          @else
                              <button type="button" class="btn btn-blocks mob-font-sizes btn-24 cart swipe-to-top" products_id="{{$products->products_id}}" ><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 50.948 44.099">
                        ...
                        @endif
                      @else
                          <button type="button" class="btn btn-24 mob-font-sizes active swipe-to-top">@lang('website.Added')</button>
                      @endif
                  @elseif($products->products_type==1)
                      <a class="btn btn-blocks btn-24 mob-font-sizes swipe-to-top" href="{{ URL::to('/product-detail/'.$products->products_slug)}}" >&nbsp;&nbsp; @lang('website.View Detail')</a>
                  @elseif($products->products_type==2)
                      <a href="{{$products->products_url}}" target="_blank" class="btn btn-24 mob-font-sizes swipe-to-top" >&nbsp;&nbsp; @lang('website.External Link')</a>
                  ...
                  <button type="button" class="btn btn-24 mob-font-sizes  swipe-to-top modal_show3" products_id="{{$products->products_id}}" products_name="{{$products->products_name}}">Book</button>
