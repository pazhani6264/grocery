...
<div class="product product4 ajax_product_4">
        ...
        'products_filter_price' => $orignal_price,
            ...
            ?>
              ...
              <div class="product-action">
                <a class="btn btn-fs15 btn-secondary swipe-to-top" href="{{ URL::to('/product-detail/'.$products->products_slug)}}" >@lang('website.View Detail')</a>
