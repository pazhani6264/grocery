...
.griding4 .product2 .pricetag .price {
    font-size: 0.8rem;
}
.griding4 .product2 .pricetag .price span {
    font-size: 0.7rem;
}
.griding4 .product2 .pricetag .icon {
...
<div class="product2 product10 ajax_product_10">
      ...
      ?>
        ...
        'products_filter_price' => $orignal_price,
            ...
            @if($products->button_type == 1 || $products->button_type == 3)
              ...
              @if($products->products_type==0)
                ...
                @if($products->stock_status == 1)
                    ...
                    <button type="button" id="add-to-cart-d-hide{{$products->products_id}}" class="icon btn-secondary cart-icon-sb swipe-to-top add-to-cart-d-hide add-to-cart-d-hide{{$products->products_id}}" products_id="{{$products->products_id}}" data-toggle="tooltip" data-placement="bottom" title="@lang('website.Add to Cart')"><i class="fas fa-shopping-bag"></i> </button>
            ...
            @elseif($products->products_type==2)
                <a href="{{$products->products_url}}" target="_blank" class="icon btn-secondary swipe-to-top" data-toggle="tooltip" data-placement="bottom" title="@lang('website.External Link')"><i class="fas fa-shopping-bag"></i></a>
