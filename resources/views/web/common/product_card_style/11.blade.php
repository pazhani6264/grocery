...
<style>
  ...
  .product13 .btn-danger{
    border-radius:5px;
  }
  .product13 .btn-secondary{
    border-radius:5px;
  }
...
<div class="product product13 ratingstar ajax_product_11">
...
$string = substr($created_date->created_at, 0, strpos($created_date->created_at, ' '));        $date=date_create($string);
      ...
      <div class="product-hover d-none d-lg-block d-xl-block">
        ...
        <div class="desktop-hover d-none display-grid d-lg-block d-xl-block">   
...
<?php } ?>
    ...
    <div class="content">
      ...
      <div class="pro-rating">
        <fieldset class="disabled-ratings" style="text-align:right">                                           
        ...
        <h5 class="title" style="text-align:center"><a href="{{ URL::to('/product-detail/'.$products->products_slug)}}">{{$products->products_name}}</a></h5>
    <!--   <p>
        <?php
