...
@endif -->
     ...
     <?php if(auth()->guard('customer')->check() &&  auth()->guard('customer')->user()->phone_verified== '1')
        ...
        { ?>
          <a id="wish_molla_show_{{$products->products_id}}" class="wish_molla_show icon border-radius-50 wishlist-21 active cursor-pointer is_liked_molla_1" products_id="<?= $products->products_id ?>" data-toggle="" data-placement="bottom" title="add to wishlist"><i class="fa fa-heart-o heart_show "></i><i style="display:none;" class="fa fa-heart  heart_hide"></i></a>

          <a style="display:none;" id="wish_molla_hide_{{$products->products_id}}" class="wish_molla_hide icon border-radius-50 wishlist-21 active cursor-pointer"  href="{{url('wishlist')}}" data-toggle="" data-placement="bottom" title="go to wishlist"><i class="fa fa-heart "></i></a>
    <?php } else { ?>
          <a class="icon border-radius-50 wishlist-21 active cursor-pointer" href="{{url('wishlist')}}"  data-toggle="" data-placement="bottom" title="go to wishlist"><i class="fa fa-heart "></i></a>
    <?php } } else { ?>
          <a class="icon border-radius-50 wishlist-21 active cursor-pointer is_liked_molla_1" products_id="<?= $products->products_id ?>" data-toggle="" data-placement="bottom" title="add to wishlist"><i class="fa fa-heart-o "></i></a>
    <?php } ?>
              ...
              @if($products->button_type == 1 || $products->button_type == 3)
                  ...
                  @if($products->products_type==0)
                    ...
                    @elseif($products->products_type==1)
                        <a style="font-size:1.2rem;padding:0px !important" class="btn padding-0 text-white swipe-to-top hover-20-right" href="{{ URL::to('/product-detail/'.$products->products_slug)}}" data-toggle="tooltip" data-placement="bottom" title="@lang('website.View Detail')"> </a>
                    @elseif($products->products_type==2)
                        <a style="font-size:1.2rem;padding:0px !important" href="{{$products->products_url}}" target="_blank" class="btn padding-0 text-white swipe-to-top hover-20-right" data-toggle="tooltip" data-placement="bottom" title="@lang('website.External Link')"></a>
    ...
    @endif
              ...
              <?php } ?>
              <div class="left-20 quickmodal_show3 cursor-pointer color-fill-white" products_id ="{{$products->products_id}}" data-toggle="tooltip" data-placement="bottom" title="Quick View"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 39.356 27.497">
