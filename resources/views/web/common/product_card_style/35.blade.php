...
.product-molla-35 article .content {
...
<div class="product-molla ajax_product_35 product-molla-35 product product9 product4" style="background-color:{{ $result['commonContent']['settings']['card_background'] }}">
             <article>
      ...
      @endif
        ...
        if ($after_date >= $current_date) {
          print '<span class="badge badge-success bage-35-new">';
...
@endif -->
        ...
        @if($products->products_ordered > 0)
          <span class="badge badge-success bage-35-top">Top</span>
          @endif

          @if($products->products_liked > 0)
          <span class="badge badge-success bage-35-sale">Sale</span>
          @endif
              ...
              @if(!in_array($products->products_id,$result['cartArray']))
                ...
                @if($products->stock_status == 1)
                  @if($products->defaultStock<=0)
                    <span class="badge badge-success bage-35-out">@lang('website.Out of Stock')</span>
                  @endif
                  @endif
                @endif
              @endif
      ...
      <?php if(auth()->guard('customer')->check() &&  auth()->guard('customer')->user()->phone_verified== '1')
                  {
                    ...
                    { ?>
                      <a id="wish_molla_show_{{$products->products_id}}" class="wish_molla_show wishlist-style-22 btn-expandable  active is_liked_molla_1" products_id="<?= $products->products_id ?>"><spans>add to wishlist</spans><i class="fa fa-heart-o"></i></a>

                      <a style="display:none;" id="wish_molla_hide_{{$products->products_id}}" class="wish_molla_hide wishlist-style-22 btn-expandable  active "  href="{{url('wishlist')}}"><spans>go to wishlist</spans><i class="fa fa-heart"></i></a>
                <?php } else { ?>
                      <a class="wishlist-style-22 btn-expandable  active" href="{{url('wishlist')}}"><spans>go to wishlist</spans><i class="fa fa-heart"></i></a>
                <?php } } else { ?>
                      <a class="wishlist-style-22 btn-expandable  active is_liked_molla_1" products_id="<?= $products->products_id ?>"><spans>add to wishlist</spans><i class="fa fa-heart-o"></i></a>
                <?php } ?>


      <!--   <a class="wishlist-style-22 btn-expandable active  is_liked" products_id="<?= $products->products_id ?>" data-toggle="" data-placement="bottom" title="@lang('website.Wishlist')">
      ...
      <?php 
              ...
              <div class="content  up-35-hover-trans" style="background:#fff">
...
<?php 
      ...
      ?>
        ...
        'products_filter_price' => $orignal_price,
          ...
          @endif                        
              ...
              <div class="product-action footer-27-hover-trans mobileshow-all">
              <div class="btns btn-blocksswipe-to-top padding-3" >

                <div class="pro-rating hover-27">
                <fieldset class="disabled-ratings-27 text-center">                                           
            ...
            ?>
              ...
              @if($products->button_type == 1 || $products->button_type == 3)
                ...
                @if($products->products_type==0)
                      ...
                      @if(!in_array($products->products_id,$result['cartArray']))
                        ...
                        @if($products->stock_status == 1)
                            @if($products->defaultStock<=0)
                              ...
                              <div style="width:100% !important;padding:5px 0px !important;text-transform:initial !important;" class="btn padding-0 common-fill cursor-pointer btn-27 modal_show2" data-toggle="" products_id ="{{$products->products_id}}" data-placement="bottom" title="@lang('website.Quick View')"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 39.356 27.497" style="margin-right:15px;">
                    <path id="binocular" d="M22.253,20.3a3.69,3.69,0,0,1-5.15,0A8.61,8.61,0,1,1,1.258,14.4l-.022,0A18.577,18.577,0,0,1,2.777,9.381c1.561-3.292,3.9-5.4,6.8-6.137C10.23,1.978,11.551.317,13.39.191c.075-.006.151-.008.226-.008,1.47,0,2.84.993,4.083,2.959,1.085.042,3.026.008,4.24-.023.6-1.06,1.968-3.014,4-3.115.055,0,.11,0,.165,0,1.553,0,3.01,1.1,4.333,3.276A12.234,12.234,0,0,1,34.107,5.82,10.343,10.343,0,0,1,37.382,13.4a8.61,8.61,0,1,1-15.129,6.9ZM24.6,18.888a6.149,6.149,0,1,0,6.15-6.15A6.156,6.156,0,0,0,24.6,18.888Zm-22.138,0a6.149,6.149,0,1,0,6.15-6.15A6.156,6.156,0,0,0,2.459,18.888Zm15.989-1.23a1.23,1.23,0,1,0,1.23-1.23A1.231,1.231,0,0,0,18.448,17.658Zm4.321-2.014a8.615,8.615,0,0,1,12.169-4.278A10.063,10.063,0,0,0,29.55,5.305l-.522-.049-.286-.5c-.935-1.643-1.872-2.54-2.642-2.54h-.045c-1.017.048-2.069,1.667-2.42,2.444l-.283.63-.691.023c-.451.014-4.439.137-5.735-.006l-.559-.063-.279-.486C15.212,3.232,14.334,2.4,13.606,2.4l-.064,0c-.89.061-1.819,1.361-2.166,2.222l-.227.562-.6.112C8.1,5.755,6.165,7.43,4.8,10.28c-.186.389-.349.774-.491,1.147a8.615,8.615,0,0,1,12.275,4.217,3.69,3.69,0,0,1,6.183,0Z" />
                  </svg>@lang('website.Quick View')</div>
                            @else
                            <button style="padding:5px 0px !important" type="button"  class="left-27 common-fill btn padding-0 btn-27 cart" products_id="{{$products->products_id}}" data-toggle="" data-placement="bottom" title="@lang('website.Add to Cart')"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 50.948 44.099"  style="margin-right:15px;">
                      ...
                      <div style="padding:5px 0px !important;text-transform:initial !important;cursor:pointer" class="left-27 btn padding-0 btn-27 modal_show2 common-fill" data-toggle="" products_id ="{{$products->products_id}}" data-placement="bottom" title="Quick View"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 39.356 27.497" style="margin-right:10px;">
                            <path id="binocular" d="M22.253,20.3a3.69,3.69,0,0,1-5.15,0A8.61,8.61,0,1,1,1.258,14.4l-.022,0A18.577,18.577,0,0,1,2.777,9.381c1.561-3.292,3.9-5.4,6.8-6.137C10.23,1.978,11.551.317,13.39.191c.075-.006.151-.008.226-.008,1.47,0,2.84.993,4.083,2.959,1.085.042,3.026.008,4.24-.023.6-1.06,1.968-3.014,4-3.115.055,0,.11,0,.165,0,1.553,0,3.01,1.1,4.333,3.276A12.234,12.234,0,0,1,34.107,5.82,10.343,10.343,0,0,1,37.382,13.4a8.61,8.61,0,1,1-15.129,6.9ZM24.6,18.888a6.149,6.149,0,1,0,6.15-6.15A6.156,6.156,0,0,0,24.6,18.888Zm-22.138,0a6.149,6.149,0,1,0,6.15-6.15A6.156,6.156,0,0,0,2.459,18.888Zm15.989-1.23a1.23,1.23,0,1,0,1.23-1.23A1.231,1.231,0,0,0,18.448,17.658Zm4.321-2.014a8.615,8.615,0,0,1,12.169-4.278A10.063,10.063,0,0,0,29.55,5.305l-.522-.049-.286-.5c-.935-1.643-1.872-2.54-2.642-2.54h-.045c-1.017.048-2.069,1.667-2.42,2.444l-.283.63-.691.023c-.451.014-4.439.137-5.735-.006l-.559-.063-.279-.486C15.212,3.232,14.334,2.4,13.606,2.4l-.064,0c-.89.061-1.819,1.361-2.166,2.222l-.227.562-.6.112C8.1,5.755,6.165,7.43,4.8,10.28c-.186.389-.349.774-.491,1.147a8.615,8.615,0,0,1,12.275,4.217,3.69,3.69,0,0,1,6.183,0Z"/>
                          </svg>Quick View</div>
                      ...
                      <div style="padding:5px 0px !important;text-transform:initial !important;cursor:pointer" class="left-27 btn padding-0 btn-27 modal_show2 common-fill" data-toggle="" products_id ="{{$products->products_id}}" data-placement="bottom" title="Quick View"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 39.356 27.497" style="margin-right:10px;">
                            ...
                            @endif
                          @else
                          <button style="padding:5px 0px !important" type="button"  class="left-27 btn padding-0 btn-27 common-fill cart" products_id="{{$products->products_id}}" data-toggle="" data-placement="bottom" title="@lang('website.Add to Cart')"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 50.948 44.099"  style="margin-right:15px;">
                        <path id="cart_plus" d="M30.728,37.537a6.564,6.564,0,0,1,4.949-6.361H19.219a6.561,6.561,0,1,1-3.226,0H13.216l-.4-1.44L5.589,3.938H0V0H8.575l.4,1.439,7.224,25.8H39.28L46.6,9.93h4.345L41.889,31.176H38.9a6.562,6.562,0,1,1-8.175,6.361Zm3.281,0a3.281,3.281,0,1,0,3.28-3.28A3.284,3.284,0,0,0,34.009,37.537Zm-19.684,0a3.281,3.281,0,1,0,3.281-3.28A3.284,3.284,0,0,0,14.325,37.537Zm12.659-18.3v-6.76H20.19V8.919h6.794V2.125h3.547V8.919H37.29v3.563H30.531v6.76Z"/>
                      </svg>@lang('website.Add to Cart')</button>
                      ...
                      <div style="padding:5px 0px !important;text-transform:initial !important;cursor:pointer" class="left-27 btn padding-0 btn-27 modal_show2 common-fill" data-toggle="" products_id ="{{$products->products_id}}" data-placement="bottom" title="Quick View"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 39.356 27.497" style="margin-right:10px;">
                          ...
                          @endif
                      @else
                          <button style="padding:5px 0px !important" type="button"  class="left-27 btn padding-0 btn-27 active" data-toggle="" data-placement="bottom" title="@lang('website.Added')">@lang('website.Added')</button>
                      @endif

                      @elseif($products->products_type==1)
                        <a style="padding:5px 0px !important" class="left-27 btn padding-0 btn-27" href="{{ URL::to('/product-detail/'.$products->products_slug)}}" data-toggle="" data-placement="bottom" title="@lang('website.View Detail')">@lang('website.View Detail')</a>
                      ...
                      @elseif($products->products_type==2)
                        <a style="padding:5px 0px !important" href="{{$products->products_url}}" target="_blank" class="left-27  btn padding-0 btn-27  swipe-to-top" data-toggle="" data-placement="bottom" title="@lang('website.External Link')"> @lang('website.External Link')</a>
                  ...
                  @elseif($products->products_type==3)
                    ...
                    <path id="binocular" d="M22.253,20.3a3.69,3.69,0,0,1-5.15,0A8.61,8.61,0,1,1,1.258,14.4l-.022,0A18.577,18.577,0,0,1,2.777,9.381c1.561-3.292,3.9-5.4,6.8-6.137C10.23,1.978,11.551.317,13.39.191c.075-.006.151-.008.226-.008,1.47,0,2.84.993,4.083,2.959,1.085.042,3.026.008,4.24-.023.6-1.06,1.968-3.014,4-3.115.055,0,.11,0,.165,0,1.553,0,3.01,1.1,4.333,3.276A12.234,12.234,0,0,1,34.107,5.82,10.343,10.343,0,0,1,37.382,13.4a8.61,8.61,0,1,1-15.129,6.9ZM24.6,18.888a6.149,6.149,0,1,0,6.15-6.15A6.156,6.156,0,0,0,24.6,18.888Zm-22.138,0a6.149,6.149,0,1,0,6.15-6.15A6.156,6.156,0,0,0,2.459,18.888Zm15.989-1.23a1.23,1.23,0,1,0,1.23-1.23A1.231,1.231,0,0,0,18.448,17.658Zm4.321-2.014a8.615,8.615,0,0,1,12.169-4.278A10.063,10.063,0,0,0,29.55,5.305l-.522-.049-.286-.5c-.935-1.643-1.872-2.54-2.642-2.54h-.045c-1.017.048-2.069,1.667-2.42,2.444l-.283.63-.691.023c-.451.014-4.439.137-5.735-.006l-.559-.063-.279-.486C15.212,3.232,14.334,2.4,13.606,2.4l-.064,0c-.89.061-1.819,1.361-2.166,2.222l-.227.562-.6.112C8.1,5.755,6.165,7.43,4.8,10.28c-.186.389-.349.774-.491,1.147a8.615,8.615,0,0,1,12.275,4.217,3.69,3.69,0,0,1,6.183,0Z" />
                      ...
                      <button type="button"  class="left-27 btn padding-0 btn-27  swipe-to-top modal_show3" products_id="{{$products->products_id}}" products_name="{{$products->products_name}}">Book</button>
    ...
    @endif 
            ...
            <?php
              ...
              if($ck == 0){
            ?>
            <div class="desktop-display-none" style="margin-top:20px">
            @if($products->button_type == 1 || $products->button_type == 3)
            ...
            @if($products->products_type==0)
                    <div class="left-35">
                      @if(!in_array($products->products_id,$result['cartArray']))
                        ...
                        @if($products->stock_status == 1)
                            @if($products->defaultStock<=0)
                              <button style="display:none" type="button"  class="btn padding-0 btn-27-danger active " products_id="{{$products->products_id}}" data-toggle="" data-placement="bottom" title="@lang('website.Out of Stock')">@lang('website.Out of Stock')</button>
                            @else
                            <button type="button"  class="btn padding-0 btn-27 common-fill cart" products_id="{{$products->products_id}}" data-toggle="" data-placement="bottom" title="@lang('website.Add to Cart')"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 50.948 44.099"  style="margin-right:15px;">
                        <path id="cart_plus" d="M30.728,37.537a6.564,6.564,0,0,1,4.949-6.361H19.219a6.561,6.561,0,1,1-3.226,0H13.216l-.4-1.44L5.589,3.938H0V0H8.575l.4,1.439,7.224,25.8H39.28L46.6,9.93h4.345L41.889,31.176H38.9a6.562,6.562,0,1,1-8.175,6.361Zm3.281,0a3.281,3.281,0,1,0,3.28-3.28A3.284,3.284,0,0,0,34.009,37.537Zm-19.684,0a3.281,3.281,0,1,0,3.281-3.28A3.284,3.284,0,0,0,14.325,37.537Zm12.659-18.3v-6.76H20.19V8.919h6.794V2.125h3.547V8.919H37.29v3.563H30.531v6.76Z"/>
                      </svg></button>
                            @endif
                            @else
                        ...
                        <path id="cart_plus" d="M30.728,37.537a6.564,6.564,0,0,1,4.949-6.361H19.219a6.561,6.561,0,1,1-3.226,0H13.216l-.4-1.44L5.589,3.938H0V0H8.575l.4,1.439,7.224,25.8H39.28L46.6,9.93h4.345L41.889,31.176H38.9a6.562,6.562,0,1,1-8.175,6.361Zm3.281,0a3.281,3.281,0,1,0,3.28-3.28A3.284,3.284,0,0,0,34.009,37.537Zm-19.684,0a3.281,3.281,0,1,0,3.281-3.28A3.284,3.284,0,0,0,14.325,37.537Zm12.659-18.3v-6.76H20.19V8.919h6.794V2.125h3.547V8.919H37.29v3.563H30.531v6.76Z"/>
                          ...
                          @endif
                      @else
                          <button type="button"  class="btn padding-0 btn-27 active" data-toggle="" data-placement="bottom" title="@lang('website.Added')">Added</button>
                      @endif
                      @elseif($products->button_type == 2)
                      <button type="button"  class="btn padding-0 btn-27  swipe-to-top modal_show3" products_id="{{$products->products_id}}" products_name="{{$products->products_name}}">Book</button>
    @elseif($products->button_type == 4)
      <a style="width:100% !important;padding:5px 0px !important" class="btn padding-0 btn-27" href="{{ URL::to('/product-detail/'.$products->products_slug)}}" data-toggle="" data-placement="bottom" title="@lang('website.View Detail')">@lang('website.View Detail')</a>
    @endif 
                   
             

                  @elseif($products->products_type==1)
                      <!-- <a class="btn padding-0 btn-27" href="{{ URL::to('/product-detail/'.$products->products_slug)}}" data-toggle="" data-placement="bottom" title="@lang('website.View Detail')"><i class="fa fa-shopping-cart mr-10"></i></a> -->
                  @elseif($products->products_type==2)
                      <!-- <a href="{{$products->products_url}}" target="_blank" class="btn padding-0 btn-27  swipe-to-top" data-toggle="" data-placement="bottom" title="@lang('website.External Link')"> <i class="fa fa-shopping-cart mr-10"></i></a> -->
                  @endif

              @if($products->defaultStock<=0)
                @if($products->products_type==0)
                  <!-- <div style="width:100% !important;border-left:0px !important" class="right-35 btn-27 modal_show2" products_id ="{{$products->products_id}}"><i class="fa fa-eye mr-10"></i></div> -->
                @endif
              @else
              <div class="right-35 btn-27 common-fill cursor-pointer modal_show2" products_id ="{{$products->products_id}}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 39.356 27.497" style="margin-right:15px;">
                    <path id="binocular" d="M22.253,20.3a3.69,3.69,0,0,1-5.15,0A8.61,8.61,0,1,1,1.258,14.4l-.022,0A18.577,18.577,0,0,1,2.777,9.381c1.561-3.292,3.9-5.4,6.8-6.137C10.23,1.978,11.551.317,13.39.191c.075-.006.151-.008.226-.008,1.47,0,2.84.993,4.083,2.959,1.085.042,3.026.008,4.24-.023.6-1.06,1.968-3.014,4-3.115.055,0,.11,0,.165,0,1.553,0,3.01,1.1,4.333,3.276A12.234,12.234,0,0,1,34.107,5.82,10.343,10.343,0,0,1,37.382,13.4a8.61,8.61,0,1,1-15.129,6.9ZM24.6,18.888a6.149,6.149,0,1,0,6.15-6.15A6.156,6.156,0,0,0,24.6,18.888Zm-22.138,0a6.149,6.149,0,1,0,6.15-6.15A6.156,6.156,0,0,0,2.459,18.888Zm15.989-1.23a1.23,1.23,0,1,0,1.23-1.23A1.231,1.231,0,0,0,18.448,17.658Zm4.321-2.014a8.615,8.615,0,0,1,12.169-4.278A10.063,10.063,0,0,0,29.55,5.305l-.522-.049-.286-.5c-.935-1.643-1.872-2.54-2.642-2.54h-.045c-1.017.048-2.069,1.667-2.42,2.444l-.283.63-.691.023c-.451.014-4.439.137-5.735-.006l-.559-.063-.279-.486C15.212,3.232,14.334,2.4,13.606,2.4l-.064,0c-.89.061-1.819,1.361-2.166,2.222l-.227.562-.6.112C8.1,5.755,6.165,7.43,4.8,10.28c-.186.389-.349.774-.491,1.147a8.615,8.615,0,0,1,12.275,4.217,3.69,3.69,0,0,1,6.183,0Z" />
                  </svg></div>
