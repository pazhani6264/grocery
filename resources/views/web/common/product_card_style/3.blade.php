...
<div class="product product3 ajax_product_3">
...
@endif
    ...
    @elseif($products->button_type == 2)
      <button type="button"  class="btn btn-secondary swipe-to-top modal_show3" products_id="{{$products->products_id}}" products_name="{{$products->products_name}}">Book</button>
