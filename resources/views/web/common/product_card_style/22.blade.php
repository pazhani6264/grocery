...
.product-molla-22 article .content .price {
    display: inline-block;
}
.griding4 .btn-22:hover svg {
    left: 20% !important;
    transition-delay: .1s;
    fill: #fff !important;
}
...
<div class="product-molla ajax_product_22 product-molla-22 product product9 product4">
  <article style="background-color:#dcdcdc !important;">
  @if($result['commonContent']['settings']['product_column'] == 1)
     ...
     <?php if(auth()->guard('customer')->check() &&  auth()->guard('customer')->user()->phone_verified== '1')
      ...
      <div class="icon wishlist-22 border-radius-50 cursor-pointer swipe-to-top modal_show2 common-fill color-fill-hover" products_id="{{$products->products_id}}" data-toggle="" data-placement="bottom" title="Quick View"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 39.356 27.497">
     ...
     <div class="product-action">
          ...
          <div class="btns btn-blocks  hover-22   swipe-to-top padding-0" >
          <?php
          ...
          @if($products->button_type == 1 || $products->button_type == 3)
                ...
                @if($products->products_type==0)
                      @if(!in_array($products->products_id,$result['cartArray']))
                        ...
                        @if($products->stock_status == 1)
                          @if($products->defaultStock<=0)
                            <button style="display:none;" type="button" class="btn btn-blocks mob-font-sizes btn-danger swipe-to-top" products_id="{{$products->products_id}}" >@lang('website.Out of Stock')</button>
                          @else
                          <button type="button" class="btn btn-blocks mob-font-sizes btn-22 cart swipe-to-top" products_id="{{$products->products_id}}" ><svg xmlns="http://www.w3.org/2000/svg" width="13" height="14" viewBox="0 0 50.948 44.099" style="position:absolute;left:36%;fill:transparent;">
                         ...
                         <path id="cart_plus" d="M30.728,37.537a6.564,6.564,0,0,1,4.949-6.361H19.219a6.561,6.561,0,1,1-3.226,0H13.216l-.4-1.44L5.589,3.938H0V0H8.575l.4,1.439,7.224,25.8H39.28L46.6,9.93h4.345L41.889,31.176H38.9a6.562,6.562,0,1,1-8.175,6.361Zm3.281,0a3.281,3.281,0,1,0,3.28-3.28A3.284,3.284,0,0,0,34.009,37.537Zm-19.684,0a3.281,3.281,0,1,0,3.281-3.28A3.284,3.284,0,0,0,14.325,37.537Zm12.659-18.3v-6.76H20.19V8.919h6.794V2.125h3.547V8.919H37.29v3.563H30.531v6.76Z"/>
                          ...
                          @endif
                        @else
                        <button type="button" class="btn btn-blocks mob-font-sizes btn-22 cart swipe-to-top" products_id="{{$products->products_id}}" ><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 50.948 44.099" style="position:absolute;left:36%;fill:transparent;">
                     <path id="cart_plus" d="M30.728,37.537a6.564,6.564,0,0,1,4.949-6.361H19.219a6.561,6.561,0,1,1-3.226,0H13.216l-.4-1.44L5.589,3.938H0V0H8.575l.4,1.439,7.224,25.8H39.28L46.6,9.93h4.345L41.889,31.176H38.9a6.562,6.562,0,1,1-8.175,6.361Zm3.281,0a3.281,3.281,0,1,0,3.28-3.28A3.284,3.284,0,0,0,34.009,37.537Zm-19.684,0a3.281,3.281,0,1,0,3.281-3.28A3.284,3.284,0,0,0,14.325,37.537Zm12.659-18.3v-6.76H20.19V8.919h6.794V2.125h3.547V8.919H37.29v3.563H30.531v6.76Z"/>
                   </svg> &nbsp;&nbsp; Add to Cart</button>
                           
                        @endif
                      @else
                          <button type="button" class="btn btn-22 mob-font-sizes active swipe-to-top" >@lang('website.Added')</button>
                      @endif
                  @elseif($products->products_type==1)
                      <a class="btn btn-blocks btn-22 mob-font-sizes swipe-to-top" href="{{ URL::to('/product-detail/'.$products->products_slug)}}" ></i>&nbsp;&nbsp; @lang('website.View Detail')</a>
                  @elseif($products->products_type==2)
                      <a href="{{$products->products_url}}" target="_blank" class="btn btn-blocks btn-22 mob-font-sizes swipe-to-top" >&nbsp;&nbsp; @lang('website.External Link')</a>
                  ...
                  <button type="button"   class="btn btn-blocks btn-22 mob-font-sizes  swipe-to-top modal_show3" products_id="{{$products->products_id}}" products_name="{{$products->products_name}}">Book</button>
    @elseif($products->button_type == 4)
      <a class="btn btn-blocks btn-22 mob-font-sizes swipe-to-top" href="{{ URL::to('/product-detail/'.$products->products_slug)}}" ><&nbsp;&nbsp; @lang('website.View Detail')</a>
    @endif 
    <?php } ?>
              </div>
    </div>
