...
<div id="getmultibannerone_38_loading"></div>

  <div id="getmultibannerone_38_product"></div>

  <script>
    getmultibannerone_38();
    function getmultibannerone_38() {
      var type = '3'
      var content ='';
      ...
      jQuery('#getmultibannerone_38_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_38_loading').html(' ');
              jQuery('#getmultibannerone_38_product').html(res);
