...
<div id="getmultibannerone_19_loading"></div>

  <div id="getmultibannerone_19_product"></div>

  <script>
    getbanner_19();
    function getbanner_19() {
      var type = '3'
      var content ='';
      ...
      jQuery('#getmultibannerone_19_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getbanner_19")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_19_loading').html(' ');
              jQuery('#getmultibannerone_19_product').html(res);
