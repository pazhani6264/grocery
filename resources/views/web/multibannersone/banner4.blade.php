...
<div id="getmultibannerone_4_loading"></div>

  <div id="getmultibannerone_4_product"></div>
  ...
  <script>
    ...
    function getbanner_4() {
      ...
      jQuery('#getmultibannerone_4_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_4_loading').html(' ');
              jQuery('#getmultibannerone_4_product').html(res);
