...
<div id="getmultibannerone_3_loading"></div>

  <div id="getmultibannerone_3_product"></div>

  <script>
    getbanner_3();
    function getbanner_3() {
      var type = '3'
      var content ='';
      ...
      jQuery('#getmultibannerone_3_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getbanner_3")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_3_loading').html(' ');
              jQuery('#getmultibannerone_3_product').html(res);
