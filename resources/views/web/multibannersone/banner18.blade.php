...
<div id="getmultibannerone_18_loading"></div>

  <div id="getmultibannerone_18_product"></div>
  ...
  <script>
    ...
    function getbanner_18() {
      ...
      jQuery('#getmultibannerone_18_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_18_loading').html(' ');
              jQuery('#getmultibannerone_18_product').html(res);
