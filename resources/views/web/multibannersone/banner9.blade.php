...
<div id="getmultibannerone_9_loading"></div>

  <div id="getmultibannerone_9_product"></div>
  ...
  <script>
    ...
    function getbanner_9() {
      ...
      jQuery('#getmultibannerone_9_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_9_loading').html(' ');
              jQuery('#getmultibannerone_9_product').html(res);
