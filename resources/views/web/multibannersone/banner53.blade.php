...
<div id="getmultibannerone_53_loading"></div>

  <div id="getmultibannerone_53_product"></div>
  ...
  <script>
    ...
    function getbanner_53() {
      ...
      jQuery('#getmultibannerone_53_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_53_loading').html(' ');
              jQuery('#getmultibannerone_53_product').html(res);
              getbanner41script();
