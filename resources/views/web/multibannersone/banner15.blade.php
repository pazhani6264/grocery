...
<div id="getmultibannerone_15_loading"></div>

  <div id="getmultibannerone_15_product"></div>

  <script>
    getbanner_15();
    function getbanner_15() {
      var type = '3'
      var content ='';
      ...
      jQuery('#getmultibannerone_15_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getbanner_15")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_15_loading').html(' ');
              jQuery('#getmultibannerone_15_product').html(res);
