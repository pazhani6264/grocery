...
<div id="getmultibannerone_17_loading"></div>

  <div id="getmultibannerone_17_product"></div>

  <script>
    getbanner_17();
    function getbanner_17() {
      var type = '3'
      var content ='';
      ...
      jQuery('#getmultibannerone_17_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getbanner_17")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_17_loading').html(' ');
              jQuery('#getmultibannerone_17_product').html(res);
