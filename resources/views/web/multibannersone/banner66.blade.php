...
<div id="getmultibannerone_66_loading"></div>

  <div id="getmultibannerone_66_product"></div>
  ...
  <script>
    ...
    function getbanner_66() {
      ...
      jQuery('#getmultibannerone_66_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_66_loading').html(' ');
              jQuery('#getmultibannerone_66_product').html(res);
              getbanner66script();
