...
<div id="getmultibannerone_2_loading"></div>

  <div id="getmultibannerone_2_product"></div>

  <script>
    getbanner_2();
    function getbanner_2() {
      var type = '3'
      var content ='';
      ...
      jQuery('#getmultibannerone_2_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getbanner_2")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_2_loading').html(' ');
              jQuery('#getmultibannerone_2_product').html(res);
