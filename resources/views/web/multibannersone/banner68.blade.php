...
<div id="getmultibannerone_68_loading"></div>

  <div id="getmultibannerone_68_product"></div>

  <script>
    getmultibannerone_68();
    function getmultibannerone_68() {
      var type = '3'
      var content ='';
      ...
      jQuery('#getmultibannerone_68_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#ggetmultibannerone_68_loading').html(' ');
              jQuery('#getmultibannerone_68_product').html(res);
