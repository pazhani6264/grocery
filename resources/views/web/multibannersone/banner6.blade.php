...
<div id="getmultibannerone_6_loading"></div>

  <div id="getmultibannerone_6_product"></div>

  <script>
    getbanner_6();
    function getbanner_6() {
      var type = '3'
      var content ='';
      ...
      jQuery('#getmultibannerone_6_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getbanner_6")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_6_loading').html(' ');
              jQuery('#getmultibannerone_6_product').html(res);
