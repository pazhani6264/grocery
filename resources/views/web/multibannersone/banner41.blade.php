...
<div id="getmultibannerone_41_loading"></div>

  <div id="getmultibannerone_41_product"></div>
  ...
  <script>
    ...
    function getbanner_41() {
      ...
      jQuery('#getmultibannerone_41_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_41_loading').html(' ');
              jQuery('#getmultibannerone_41_product').html(res);
              getmultibannerone41script();
        ...
        function getmultibannerone41script(){
