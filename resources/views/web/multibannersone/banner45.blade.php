...
<div id="getmultibannerone_45_loading"></div>

  <div id="getmultibannerone_45_product"></div>
  ...
  <script>
    ...
    function getbanner_45() {
      ...
      jQuery('#getmultibannerone_45_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_45_loading').html(' ');
              jQuery('#getmultibannerone_45_product').html(res);
