...
<div id="getmultibannerone_54_loading"></div>

  <div id="getmultibannerone_54_product"></div>
  ...
  <script>
    ...
    function getbanner_54() {
      ...
      jQuery('#getmultibannerone_54_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_54_loading').html(' ');
              jQuery('#getmultibannerone_54_product').html(res);
