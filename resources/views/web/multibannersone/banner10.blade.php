...
<div id="getmultibannerone_10_loading"></div>

  <div id="getmultibannerone_10_product"></div>

  <script>
    getbanner_10();
    function getbanner_10() {
      var type = '3'
      var content ='';
      ...
      jQuery('#getmultibannerone_10_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getbanner_10")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_10_loading').html(' ');
              jQuery('#getmultibannerone_10_product').html(res);
