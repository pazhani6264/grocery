...
<div id="getmultibannerone_12_loading"></div>

  <div id="getmultibannerone_12_product"></div>
  ...
  <script>
    ...
    function getbanner_12() {
      ...
      jQuery('#getmultibannerone_12_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_12_loading').html(' ');
              jQuery('#getmultibannerone_12_product').html(res);
