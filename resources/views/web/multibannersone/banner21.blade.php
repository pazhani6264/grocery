...
<div id="getmultibannerone_21_loading"></div>

  <div id="getmultibannerone_21_product"></div>
  ...
  <script>
    ...
    function getbanner_21() {
      ...
      jQuery('#getmultibannerone_21_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_21_loading').html(' ');
              jQuery('#getmultibannerone_21_product').html(res);
