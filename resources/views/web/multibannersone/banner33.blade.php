...
<div id="getmultibannerone_33_loading"></div>

  <div id="getmultibannerone_33_product"></div>
  ...
  <script>
    ...
    function getbanner_33() {
      ...
      jQuery('#getmultibannerone_33_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_33_loading').html(' ');
              jQuery('#getmultibannerone_33_product').html(res);
