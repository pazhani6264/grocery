...
#getmultibannerone_64_product .btn-outline-primary-2 {
    color: #fff;
    background-color: transparent;
    border-color: #fff;
...
#getmultibannerone_64_product .btn-outline-primary-2:hover {
    color: #fff !important;
...
<div id="getmultibannerone_64_loading"></div>

  <div id="getmultibannerone_64_product"></div>
  ...
  <script>
    ...
    function getbanner_64() {
      ...
      jQuery('#getmultibannerone_64_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_64_loading').html(' ');
              jQuery('#getmultibannerone_64_product').html(res);
