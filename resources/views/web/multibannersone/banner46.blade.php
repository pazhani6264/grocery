...
<div id="getmultibannerone_46_loading"></div>

  <div id="getmultibannerone_46_product"></div>

  <script>
    getmultibannerone_46();
    function getmultibannerone_46() {
      var type = '3'
      var content ='';
      ...
      jQuery('#getmultibanner_46_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_46_loading').html(' ');
              jQuery('#getmultibannerone_46_product').html(res);
