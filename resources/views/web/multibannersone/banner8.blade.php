...
<div id="getmultibannerone_8_loading"></div>

  <div id="getmultibannerone_8_product"></div>

  <script>
    getbanner_8();
    function getbanner_8() {
      var type = '3'
      var content ='';
      ...
      jQuery('#getmultibannerone_8_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getbanner_8")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_8_loading').html(' ');
              jQuery('#getmultibannerone_8_product').html(res);
