...
<div id="getmultibannerone_16_loading"></div>

  <div id="getmultibannerone_16_product"></div>
  ...
  <script>
    ...
    function getbanner_16() {
      ...
      jQuery('#getmultibannerone_16_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_16_loading').html(' ');
              jQuery('#getmultibannerone_16_product').html(res);
