...
<div id="getmultibannerone_14_loading"></div>

  <div id="getmultibannerone_14_product"></div>

  <script>
    getbanner_14();
    function getbanner_14() {
      var type = '3'
      var content ='';
      ...
      jQuery('#getmultibannerone_14_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getbanner_14")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_14_loading').html(' ');
              jQuery('#getmultibannerone_14_product').html(res);
