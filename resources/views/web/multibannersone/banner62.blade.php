<!-- //banner six -->
<style>
    #getmultibannerone_62_product .btn-outline-white {
    border: 2px solid;
    min-width: 140px;
...
#getmultibannerone_62_product .btn-outline-white:hover, #getmultibannerone_62_product .btn-outline-white:not(:disabled):not(.disabled).active, #getmultibannerone_62_product .btn-outline-white:not(:disabled):not(.disabled):active, .show>.btn-outline-white.dropdown-toggle {
    color: #000 !important;
...
<div id="getmultibannerone_62_loading"></div>

  <div id="getmultibannerone_62_product"></div>

  <script>
    getmultibannerone_62();
    function getmultibannerone_62() {
      var type = '3'
      var content ='';
      ...
      jQuery('#getmultibannerone_62_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_62_loading').html(' ');
              jQuery('#getmultibannerone_62_product').html(res);
