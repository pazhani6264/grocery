...
<div id="getmultibannerone_7_loading"></div>

  <div id="getmultibannerone_7_product"></div>
  ...
  <script>
    ...
    function getbanner_7() {
      ...
      jQuery('#getmultibannerone_7_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_7_loading').html(' ');
              jQuery('#getmultibannerone_7_product').html(res);
