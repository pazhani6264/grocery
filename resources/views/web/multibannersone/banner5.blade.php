...
<div id="getmultibannerone_5_loading"></div>

  <div id="getmultibannerone_5_product"></div>

  <script>
    getbanner_5();
    function getbanner_5() {
      var type = '3'
      var content ='';
      ...
      jQuery('#getmultibannerone_5_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getbanner_5")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_5_loading').html(' ');
              jQuery('#getmultibannerone_5_product').html(res);
