...
<div id="getmultibannerone_70_loading"></div>

  <div id="getmultibannerone_70_product"></div>
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_70_loading').html(' ');
              jQuery('#getmultibannerone_70_product').html(res);
              getbanner70script();
