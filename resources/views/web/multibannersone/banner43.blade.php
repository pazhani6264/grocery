...
<div id="getmultibannerone_43_loading"></div>

  <div id="getmultibannerone_43_product"></div>
  ...
  <script>
    ...
    function getbanner_43() {
      ...
      jQuery('#getmultibannerone_43_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_43_loading').html(' ');
              jQuery('#getmultibannerone_43_product').html(res);
