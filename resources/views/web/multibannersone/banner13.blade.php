...
<div id="getmultibannerone_13_loading"></div>

  <div id="getmultibannerone_13_product"></div>

  <script>
    getbanner_13();
    function getbanner_13() {
      var type = '3'
      var content ='';
      ...
      jQuery('#getmultibannerone_13_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getbanner_13")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_13_loading').html(' ');
              jQuery('#getmultibannerone_13_product').html(res);
