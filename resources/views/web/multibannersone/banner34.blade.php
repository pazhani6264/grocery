...
<div id="getmultibannerone_34_loading"></div>

  <div id="getmultibannerone_34_product"></div>

  <script>
    getmultibannerone_34();
    function getbanner_34() {
      ...
      jQuery('#getmultibannerone_34_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getmultibannerone_34")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_34_loading').html(' ');
              jQuery('#getmultibannerone_34_product').html(res);
