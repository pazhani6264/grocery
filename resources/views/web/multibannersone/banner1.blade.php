...
<div id="getmultibannerone_1_loading"></div>

  <div id="getmultibannerone_1_product"></div>
  ...
  <script>
    ...
    function getbanner_1() {
      ...
      jQuery('#getmultibannerone_1_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_1_loading').html(' ');
              jQuery('#getmultibannerone_1_product').html(res);
