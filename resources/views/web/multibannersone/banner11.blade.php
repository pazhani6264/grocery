...
<div id="getmultibannerone_11_loading"></div>

  <div id="getmultibannerone_11_product"></div>

  <script>
    getbanner_11();
    function getbanner_11() {
      var type = '3'
      var content ='';
      ...
      jQuery('#getmultibannerone_11_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getbanner_11")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_11_loading').html(' ');
              jQuery('#getmultibannerone_11_product').html(res);
