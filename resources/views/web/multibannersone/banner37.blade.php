...
<div id="getmultibannerone_37_loading"></div>

  <div id="getmultibannerone_37_product"></div>

  <script>
    getmultibannerone_37();
    function getmultibannerone_37() {
      var type = '3'
      var content ='';
      ...
      jQuery('#getmultibannerone_37_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannerone_37_loading').html(' ');
              jQuery('#getmultibannerone_37_product').html(res);
