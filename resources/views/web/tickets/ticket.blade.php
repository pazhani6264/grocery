			...
			<div class="col-lg-9">
				...
				<div class="card ticket-card mb-3">
							...
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
									...
									<div class="embed-responsive embed-responsive-16by9">
										<iframe class="embed-responsive-item" src="{{asset('uploads/tickets/'.$ticket->attachfile)}}" allowfullscreen></iframe>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="card-body p-2">
						...
						@endphp
						<div class="auth__reply @if($user->role_id == 1) bg-admin @elseif($user->role_id == 2) bg-user @endif">
				...
				<div class="card mb-3">
					<div class="card-body">
						...
						<div class="replay__form">
							<form action="{{ URL::to('/ticket/store')}}" method="POST" enctype="multipart/form-data">
								@csrf
								<input type="hidden" name="ticket_id" value="{{$ticket->id}}">
								<div class="form-group">
									<label>{{ __('Your Reply :') }} <span class="fsgred">*</span></label>
			...
			<div class="col-lg-3">
				<div class="card ticket-card ticketview-info">
					<div class="card-body">
						...
						<form action="{{ URL::to('/ticket/update')}}" method="POST">
							@csrf
