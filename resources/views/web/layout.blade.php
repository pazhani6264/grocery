...
#shopModal .modal-body .promo-box {
  padding: 30px 0 30px 15px;
  text-align: center;
  z-index: 999;
}

#shopModal .modal-body .promo-box .text-01 {
  z-index: 999;
...
#shopModal .modal-body .promo-box .text-03 {
  z-index: 999;
  font-size: 1rem;
  color: #000;
  margin-bottom: 15px;
...
#shopModal {
    ...
    @if($result['commonContent']['setting'][226]->value == 2)
      ...
      @else
        <div class="modal fade show" id="shopModal" tabindex="-1" role="dialog" aria-hidden="false">
                ...
                <div class="container">
                  <div class="row align-items-center"> 
                    ...
                    <div class="col-12 col-md-6" style="padding-left: 0;">
                      <div class="promo-box">
                        <h2 class="text-01">Shop Closed</h2>
                        <h4 class="text-02">Order Open Time</h4>
                        <p class="text-03">{{ $result['commonContent']['setting'][227]->value }}</p>
                      </div> 
                    </div>
                ...
                <div class="col-lg-7m">
                  <div class="sub3-let">
                    ...
                    <h2 class="subscribe-modal-3-h2">                            
                      {{$result['commonContent']['setting'][233]->value }}
                    </h2>
                    <p class="subscribe-modal-3-p">                            
                      {{$result['commonContent']['setting'][234]->value }}
                    </p>
                    <form class=" mailchimp-form" action="{{url('subscribeMail')}}" >
                    <div class="g-recaptcha" style="margin-bottom:5px;" data-sitekey="6LcgaOIlAAAAANQ9-qy97ERNTHeRVjnFgiwRiK90"></div> 
                      <div class="captca" style="margin-bottom:30px;">please verify you are human! </div>
                    ...
                    <p class="subscribe-modal-3-p">                            
                      <input type="checkbox" style="margin-right:10px;margin-top:2.5rem"/> Don't show this popup again
                    </p>
                  </div>
                </div>
                <div class="col-lg-5m">
    ...
    <form method="post">
      ...
      <div class="modal-body">
        ...
        <div class="col-sm-12 form-group">
          ...
          <div id="appServices" class="col-sm-12 form-group" style="display:none">
            <label>Appointment Services</label>
            <select name="app_services" id="app_services" class="form-control">
                  <option value="">Select Appointment Services</option>
              </select>
            <span style="color:red;margin-top:10px" class="err-req7"></span>
          </div>

          <div id="appStaffs" class="col-sm-12 form-group" style="display:none">
            <label>Appointment Staffs</label>
            <select name="app_staffs" id="app_staffs" class="form-control">
                  <option value="">Select Appointment Staffs</option>
              </select>
            <span style="color:red;margin-top:10px" class="err-req7"></span>
          </div>
