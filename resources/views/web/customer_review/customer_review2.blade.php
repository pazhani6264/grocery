               ...
               <div class="testimonial_box-inner">
                 ...
                 <div class="testimonial-item" style="font-size: 14px;"> 
                    <div class="testimonial-item_review"> 
                        ...
                        <div class="testimonial-item__product-title">"{{$rev->products_name}}"</div> 
                        <div class="testimonial-item__review-content">  <div class="testimonial-item__review-body" style="-webkit-line-clamp: 2;"><p>{{$rev->comments}}</p></div> </div> </div> <div class="testimonial-item_reviewer-name-wrapper"> 
                        <div class="testimonial-item__review-name"> {{$rev->customers_name}} </div>
