...
.cr8 .slick-next:hover, .slick-next:focus {
  background:#fff !important;
  color:#333;
}


.cr8  .slick-next:before {
    content: '\203A';
    font-size: 4rem;
    top: -9px;
    position: absolute;
...
.cr8 .slick-prev:hover, .slick-prev:focus {
  background:#fff !important;
  color:#333 !important;
}
.cr8 .slick-next:hover, .slick-next:focus {
    ...
    <div class="testimonial">
      ...
      <hr> 
       ...
       <div class="testimonial-title-and-link">
        ...
        <p class="parins">What Members Are Saying</p>
      </div>
                 ...
                 <div class="testimonial-item" style="font-size: 14px;"> 
                    <div class="testimonial-item_review"> 
                        ...
                        <div class="testimonial-item__review-content"> 
                             <div class="testimonial-item__review-body" style="-webkit-line-clamp: 2;">
                             <p class="comme">" {{$rev->comments}} "</p>
                            </div>
                         </div> 
                    </div> 
                    <div class="testimonial-item_reviewer-name-wrapper"> 
