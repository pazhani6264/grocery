<style>
      .demo-34-testimonial-section
      {
        border-bottom: solid 1px #ddd;
      }
   .demo-34-testimonial-container
    {
       padding-right: 10px !important;
       padding-left: 10px !important;
    }
    .demo-34-testimonial-section .demo-34-testimonial-heading-outer {
    margin-bottom: 62px;
    padding-top: 15px;
}
.demo-34-testimonial-section .demo-34-testimonial-title {
    margin: 50px 0 2px;
    font-size: 28px;
    color: #222;
    font-weight: 600;
}
.demo-34-testimonial-item
{
    width: 100%;
}
.demo-34-marks-ratings-container
{
...
.demo-34-testimonial-section .testimonial-item__review-rating
{
    margin-bottom: 9px;
}
.demo-34-testimonial-section .testimonial-star-outer > label:before {
    font-size: 14px;
    margin-top: 5px;
...
.demo-34-testimonial-section .demo-34-testimonial-p {
    font-size: 15px;
    color: #999;
    letter-spacing: 0;
    line-height: 1.5;
}
 .demo-34-testimonial-marks {
    margin-bottom: 9px;
    font-size: 34px;
    line-height:1;
    font-weight: 600;
...
.demo-34-testimonial-section .cus-review2 .slick-dots {
    display: none;
    position: static !important;
}

.demo-34-testimonial-section .slick-slide:first-child {
...
.testimonial-title {
  ...
  <section class="demo-34-testimonial-section">
    <div class="testimonial">
    <div class="demo-34-testimonial-container container-fluid">
       <div class="estimonial__inner cus-review2">
        <div class="">
        <div class="demo-34-testimonial-heading-outer">
            <h2 class="demo-34-testimonial-title">What Our Customers Are Saying</h2>
            <p class="demo-34-testimonial-p">Our Customers Love Us</p>
        </div>
        </div>
           ...
           <div class="testimonial-slide">
             <div class="testimonial_box">
               <div class="testimonial_box-inner">
                 ...
                 <div class="demo-34-testimonial-item" style="font-size: 14px;"> 
                    <div class="testimonial-item_review"> 

                    <div class="demo-34-testimonial-marks-ratings-container">
                            <div class="demo-34-testimonial-marks common-color">{{$rev->rating}} / 5.0</div>
                        ...
                        <div class="">  <div class="testimonial-item__review-body" style="-webkit-line-clamp: 2;"><p class="demo-34-testimonial-comment">{{$rev->comments}}</p></div> </div> </div> <div class="demo-33-testimonial-item_reviewer-name-wrapper"> 
                        <div class="demo-34-testimonial-commenter ">{{$rev->customers_name}} </div>
