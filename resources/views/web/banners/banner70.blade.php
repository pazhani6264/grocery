...
<div id="getbanner_70_loading"></div>

  <div id="getbanner_70_product"></div>
  ...
  <script>
    ...
    function getbanner_70() {
      ...
      jQuery('#getbanner_70_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_70_loading').html(' ');
              jQuery('#getbanner_70_product').html(res);
              getbanner70script();
