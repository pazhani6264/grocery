...
<div id="getbanner_21_loading"></div>

  <div id="getbanner_21_product"></div>
  ...
  <script>
    ...
    function getbanner_21() {
      ...
      jQuery('#getbanner_21_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_21_loading').html(' ');
              jQuery('#getbanner_21_product').html(res);
