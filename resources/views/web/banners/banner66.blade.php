...
<div id="getbanner_66_loading"></div>

  <div id="getbanner_66_product"></div>
  ...
  <script>
    ...
    function getbanner_66() {
      ...
      jQuery('#getbanner_66_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_66_loading').html(' ');
              jQuery('#getbanner_66_product').html(res);
              getbanner66script();
