...
<div id="getbanner_17_loading"></div>

  <div id="getbanner_17_product"></div>
  ...
  <script>
    ...
    function getbanner_17() {
      ...
      jQuery('#getbanner_17_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_17_loading').html(' ');
              jQuery('#getbanner_17_product').html(res);
