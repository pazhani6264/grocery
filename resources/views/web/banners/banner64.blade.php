...
#getbanner_64_product .btn-outline-primary-2 {
    color: #fff;
    background-color: transparent;
    border-color: #fff;
...
#getbanner_64_product .btn-outline-primary-2:hover {
    color: #fff !important;
...
<div id="getbanner_64_loading"></div>

  <div id="getbanner_64_product"></div>
  ...
  <script>
    ...
    function getbanner_64() {
      ...
      jQuery('#getbanner_64_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_64_loading').html(' ');
              jQuery('#getbanner_64_product').html(res);
