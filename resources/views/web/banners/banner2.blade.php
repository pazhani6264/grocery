...
<div id="getbanner_2_loading"></div>

  <div id="getbanner_2_product"></div>
  ...
  <script>
    ...
    function getbanner_2() {
      ...
      jQuery('#getbanner_2_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_2_loading').html(' ');
              jQuery('#getbanner_2_product').html(res);
