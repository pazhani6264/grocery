...
<div id="getbanner_43_loading"></div>

  <div id="getbanner_43_product"></div>
  ...
  <script>
    ...
    function getbanner_43() {
      ...
      jQuery('#getbanner_43_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_43_loading').html(' ');
              jQuery('#getbanner_43_product').html(res);
