...
<div id="getbanner_37_loading"></div>

  <div id="getbanner_37_product"></div>

  <script>
    getbanner_37();
    function getbanner_37() {
      var type = '1'
      var content ='';
      ...
      jQuery('#getbanner_37_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_37_loading').html(' ');
              jQuery('#getbanner_37_product').html(res);
