...
.demo-33-banner-position-relative
{
  position: relative;
}
...
.demo-33-banner-45-left-title-sub
{
    margin-bottom: 16px;
    color: #222!important;
...
<div id="getbanner_45_loading"></div>

  <div id="getbanner_45_product"></div>
  ...
  <script>
    ...
    function getbanner_45() {
      ...
      jQuery('#getbanner_45_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_45_loading').html(' ');
              jQuery('#getbanner_45_product').html(res);
