...
<div id="getbanner_3_loading"></div>

  <div id="getbanner_3_product"></div>
  ...
  <script>
    ...
    function getbanner_3() {
      ...
      jQuery('#getbanner_3_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_3_loading').html(' ');
              jQuery('#getbanner_3_product').html(res);
