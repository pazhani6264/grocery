...
<div id="getbanner_35_loading"></div>

  <div id="getbanner_35_product"></div>

  <script>
    getbanner_35();
    function getbanner_35() {
      var type = '1'
      var content ='';
      ...
      jQuery('#getbanner_35_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_35_loading').html(' ');
              jQuery('#getbanner_35_product').html(res);
