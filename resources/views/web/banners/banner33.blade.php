...
.demo-31-banner-overlay:focus>a:after, .demo-31-banner-overlay:hover>a:after {
    visibility: visible;
    opacity: 1;
}
.demo-31-banner-overlay>a:after {
    content: "";
    display: block;
    position: absolute;
    left: 0;
...
<div id="getbanner_33_loading"></div>

  <div id="getbanner_33_product"></div>
  ...
  <script>
    ...
    function getbanner_33() {
      ...
      jQuery('#getbanner_33_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_33_loading').html(' ');
              jQuery('#getbanner_33_product').html(res);
