...
.banner-fiftyfour .banner-title a{
  font-weight: 600 !important;
}

.banner-fiftyfour .banner-titles1 a{
  font-weight: 600 !important;
}
...
<div id="getbanner_54_loading"></div>

  <div id="getbanner_54_product"></div>
  ...
  <script>
    ...
    function getbanner_54() {
      ...
      jQuery('#getbanner_54_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_54_loading').html(' ');
              jQuery('#getbanner_54_product').html(res);
