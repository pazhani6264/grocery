...
<div id="getbanner_38_loading"></div>

  <div id="getbanner_38_product"></div>

  <script>
    getbanner_38();
    function getbanner_38() {
      var type = '1'
      var content ='';
      ...
      jQuery('#getbanner_38_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_38_loading').html(' ');
              jQuery('#getbanner_38_product').html(res);
