...
<div id="getbanner_9_loading"></div>

  <div id="getbanner_9_product"></div>
  ...
  <script>
    ...
    function getbanner_9() {
      ...
      jQuery('#getbanner_9_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_9_loading').html(' ');
              jQuery('#getbanner_9_product').html(res);
