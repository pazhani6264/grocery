...
<div id="getbanner_6_loading"></div>

  <div id="getbanner_6_product"></div>
  ...
  <script>
    ...
    function getbanner_6() {
      ...
      jQuery('#getbanner_6_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_6_loading').html(' ');
              jQuery('#getbanner_6_product').html(res);
