...
<div id="getbanner_13_loading"></div>

  <div id="getbanner_13_product"></div>
  ...
  <script>
    ...
    function getbanner_13() {
      ...
      jQuery('#getbanner_13_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_13_loading').html(' ');
              jQuery('#getbanner_13_product').html(res);
