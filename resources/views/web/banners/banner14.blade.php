...
<div id="getbanner_14_loading"></div>

  <div id="getbanner_14_product"></div>
  ...
  <script>
    ...
    function getbanner_14() {
      ...
      jQuery('#getbanner_14_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_14_loading').html(' ');
              jQuery('#getbanner_14_product').html(res);
