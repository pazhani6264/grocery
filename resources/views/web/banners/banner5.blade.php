...
<div id="getbanner_5_loading"></div>

  <div id="getbanner_5_product"></div>
  ...
  <script>
    ...
    function getbanner_5() {
      ...
      jQuery('#getbanner_5_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_5_loading').html(' ');
              jQuery('#getbanner_5_product').html(res);
