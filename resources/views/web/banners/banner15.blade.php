...
<div id="getbanner_15_loading"></div>

  <div id="getbanner_15_product"></div>
  ...
  <script>
    ...
    function getbanner_15() {
      ...
      jQuery('#getbanner_15_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_15_loading').html(' ');
              jQuery('#getbanner_15_product').html(res);
