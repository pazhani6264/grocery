...
<div class="banner-two banner-img-molla banner32">
  ...
  <div class="container-fluid"> 
    <div class="group-banners">
            ...
            @if(count($result['commonContent']['homeBanners'])>0)
              @foreach(($result['commonContent']['homeBanners']) as $homeBanners)
                @if($homeBanners->type==169)
                  <figure class="banner-image demo-28-banner-overlay   banner-32-margin-right">
            ...
            @if(count($result['commonContent']['homeBanners'])>0)
              @foreach(($result['commonContent']['homeBanners']) as $homeBanners)
                @if($homeBanners->type==170)
                  <figure class="banner-image  demo-28-banner-overlay banner-32-margin-left">
                    <a href="{{ $homeBanners->banners_url}}">
        ...
        <div class="banner-banner-js-32" style="margin-left: -5px !important;">
          @if(count($result['commonContent']['homeBanners'])>0)
            @foreach(($result['commonContent']['homeBanners']) as $homeBanners)
              @if($homeBanners->type==171)
                <div class="slick demo-29-margin-lr-new" >
                  <div class="banner32-main banner-link-anim">  
                    <figure class="banner-image demo-28-banner-overlay">
                      <a href="{{ $homeBanners->banners_url}}">
            ...
            @if(count($result['commonContent']['homeBanners'])>0)
              @foreach(($result['commonContent']['homeBanners']) as $homeBanners)
                @if($homeBanners->type==172)
                  <div class="slick demo-29-margin-lr">
                      <div class="banner32-main banner-link-anim">  
                        <figure class="banner-image demo-28-banner-overlay">
                          <a href="{{ $homeBanners->banners_url}}">
