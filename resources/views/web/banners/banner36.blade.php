...
<div id="getbanner_36_loading"></div>

  <div id="getbanner_36_product"></div>

  <script>
    getbanner_36();
    function getbanner_36() {
      var type = '1'
      var content ='';
      ...
      jQuery('#getbanner_36_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_36_loading').html(' ');
              jQuery('#getbanner_36_product').html(res);
