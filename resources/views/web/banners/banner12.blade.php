...
<div id="getbanner_12_loading"></div>

  <div id="getbanner_12_product"></div>
  ...
  <script>
    ...
    function getbanner_12() {
      ...
      jQuery('#getbanner_12_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_12_loading').html(' ');
              jQuery('#getbanner_12_product').html(res);
