...
<div id="getbanner_19_loading"></div>

  <div id="getbanner_19_product"></div>
  ...
  <script>
    ...
    function getbanner_19() {
      ...
      jQuery('#getbanner_19_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_19_loading').html(' ');
              jQuery('#getbanner_19_product').html(res);
