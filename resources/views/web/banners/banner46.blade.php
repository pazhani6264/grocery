...
<div id="getbanner_46_loading"></div>

  <div id="getbanner_46_product"></div>

  <script>
    getbanner_46();
    function getbanner_46() {
      var type = '1'
      var content ='';
      ...
      jQuery('#getbanner_46_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_46_loading').html(' ');
              jQuery('#getbanner_46_product').html(res);
