...
<div id="getbanner_11_loading"></div>

  <div id="getbanner_11_product"></div>
  ...
  <script>
    ...
    function getbanner_11() {
      ...
      jQuery('#getbanner_11_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_11_loading').html(' ');
              jQuery('#getbanner_11_product').html(res);
