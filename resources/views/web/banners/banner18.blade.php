...
<div id="getbanner_18_loading"></div>

  <div id="getbanner_18_product"></div>
  ...
  <script>
    ...
    function getbanner_18() {
      ...
      jQuery('#getbanner_18_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_18_loading').html(' ');
              jQuery('#getbanner_18_product').html(res);
