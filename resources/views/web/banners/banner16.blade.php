...
<div id="getbanner_16_loading"></div>

  <div id="getbanner_16_product"></div>
  ...
  <script>
    ...
    function getbanner_16() {
      ...
      jQuery('#getbanner_16_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_16_loading').html(' ');
              jQuery('#getbanner_16_product').html(res);
