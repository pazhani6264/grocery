...
<div id="getbanner_10_loading"></div>

  <div id="getbanner_10_product"></div>
  ...
  <script>
    ...
    function getbanner_10() {
      ...
      jQuery('#getbanner_10_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_10_loading').html(' ');
              jQuery('#getbanner_10_product').html(res);
