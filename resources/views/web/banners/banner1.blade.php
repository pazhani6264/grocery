...
<div id="getbanner_1_loading"></div>

  <div id="getbanner_1_product"></div>
  ...
  <script>
    ...
    function getbanner_1() {
      ...
      jQuery('#getbanner_1_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_1_loading').html(' ');
              jQuery('#getbanner_1_product').html(res);
