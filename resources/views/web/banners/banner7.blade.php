...
<div id="getbanner_7_loading"></div>

  <div id="getbanner_7_product"></div>
  ...
  <script>
    ...
    function getbanner_7() {
      ...
      jQuery('#getbanner_7_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_7_loading').html(' ');
              jQuery('#getbanner_7_product').html(res);
