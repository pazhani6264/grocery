...
<div id="getbanner_41_loading"></div>

  <div id="getbanner_41_product"></div>
  ...
  <script>
    ...
    function getbanner_41() {
      ...
      jQuery('#getbanner_41_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_41_loading').html(' ');
              jQuery('#getbanner_41_product').html(res);
              getbanner41script();
