...
<div id="getbanner_4_loading"></div>

  <div id="getbanner_4_product"></div>
  ...
  <script>
    ...
    function getbanner_4() {
      ...
      jQuery('#getbanner_4_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getbanner_4_loading').html(' ');
              jQuery('#getbanner_4_product').html(res);
