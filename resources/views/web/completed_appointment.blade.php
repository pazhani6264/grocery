        ...
        <div class="wallet-desktop-main mobile-display-none-web">
            ...
            <div class="wallet-desktop-content-main">
              ...
              <div style="border-bottom:1px solid #eaeceb;margin-top:5px;">
                ...
                <div class="order-main-right">
                  ...
                  <input type="hidden" name="status_name" value="Completed">
                  ...
                  <!-- <a href="{{ URL::to('/appointment_export')}}">
              ...
              <form name="changePhone" action="{{ URL::to('/completed_appointment_filter')}}" class="align-items-center form-validate" enctype="multipart/form-data"  method="get" style="padding:0px !important">
              @csrf
                <div class="order-search-main">
                  ...
                  <div class="order-search2 select-control-search">
                    <input type="hidden" name="orders_status" class="form-control-search" placeholder="Completed" readonly value="4">
                    <input class="form-control-search" placeholder="Completed" readonly value="Completed">
          ...
          ?>
                  ...
                  <div id="material-tabs" class="order-main-tab" style="padding-left:17px;background:#f8f8f8">
                    ...
                    <a style="font-size:12px;margin-right:25px"  href="{{ URL::to('/pending_appointment')}}" class="order-table-title-normal"><i class="fas fa-bug" style="margin-right: 5px;"></i> Pending <div class="table-count">{{ count($result['pending_appointment']) }}</div></a>
                    <a style="font-size:12px;margin-right:25px"  href="{{ URL::to('/completed_appointment')}}" class="order-table-title-normal profile-table-title"><i class="fas fa-list" style="margin-right: 5px;"></i> Completed <div class="table-count table-count-active">{{ count($result['completed_appointment_count']) }}</div></a>
                  </div>
                  <div class="tab-content" style="padding: 0px 0px !important;">
                    ...
                    <div id="tab1">
                      <div class="table-top-header">
                        <div class="table-top-header-left">showing {{ $result['completed_appointment']->firstItem() }} - {{ $result['completed_appointment']->lastItem() }} 0f {{ count($result['completed_appointment_count']) }} results</div>
                      ...
                      <table id="example" class="table order-table">
                        ...
                        <tbody>
                          @if(count($result['completed_appointment']) > 0)
                          @foreach( $result['completed_appointment'] as $resappointment)
                      ...
                      <div class="col-xs-12" style="float:right">
                          {!! $result['completed_appointment']->appends(Request::except('page'))->links() !!}
                      </div>
                    </div>
                  </div>
...
<div class="desktop-display-none-web">
            ...
            <div  style="background:#fff;margin-left:0px;">
              ...
              @csrf
                ...
                <div class="order-search2-mobile" style="padding: 0px 10px 10px 10px;">
                  ...
                  <input type="hidden" name="orders_status" class="form-control-search" placeholder="Completed" readonly value="4">
                  <input style="border:1px solid #ddd7d7;text-indent: 30px !important;height: calc(2.5em + 0.75rem + 2px);"   class="form-control-search" placeholder="Completed" readonly value="Completed">
                ...
                <div id="material-tabs-mobile" class="order-main-tab" style="padding-left:10px;background:#f8f8f8;border: 1px solid #dad2d2;">
                  ...
                  <a style="font-size:13px;margin-right:15px;letter-spacing: 0px;"  href="{{ URL::to('/pending_appointment')}}" class="order-table-title-normal"><i class="fas fa-bug" style="margin-right: 5px;"></i> PENDING <div class="table-count">{{ count($result['pending_appointment']) }}</div></a>
                  <a style="font-size:13px;letter-spacing: 0px;"  href="{{ URL::to('/completed_appointment')}}" class="order-table-title-normal profile-table-title"><i class="fas fa-list" style="margin-right: 5px;"></i> COMPLETED <div class="table-count table-count-active">{{ count($result['completed_appointment_count']) }}</div></a>
                </div>
                <div class="tab-content" style="padding: 0px 0px !important;">
                  @if(session()->has('success') )
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                  ...
                  <div id="tab4">
                    <div class="table-top-header">
                      <div class="table-top-header-left-mobile">{{ $result['completed_appointment']->firstItem() }} - {{ $result['completed_appointment']->lastItem() }} 0f {{ count($result['completed_appointment_count']) }} results</div>
  ...
  <script type="text/javascript">
    ...
    window.location.href="completed_appointment?{!! $result['varr'] !!}&pagecnt="+vals;
    }
  </script>
