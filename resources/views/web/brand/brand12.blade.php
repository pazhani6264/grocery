...
<div id="getclientbrand_12_loading"></div>

  <div id="getclientbrand_12_product"></div>

  <script>
    getclientbrand_12();
    function getclientbrand_12() {
      var type = '3'
      var content ='';
      ...
      jQuery('#getclientbrand_12_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getclientbrand_12")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getclientbrand_12_loading').html(' ');
              jQuery('#getclientbrand_12_product').html(res);
              getclientbrand12_slick();
...
function getclientbrand12_slick(){
jQuery(document).ready(function () {
    (function (jQuery) {
  var tabCarousel = jQuery('.brand-carousel-js-12');
