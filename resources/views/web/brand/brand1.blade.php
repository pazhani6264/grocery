...
<div id="getclientbrand_1_loading"></div>

  <div id="getclientbrand_1_product"></div>

  <script>
    getclientbrand_1();
    function getclientbrand_1() {
      var type = '1'
      var content ='';
      ...
      jQuery('#getclientbrand_one_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getclientbrand_1")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getclientbrand_1_loading').html(' ');
              jQuery('#getclientbrand_1_product').html(res);
              getclientbrand_1_slick();
...
function getclientbrand_1_slick(){
