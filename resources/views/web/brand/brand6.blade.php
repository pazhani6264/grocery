...
<div id="getclientbrand_6_loading"></div>

  <div id="getclientbrand_6_product"></div>

  <script>
    getclientbrand_6();
    function getclientbrand_6() {
      var type = '6'
      var content ='';
      ...
      jQuery('#getclientbrand_6_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getclientbrand_6")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getclientbrand_6_loading').html(' ');
              jQuery('#getclientbrand_6_product').html(res);
              getclientbrand6_slick();
...
function getclientbrand6_slick(){
