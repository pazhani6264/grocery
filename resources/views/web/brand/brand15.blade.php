...
<div id="getclientbrand_15_loading"></div>

  <div id="getclientbrand_15_product"></div>

  <script>
    getclientbrand_15();
    function getclientbrand_15() {
      var type = '3'
      var content ='';
      ...
      jQuery('#getclientbrand_15_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getclientbrand_15")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getclientbrand_15_loading').html(' ');
              jQuery('#getclientbrand_15_product').html(res);
              getclientbrand15_slick();
...
function getclientbrand15_slick(){
jQuery(document).ready(function () {
    (function (jQuery) {
  var tabCarousel = jQuery('.brand-carousel-js-15');
