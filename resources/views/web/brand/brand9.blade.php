...
<div id="getclientbrand_9_loading"></div>

  <div id="getclientbrand_9_product"></div>

  <script>
    getclientbrand_9();
    function getclientbrand_9() {
      var type = '9'
      var content ='';
      ...
      jQuery('#getclientbrand_9_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getclientbrand_9")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getclientbrand_9_loading').html(' ');
              jQuery('#getclientbrand_9_product').html(res);
              getclientbrand9_slick();
...
function getclientbrand9_slick(){
