...
<div id="getclientbrand_4_loading"></div>

  <div id="getclientbrand_4_product"></div>

  <script>
    getclientbrand_4();
    function getclientbrand_4() {
      var type = '4'
      var content ='';
      ...
      jQuery('#getclientbrand_4_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getclientbrand_4")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getclientbrand_4_loading').html(' ');
              jQuery('#getclientbrand_4_product').html(res);
              getclientbrand4_slick();
...
function getclientbrand4_slick(){
