                ...
                <div class="slick" style="position:relative">
                  ...
                  @if($slides_data->type == 'category')
                    ...
                    @endif 
                        ...
                        <span style="font-size:1rem;">{{ $slides_data->con_name  }}</span><svg xmlns="http://www.w3.org/2000/svg" width="10" height="17" viewBox="0 0 33.908 19.619" style="margin-left: 10px;">
