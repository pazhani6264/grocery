              ...
              <div class="product">
                  <article>
                    <div class="thumb">
                      ...
                      <img class="img-fluid" src="{{$products->image_path}}" alt="{{$products->products_name}}" style="height:100%">
                    @else
                    <img class="img-fluid" src="{{asset('').$products->image_path}}" alt="{{$products->products_name}}" style="height:100%"> 
                  @endif
