...
?>
                        ...
                        @if($result['commonContent']['settings']['Inventory'] == 0)
                          @if($products->max_order == 0)
                            ...
                            @elseif($products->products_type == 3 || $products->products_type == 4) 
...
@else
                  ...
                  <form id="apply_coupon" class="form-validate">
                    <div class="row">
                        <div class="input-group">
                            <input type="text" name="coupon_code" class="form-control" id="coupon_code" placeholder="Coupon Code" aria-label="Coupon Code" aria-describedby="coupon-code" style="height:100%;">
          ...
          @if($result['commonContent']['settings']['Loyalty']=='1')
            <a href="javascript:;" data-toggle="modal" data-target="#myModalcoupon" class="btn btn-secondary swipe-to-top mar-bottom-mobile">Available Coupon</a>
             @endif
            <?php } ?>
