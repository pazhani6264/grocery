            ...
            <div class="col-12 col-lg-12 mb-4">
              <div class="row justify-content-between click-btn">
                ...
                <div class="col-12 col-lg-7 align-right">
                  <div class="row">
                    <a  href="{{ URL::to('/ordershop')}}" class="btn btn-secondary swipe-to-top">@lang('website.Back To Shopping')</a>
            ...
            <table class="table right-table">
              ...
              <tbody>
                ...
                <tr class="item-price">
                  ...
                  <td align="right" >{{Session::get('symbol_left')}}{{session('currency_value') * $price+0}}{{Session::get('symbol_right')}}</td>
                </tr>
              </tbody>
            </table>
            
            <button id="addTableOrder" class="btn btn-secondary m-btn col-12 swipe-to-top">PLACE ORDER</button>
