              ...
              <div class="page-heading-title">
                <div class="pbc-2-header">
                  ...
                  <div class="hitter btntab12 common-text md-none" style="text-transform:initial;float:right"><a href="{{ URL::to('/')}}" class="common-text" id="apply_options"> Clean All </a></div>
                    <div class="menucate">
                    <a href="filter_index?category=all"><div class="@if(request()->get('category') == 'all') cateactive @endif btntab12" id="all">All</div></a>
                      <?php 
                        foreach ($result1['category_section'] as $item)
                        {
                            ...
                            {
                              ?>
                               <a href="filter_index?category={{ $item->categories_slug }}"><div class="@if(request()->get('category') == $item->categories_slug ) cateactive @endif btntab12" id="{{ $item->categories_name }}"> {{ $item->categories_name }}</div></a>
                           <?php }
                        }
                      ?>
                      </div>
                        ...
                        <div id="profile-description" class="right-menu-categories">
                          <div class="text show-more-height">
                            ...
                            <ul id="accordion" class="accordion">
                              @include('web.common.recent12Categories')
                              @php    recent12Categories(); @endphp 
                            </ul>
                          </div>
