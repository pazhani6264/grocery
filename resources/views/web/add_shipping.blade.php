      ...
      <div class="wallet-desktop-main ">
          ...
          <div class="wallet-desktop-content-main ">
            ...
            <div class="shipping-desktop-content-right">
              <div class="ship_form_content" style="padding-top: 10px;margin-left:30px;">
                  <h3 style="margin:10px 0px 30px 10px"><i onclick="history.back()" class="fa fa-arrow-left" style="margin-right:30px;"></i> Add New Address</h3>
                  <div class="shipping-main">

                  <form class="form-validate" enctype="multipart/form-data" action="{{ URL::to('/addMyAddress')}}" method="post">
                   ...
                   @endif
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" name="entry_firstname" class="form-control-shipping field-validate" id="entry1_firstname" value="{{auth()->guard('customer')->user()->first_name}}{{ old('entry_firstname') }}">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" name="entry_lastname" class="form-control-shipping field-validate" rid="entry1_lastname" value="{{auth()->guard('customer')->user()->last_name}}{{ old('entry_lastname') }}">
                    ...
                    <div class="form-row">
                      <div class="form-group col-4 col-md-2">
                        ...
                        ?>
                        <select name="entry_cc_code" id="entry_cc_code" class="form-control-country-code field-validate" style="border:none !important">
                            @if(!empty($code))
                              @foreach($code as $jescode)
                                <option value="{{$jescode->country_code}}" @if($jescode->country_code==auth()->guard('customer')->user()->country_code) selected @endif>{{$jescode->countries_iso_code_3}}({{$jescode->country_code}})</option>
                              @endforeach
                              @endif
                        </select>
                      </div>
                      <div class="form-group col-8 col-md-4">
                        ...
                        <input type="text" name="phone_number"  class="form-control-shipping field-validate" id="phone_number1" value="{{auth()->guard('customer')->user()->phone}}" onkeydown="return ( event.ctrlKey || event.altKey
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-12">
                        ...
                        <input type="text"  name="entry_street_address"  class="form-control-shipping field-validate" aria-describedby="addressHelp" placeholder="House Number, Building, Street Name" id="entry1_street_address"  value="{{ old('entry_street_address') }}">
                      </div>
                    </div>
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" name="entry_city"  class="form-control-shipping field-validate city" id="entry_city1">
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" name="entry_postcode"  class="form-control-shipping field-validate" id="entry_postcode1" onkeydown="return ( event.ctrlKey || event.altKey
                      || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)
                      || (95<event.keyCode && event.keyCode<106)
                      || (event.keyCode==8) || (event.keyCode==9)
                      || (event.keyCode>34 && event.keyCode<40)
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" name="landmark"  class="form-control-shipping">
                      </div>
                    </div>
                    <?php 
                        $ckaddr = DB::table('address_book')->where('user_id',auth()->guard('customer')->user()->id)->count();
                    ?>
                    ...
                    <div class="form-row">
                      @if($ckaddr == 0)
                        <div class="form-group-checkbox col-md-12">
                          ...
                          <input type="checkbox" checked style="margin-right:10px"> <label for="addr"><b>Set as Default Address<b></label>
                        </div>
                      @else
                        <div class="form-group-checkbox col-md-12">
                          <input type="checkbox" name="default_set" value="1" id="addr"  style="margin-right:10px"> <label for="addr"><b>Set as Default Address<b></label>
                        </div>
                      @endif
                    </div>
                    <div class="button" style="margin:0px 10px;">
                        <button style="width:100%;border-radius: 5px;padding: 10px;" type="submit" class="btn btn-secondary swipe-to-top">Save</button>
                    </div>
                  </form>
