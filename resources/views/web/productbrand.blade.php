...
<?php  $resultnew = DB::table('manufacturers')
        ->LeftJoin('image_categories', 'manufacturers.manufacturer_image', '=', 'image_categories.image_id')
        ->select('image_categories.path_type as image_path_type','image_categories.path','manufacturers.manufacturer_name')->where('image_categories.image_type', 'ACTUAL')->orderBy('manufacturers.manufacturers_id', 'ASC')
       ->get(); 
        ?>
