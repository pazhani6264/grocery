...
<section class="blog-content pt-2ins  instagram2">
    ...
    <hr>
        ...
        <div class="heading2 text-center">
            ...
            <p class="font-weight-normal parag">@<?php echo $result['commonContent']['settings']['instauserid'];?> Instagram</p>
        </div>
                    ...
                    <div class="feed-col">
                        <div class="instagram-feed">
                            ...
                            <div class="instagram-feed-content">
                                <a target="_blank" style="color:#fff;font-weight:400 !important;" href="https://www.instagram.com/{{ $result['commonContent']['settings']['instauserid']}}"><i class="fa fa-instagram"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
