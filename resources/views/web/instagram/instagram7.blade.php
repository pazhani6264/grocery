...
<section class="blog-content instagram2">
	<div class="container"> 
        <div class="heading2 text-center">
            <h2 class="title title-lg">Let Us Inspire You On Instagram</h2>
        ...
        <div class="more-container text-center"><a href="#" class="btn btn-outline-primary-2 btn-more">@<?php echo $result['commonContent']['settings']['instauserid'];?> Instagram</a></div>
