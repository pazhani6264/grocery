  ...
  <div class="container">
      ...
      <div class="row">
        <div class="col-12">
          ...
          @if(session('wpay_status')=='2' || session('wpay_status')=='3')
            <div class="pro-empty-page">
              <h2 style="font-size: 150px;"><i class="far fa-check-circle"></i></h2>
              <h1 >@lang('website.Thank You')</h1>
              <p>
                You have successfully added wallet amount
                <a href="{{ URL::to('/wallet')}}" class="btn-link"><b>Wallet</b></a>
              </p>
            </div>
          @elseif(session('wpay_status')=='1')
            <div class="pro-empty-page">
              <h2 style="font-size: 150px;"><i class="far fa fa-ban"></i></h2>
              <h1 >@lang('website.Sorry')</h1>
              <p>
                Your online payment failed
                <a href="{{ URL::to('/wallet')}}" class="btn-link"><b>Wallet</b></a>
              </p>
            </div>
           @endif
                    ...
                    <tbody>
                        <tr class="d-flex">
                          <td class="col-6 col-md-6" style="border-top: 0; border-bottom: 1px solid #dee2e6;">@lang('website.orderID')</td>
                            ...
                            <span class="badge badge-primary"><a href="{{ URL::to('/wallet')}}" class="btn-link">Wallet</a></span>
                            </td>
                          </tr>
                          <tr class="d-flex">
