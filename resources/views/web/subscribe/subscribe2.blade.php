        ...
        <div class="subscribe-1-inner-content">
            ...
            <!-- <div class="g-recaptcha" style="margin-bottom:5px;" data-sitekey="6LcgaOIlAAAAANQ9-qy97ERNTHeRVjnFgiwRiK90"></div> 
                ...
                <div class="input-group mobile-group">
                  <input style="height: 46px;" type="email" name="email" class="form-control mr-0 font-weight-normal border-0" placeholder="Enter your Email Address" aria-label="Email Adress" required="">
                  <div class="input-group-append molla_sub_btn_outer" >
                    <button  id="mc-embedded-subscribe" class="btn subscribe-2-btn molla_sub_btn_inner" type="submit"><span style="font-weight: 500;letter-spacing: -0.02em;font-size:1rem">Subscribe <i  class="fa fa-arrow-right" style="margin-left:10px"></i></span></button>
                  </div>
