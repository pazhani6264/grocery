        ...
        <div class="subscribe-1-inner-content">
            ...
            <!-- <div class="g-recaptcha" style="margin-bottom:5px;" data-sitekey="6LcgaOIlAAAAANQ9-qy97ERNTHeRVjnFgiwRiK90"></div> 
                ...
                <div class="input-group mobile-group">
                  <input style="height: calc(3rem + 5px);" type="email" name="email" class="form-control mr-0 font-weight-normal" placeholder="Enter your Email Address" aria-label="Email Adress" required="">
                  <div class="input-group-append molla_sub_btn_outer8" >
                    <button  id="mc-embedded-subscribe" class="btn btn-secondary subscribe-8-btn molla_sub_btn_inner8" type="submit"><span style="font-weight: 500;letter-spacing: -0.02em;font-size:1rem"><svg xmlns="http://www.w3.org/2000/svg" width="12" height="17" viewBox="0 0 33.908 19.619" style="margin: 0 10px;">
