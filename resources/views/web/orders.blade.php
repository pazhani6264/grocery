...
<div class="container-fuild">
        ...
        <div class="row">
            ...
            <div class="wallet-desktop-content-main">
              ...
              <div style="border-bottom:1px solid #eaeceb;margin-top:5px;">
                ...
                <div class="order-main-right">
                  ...
                  <input type="hidden" name="status_name" value="All">
              ...
              <form name="changePhone" action="{{ URL::to('/order_filter')}}" class="align-items-center form-validate" enctype="multipart/form-data"  method="get" style="padding:0px !important">
              @csrf
                <div class="order-search-main">
                  ...
                  <div class="order-search2 select-control-search">
                    <select name="orders_status" class="form-control-search">
                    <option value="">Status</option>
                      <?php foreach ($result['status'] as $orders_status) { ?>
                        <option value="{{ $orders_status->orders_status_id }}"
                          @if(app('request')->input('orders_status') == $orders_status->orders_status_id) selected="selected" @endif>
          ...
          ?>
                  ...
                  <div id="material-tabs" class="order-main-tab" style="padding-left:17px;background:#f8f8f8">
                    <a style="font-size:12px;margin-right:25px"  href="{{ URL::to('/orders')}}" class="order-table-title-normal profile-table-title"><i class="fas fa-home" style="margin-right: 5px;"></i>All <div class="table-count table-count-active">{{ count($result['ordersCount']) }}</div></a>
                  ...
                  <div class="tab-content" style="padding: 0px 0px !important;">
                    ...
                    <div id="tab1">
                      <div class="table-top-header">
                        <div class="table-top-header-left">showing {{ $result['orders']->firstItem() }} - {{ $result['orders']->lastItem() }}  0f {{ count($result['ordersCount']) }} results</div>
                        ...
                        <tbody>
                          ...
                          <td></td>
                            ...
                            <td style="display:table-cell;" class="">
                                  ...
                                  <div>
                                    <span class="badge badge-primary" style="padding:0px !important"><div class="dot-badge-cancel"></div> {{$orders->orders_status}} </span><br>
                                    <form action="{{ URL::to('/updatestatus')}}" method="post" onSubmit="return cancelOrder();">
                                    <input type="hidden" name="_token" id="csrf-token" value="{{ Session::token() }}" />
                                    <input type="hidden" name="orders_id" value="{{$orders->orders_id}}">
                                    <input type="hidden" name="orders_status" value="3">
                      ...
                      <div class="col-xs-12" style="float:right">
                          {!! $result['orders']->appends(Request::except('page'))->links() !!}
                      </div>
                    </div>
                  </div>
            ...
            <div  style="background:#fff;margin-left:0px;">
              ...
              @csrf
                ...
                <div id="material-tabs-mobile" class="order-main-tab" style="padding-left:10px;background:#f8f8f8;border: 1px solid #dad2d2;">
                  <a style="font-size:13px;margin-right:15px;letter-spacing: 0px;"  href="{{ URL::to('/orders')}}" class="order-table-title-normal profile-table-title"><i class="fas fa-home" style="margin-right: 5px;"></i>ALL <div class="table-count table-count-active">{{ count($result['ordersCount']) }}</div></a>
                ...
                <div class="tab-content" style="padding: 0px 0px !important;">
                  ...
                  <div id="tab4">
                    <div class="table-top-header">
                      <div class="table-top-header-left-mobile">{{ $result['orders']->firstItem() }} - {{ $result['orders']->lastItem() }} 0f {{ count($result['ordersCount']) }} results</div>
  ...
  <script type="text/javascript">
    ...
    window.location.href="orders?{!! $result['varr'] !!}&pagecnt="+vals;
    }  
  </script>
@endsection
