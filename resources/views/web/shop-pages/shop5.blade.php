...
<!-- Shop Page One content -->
  <div class="container-fuild">
    ...
    <section class="pro-content">
                ...
                <div class="row">
                  <div class="col-12 col-lg-12">
                      <div class="row align-items-center">
                          ...
                          <div class="col-12 col-xl-7 col-md-5 block select-bar">
          ...
          <section class="shop-content shop-content-5 shop-three shop-topbar">
            ...
            <div class="shop-side-scroll">
              ...
              <div class="text show-more-height">
                    ...
                    <ul id="accordion" class="accordion">
                     ...
                     <div class="show-more common-hover" style="width:90%; margin:auto;">(Show More)</div></div>
                  ...
                  <div class="col-12 col-lg-9">
                    @if($result['products']['success']==1)
                      <div class="products-area">
                        ...
                        <section id="swap" class="shop-content shop-content-5" >
                              <div class="products-area">
