      ...
      <div class="row justify-content-center">
        ...
        <div class="col-12 col-sm-12 col-md-6">
          ...
          <div class="col-12 my-5">
             ...
             <h5>OTP Verfication</h5>
             <hr style="margin-bottom: 0;">
                <div class="tab-content" id="registerTabContent">
                  <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="login-tab">
                      <div class="registration-process">
                      <form name="signup" enctype="multipart/form-data" class="form-validate"  action="{{ URL::to('/socialprocessotpsignup')}}" method="post">
                        {{csrf_field()}}
                    ...
                    || (event.keyCode==46) )" maxlength="4">
                          ...
                          <div class="col-12 col-sm-12 account_form">
                                ...
                                <span id="link_dis"><a href="{{ URL::to('/socialresendotp/' . $result['user_data']->id . '/' . $result['user_data']->phone )}}">@lang('website.Resend otp')</a></span> 
                            </div>
