<!-- //banner six -->
<style>
#getmultibanner_62_product .btn-outline-white {
    border: 2px solid;
    min-width: 140px;
...
#getmultibanner_62_product .btn-outline-white:hover, #getmultibanner_62_product .btn-outline-white:not(:disabled):not(.disabled).active, #getmultibanner_62_product .btn-outline-white:not(:disabled):not(.disabled):active, .show>.btn-outline-white.dropdown-toggle {
    color: #000 !important;
...
<div id="getmultibanner_62_loading"></div>

  <div id="getmultibanner_62_product"></div>

  <script>
    getmultibanner_62();
    function getmultibanner_62() {
      var type = '2'
      var content ='';
      ...
      jQuery('#getmultibanner_62_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_62_loading').html(' ');
              jQuery('#getmultibanner_62_product').html(res);
