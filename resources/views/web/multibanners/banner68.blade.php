...
<div id="getmultibanner_68_loading"></div>

  <div id="getmultibanner_68_product"></div>

  <script>
    getmultibanner_68();
    function getmultibanner_68() {
      var type = '2'
      var content ='';
      ...
      jQuery('#getmultibanner_68_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_68_loading').html(' ');
              jQuery('#getmultibanner_68_product').html(res);
