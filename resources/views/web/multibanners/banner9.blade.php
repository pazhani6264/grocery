...
<div id="getmultibanner_9_loading"></div>

  <div id="getmultibanner_9_product"></div>
  ...
  <script>
    ...
    function getbanner_9() {
      ...
      jQuery('#getmultibanner_9_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_9_loading').html(' ');
              jQuery('#getmultibanner_9_product').html(res);
