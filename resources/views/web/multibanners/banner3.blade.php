...
<div id="getmultibanner_3_loading"></div>

  <div id="getmultibanner_3_product"></div>
  ...
  <script>
    ...
    function getbanner_3() {
      ...
      jQuery('#getmultibanner_3_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_3_loading').html(' ');
              jQuery('#getmultibanner_3_product').html(res);
