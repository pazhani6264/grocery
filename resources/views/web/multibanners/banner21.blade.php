...
<div id="getmultibanner_21_loading"></div>

  <div id="getmultibanner_21_product"></div>
  ...
  <script>
    ...
    function getbanner_21() {
      ...
      jQuery('#getmultibanner_21_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_21_loading').html(' ');
              jQuery('#getmultibanner_21_product').html(res);
