...
<div id="getmultibanner_5_loading"></div>

  <div id="getmultibanner_5_product"></div>
  ...
  <script>
    ...
    function getbanner_5() {
      ...
      jQuery('#getmultibanner_5_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_5_loading').html(' ');
              jQuery('#getmultibanner_5_product').html(res);
