...
<div id="getmultibanner_13_loading"></div>

  <div id="getmultibanner_13_product"></div>
  ...
  <script>
    ...
    function getbanner_13() {
      ...
      jQuery('#getmultibanner_13_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_13_loading').html(' ');
              jQuery('#getmultibanner_13_product').html(res);
