...
<div id="getmultibanner_7_loading"></div>

  <div id="getmultibanner_7_product"></div>
  ...
  <script>
    ...
    function getbanner_7() {
      ...
      jQuery('#getmultibanner_7_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_7_loading').html(' ');
              jQuery('#getmultibanner_7_product').html(res);
