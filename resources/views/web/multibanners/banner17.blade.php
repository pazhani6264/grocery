...
<div id="getmultibanner_17_loading"></div>

  <div id="getmultibanner_17_product"></div>
  ...
  <script>
    ...
    function getbanner_17() {
      ...
      jQuery('#getmultibanner_17_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_17_loading').html(' ');
              jQuery('#getmultibanner_17_product').html(res);
