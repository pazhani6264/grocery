...
<div id="getmultibanner_66_loading"></div>

  <div id="getmultibanner_66_product"></div>
  ...
  <script>
    ...
    function getbanner_66() {
      ...
      jQuery('#getmultibanner_66_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_66_loading').html(' ');
              jQuery('#getmultibanner_66_product').html(res);
              getbanner66script();
