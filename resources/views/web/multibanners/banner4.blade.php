...
<div id="getmultibanner_4_loading"></div>

  <div id="getmultibanner_4_product"></div>
  ...
  <script>
    ...
    function getbanner_4() {
      ...
      jQuery('#getmultibanner_4_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_4_loading').html(' ');
              jQuery('#getmultibanner_4_product').html(res);
