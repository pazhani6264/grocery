...
<div id="getmultibanner_14_loading"></div>

  <div id="getmultibanner_14_product"></div>
  ...
  <script>
    ...
    function getbanner_14() {
      ...
      jQuery('#getmultibanner_14_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_14_loading').html(' ');
              jQuery('#getmultibanner_14_product').html(res);
