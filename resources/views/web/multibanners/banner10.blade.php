...
<div id="getmultibanner_10_loading"></div>

  <div id="getmultibanner_10_product"></div>
  ...
  <script>
    ...
    function getbanner_10() {
      ...
      jQuery('#getmultibanner_10_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_10_loading').html(' ');
              jQuery('#getmultibanner_10_product').html(res);
