...
<div id="getmultibanner_12_loading"></div>

  <div id="getmultibanner_12_product"></div>
  ...
  <script>
    ...
    function getbanner_12() {
      ...
      jQuery('#getmultibanner_12_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_12_loading').html(' ');
              jQuery('#getmultibanner_12_product').html(res);
