...
<div id="getmultibanner_19_loading"></div>

  <div id="getmultibanner_19_product"></div>
  ...
  <script>
    ...
    function getbanner_19() {
      ...
      jQuery('#getmultibanner_19_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_19_loading').html(' ');
              jQuery('#getmultibanner_19_product').html(res);
