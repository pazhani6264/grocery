...
<div id="getmultibanner_15_loading"></div>

  <div id="getmultibanner_15_product"></div>
  ...
  <script>
    ...
    function getbanner_15() {
      ...
      jQuery('#getmultibanner_15_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_15_loading').html(' ');
              jQuery('#getmultibanner_15_product').html(res);
