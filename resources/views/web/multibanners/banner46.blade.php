...
<div id="getmultibanner_46_loading"></div>

  <div id="getmultibanner_46_product"></div>

  <script>
    getmultibanner_46();
    function getmultibanner_46() {
      var type = '2'
      var content ='';
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_46_loading').html(' ');
              jQuery('#getmultibanner_46_product').html(res);
