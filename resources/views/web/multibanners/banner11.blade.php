...
<div id="getmultibanner_11_loading"></div>

  <div id="getmultibanner_11_product"></div>
  ...
  <script>
    ...
    function getbanner_11() {
      ...
      jQuery('#getmultibanner_11_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_11_loading').html(' ');
              jQuery('#getmultibanner_11_product').html(res);
