...
<div id="getmultibanner_54_loading"></div>

  <div id="getmultibanner_54_product"></div>
  ...
  <script>
    ...
    function getbanner_54() {
      ...
      jQuery('#getmultibanner_54_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_54_loading').html(' ');
              jQuery('#getmultibanner_54_product').html(res);
