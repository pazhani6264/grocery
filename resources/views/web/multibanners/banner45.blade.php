...
<div id="getmultibanner_45_loading"></div>

  <div id="getmultibanner_45_product"></div>
  ...
  <script>
    ...
    function getbanner_45() {
      ...
      jQuery('#getmultibanner_45_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_45_loading').html(' ');
              jQuery('#getmultibanner_45_product').html(res);
