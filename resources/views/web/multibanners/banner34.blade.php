...
<div id="getmultibanner_34_loading"></div>

  <div id="getmultibanner_34_product"></div>

  <script>
    getmultibanner_34();
    function getmultibanner_34() {
      var type = '2'
      var content ='';
      ...
      jQuery('#getmultibanner_34_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_34_loading').html(' ');
              jQuery('#getmultibanner_34_product').html(res);
