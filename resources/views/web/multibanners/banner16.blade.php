...
<div id="getmultibanner_16_loading"></div>

  <div id="getmultibanner_16_product"></div>
  ...
  <script>
    ...
    function getbanner_16() {
      ...
      jQuery('#getmultibanner_16_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_16_loading').html(' ');
              jQuery('#getmultibanner_16_product').html(res);
