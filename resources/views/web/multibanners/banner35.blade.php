...
<div id="getmultibanner_35_loading"></div>

  <div id="getmultibanner_35_product"></div>

  <script>
    getmultibanner_35();
    function getmultibanner_35() {
      var type = '2'
      var content ='';
      ...
      jQuery('#getmultibanner_35_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_35_loading').html(' ');
              jQuery('#getmultibanner_35_product').html(res);
