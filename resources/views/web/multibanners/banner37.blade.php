...
<div id="getmultibanner_37_loading"></div>

  <div id="getmultibanner_37_product"></div>

  <script>
    getmultibanner_37();
    function getmultibanner_37() {
      var type = '2'
      var content ='';
      ...
      jQuery('#getmultibanner_37_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_37_loading').html(' ');
              jQuery('#getmultibanner_37_product').html(res);
