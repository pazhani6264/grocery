...
<div id="getmultibanner_18_loading"></div>

  <div id="getmultibanner_18_product"></div>
  ...
  <script>
    ...
    function getbanner_18() {
      ...
      jQuery('#getmultibanner_18_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_18_loading').html(' ');
              jQuery('#getmultibanner_18_product').html(res);
