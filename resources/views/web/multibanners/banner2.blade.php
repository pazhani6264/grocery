...
<div id="getmultibanner_2_loading"></div>

  <div id="getmultibanner_2_product"></div>
  ...
  <script>
    ...
    function getbanner_2() {
      ...
      jQuery('#getmultibanner_2_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_2_loading').html(' ');
              jQuery('#getmultibanner_2_product').html(res);
