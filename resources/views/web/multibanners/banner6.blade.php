...
<div id="getmultibanner_6_loading"></div>

  <div id="getmultibanner_6_product"></div>
  ...
  <script>
    ...
    function getbanner_6() {
      ...
      jQuery('#getmultibanner_6_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_6_loading').html(' ');
              jQuery('#getmultibanner_6_product').html(res);
