...
<div id="getmultibanner_1_loading"></div>

  <div id="getmultibanner_1_product"></div>
  ...
  <script>
    ...
    function getbanner_1() {
      ...
      jQuery('#getmultibanner_1_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_1_loading').html(' ');
              jQuery('#getmultibanner_1_product').html(res);
