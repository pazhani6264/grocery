...
<div id="getmultibanner_53_loading"></div>

  <div id="getmultibanner_53_product"></div>
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_53_loading').html(' ');
              jQuery('#getmultibanner_53_product').html(res);
              getbanner41script();
