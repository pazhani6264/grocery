...
<div id="getmultibanner_36_loading"></div>

  <div id="getmultibanner_36_product"></div>

  <script>
    getmultibanner_36();
    function getmultibanner_36() {
      var type = '2'
      var content ='';
      ...
      jQuery('#getmultibanner_36_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibanner_36_loading').html(' ');
              jQuery('#getmultibanner_36_product').html(res);
