...
<input type="hidden" id="mobheadergetvalue" value="24"/>
...
<a class="demo-15-mobile-wish-hide" href="{{ URL::to('/wishlist')}}">
  <?php } else {?>
    <?php 
    $loginID = DB::table('current_theme')->first();
    if($loginID->login == 4) {
  ?>
    <a class="demo-15-mobile-wish-hide login_modal" style="cursor:pointer"> 
  <?php } else if($loginID->login == 5){ ?>
    <a class="demo-15-mobile-wish-hide login_modal1" style="cursor:pointer">     
  <?php } else if($loginID->login == 6){ ?>
    <a class="demo-15-mobile-wish-hide login_modal2" style="cursor:pointer">   
  <?php } else if($loginID->login == 7){ ?>
    <a class="demo-15-mobile-wish-hide login_modal3" style="cursor:pointer"> 
  <?php } else if($loginID->login == 8){ ?>
    <a class="demo-15-mobile-wish-hide login_modal4" style="cursor:pointer"> 
  <?php } else { ?>
    <a class="demo-15-mobile-wish-hide" href="{{ URL::to('/wishlist')}}"> 
  <?php } ?>
    <?php }?>

                      <div class="pro-header-right-options display-inline cart-left-wishlist cart-left-wishlist-11 text-center common-fill-hover color-fill" style="margin-right:40px !important;vertical-align:super">
                      ...
                      <g id="wishlist" transform="translate(0 -36.545)">
                        ...
                        <span class="badge badge-secondary badge-wishlist-29">{{ $result['commonContent']['total_wishlist'] }}</span>
                      </div>
                    </a>     
                    
                    @if($result['commonContent']['settings']['view_cart_button'] == 1)

            <ul class="pro-header-right-options header-29-mobile-cart-drop common-fill-hover color-fill" id="resposive-header-cart" style="display:inline-block">
              @include('web.headers.cartButtons.cartButtonMobile24')
            </ul> 
            @endif
          </div>
          </div>
