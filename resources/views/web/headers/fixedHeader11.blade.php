              ...
              <div class="container">
                  <div class="row align-items-center">
                    ...
                    @include('web.common.HeaderCategoriesFixed')
                      <nav class="navbar navbar-expand-sm navbar-dark-11 menu-11-padding" style="position:relative">
                          <button type="button" class="navbar-toggler" data-toggle="collapse" data-target="#navbarCollapse">
                              <span class="navbar-toggler-icon"></span>
                          </button>
                          <div class="collapse navbar-collapse menu-11 menu-11-border" id="navbarCollapse">
                              <div class="navbar-nav width-100">
                                  <div class="nav-item dropdown  width-100" style="padding:9px">
                                ...
                                ->get();
                                  ...
                                  ?> 
                                    <li class="nav-item dropdown menu-active-11-{{ $menuactive }} hover-menu-11">
                                      <a style="white-space:nowrap;font-weight:500 !important" class="nav-link  fixed-header-11-nopadding" <?php echo $link; ?>>{{ $item->name }} <?php  if ($childs->isNotEmpty()){?>  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/></svg><?php } ?></i></a>
                                  ...
                                  <?php }} if(count($items) > 4){?>
                                    ...
                                    <li class="nav-item dropdown  hover-menu-11">
                                      <a style="white-space:nowrap;font-weight:500 !important" class="nav-link fixed-header-11-nopadding" href="#">More  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
</svg></a>
                                        <div class="dropdown-menu">
                                        <?php
