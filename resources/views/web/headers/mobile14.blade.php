  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
                      ...
                      <?php if(auth()->guard('customer')->check() &&  auth()->guard('customer')->user()->phone_verified == '1'){ ?>
                        ...
                        if($result['commonContent']['settings']['view_login_button'] == 1){
                            ...
                            if($loginID->login == 4) { 
                            ?>
                               <a style="cursor:pointer" class="color-14-top login_modal" >&nbsp;@lang('website.Login/Register')</a>
                            <?php } else if($loginID->login == 5){ ?>
                               <a style="cursor:pointer" class="color-14-top login_modal1" >&nbsp;@lang('website.Login/Register')</a>
                            <?php } else if($loginID->login == 6){ ?>
                               <a style="cursor:pointer" class="color-14-top login_modal2" >&nbsp;@lang('website.Login/Register')</a>
                            <?php } else if($loginID->login == 7){ ?>
                               <a style="cursor:pointer" class="color-14-top login_modal3" >&nbsp;@lang('website.Login/Register')</a>
                            <?php } else if($loginID->login == 8){ ?>
                               <a style="cursor:pointer" class="color-14-top login_modal4" >&nbsp;@lang('website.Login/Register')</a>
                          <?php } else { ?>
...
<a href="{{ URL::to('/wishlist')}}">
  ...
  <?php } ?>
    <?php }?>
            ...
            <ul class="pro-header-right-options header-14-mobile-cart-drop common-fill-hover" id="resposive-header-cart" style="display:inline-block">
              @include('web.headers.cartButtons.cartButtonMobile14')
            </ul> 
