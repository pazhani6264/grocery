...
<input type="hidden" id="mobheadergetvalue" value="44"/>
                ...
                <div class="dropdown-mobile-12 left-11">
                  <ul class="navbar-nav">
                    <li class="nav-item mr-20" style="margin-left:10px">
                      <a class="color-14-top common-fill-hover demo-19-fill-down" href="tel:{{$result['commonContent']['setting'][11]->value}}">
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/>
                      ...
                      @if(count($languages) > 1)
                        <div class="dropdown-mobile-11-con drop-left color-14-top">
                          <a class="dropbtn-mobile-11-con common-fill-hover demo-19-fill-down"> {{	session('language_name')}} &nbsp; <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/>
</svg></a>
...
<a class="demo-19-mobile-display-none" href="{{ URL::to('/profile')}}">
  ...
  <?php } ?>
    <?php }?>
                  <div class="pro-header-right-options fill-black-color common-fill-hover display-inline cart-left-wishlist cart-left-wishlist-11 text-center" style="margin-right:10px !important">
...
<a class="demo-19-mobile-display-none" href="{{ URL::to('/wishlist')}}">
  ...
  <?php } ?>
    <?php }?>
                  <div class="pro-header-right-options fill-black-color common-fill-hover display-inline cart-left-wishlist cart-left-wishlist-11 text-center" style="margin-right:15px !important">
            ...
            <ul class="pro-header-right-options fill-black-color common-fill-hover header-23-mobile-cart-drop" id="resposive-header-cart" style="display:inline-block">
              @include('web.headers.cartButtons.cartButtonMobile44')
            </ul> 
