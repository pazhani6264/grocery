                  ...
                  <div class="row align-items-center">
                    ...
                    @include('web.common.HeaderCategoriesFixed')
                      <nav class="navbar navbar-expand-sm navbar-dark-11 menu-11-padding">
                          ...
                          <div class="collapse navbar-collapse menu-11-border-fixed" id="navbarCollapse">
                              <div class="navbar-nav width-100">
                                  <div class="nav-item dropdown menu-11 width-100" style="padding:8px">
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
                                      ...
                                      <a id="shopclcikfixed" href="#" class="nav-link menu-hover-11 menu-color-11  cate-color-22" data-toggle="dropdown"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="15" viewBox="0 0 27.001 27">
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#fff"/>
                                      ...
                                      <div class="dropdown-menu dropdown-menu-11">
                                      <?php productCategoriesFixed(); ?>
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/></svg><?php } ?></i></a>
                                  ...
                                  <?php }} if(count($items) > 4){?>
                                    ...
                                    <li class="nav-item dropdown  hover-menu-13">
                                      <a style="white-space:nowrap" class="nav-link  fixed-header-11-nopadding" href="#">More  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
</svg> </a>
                                        <div class="dropdown-menu">
                                        <?php
                    ...
                    <div class="col-12 col-sm-3 border-left">
                        <?php if(strlen($result['commonContent']['settings']['head_offer_title']) <= 17) { ?>
                          <a href="{{ $result['commonContent']['settings']['head_offer_url'] }}">
                            <div class="head-11 "><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 49.479 49.99">
