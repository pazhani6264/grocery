<input type="hidden" id="fixheadergetvalue" value="20"/>
        ...
        <header id="stickyHeader" class="header-12-search-fixed header-fixed header-area header-sticky d-none">
          ...
          <div class="navbar-collapse" style="margin-left:65px">
            <ul class="navbar-nav">
            <?php 
              ...
              ->get();
                ...
                ?> 
                  <li class="nav-item dropdown menu-active-{{ $menuactive }} fixed-12-padding-black">
                    <a style="white-space:nowrap" class="nav-link padding-0-black fill-color common-fill-hover" <?php echo $link; ?>>{{ $item->name }} <?php  if ($childs->isNotEmpty()){?> <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/></svg><?php } ?></a>
                ...
                <?php }} if(count($items) > 4){?>
                  ...
                  <li class="nav-item dropdown fixed-12-padding-black ">
                    <a style="white-space:nowrap" class="nav-link padding-0-black fill-color common-fill-hover" href="#">More <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/>
</svg></a>
                      <div class="dropdown-menu">
                      <?php
                          ...
                          <form class="form-inline-search" action="{{ URL::to('/shop')}}" method="get" style="margin-left: 15px;position: relative;right: -25px;">
                            <div class="input-main" id="searchbuttonsfixed">
                              ...
                              <div class="input-main" id="searchbuttonfixed" style="display:none">
                                  <input autocomplete="off" required name="search" type="text" value="{{ app('request')->input('search') }}"  class="search-input-bg typeheads_fixed" placeholder="Search Product ..... ">
                                  <div class="search_outer_con_fixed">
                                    <div id="viewsearchproduct_fixed"></div>
                                  </div>
                              </div>
                              <button id="dropdownCartButton" class="btn search-button-main color-fill-phone" type="button" style="right:0;padding:0.6rem 1rem"> 
                                
                                <svg id="search" xmlns="http://www.w3.org/2000/svg" class="cus-style-search" onclick="myFunctionfixed()" width="20" height="20" viewBox="0 0 27 27" class="search-icon-16 icon-font-16">
  <g id="Layer_1" data-name="Layer 1" transform="translate(0 0)">
    <path id="Path_55427" data-name="Path 55427" d="M.216,25.052l6.72-6.72a11.27,11.27,0,1,1,1.591,1.591l-6.72,6.72A1.127,1.127,0,0,1,.216,25.052Zm15.427-4.833a9.007,9.007,0,1,0-9-9,9.007,9.007,0,0,0,9,9Z" transform="translate(0.07 0.07)"/>
                        ...
                        <div class="col-md-3">
                          <ul class="pro-header-right-options header-20-fixed-cart-drop common-hover color-fill-phone common-fill-hover" style="margin-top:4px;margin-left:15px">
                            <li class="dropdown head-cart-content-fixed">
                              @include('web.headers.cartButtons.cartButtonFixed20')
                            </li>
                          </ul>
                        </div>
                        @endif
