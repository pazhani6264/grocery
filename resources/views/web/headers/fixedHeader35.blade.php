<input type="hidden" id="fixheadergetvalue" value="35"/>
              ...
              ->get();
                ...
                ?> 
                  <li class="nav-item dropdown menu-active-30-{{ $menuactive }} fixed-12-padding-black">
                    <a style="white-space:nowrap" class="nav-link font-500 menu-color-38 fill-color common-fill-hover menu-16-color-black fixed-padding-30 padding-0-black" <?php echo $link;?>>{{ $item->name }} <?php  if ($childs->isNotEmpty()){?> <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/></svg><?php } ?></a>
                ...
                <?php }} if(count($items) > 4){?>
                  ...
                  <li class="nav-item dropdown fixed-12-padding-black">
                    <a style="white-space:nowrap" class="nav-link font-500 fill-color common-fill-hover menu-color-38 menu-16-color-black fixed-padding-30 padding-0-black" href="#">More <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/>
</svg></a>
                      <div class="dropdown-menu">
                      <?php
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/></svg><?php } ?></a>
        ...
        <div class="col-12 col-sm-3" style="text-align:right">
                  ...
                  <!-- <form class="form-inline-search" action="{{ URL::to('/shop')}}" method="get" >
                    <div class="input-main" id="searchbuttonsfixed">
                      ...
                      <div class="input-main" id="searchbuttonfixed" style="display:none;margin-right:20px">
                          <input autocomplete="off" name="search" type="text" value="{{ app('request')->input('search') }}" class="search-input-bg-white typeheads_fixed" placeholder="Search Product ..... " style="position:relative">
                  ...
                  <button id="dropdownCartButton" class="btn srach-18-butt fill-search common-fill-hover" type="button" style="margin-right: 40px;padding: 4px;margin-top: 4px;"> 

                  <svg id="search" xmlns="http://www.w3.org/2000/svg" onclick="myFunctionfixed()" width="18" height="18" viewBox="0 0 27 27" class="cus-style-search icon-39-color menu-16-color-black">
    ...
    <path id="Path_55427" data-name="Path 55427" d="M.216,25.052l6.72-6.72a11.27,11.27,0,1,1,1.591,1.591l-6.72,6.72A1.127,1.127,0,0,1,.216,25.052Zm15.427-4.833a9.007,9.007,0,1,0-9-9,9.007,9.007,0,0,0,9,9Z" transform="translate(0.07 0.07)" />
                    ...
                    <form class="form-inline-search" action="{{ URL::to('/shop')}}" method="get" style="display:inline-block;position:relative">
                        ...
                        <div class="input-main srach-18-main-input" id="searchbuttonfixed" style="display:none;">
                            <input autocomplete="off" required style="position:unset" name="search" value="{{ app('request')->input('search') }}"  type="text" class="search-input-33 typeheads_fixed" placeholder="Search Product ..... ">
                  ...
                  <ul class="pro-header-right-options display-inline header-35-fixed-cart-drop" style="float:right;position:relative;">
                    <li class="dropdown head-cart-content-fixed common-hover fill-search common-fill-hover" style="margin-left:0px">
                      @include('web.headers.cartButtons.cartButtonFixed35')
                    </li>
                  </ul>
                  @endif
                </div>
