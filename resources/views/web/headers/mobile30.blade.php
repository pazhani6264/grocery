...
<input type="hidden" id="mobheadergetvalue" value="30"/>

<header id="headerMobileTwele" class="header-area header-mobile header-mobile-12 d-lg-none d-xl-none">


    <div id="add30-mobile-hover" class="img-header-mobile30 header-maxi mobile-12 bg-header-bar-35" style="height:100px !important">
      <div class="container">
        <div class="row align-items-center">

            <nav id="navbar_0" class="navbar navbar-expand-md navbar-dark navbar-0" style="padding:1rem !important">
              <div class="navbar-lang">

              @if(count($currencies) > 1)
                  <div class="dropdown-mobile-12 drop-left1 color-16-top">
                    <a class="dropbtn-mobile-12 common-fill-hover demo-19-fill-down text-white"> {{	session('currency_code')}}  &nbsp; <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/>
                ...
                @if(count($languages) > 1)
                  <div class="dropdown-mobile-12 drop-left color-16-top">
                    <a class="dropbtn-mobile-12 common-fill-hover demo-19-fill-down text-white"> {{	session('language_name')}}  &nbsp; <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/>
</svg> </a>
                    <div class="dropdown-content-mobile-12 dropdown-left">
                ...
                <div class="dropdown-mobile-11 drop-right">
                  <a style="color:#fff !important" class="dropbtn-mobile-11 color-14-top demo-19-fill-down">LINKS  &nbsp; <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/>
</svg></a>
...
<a class="demo-19-mobile-display-none" href="{{ URL::to('/wishlist')}}">
  ...
  <?php } ?>
    <?php }?>
              <div class="pro-header-right-options display-inline common-fill-hover demo-19-fill-down cart-left-wishlist icon-39-color">
            ...
            <ul class="pro-header-right-options common-fill-hover demo-19-fill-down header-30-mobile-cart-drop head-30-cart" id="resposive-header-cart" style="display:inline-block;">
              @include('web.headers.cartButtons.cartButtonMobile30')
            </ul> 
            @endif
          </div>
          </div>
