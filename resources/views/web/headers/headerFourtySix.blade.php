...
#demo-17-footer-con .footer-bottom .container:before {
                ...
                <?php if(auth()->guard('customer')->check() &&  auth()->guard('customer')->user()->phone_verified== '1'){ ?>
                  ...
                  <?php }else{ ?>
                    ...
                    <?php } else if($loginID->login == 7){ ?>
                      <li class="nav-item common-fill-hover color-fill-phone 3" style="margin-left:20px;"> <a class="color-16-top">  <svg xmlns="http://www.w3.org/2000/svg" width="12" height="11" viewBox="0 0 24.552 26.999" style="margin-right:5px;">
                      <path id="profile" d="M22.1,27a9.828,9.828,0,0,0-9.732-9.819h-.174A9.828,9.828,0,0,0,2.457,27H0A12.294,12.294,0,0,1,7.467,15.7a8.591,8.591,0,1,1,9.618,0A12.294,12.294,0,0,1,24.552,27ZM6.142,8.582a6.134,6.134,0,1,0,6.134-6.134A6.143,6.143,0,0,0,6.142,8.582Z"/></svg>&nbsp;<span>Login</span></a> </li>
    ...
    <?php }?>
                  ...
                  <ul class="pro-header-right-options display-inline header-19-cart-drop common-hover common-fill-hover fill-search">
                    <li class="dropdown head-cart-content" style="float:none;">
                      @include('web.headers.cartButtons.cartButton19')
                    </li>
                  </ul>
                  @endif
                </div>
