...
.icon-cart-new
    ...
    .icon-cart-131964784999299812:before {
  content: "\e900";
}
.cart-left:hover .icon-cart-new
{
...
<div class="header-mini bg-top-bar-14">
          ...
          <nav id="navbar_0_6" class="navbar navbar-expand-md navbar-dark navbar-0">
            ...
            <ul class="navbar-nav">
              <li class="nav-item mr-20">
                <a class="color-14-top common-fill-hover" href="tel:{{$result['commonContent']['setting'][11]->value}}">
              ...
              <div class="navbar-lang">
                ...
                @if(count($currencies) > 1)
                  <div class="dropdown" style="margin-right:0px;margin-left:20px;">
                    <button class="btn dropdown-toggle color-14-top" type="button" >
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
                ...
                @if(count($languages) > 1)
                  <div class="dropdown" style="margin-right:0px;margin-left:20px;">
                      <button class="btn dropdown-toggle color-14-top" type="button" style="text-transform:initial">
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
              ...
              <?php if(auth()->guard('customer')->check() &&  auth()->guard('customer')->user()->phone_verified== '1'){ ?>
                  ...
                  <li class="nav-item" style="margin-left:25px;"> <a class="color-14-top" href="{{url('profile')}}" class="nav-link">@lang('website.Profile')</a> </li>
                  <li class="nav-item" style="margin-left:25px;"> <a class="color-14-top" href="{{url('orders')}}" class="nav-link">@lang('website.Orders')</a> </li>
                  <li class="nav-item" style="margin-left:25px;"> <a class="color-14-top" href="{{url('shipping-address')}}" class="nav-link">@lang('website.Shipping Address')</a> </li>
                  <li class="nav-item" style="margin-left:25px;"> <a class="color-14-top" href="{{url('logout')}}" class="nav-link">@lang('website.Logout')</a> </li>
                  <?php }else{ ?>
                   ...
                   if($result['commonContent']['settings']['view_login_button'] == 1){
                      ...
                      if($loginID->login == 4) {
                    ?>
                      <li class="nav-item login_modal" style="margin-left:25px;"> <a class="color-14-top">Sign In / Sign Up</a> </li>    
                    <?php } else if($loginID->login == 5){ ?>
                      <li class="nav-item login_modal1" style="margin-left:25px;"> <a class="color-14-top">Sign In / Sign Up</a> </li>  
                    <?php } else if($loginID->login == 6){ ?>
                      <li class="nav-item login_modal2" style="margin-left:25px;"> <a class="color-14-top">Sign In / Sign Up</a> </li>    
                    <?php } else if($loginID->login == 7){ ?>
                      <li class="nav-item login_modal3" style="margin-left:25px;"> <a class="color-14-top">Sign In / Sign Up</a> </li>
                    <?php } else if($loginID->login == 8){ ?>
                      <li class="nav-item login_modal4" style="margin-left:25px;"> <a class="color-14-top">Sign In / Sign Up</a> </li>    
                    <?php } else { ?>
                      <li class="nav-item" style="margin-left:25px;"> <a class="color-14-top" href="{{ URL::to('/login')}}">Sign In / Sign Up</a> </li>       
                    <?php } } }?>
              </ul> 
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-12 col-md-3 col-lg-3">
          ...
          <div class="col-12 col-sm-7 col-md-6 col-lg-6" style="padding-right:10px">      
            <form class="form-inline" action="{{ URL::to('/shop')}}" method="get"> 
              <div class="search-field-module border-radius-main border-color-14">     
                <div class="search-field-wrap search-field-wrap-11">
                <input type="hidden" class="category-value" name="categories_id" value="" /> 
                  <input autocomplete="off" required type="text" name="search" class="search-13 typeheads" placeholder="@lang('website.Search entire store here')..." data-toggle="" data-placement="bottom" title="@lang('website.Search Products')" value="{{ app('request')->input('search') }}">
                  <button class="btn  swipe-to-top search-button-13 common-fill-hover" data-toggle="" 
  ...
  <path id="compare" d="M35.917,40.161H27.343L22.074,29.623l1.567-3.051,5.521,10.589h6.755V30.434L44,38.515l-8.082,7.543ZM0,40.161v-3H10.48l7.535-14.226L9.924,9.4H0v-3H11.626l8.031,13.437L26.5,6.908h9.413V0L44,8.081l-8.082,7.543V9.907H28.31L12.286,40.161Z" />
                      ...
                      <div class="small-font-size">Compare</div>
                    </div>
                  </a>
  ...
  <g id="wishlist" transform="translate(0 -36.545)">
    <path id="Path_55409" data-name="Path 55409" d="M44.814,39.883q-3.419-3.338-9.447-3.338a10.733,10.733,0,0,0-3.4.578,13.76,13.76,0,0,0-3.229,1.561q-1.494.982-2.571,1.844a24.872,24.872,0,0,0-2.045,1.83,24.905,24.905,0,0,0-2.046-1.83q-1.077-.861-2.571-1.844a13.779,13.779,0,0,0-3.23-1.561,10.736,10.736,0,0,0-3.4-.578q-6.029,0-9.447,3.338T0,49.141a11.791,11.791,0,0,0,.633,3.714,16.292,16.292,0,0,0,1.44,3.257A23.82,23.82,0,0,0,3.9,58.736Q4.926,60.014,5.4,60.5a8.916,8.916,0,0,0,.74.7L22.932,77.4a1.689,1.689,0,0,0,2.369,0l16.768-16.15q6.164-6.163,6.164-12.111Q48.232,43.219,44.814,39.883Zm-5.087,18.84L24.116,73.768,8.479,58.7q-5.033-5.032-5.033-9.555a11.735,11.735,0,0,1,.578-3.849A7.518,7.518,0,0,1,5.5,42.641a7.11,7.11,0,0,1,2.194-1.6,9.725,9.725,0,0,1,2.53-.834,15.416,15.416,0,0,1,2.638-.215,7.741,7.741,0,0,1,3.015.686A13.761,13.761,0,0,1,18.854,42.4q1.359,1.037,2.329,1.938A20.908,20.908,0,0,1,22.8,45.992a1.764,1.764,0,0,0,2.638,0,20.851,20.851,0,0,1,1.615-1.655q.969-.9,2.328-1.938a13.757,13.757,0,0,1,2.975-1.722,7.74,7.74,0,0,1,3.015-.686A15.419,15.419,0,0,1,38,40.205a9.714,9.714,0,0,1,2.53.834,7.11,7.11,0,0,1,2.193,1.6,7.518,7.518,0,0,1,1.481,2.651,11.745,11.745,0,0,1,.578,3.849Q44.787,53.663,39.727,58.723Z" transform="translate(0 0)" />
                  ...
                  <ul class="header-14-cart-drop pro-header-right-options display-inline common-fill-hover" style="float:right;margin-top:5px;margin-left: 20px;">
                    <li class="dropdown head-cart-content">
                      @include('web.headers.cartButtons.cartButton14')
                    </li>
                  </ul>
                  @endif
                </div>
...
<div class="bg-header" style="background-color:#fff">
  <div class="container">
      <div class="row align-items-center">
        <div class="col-12 col-sm-3">
          <nav class="navbar navbar-expand-sm navbar-dark-14 menu-11-padding menu-11">
              ...
              <div class="collapse navbar-collapse" id="navbarCollapse">
                  <div class="navbar-nav width-100">
                      <div class="nav-item dropdown  width-100">
                          <a href="#" style="padding: 16px 16px;" class="nav-link menu-hover-11 common-color cate-color-14 padding-14" data-toggle="dropdown"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="12" viewBox="0 0 36 27">
  <g id="hamburger_menu" transform="translate(0.307 0.307)">
    <rect id="Rectangle_5800" class="common-fill" data-name="Rectangle 5800" width="36" height="3" transform="translate(-0.307 -0.307)" />
    <rect id="Rectangle_5801" class="common-fill" data-name="Rectangle 5801" width="36" height="3" transform="translate(-0.307 11.693)" />
    <rect id="Rectangle_5802" class="common-fill" data-name="Rectangle 5802" width="36" height="3" transform="translate(-0.307 23.693)" />
  </g>
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
                          ...
                          <a id="shopclcik" href="#" style="padding: 16px 16px;" class="nav-link menu-hover-11 menu-color-11 cate-color-14-2 padding-14" data-toggle="dropdown"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="15" viewBox="0 0 27.001 27">
                    ...
                    ->get();
                      ...
                      ?> 
                        <li class="nav-item dropdown menu-active-11-{{ $menuactive }} hover-menu-11">
                          <a style="white-space:nowrap;" class="nav-link" <?php echo $link; ?>>{{ $item->name }} <?php  if ($childs->isNotEmpty()){?> <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
</svg><?php } ?></a>
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/></svg><?php } ?></a>
                      ...
                      <?php }} if(count($items) > 4){?>
                        ...
                        <li class="nav-item dropdown  hover-menu-11">
                          <a style="white-space:nowrap;" class="nav-link" href="#">More <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
</svg></a>
                            <div class="dropdown-menu">
                            <?php
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/></svg><?php } ?></i></a>
        ...
        <div class="col-12 col-sm-3 border-left">
          <?php if(strlen($result['commonContent']['settings']['head_offer_title']) <= 17) { ?>
              ...
              <div class="head-11 color-11-clearance"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 49.479 49.99">
