...
<input type="hidden" id="mobheadergetvalue" value="47"/>
        ...
        <div class="row">
            ...
            <nav id="navbar_0" class="navbar navbar-expand-md navbar-dark navbar-0">
              ...
              <div id="rssBlock" class="dropdown-mobile-12 left-11 desk-none">
                  <p class="cnnContents">
                      <span class="marqueeStyle color-16-top1"><a class="color-14-top" href="tel:{{$result['commonContent']['setting'][11]->value}}">
                      ...
                      <?php } else { ?>
                       ...
                       if($result['commonContent']['settings']['view_login_button'] == 1){
                            ...
                            <?php } else if($loginID->login == 6){ ?>
                              <a class="color-14-top login_modal12" >Sign In/ Sign Up</a>                    
          ...
          <div class="mobile-header-right"> 
            <div class="" style="display:inline-block;">
                <a class="demo-19-mobile-display-none" href="{{ URL::to('/compare')}}">
                  <div class="pro-header-right-options common-hover common-fill-hover display-inline cart-left-wishlist cart-left-wishlist-11 text-center" style="margin-right:10px !important">
...
<a class="demo-19-mobile-display-none" href="{{ URL::to('/wishlist')}}">
  ...
  <?php } ?>
    <?php }?>
                  <div class="pro-header-right-options common-hover common-fill-hover display-inline cart-left-wishlist cart-left-wishlist-11 text-center" style="margin-right:15px !important">
            ...
            <ul class="pro-header-right-options common-hover common-fill-hover header-23-mobile-cart-drop" id="resposive-header-cart" style="display:inline-block">
              @include('web.headers.cartButtons.cartButtonMobile47')
            </ul> 
