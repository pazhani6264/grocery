                          ...
                          <div class="collapse navbar-collapse" id="navbarCollapse">
                              <div class="navbar-nav width-100">
                                  <div class="nav-item dropdown  width-100">
                                      <a href="#" style="padding: 14px 20px;" class="nav-link menu-hover-11 cate-color-14 padding-14" data-toggle="dropdown"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="12" viewBox="0 0 36 27">
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
                                      ...
                                      <a id="shopclcikfixed" href="#" style="padding: 14px 20px;" class="nav-link menu-hover-11 menu-color-11 padding-14 cate-color-14-2" data-toggle="dropdown"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="15" viewBox="0 0 27.001 27">
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#fff"/>
                                      ...
                                      <div class="dropdown-menu dropdown-menu-11" style="top:55px !important">
                                          ...
                                          @php    productCategoriesFixed(); @endphp       
                                      </div>
                                  </div>
                              </div>
                          </div>
                      ...
                      $menuactive = '';
                                  ...
                                  ?> 
                                    <li class="nav-item dropdown menu-active-11-{{ $menuactive }} hover-menu-11">
                                      <a style="white-space:nowrap" class="nav-link  fixed-header-11-nopadding" <?php echo $link; ?> >{{ $item->name }} <?php  if ($childs->isNotEmpty()){?> <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
</svg> <?php } ?></a>
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/></svg><?php } ?></i></a>
                                  ...
                                  <?php }} if(count($items) > 4){?>
                                    ...
                                    <li class="nav-item dropdown ">
                                      <a style="white-space:nowrap" class="nav-link fixed-header-11-nopadding hover-menu-11" href="#">More <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
</svg></a>
                                        <div class="dropdown-menu">
                                        <?php
