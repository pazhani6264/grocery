            ...
            <nav id="navbar_0" class="navbar navbar-expand-md navbar-dark navbar-0">
              <div class="navbar-lang">
                ...
                <div class="dropdown-mobile-12 left-11">
                  <ul class="navbar-nav">
                    <li class="nav-item mr-20" style="margin-left:10px">
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/>
                      ...
                      <?php } else { ?>
                        ...
                        if($result['commonContent']['settings']['view_login_button'] == 1){
                            ...
                            if($loginID->login == 4) { 
                            ?>
                               <a class="color-14-top login_modal">Sign In / Sign Up</a>              
                            <?php } else if($loginID->login == 5){ ?>
                              <a class="color-14-top login_modal1">Sign In / Sign Up</a>                   
                            <?php } else if($loginID->login == 6){ ?>
                              <a class="color-14-top login_modal2">Sign In / Sign Up</a>                    
                            <?php } else if($loginID->login == 7){ ?>
                              <a class="color-14-top login_modal3">Sign In / Sign Up</a>
                            <?php } else if($loginID->login == 8){ ?>
                              <a class="color-14-top login_modal4">Sign In / Sign Up</a>                     
                          <?php } else { ?>
                            <a class="color-14-top" href="{{ URL::to('/login')}}" >Sign In / Sign Up</a>                 
                        <?php } } }?>
        ...
        <div class="row align-items-center">
          <div class="mobile-header-left"> 
              <div class="navigation-mobile-container">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" class="menu-23-fontsize" width="16" height="12" viewBox="0 0 36 27">
    ...
    <rect id="Rectangle_5802"  data-name="Rectangle 5802" width="36" height="3" transform="translate(-0.307 23.693)" fill="#000"/>
                  ...
                  <nav id="navigation-mobiles" class="mobile-bf-39">
                      <div class="logout-main mobile-bf-39">
                          ...
                          <span class="close-bttn close-bttn-11"><svg xmlns="http://www.w3.org/2000/svg" class="menu-23-fontsize" width="16" height="15" viewBox="0 0 27.001 27">
                       ...
                       <footer id="footerMobile" class="footer-area footer-mobile-menu d-lg-none d-xl-none mobile-bf-39 footer-11-color">
                          <div class="container-fluid p-0">
                            <div class="container">
                              <div class="row">
                                <div class="col-12">
                                      <div class="socials mt-40 mb-40" style="padding-bottom:150px">
                                          <ul class="list">
                                          <li>
          ...
          <div class="mobile-header-right"> 
            <div class="" style="display:inline-block;">
                <a href="{{ URL::to('/compare')}}">
                  <div class="pro-header-right-options common-fill-hover display-inline cart-left-wishlist cart-left-wishlist-11 text-center" style="margin-right:10px !important">
...
<a href="{{ URL::to('/wishlist')}}">
  ...
  <?php } ?>
    <?php }?>
                  <div class="pro-header-right-options common-fill-hover display-inline cart-left-wishlist cart-left-wishlist-11 text-center" style="margin-right:15px !important">
  ...
  <g id="wishlist" transform="translate(0 -36.545)">
    <path id="Path_55409" data-name="Path 55409" d="M44.814,39.883q-3.419-3.338-9.447-3.338a10.733,10.733,0,0,0-3.4.578,13.76,13.76,0,0,0-3.229,1.561q-1.494.982-2.571,1.844a24.872,24.872,0,0,0-2.045,1.83,24.905,24.905,0,0,0-2.046-1.83q-1.077-.861-2.571-1.844a13.779,13.779,0,0,0-3.23-1.561,10.736,10.736,0,0,0-3.4-.578q-6.029,0-9.447,3.338T0,49.141a11.791,11.791,0,0,0,.633,3.714,16.292,16.292,0,0,0,1.44,3.257A23.82,23.82,0,0,0,3.9,58.736Q4.926,60.014,5.4,60.5a8.916,8.916,0,0,0,.74.7L22.932,77.4a1.689,1.689,0,0,0,2.369,0l16.768-16.15q6.164-6.163,6.164-12.111Q48.232,43.219,44.814,39.883Zm-5.087,18.84L24.116,73.768,8.479,58.7q-5.033-5.032-5.033-9.555a11.735,11.735,0,0,1,.578-3.849A7.518,7.518,0,0,1,5.5,42.641a7.11,7.11,0,0,1,2.194-1.6,9.725,9.725,0,0,1,2.53-.834,15.416,15.416,0,0,1,2.638-.215,7.741,7.741,0,0,1,3.015.686A13.761,13.761,0,0,1,18.854,42.4q1.359,1.037,2.329,1.938A20.908,20.908,0,0,1,22.8,45.992a1.764,1.764,0,0,0,2.638,0,20.851,20.851,0,0,1,1.615-1.655q.969-.9,2.328-1.938a13.757,13.757,0,0,1,2.975-1.722,7.74,7.74,0,0,1,3.015-.686A15.419,15.419,0,0,1,38,40.205a9.714,9.714,0,0,1,2.53.834,7.11,7.11,0,0,1,2.193,1.6,7.518,7.518,0,0,1,1.481,2.651,11.745,11.745,0,0,1,.578,3.849Q44.787,53.663,39.727,58.723Z" transform="translate(0 0)" />
            ...
            <ul class="pro-header-right-options common-fill-hover common-hover header-23-mobile-cart-drop" id="resposive-header-cart" style="display:inline-block">
              @include('web.headers.cartButtons.cartButtonMobile23')
            </ul> 
            @endif
          </div>
          </div>
