...
<input type="hidden" id="mobheadergetvalue" value="45"/>
...
<!-- <div class="header-mini bg-top-bar-11">
    ...
    <div class="header-maxi mobile-12 bg-header-bar ">
      <div class="container">
        ...
        <div class="mobile-header-left" style="width:61% !important"> 
  ...
  <g id="Layer_1" data-name="Layer 1" transform="translate(0 0)">
    <path id="Path_55427" data-name="Path 55427" d="M.216,25.052l6.72-6.72a11.27,11.27,0,1,1,1.591,1.591l-6.72,6.72A1.127,1.127,0,0,1,.216,25.052Zm15.427-4.833a9.007,9.007,0,1,0-9-9,9.007,9.007,0,0,0,9,9Z" transform="translate(0.07 0.07)" fill="#fff"/>
                      ...
                      <!-- <?php //else{ ?>
                        ...
                        //     if($loginID->login == 4) { 
                            ?>
                               <a class="main-manu btn login_modal">Sign In / Sign Up</a>              
                            <?php //} else if($loginID->login == 5){ ?>
                              <a class="main-manu btn login_modal1">Sign In / Sign Up</a>                   
                            <?php //} else  if($loginID->login == 6){ ?>
                              <a class="main-manu btn login_modal2">Sign In / Sign Up</a>                    
                            <?php //} else  if($loginID->login == 7){ ?>
                              <a class="main-manu btn login_modal3">Sign In / Sign Up</a> 
                            <?php //} else  if($loginID->login == 8){ ?>
                              <a class="main-manu btn login_modal4">Sign In / Sign Up</a>                     
                          <?php //} else { ?>
                            <a class="main-manu btn" href="{{ URL::to('/login')}}" >Sign In / Sign Up</a>                 
                        <?php //} } }?> -->
            ...
            <a class="" href="#" class="logo">
              <span class="demo-23-nav-title-top" style="font-size:0.9rem">Free Delivery For Members</span>
           </a>
          </div>

          <div class="mobile-header-right" style="width:39% !important"> 
          <button id="dropdownCartButton" class="btn display-mobile-none srach-18-butt common-fill-hover fill-search" type="button"> 
...
<a class="display-mobile-none" href="{{ URL::to('/wishlist')}}">
  <?php } else {?>
    <?php 
    $loginID = DB::table('current_theme')->first();
    if($loginID->login == 4) {
  ?>
    <a class="display-mobile-none login_modal" style="cursor:pointer"> 
  <?php } else if($loginID->login == 5){ ?>
    <a class="display-mobile-none login_modal1" style="cursor:pointer">     
  <?php } else if($loginID->login == 6){ ?>
    <a class="display-mobile-none login_modal2" style="cursor:pointer">   
  <?php } else if($loginID->login == 7){ ?>
    <a class="display-mobile-none login_modal3" style="cursor:pointer"> 
  <?php } else if($loginID->login == 8){ ?>
    <a class="display-mobile-none login_modal4" style="cursor:pointer"> 
  <?php } else { ?>
    <a class="display-mobile-none" href="{{ URL::to('/wishlist')}}"> 
  <?php } ?>
    <?php }?>

              <div class="pro-header-right-options display-inline  cart-left-wishlist common-fill-hover fill-search">
            ...
            <ul class="pro-header-right-options header-18-mobile-cart-drop common-hover common-fill-hover fill-search" id="resposive-header-cart" style="display:inline-block;vertical-align:bottom">
              @include('web.headers.cartButtons.cartButtonMobile45')
            </ul> 
