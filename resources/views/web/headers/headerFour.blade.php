...
<!--                       <li class="nav-item"> <a class="nav-link" href="{{url('tickets')}}" >@lang('website.tickets')</a> </li>
                    ...
                    <h4><span>@lang('website.Country')&nbsp;:&nbsp;</span>
                        ...
                        <ul>
                          @foreach($languages as $language)
                            ...
                            <li><a onclick="myFunction1({{$language->languages_id}})" href="#">
                            @if($language->image_path_type == 'aws')
