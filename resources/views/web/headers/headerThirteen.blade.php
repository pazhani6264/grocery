...
.header-twele .dropdown-item {
    padding: 4px 10px;
    position: relative;
}
.header-twele .header-mini .dropdown-toggle {
...
<!-- //header style Twele -->
@include('web.headers.fixedHeader13') 
<header id="headerTwele" class="header-area header-twele  header-desktop d-none d-lg-block d-xl-block">
<div class="header-mini bg-top-bar-13">
    <div class="container demo-3-col-pad">
      <div class="row align-items-center demo-3-row-pad">
        <div class="col-12 demo-3-col-pad">
          <nav id="navbar_0_6" class="navbar navbar-expand-md navbar-dark navbar-0 nav-border-13" style="padding:0px !important">

            <ul class="navbar-nav">
              <li class="nav-item mr-20">
                <a class="color-13-top menu-16-color-black common-fill-hover" href="tel:{{$result['commonContent']['setting'][11]->value}}">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="12" viewBox="0 0 25.175 26.863">
            ...
            <div class="navbar-collapse">
              ...
              <div class="navbar-lang">
                ...
                @if(count($currencies) > 1)
                  <div class="dropdown " style="margin-right:0px;margin-left:10px;">
                    <button class="btn dropdown-toggle color-13-top menu-16-color-black" type="button" >
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
                    ...
                    <div class="dropdown-menu">
                      ...
                      <a onclick="myFunction2({{$currency->id}})" class="dropdown-item color-13-top" href="#">
                ...
                @if(count($languages) > 1)
                  <div class="dropdown" style="margin-right:10px;margin-left:10px;">
                      <button style="text-transform:initial;" class="btn dropdown-toggle color-13-top menu-16-color-black" type="button" >
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
                      ...
                      <div class="dropdown-menu" >
                        ...
                        <a onclick="myFunction1({{$language->languages_id}})" class="dropdown-item color-13-top" href="#">                      
                          {{$language->name}}
                        </a>                   
                        @endforeach                   
                      </div>
              ...
              <?php if(auth()->guard('customer')->check() &&  auth()->guard('customer')->user()->phone_verified== '1'){ ?>
                  ...
                  <li class="nav-item mr-20"> <a class="color-13-top menu-16-color-black" href="{{url('profile')}}" class="nav-link">@lang('website.Profile')</a> </li>
                  <li class="nav-item mr-20"> <a class="color-13-top menu-16-color-black" href="{{url('orders')}}" class="nav-link">@lang('website.Orders')</a> </li>
                  <li class="nav-item mr-20"> <a class="color-13-top menu-16-color-black" href="{{url('shipping-address')}}" class="nav-link">@lang('website.Shipping Address')</a> </li>
                  <li class="nav-item"> <a class="color-13-top menu-16-color-black" href="{{url('logout')}}" class="nav-link">@lang('website.Logout')</a> </li>
                  <?php }else{ ?>
                  ...
                  if($result['commonContent']['settings']['view_login_button'] == 1){
                      ...
                      if($loginID->login == 4) {
                    ?>
                       <li class="nav-item login_modal" style="margin-left:4px;"> <a class="color-13-top menu-16-color-black">Sign In / Sign Up</a> </li>        
                    <?php } else if($loginID->login == 5){ ?>
                      <li class="nav-item login_modal1" style="margin-left:4px;"> <a class="color-13-top menu-16-color-black">Sign In / Sign Up</a> </li>  
                    <?php } else if($loginID->login == 6){ ?>
                      <li class="nav-item login_modal2" style="margin-left:4px;"> <a class="color-13-top menu-16-color-black">Sign In / Sign Up</a> </li>    
                    <?php } else if($loginID->login == 7){ ?>
                      <li class="nav-item login_modal3" style="margin-left:4px;"> <a class="color-13-top menu-16-color-black">Sign In / Sign Up</a> </li>
                    <?php } else if($loginID->login == 8){ ?>
                      <li class="nav-item login_modal4" style="margin-left:4px;"> <a class="color-13-top menu-16-color-black">Sign In / Sign Up</a> </li>    
                    <?php } else { ?>
                      <li class="nav-item" style="margin-left:4px;"> <a class="color-13-top menu-16-color-black" href="{{ URL::to('/login')}}">Sign In / Sign Up</a> </li>       
                    <?php } } }?>
              </ul> 
  ...
  <div class="header-maxi   bg-header-bar-13 header-maxi-twele">
    <div class="container demo-3-col-pad">
      <div class="row align-items-center demo-3-row-pad">
        ...
        <div class="col-12 col-md-3 col-lg-3 demo-3-col-pad">
          ...
          <div class="col-12 col-sm-7 col-md-6 col-lg-6 demo-3-col-pads">      
            <form class="form-inline" action="{{ URL::to('/shop')}}" method="get"> 
              <div class="search-field-module border-radius-main ">     
                ...
                <input type="hidden" class="category-value" name="categories_id" value="" /> 
                  <input required type="text" name="search" class="search-13 typeheads" placeholder="@lang('website.Search entire store here')..." data-toggle="" data-placement="bottom" title="@lang('website.Search Products')" value="{{ app('request')->input('search') }}">
                  <button class="btn  search-button-13 common-fill-hover" data-toggle="" 
  ...
  <g id="Layer_1" data-name="Layer 1" transform="translate(0 0)">
    <path id="Path_55427" data-name="Path 55427" d="M.216,25.052l6.72-6.72a11.27,11.27,0,1,1,1.591,1.591l-6.72,6.72A1.127,1.127,0,0,1,.216,25.052Zm15.427-4.833a9.007,9.007,0,1,0-9-9,9.007,9.007,0,0,0,9,9Z" transform="translate(0.07 0.07)" />
        ...
        <div class="col-12 col-sm-3 demo-3-col-pad">
              <div class="col-md-12 text-right demo-3-col-pad" style="padding:10px">

                  <a href="{{ URL::to('/compare')}}">
                    <div class="pro-header-right-options display-inline cart-left-wishlist cart-left-wishlist-11 text-center common-fill-hover fill-color" style="margin-right:20px !important">
  ...
  <path id="compare" d="M35.917,40.161H27.343L22.074,29.623l1.567-3.051,5.521,10.589h6.755V30.434L44,38.515l-8.082,7.543ZM0,40.161v-3H10.48l7.535-14.226L9.924,9.4H0v-3H11.626l8.031,13.437L26.5,6.908h9.413V0L44,8.081l-8.082,7.543V9.907H28.31L12.286,40.161Z" />
                      ...
                      <div class="small-font-size color-13-top-text menu-16-color-black">Compare</div>
                    </div>
                  </a>
                  ...
                  <a href="{{ URL::to('/wishlist')}}">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 48.232 41.342">
                      ...
                      <div class="small-font-size color-13-top-text menu-16-color-black">Wishlist</div>
                  ...
                  <ul class="pro-header-right-options display-inline header-13-cart-drop common-fill-hover fill-color" style="float:right;margin-top:5px;margin-left: 20px;">
                    <li class="dropdown head-cart-content">
                      @include('web.headers.cartButtons.cartButton13')
                    </li>
                  </ul>
                  @endif
                </div>
...
<div class="bg-header-13">
          ...
          <nav class="navbar navbar-expand-sm navbar-dark-11 menu-11-padding">
              ...
              <div class="collapse navbar-collapse menu-11-border" id="navbarCollapse">
                  <div class="navbar-nav width-100">
                      <div class="nav-item dropdown menu-11 width-100" style="padding:10px">
...
</svg>  <span class="menu-11-title">Browse Categories</span><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64" style="float:right;margin-top: 5px;">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
</svg> </a>
                          <a id="shopclcik" href="#" class="nav-link menu-hover-11 menu-color-11 cate-color-22" data-toggle="dropdown"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="15" viewBox="0 0 27.001 27">
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#fff"/>
                          ...
                          <div class="dropdown-menu dropdown-menu-11-normal" style="top:55px !important">
                    ...
                    ->get();
                      ...
                      ?> 
                        <li class="nav-item dropdown menu-active-13-{{ $menuactive }} hover-menu-13">
                          <a style="white-space:nowrap;padding: 1.2rem 20px 1.2rem 5px !important;" class="nav-link" <?php echo $link; ?>>{{ $item->name }} <?php  if ($childs->isNotEmpty()){?><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
</svg>  <?php } ?></a>
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/></svg><?php } ?></i></a>
                      ...
                      <?php }} if(count($items) > 4){?>
                        ...
                        <li class="nav-item dropdown  hover-menu-13">
                          <a style="white-space:nowrap;padding: 1.2rem 20px 1.2rem 5px !important;" class="nav-link" href="#">More <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
</svg> </a>
                            <div class="dropdown-menu">
                            <?php
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/></svg><?php } ?></a>
        ...
        <div class="col-12 col-sm-3 border-left demo-3-col-pad">
          

          <?php if(strlen($result['commonContent']['settings']['head_offer_title']) <= 17) { ?>
            <a href="{{ $result['commonContent']['settings']['head_offer_url'] }}">
              <div class="head-11 ">
<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 49.479 49.99">
