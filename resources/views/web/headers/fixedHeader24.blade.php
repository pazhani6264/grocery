<input type="hidden" id="fixheadergetvalue" value="24"/>
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#fff"/></svg><?php } ?></a>
        ...
        <div class="col-12 col-sm-4">
              <div class="row">
                  <form class="form-inline-search" action="{{ URL::to('/shop')}}" method="get" style="width: 66%;margin-right: 25px;position: relative;">
  ...
  <g id="Layer_1" data-name="Layer 1" transform="translate(0 0)">
    <path id="Path_55427" data-name="Path 55427" d="M.216,25.052l6.72-6.72a11.27,11.27,0,1,1,1.591,1.591l-6.72,6.72A1.127,1.127,0,0,1,.216,25.052Zm15.427-4.833a9.007,9.007,0,1,0-9-9,9.007,9.007,0,0,0,9,9Z" transform="translate(0.07 0.07)"/>
                  ...
                  <a href="{{ URL::to('/wishlist')}}">
                      <div class="pro-header-right-options display-inline common-fill-hover color-fill cart-left-wishlist cart-left-wishlist-11 text-center" style="margin-right:20px !important;margin-top:2px;">
                      ...
                      <g id="wishlist" transform="translate(0 -36.545)">
                        ...
                        <span class="total_wishlist badge badge-secondary badge-wishlist-29 badge-wishlist-29-black" style="">{{ $result['commonContent']['total_wishlist'] }}</span>
                      </div>
                    </a>
                  
                    @if($result['commonContent']['settings']['view_cart_button'] == 1)

                    <ul class="pro-header-right-options display-inline header-24-fixed-cart-drop common-fill-hover color-fill" style="float:right;margin-top:7px">
                    <li class="dropdown head-cart-content-fixed margin-left-24-fixed">
                      @include('web.headers.cartButtons.cartButtonFixed24')
                    </li>
                  </ul>
                  @endif
                </div>
