...
.header-twele .header-mini .navbar {
    padding: 0;
    height: 35px;
}
.quick-fill:hover
...
.cus-input-style-16::placeholder{
  font-size:0.9rem !important;
}
.hover-menu-16:before {
    bottom: 0;
    display: block;
    height: 1px;
    width: 0%;
...
<!-- //header style Twele -->
@include('web.headers.fixedHeader16') 
...
<div class="header-mini bg-top-bar-twele">
  ...
  <path id="call" d="M18.267,26.863c-.153,0-.306-.006-.471-.019a12.88,12.88,0,0,1-7.018-2.818A42.043,42.043,0,0,1,2.658,15.36,14.847,14.847,0,0,1,.018,7.872,7,7,0,0,1,.38,5.1,6.652,6.652,0,0,1,1.8,2.744L3.343,1.091a3.342,3.342,0,0,1,4.939,0l1.4,1.495a3.719,3.719,0,0,1,.757,1.209,3.96,3.96,0,0,1,0,2.852,3.719,3.719,0,0,1-.757,1.209l-.8.857a1.976,1.976,0,0,0-.514,1.162,2.015,2.015,0,0,0,.291,1.247,22.553,22.553,0,0,0,6.1,6.505,1.714,1.714,0,0,0,.992.318,1.679,1.679,0,0,0,.177-.009,1.754,1.754,0,0,0,1.089-.548l.8-.856a3.494,3.494,0,0,1,1.134-.808,3.289,3.289,0,0,1,2.672,0,3.494,3.494,0,0,1,1.134.808l1.4,1.493a3.744,3.744,0,0,1,.757,1.21,3.948,3.948,0,0,1,0,2.852,3.731,3.731,0,0,1-.757,1.209L22.6,24.944a6.068,6.068,0,0,1-1.987,1.419,5.752,5.752,0,0,1-2.345.5ZM5.128,1.962a1.766,1.766,0,0,0-.579.413L3,4.029a4.81,4.81,0,0,0-1.022,1.7,5.051,5.051,0,0,0-.261,2A12.967,12.967,0,0,0,4.02,14.27a40.3,40.3,0,0,0,7.779,8.3,11.246,11.246,0,0,0,6.125,2.462c.111.009.225.014.337.014a4.171,4.171,0,0,0,1.539-.294,4.385,4.385,0,0,0,1.6-1.09l1.549-1.653a2,2,0,0,0,0-2.7l-1.4-1.492a1.754,1.754,0,0,0-2.532,0l-.8.855a3.351,3.351,0,0,1-2.47,1.089,3.335,3.335,0,0,1-1.936-.623,24.3,24.3,0,0,1-6.569-7.01,3.945,3.945,0,0,1-.567-2.434,3.857,3.857,0,0,1,1-2.268l.8-.857a2,2,0,0,0,0-2.7l-1.4-1.495a1.763,1.763,0,0,0-.58-.414,1.672,1.672,0,0,0-.682-.145h0A1.675,1.675,0,0,0,5.128,1.962Z" transform="translate(0)"/>
            ...
            <div class="navbar-collapse">
              <ul class="navbar-nav" style="padding:7px 5px !important">
                ...
                @if($result['commonContent']['setting'][218]->value!='')
                  <a target="_blank" href="{{$result['commonContent']['setting'][218]->value}}"><li class="color-16-top"><i class="fa fa-instagram mr-20 demo-25-icon-font common-hover"></i></li></a>
                @endif
                ...
                <?php if(auth()->guard('customer')->check() &&  auth()->guard('customer')->user()->phone_verified== '1'){ ?>
                  ...
                  <?php }else{ ?>
                    ...
                    if($result['commonContent']['settings']['view_login_button'] == 1){
                      ...
                      if($loginID->login == 4) {
                    ?>
                       <li class="nav-item common-fill-hover color-fill-phone login_modal" style="margin-left:20px;"> <a class="color-16-top">  <svg xmlns="http://www.w3.org/2000/svg" width="12" height="11" viewBox="0 0 24.552 26.999" style="margin-right:5px;">
                    ...
                    <?php } else if($loginID->login == 5){ ?>
                      <li class="nav-item common-fill-hover color-fill-phone login_modal1" style="margin-left:20px;"> <a class="color-16-top">  <svg xmlns="http://www.w3.org/2000/svg" width="12" height="11" viewBox="0 0 24.552 26.999" style="margin-right:5px;">
                      <path id="profile" d="M22.1,27a9.828,9.828,0,0,0-9.732-9.819h-.174A9.828,9.828,0,0,0,2.457,27H0A12.294,12.294,0,0,1,7.467,15.7a8.591,8.591,0,1,1,9.618,0A12.294,12.294,0,0,1,24.552,27ZM6.142,8.582a6.134,6.134,0,1,0,6.134-6.134A6.143,6.143,0,0,0,6.142,8.582Z"/>
                    </svg>&nbsp;<span>Login</span></a> </li>    
                    <?php } else if($loginID->login == 6){ ?>
                      <li class="nav-item common-fill-hover color-fill-phone login_modal2" style="margin-left:20px;"> <a class="color-16-top">  <svg xmlns="http://www.w3.org/2000/svg" width="12" height="11" viewBox="0 0 24.552 26.999" style="margin-right:5px;">
                      <path id="profile" d="M22.1,27a9.828,9.828,0,0,0-9.732-9.819h-.174A9.828,9.828,0,0,0,2.457,27H0A12.294,12.294,0,0,1,7.467,15.7a8.591,8.591,0,1,1,9.618,0A12.294,12.294,0,0,1,24.552,27ZM6.142,8.582a6.134,6.134,0,1,0,6.134-6.134A6.143,6.143,0,0,0,6.142,8.582Z"/>
                    </svg>&nbsp;<span>Login</span></a> </li>  
                    <?php } else if($loginID->login == 7){ ?>
                      <li class="nav-item common-fill-hover color-fill-phone login_modal3" style="margin-left:20px;"> <a class="color-16-top">  <svg xmlns="http://www.w3.org/2000/svg" width="12" height="11" viewBox="0 0 24.552 26.999" style="margin-right:5px;">
                      <path id="profile" d="M22.1,27a9.828,9.828,0,0,0-9.732-9.819h-.174A9.828,9.828,0,0,0,2.457,27H0A12.294,12.294,0,0,1,7.467,15.7a8.591,8.591,0,1,1,9.618,0A12.294,12.294,0,0,1,24.552,27ZM6.142,8.582a6.134,6.134,0,1,0,6.134-6.134A6.143,6.143,0,0,0,6.142,8.582Z"/>
                    </svg>&nbsp;<span>Login</span></a> </li>
                    <?php } else if($loginID->login == 8){ ?>
                      <li class="nav-item common-fill-hover color-fill-phone login_modal4" style="margin-left:20px;"> <a class="color-16-top">  <svg xmlns="http://www.w3.org/2000/svg" width="12" height="11" viewBox="0 0 24.552 26.999" style="margin-right:5px;">
                      <path id="profile" d="M22.1,27a9.828,9.828,0,0,0-9.732-9.819h-.174A9.828,9.828,0,0,0,2.457,27H0A12.294,12.294,0,0,1,7.467,15.7a8.591,8.591,0,1,1,9.618,0A12.294,12.294,0,0,1,24.552,27ZM6.142,8.582a6.134,6.134,0,1,0,6.134-6.134A6.143,6.143,0,0,0,6.142,8.582Z"/>
                    </svg>&nbsp;<span>Login</span></a> </li>
                    <?php } else { ?>
                      <li class="nav-item common-fill-hover color-fill-phone" style="margin-left:20px;"> <a class="color-16-top" href="{{ URL::to('/login')}}">  <svg xmlns="http://www.w3.org/2000/svg" width="12" height="11" viewBox="0 0 24.552 26.999" style="margin-right:5px;">
                      <path id="profile" d="M22.1,27a9.828,9.828,0,0,0-9.732-9.819h-.174A9.828,9.828,0,0,0,2.457,27H0A12.294,12.294,0,0,1,7.467,15.7a8.591,8.591,0,1,1,9.618,0A12.294,12.294,0,0,1,24.552,27ZM6.142,8.582a6.134,6.134,0,1,0,6.134-6.134A6.143,6.143,0,0,0,6.142,8.582Z"/>
                    </svg>&nbsp;<span>Login</span></a> </li>      
                    <?php } } }?>
              ...
              <div class="navbar-lang">
                ...
                @if(count($currencies) > 1)
                  <div class="dropdown" style="margin-right:0px;margin-left:20px;">
                    <button class="btn dropdown-toggle color-16-top" type="button" style="padding: 7px 0px 7px 8px!important;">
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
                ...
                @if(count($languages) > 1)
                  <div class="dropdown" style="margin-right:0px;margin-left:20px;">
                      <button class="btn dropdown-toggle color-16-top" type="button" style="padding: 7px 0px 7px 8px!important;text-transform:initial !important">
                        {{	session('language_name')}} &nbsp; <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
</svg> 
                      </button>
                      <div class="dropdown-menu" style="left:-15px !important;min-width:90px !important">
  ...
  <div class="header-maxi  bg-header-bar header-maxi-twele" style="height:80px !important;">
    <div class="container demo-6-col">
      <div class="row align-items-center demo-6-row">
  
        <div class="col-12 col-sm-5 demo-6-col">
  ...
  <g id="Layer_1" data-name="Layer 1" transform="translate(0 0)">
    <path id="Path_55427" data-name="Path 55427" d="M.216,25.052l6.72-6.72a11.27,11.27,0,1,1,1.591,1.591l-6.72,6.72A1.127,1.127,0,0,1,.216,25.052Zm15.427-4.833a9.007,9.007,0,1,0-9-9,9.007,9.007,0,0,0,9,9Z" transform="translate(0.07 0.07)" />
                ...
                <div class="serach-16-main-right">
                    <input autocomplete="off" required name="search" type="text" class="cus-input-style-16 typeheads" value="{{ app('request')->input('search') }}" placeholder="Search Product ...."/>
        ...
        <div class="col-12 col-md-2 col-lg-2 demo-6-col">
        ...
        <div class="col-12 col-sm-5 demo-6-col">
              <div class="row demo-6-row">
                <div class="col-md-12 demo-6-col" style="text-align:right">
...
<a href="{{ URL::to('/wishlist')}}">
  ...
  <?php } ?>
    <?php }?>
                    ...
                    <div class="pro-header-right-options display-inline cart-left-wishlist common-fill-hover fill-search" style="margin-right:15px !important">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 48.232 41.342">
                      ...
                      <span class="total_wishlist badge badge-secondary badge-wishlist-33" style="left:14px !important;top-3;">{{ $result['commonContent']['total_wishlist'] }}</span>
                      <span class="header-16-wishlist-text" style="margin-left:10px;">My Wishlist</span>
                    </div>
                  </a>
                
                  @if($result['commonContent']['settings']['view_cart_button'] == 1)

                  <ul class="pro-header-right-options display-inline header-16-cart-drop common-hover common-fill-hover fill-search">
                    <li class="dropdown head-cart-content" style="float:none;">
                      @include('web.headers.cartButtons.cartButton16')
                    </li>
                  </ul>
...
<div class="bg-header-16">
  <div class="container demo-6-col">
      <div class="row align-items-center demo-6-row">
        <div class="col-12 col-sm-8 demo-6-col" style="padding-left:10px">
                ...
                <div class="navbar-collapse" >
                  ...
                  <?php 
                    ...
                    ->get();
                      ...
                      ?> 
                        <li class="nav-item dropdown menu-active-13-{{ $menuactive }} hover-menu-16 hover-menu-16-white" style="padding: 0.5rem 0px 0.5rem 0px;">
                          <a style="padding: 0.5rem 1rem !important;text-transform:uppercase !important" class="nav-link menu-16-color menu-16-color-white" <?php echo $link; ?>>{{ $item->name }} <?php  if ($childs->isNotEmpty()){?> <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
</svg> <?php } ?></a>
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/></svg><?php } ?></a>
                      ...
                      <?php }} if(count($items) > 4){?>
                        ...
                        <li class="nav-item dropdown  hover-menu-16 hover-menu-16-white" style="padding: 0.5rem 0px 0.5rem 0px;">
                          <a style="padding: 0.5rem 1rem !important;white-space:nowrap;text-transform:uppercase !important" class="nav-link  menu-16-color menu-16-color-white" href="#">More <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
</svg> </a>
                            <div class="dropdown-menu">
                            <?php
