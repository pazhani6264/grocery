...
.product-molla-22 article .thumb {
    height: 260px;
    overflow: hidden;
    text-align: center;
    display: flex;
...
.header-twele .container-24{
  padding-left: 58px;
    padding-right: 58px;
    max-width:100%;
}
.header-fixed .container-24{
  padding-left: 58px;
    padding-right: 58px;
    max-width:100%;
}
...
<!-- //header style Twele -->
@include('web.headers.fixedHeader24') 
...
<!-- <div  class="header-mini bg-header-bar-35">
   ...
   -->
  <div id="add24-hover" class="img-header35 header-maxi bg-header-bar-35 header-maxi-twele" style="padding:0px !important;height:65px">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-12 col-sm-7">
          <div class="header-navbar no-padding">
            <div class="container">
            <nav id="navbar_header_9" class="navbar navbar-expand-lg" style="margin-left:20px;">
              ...
              ->get();
                ...
                ?> 
                  <li class="nav-item dropdown menu-active-15-{{ $menuactive }} hover-menu-15 hover-menu-15-white" style="padding:0px !important">
                    <a style="white-space:nowrap" class="nav-link font-500 menu-color-15" <?php echo  $link; ?>>{{ $item->name }} <?php  if ($childs->isNotEmpty()){?> <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#fff"/></svg><?php } ?></a>
                              <?php 
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#fff"/></svg><?php } ?></a>
            ...
            <div class="col-12 col-sm-4">
              <div class="row">
                  <form class="form-inline-search header-24-form" action="{{ URL::to('/shop')}}" method="get">
                      <input type="hidden" class="category-value" name="categories_id" value="" /> 
                      <div class="input-main">
                          <input autocomplete="off" required name="search" type="text" value="{{ app('request')->input('search') }}" class="search-input-15 typeheads" placeholder="Search Product ..... ">
                      ...
                      <svg id="search" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 27 27" onclick="myFunction()">>
...
<a href="{{ URL::to('/wishlist')}}">
  ...
  <?php } ?>
    <?php }?>
                      <div class="pro-header-right-options display-inline cart-left-wishlist cart-left-wishlist-11 text-center common-fill-hover color-fill" style="margin-right:20px !important">
                      ...
                      <g id="wishlist" transform="translate(0 -36.545)">
                        ...
                        <span class="total_wishlist badge badge-secondary badge-wishlist-29 badge-wishlist-29-black">{{ $result['commonContent']['total_wishlist'] }}</span>
                      </div>
                    </a>
                  
                    @if($result['commonContent']['settings']['view_cart_button'] == 1)

                    <ul class="pro-header-right-options display-inline header-29-cart-drop common-fill-hover color-fill" style="float:right;margin-top:5px">
                    <li class="dropdown head-cart-content margin-left-24">
                      @include('web.headers.cartButtons.cartButton24')
                    </li>
                  </ul>
                  @endif
                </div>
