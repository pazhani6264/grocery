<style>
.demo-32-header-37-section .header-sticky-inner nav .navbar-collapse ul .nav-item .nav-link {
    font-size: 14px !important;
}
.demo-32-header-37-section .search-button-main-37-fixed {
    transform: rotate(90deg);
}
.demo-32-header-37-section .cus-style-search{
  font-size: 17px;
}
  </style>

<input type="hidden" id="fixheadergetvalue" value="37"/>

        <header id="stickyHeader" class="demo-32-header-37-section header-12-search-fixed header-fixed header-area header-sticky d-none">
          <div class="header-sticky-inner  bg-sticky-bar">
            <div class="demo-32-header-container container-fluid">
                ...
                <div class="demo-32-header-row row align-items-center">
                    <div class="col-12 col-lg-1 demo-32-header-container">
                        <div class="logo">
                    ...
                    <div class="col-12 col-lg-7 demo-32-header-container" style="position: static;">
              ...
              ->get();
                ...
                ?> 
                  <li class="nav-item dropdown menu-active-13-{{ $menuactive }} hover-menu-13">
                    <a style="white-space:nowrap;padding-top:1.3rem !important;padding-bottom:1.3rem !important" class="nav-link font-500 fill-color common-fill-hover" <?php echo $link; ?>>{{ $item->name }} <?php  if ($childs->isNotEmpty()){?> <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/></svg><?php } ?></a>
                ...
                <?php }} if(count($items) > 4){?>
                  ...
                  <li class="nav-item dropdown  hover-menu-13">
                    <a style="white-space:nowrap;padding-top:1.3rem !important;padding-bottom:1.3rem !important" class="nav-link font-500 fill-color common-fill-hover" href="#">More <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/>
</svg></a>
                      <div class="dropdown-menu">
                      <?php
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/></svg><?php } ?></a>
              ...
              <?php  }?> 
                    ...
                    <div class="col-12 col-lg-4 demo-32-header-container">
                      <div class="row demo-32-header-row">
                        <div class="col-12 col-lg-10 demo-32-header-container">
  ...
  <g id="Layer_1" data-name="Layer 1" transform="translate(0 0)">
    <path id="Path_55427" data-name="Path 55427" d="M.216,25.052l6.72-6.72a11.27,11.27,0,1,1,1.591,1.591l-6.72,6.72A1.127,1.127,0,0,1,.216,25.052Zm15.427-4.833a9.007,9.007,0,1,0-9-9,9.007,9.007,0,0,0,9,9Z" transform="translate(0.07 0.07)" />
                        ...
                        <div class="col-12 col-lg-2">
                          <ul class="pro-header-right-options header-37-fixed-cart-drop color-fill-phone common-fill-hover" style="position: relative;left: -20px;">
                            <li class="dropdown head-cart-content-fixed common-yellow-fill">
                              @include('web.headers.cartButtons.cartButtonFixed37')    
                            </li>
                          </ul>
                        </div>
                        @endif
