...
footer.footer.footer-molla.footer-black.padding-top-32.footer-2.footer15.d-none.d-lg-block.d-xl-block {
    margin-top: 40px;
}
...
.header-twele .header-navbar nav .navbar-collapse ul li {
    margin-right: 0px;
}
...
<!-- //header style Twele -->
@include('web.headers.fixedHeader18') 
<header id="headerTwele" class="header-area header-twele  header-desktop d-none d-lg-block d-xl-block">
        ...
        <div class="col-12">
          ...
          <nav id="navbar_0_6" class="navbar navbar-expand-md navbar-dark navbar-0 nav-twele">
            <div class="navbar-lang">
              ...
              <div class="dropdown">
                  <button class="btn dropdown-toggle color-16-top" type="button" style="padding: 8px 10px 8px 0px!important;">
                ...
                <li class="nav-item mr-20">
                  ...
                  <?php }else{ ?>
                    ...
                    if($result['commonContent']['settings']['view_login_button'] == 1){
                      ...
                      if($loginID->login == 4) {
                    ?>
                       <li class="nav-item"> <a class="color-16-top login_modal"><i class="fa fa-user-o"></i>&nbsp;@lang('website.Login')</a> </li>   
                    <?php } else if($loginID->login == 5){ ?>
                      <li class="nav-item"> <a class="color-16-top login_modal1"><i class="fa fa-user-o"></i>&nbsp;@lang('website.Login')</a> </li>     
                    <?php } else if($loginID->login == 6){ ?>
                      <li class="nav-item"> <a class="color-16-top login_modal2"><i class="fa fa-user-o"></i>&nbsp;@lang('website.Login')</a> </li>     
                    <?php } else if($loginID->login == 7){ ?>
                      <li class="nav-item"> <a class="color-16-top login_modal3"><i class="fa fa-user-o"></i>&nbsp;@lang('website.Login')</a> </li> 
                    <?php } else if($loginID->login == 8){ ?>
                      <li class="nav-item"> <a class="color-16-top login_modal4"><i class="fa fa-user-o"></i>&nbsp;@lang('website.Login')</a> </li>    
                    <?php } else { ?>
                       <li class="nav-item"> <a class="color-16-top" href="{{ URL::to('/login')}}"><i class="fa fa-user-o"></i>&nbsp;@lang('website.Login')</a> </li>    
                    <?php } ?>
  ...
  <div class="header-maxi  bg-header-bar header-maxi-twele" style="height:60px">
    <div class="container">
      <div class="row align-items-center">
                    ...
                    ->get();
                      ...
                      ?> 
                        ...
                        <li class="nav-item dropdown menu-active-13-{{ $menuactive }} hover-menu-16" style="padding: 14px 0px 11px 5px;">
                          <a style="white-space:nowrap;padding: 0.5rem 1rem !important" class="nav-link fill-color common-fill-hover1" <?php echo $link; ?>>{{ $item->name }} <?php  if ($childs->isNotEmpty()){?> <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/></svg><?php } ?></a>
                      ...
                      <?php }} if(count($items) > 3){?>
                        ...
                        <li class="nav-item dropdown hover-menu-16" style="padding: 14px 0px 11px 5px;">
                          <a style="white-space:nowrap;padding: 0.5rem 1rem !important" class="nav-link fill-color common-fill-hover1" href="#">More <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/>
</svg></a>
                            <div class="dropdown-menu" style="top:99% !important">
                            <?php
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/></svg><?php } ?></a>
        ...
        <div class="col-12 col-sm-4" style="text-align:right">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="cus-style-search fa-search" onclick="myFunction()" width="20" height="20" viewBox="0 0 29.794 30.696">
    ...
    <path id="Path_55427" data-name="Path 55427" d="M-2.579,28.749,6.936,18.332a11.27,11.27,0,1,1,1.591,1.591L-.988,30.34a1.127,1.127,0,0,1-1.545-.046,1.127,1.127,0,0,1-.046-1.545Zm18.222-8.53a9.007,9.007,0,1,0-9-9,9.007,9.007,0,0,0,9,9Z" transform="translate(0.07 0.07)"/>
                    ...
                    <form class="form-inline-search" action="{{ URL::to('/shop')}}" method="get" style="display:inline-block;position:relative">
                        ...
                        <div class="input-main srach-18-main-input" id="searchbutton" style="display:none;">
                            <input autocomplete="off" required  name="search" value="{{ app('request')->input('search') }}"  type="text" class="search-input-18 typeheads" placeholder="Search Product ..... ">
...
<a href="{{ URL::to('/profile')}}" data-toggle="" data-placement="bottom" title="Profile">
  <?php } else {?>
    <?php 
    $loginID = DB::table('current_theme')->first();
    if($loginID->login == 4) {
  ?>
    <a class="login_modal" style="cursor:pointer" data-toggle="" data-placement="bottom" title="Login"> 
  <?php } else if($loginID->login == 5){ ?>
    <a class="login_modal1" style="cursor:pointer" data-toggle="" data-placement="bottom" title="Login">     
  <?php } else if($loginID->login == 6){ ?>
    <a class="login_modal2" style="cursor:pointer" data-toggle="" data-placement="bottom" title="Login">   
  <?php } else if($loginID->login == 7){ ?>
    <a class="login_modal3" style="cursor:pointer" data-toggle="" data-placement="bottom" title="Login"> 
  <?php } else if($loginID->login == 8){ ?>
    <a class="login_modal4" style="cursor:pointer" data-toggle="" data-placement="bottom" title="Login"> 
  <?php } else { ?>
    <a href="{{ URL::to('/profile')}}" data-toggle="" data-placement="bottom" title="Profile"> 
  <?php } ?>
    <?php }?>

  <div class="pro-header-right-options display-inline cart-left-wishlist cart-left-wishlist-11 text-center common-fill-hover fill-search" style="margin-right:5px !important">
...
<a href="{{ URL::to('/wishlist')}}">
  ...
  <?php } ?>
    <?php }?>
                        <div class="pro-header-right-options display-inline cart-left-wishlist common-fill-hover fill-search" style="padding-left:10px;margin-right:35px">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="20" viewBox="0 0 48.232 41.342">
                      <g id="wishlist" transform="translate(0 -36.545)">
                        ...
                        <span class="total_wishlist badge badge-secondary badge-wishlist-33" style="right: -8px;">{{ $result['commonContent']['total_wishlist'] }}</span>
                        </div>
                    </a>
                    ...
                    <ul class="pro-header-right-options display-inline header-18-cart-drop common-hover common-fill-hover fill-search" style="float:right;margin-top:3px;">
                        <li class="dropdown head-cart-content">
                        @include('web.headers.cartButtons.cartButton18')
                        </li>
                    </ul>
                    @endif
        </div>
