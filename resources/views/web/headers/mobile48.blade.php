<style>
  ...
  @media only screen and (min-width: 700px) and (max-width: 800px){
      ...
      .header-mini .topcontainer:after {
        content: "";
        display: block;
        height: 1px;
        position: absolute;
...
@media only screen and (max-width: 991px){
  .header-mobile-12 .header-mini .navbar {
...
<input type="hidden" id="mobheadergetvalue" value="16"/>
...
<header id="headerMobileTwele" class="header-area header-mobile header-mobile-12 d-lg-none d-xl-none">
        ...
        <div class="row">
            ...
            <nav id="navbar_0" class="navbar navbar-expand-md navbar-dark navbar-0">
              <div class="navbar-lang">
                  ...
                  <div class="dropdown-mobile-12 drop-left" style="margin-left:10px">
                    <ul class="navbar-nav">
  ...
  <path id="call" d="M18.267,26.863c-.153,0-.306-.006-.471-.019a12.88,12.88,0,0,1-7.018-2.818A42.043,42.043,0,0,1,2.658,15.36,14.847,14.847,0,0,1,.018,7.872,7,7,0,0,1,.38,5.1,6.652,6.652,0,0,1,1.8,2.744L3.343,1.091a3.342,3.342,0,0,1,4.939,0l1.4,1.495a3.719,3.719,0,0,1,.757,1.209,3.96,3.96,0,0,1,0,2.852,3.719,3.719,0,0,1-.757,1.209l-.8.857a1.976,1.976,0,0,0-.514,1.162,2.015,2.015,0,0,0,.291,1.247,22.553,22.553,0,0,0,6.1,6.505,1.714,1.714,0,0,0,.992.318,1.679,1.679,0,0,0,.177-.009,1.754,1.754,0,0,0,1.089-.548l.8-.856a3.494,3.494,0,0,1,1.134-.808,3.289,3.289,0,0,1,2.672,0,3.494,3.494,0,0,1,1.134.808l1.4,1.493a3.744,3.744,0,0,1,.757,1.21,3.948,3.948,0,0,1,0,2.852,3.731,3.731,0,0,1-.757,1.209L22.6,24.944a6.068,6.068,0,0,1-1.987,1.419,5.752,5.752,0,0,1-2.345.5ZM5.128,1.962a1.766,1.766,0,0,0-.579.413L3,4.029a4.81,4.81,0,0,0-1.022,1.7,5.051,5.051,0,0,0-.261,2A12.967,12.967,0,0,0,4.02,14.27a40.3,40.3,0,0,0,7.779,8.3,11.246,11.246,0,0,0,6.125,2.462c.111.009.225.014.337.014a4.171,4.171,0,0,0,1.539-.294,4.385,4.385,0,0,0,1.6-1.09l1.549-1.653a2,2,0,0,0,0-2.7l-1.4-1.492a1.754,1.754,0,0,0-2.532,0l-.8.855a3.351,3.351,0,0,1-2.47,1.089,3.335,3.335,0,0,1-1.936-.623,24.3,24.3,0,0,1-6.569-7.01,3.945,3.945,0,0,1-.567-2.434,3.857,3.857,0,0,1,1-2.268l.8-.857a2,2,0,0,0,0-2.7l-1.4-1.495a1.763,1.763,0,0,0-.58-.414,1.672,1.672,0,0,0-.682-.145h0A1.675,1.675,0,0,0,5.128,1.962Z" transform="translate(0)"/>
                  ...
                  <a class="dropbtn-mobile-11 color-14-top">LINKS &nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
                    ...
                    <div class="dropdown-content-mobile-11 dropdown-right">
                      ...
                      @if(count($currencies) > 1)
                        <div class="dropdown-mobile-11-cur drop-left1 color-14-top">
                          <a class="dropbtn-mobile-11-cur common-fill-hover"> {{	session('currency_code')}} &nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/>
</svg> </a>
                      ...
                      @if(count($languages) > 1)
                        <div class="dropdown-mobile-11-con drop-left color-14-top">
                          <a class="dropbtn-mobile-11-con common-fill-hover"> {{	session('language_name')}} &nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/>
</svg> </a>
 ...
 -->
                      ...
                      <?php } else { ?>
                        ...
                        if($result['commonContent']['settings']['view_login_button'] == 1){
                            ...
                            if($loginID->login == 4) { 
                            ?>
                               <a class="color-16-top common-fill-hover login_modal" style="fill: #777;">Sign In / Sign Up</a>              
                            <?php } else if($loginID->login == 5){ ?>
                              <a class="color-16-top common-fill-hover login_modal1" style="fill: #777;">Sign In / Sign Up</a>                   
                            <?php } else if($loginID->login == 6){ ?>
                              <a class="color-16-top common-fill-hover login_modal2" style="fill: #777;">Sign In / Sign Up</a>                    
                            <?php } else if($loginID->login == 7){ ?>
                              <a class="color-16-top common-fill-hover login_modal3" style="fill: #777;">Sign In / Sign Up</a>    
                            <?php } else if($loginID->login == 8){ ?>
                              <a class="color-16-top common-fill-hover login_modal4" style="fill: #777;">Sign In / Sign Up</a>                     
                          <?php } else { ?>
                            <a class="color-16-top common-fill-hover" style="fill: #777;" href="{{ URL::to('/login')}}" >Sign In / Sign Up</a>                 
                        <?php } } }?>
                  </div>
                </div>
               

                <div class="drop-right mobile-none" style="margin-right:10px;display:none;">

                  @if($result['commonContent']['setting'][50]->value!='')
                <a class="color-16-top" target="_blank" href="{{$result['commonContent']['setting'][50]->value}}"><i class="fa fa-facebook mr-20 demo-25-icon-font common-hover"></i></a>
                @endif
                @if($result['commonContent']['setting'][52]->value!='')
                <a class="color-16-top" target="_blank" href="{{$result['commonContent']['setting'][52]->value}}"><i class="fa fa-twitter mr-20 demo-25-icon-font common-hover"></i></a>
                @endif
                @if($result['commonContent']['setting'][51]->value!='')
                <a class="color-16-top" target="_blank" href="{{$result['commonContent']['setting'][51]->value}}"><i class="fa fa-google mr-20 demo-25-icon-font common-hover"></i></a>
                @endif
                @if($result['commonContent']['setting'][53]->value!='')
                <a class="color-16-top" target="_blank" href="{{$result['commonContent']['setting'][53]->value}}"><i class="fa fa-linkedin mr-20 demo-25-icon-font common-hover"></i></a>
                @endif
                @if($result['commonContent']['setting'][216]->value!='')
                  <a class="color-16-top" target="_blank" class="c777 common-fill-hover mr-20 " href="{{$result['commonContent']['setting'][216]->value}}">
                ...
                @endif
                    ...
                    if($result['commonContent']['settings']['view_login_button'] == 1){
                            ...
                            if($loginID->login == 4) { 
                            ?>
                               <a class="color-16-top common-fill-hover color-fill-phone login_modal"> <svg xmlns="http://www.w3.org/2000/svg" width="12" height="11" viewBox="0 0 24.552 26.999" style="margin-right:5px;">
                              ...
                              </svg>&nbsp;@lang('website.Login')</a>              
                            <?php } else if($loginID->login == 5){ ?>
                              <a class="color-16-top common-fill-hover color-fill-phone login_modal1"> <svg xmlns="http://www.w3.org/2000/svg" width="12" height="11" viewBox="0 0 24.552 26.999" style="margin-right:5px;">
                              <path id="profile" d="M22.1,27a9.828,9.828,0,0,0-9.732-9.819h-.174A9.828,9.828,0,0,0,2.457,27H0A12.294,12.294,0,0,1,7.467,15.7a8.591,8.591,0,1,1,9.618,0A12.294,12.294,0,0,1,24.552,27ZM6.142,8.582a6.134,6.134,0,1,0,6.134-6.134A6.143,6.143,0,0,0,6.142,8.582Z"/>
                              </svg>&nbsp;@lang('website.Login')</a>                 
                            <?php } else if($loginID->login == 6){ ?>
                              <a class="color-16-top common-fill-hover color-fill-phone login_modal2"> <svg xmlns="http://www.w3.org/2000/svg" width="12" height="11" viewBox="0 0 24.552 26.999" style="margin-right:5px;">
                              <path id="profile" d="M22.1,27a9.828,9.828,0,0,0-9.732-9.819h-.174A9.828,9.828,0,0,0,2.457,27H0A12.294,12.294,0,0,1,7.467,15.7a8.591,8.591,0,1,1,9.618,0A12.294,12.294,0,0,1,24.552,27ZM6.142,8.582a6.134,6.134,0,1,0,6.134-6.134A6.143,6.143,0,0,0,6.142,8.582Z"/>
                              </svg>&nbsp;@lang('website.Login')</a>                   
                            <?php } else if($loginID->login == 7){ ?>
                              <a class="color-16-top common-fill-hover color-fill-phone login_modal3"> <svg xmlns="http://www.w3.org/2000/svg" width="12" height="11" viewBox="0 0 24.552 26.999" style="margin-right:5px;">
                              <path id="profile" d="M22.1,27a9.828,9.828,0,0,0-9.732-9.819h-.174A9.828,9.828,0,0,0,2.457,27H0A12.294,12.294,0,0,1,7.467,15.7a8.591,8.591,0,1,1,9.618,0A12.294,12.294,0,0,1,24.552,27ZM6.142,8.582a6.134,6.134,0,1,0,6.134-6.134A6.143,6.143,0,0,0,6.142,8.582Z"/>
                              </svg>&nbsp;@lang('website.Login')</a> 
                            <?php } else if($loginID->login == 8){ ?>
                              <a class="color-16-top common-fill-hover color-fill-phone login_modal4"> <svg xmlns="http://www.w3.org/2000/svg" width="12" height="11" viewBox="0 0 24.552 26.999" style="margin-right:5px;">
                              <path id="profile" d="M22.1,27a9.828,9.828,0,0,0-9.732-9.819h-.174A9.828,9.828,0,0,0,2.457,27H0A12.294,12.294,0,0,1,7.467,15.7a8.591,8.591,0,1,1,9.618,0A12.294,12.294,0,0,1,24.552,27ZM6.142,8.582a6.134,6.134,0,1,0,6.134-6.134A6.143,6.143,0,0,0,6.142,8.582Z"/>
                              </svg>&nbsp;@lang('website.Login')</a>                 
                          <?php } else { ?>
                            <a class="color-16-top common-fill-hover color-fill-phone" href="{{ URL::to('/login')}}"> <svg xmlns="http://www.w3.org/2000/svg" width="12" height="11" viewBox="0 0 24.552 26.999" style="margin-right:5px;">
                            <path id="profile" d="M22.1,27a9.828,9.828,0,0,0-9.732-9.819h-.174A9.828,9.828,0,0,0,2.457,27H0A12.294,12.294,0,0,1,7.467,15.7a8.591,8.591,0,1,1,9.618,0A12.294,12.294,0,0,1,24.552,27ZM6.142,8.582a6.134,6.134,0,1,0,6.134-6.134A6.143,6.143,0,0,0,6.142,8.582Z"/>
                            </svg>&nbsp;@lang('website.Login')</a>            
                        <?php } } }?>
                    ...
                    <!-- @if(count($languages) > 1)
                      <div class="dropdown-mobile-12 drop-left color-16-top mobile-none">
                        <a class="dropbtn-mobile-12"> {{	session('language_name')}} &nbsp; <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
                    ...
                    <!-- @if(count($currencies) > 1)
                      <div class="dropdown-mobile-12 drop-left1 color-16-top mobile-none">
                        <a style="padding: 8px 0px 10px 8px!important;" class="dropbtn-mobile-12"> {{	session('currency_code')}} &nbsp; <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
</svg> </a>
  ...
  <g id="Layer_1" data-name="Layer 1" transform="translate(0 0)">
    <path id="Path_55427" data-name="Path 55427" d="M.216,25.052l6.72-6.72a11.27,11.27,0,1,1,1.591,1.591l-6.72,6.72A1.127,1.127,0,0,1,.216,25.052Zm15.427-4.833a9.007,9.007,0,1,0-9-9,9.007,9.007,0,0,0,9,9Z" transform="translate(0.07 0.07)" fill="#fff"/>
          ...
          <div class="mobile-header-right-16" style="padding: 4px 10px 0px 0px !important;width:70% !important"> 
          <?php if(auth()->guard('customer')->check() &&  auth()->guard('customer')->user()->phone_verified== '1'){ ?>
...
<a href="{{ URL::to('/wishlist')}}">
  ...
  <?php } ?>
    <?php }?>
              ...
              </div><span class="header-16-wishlist-text mobile-none">My Wishlist</span>
            </a>
                         
            @if($result['commonContent']['settings']['view_cart_button'] == 1)

            <ul class="pro-header-right-options header-16-mobile-cart-drop  common-hover common-fill-hover fill-search" id="resposive-header-cart" style="display:inline-block;vertical-align:bottom">
                @include('web.headers.cartButtons.cartButtonMobile16')
            </ul> 
            @endif
          </div>
          </div>
      ...
      <div class="bg-header-mobile-16 ">
        <div class="container" style="padding-left:10px !important;padding-right:10px !important;">
          <div class="row align-items-center">
            <div class="col-1 pr-0" style="padding-left:15px !important">
                <div class="navigation-mobile-container">
  ...
  <g id="hamburger_menu" transform="translate(0.307 0.307)">
    ...
    <rect id="Rectangle_5802" class="common-color" data-name="Rectangle 5802" width="36" height="3" transform="translate(-0.307 23.693)" fill="#fff"/>
            ...
            <div class="col-11" style="padding-right:15px !important">
                <?php if(strlen($result['commonContent']['settings']['head_offer_title']) <= 17) { ?>
                  
                  <div class="head-16 common-fill"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 49.479 49.99">
