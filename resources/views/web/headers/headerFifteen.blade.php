...
.product9.product .thumb .product-action-vertical .wishlist-22:hover {
    position: relative;
    border: 0px solid;
...
.header-twele .header-maxi .pro-header-right-options {
...
.header-twele .header-navbar nav .navbar-collapse ul .nav-item .nav-link {
    ...
    line-height: normal;
    padding: 1.2rem 5px 1.2rem 10px;
}
...
<!-- //header style Twele -->
@include('web.headers.fixedHeader15') 
<!-- <header id="headerTwele" class="img-header header-area header-twele  header-desktop d-none d-lg-block d-xl-block"> -->
...
<header id="headerTwele" class="header-12-search header-area header-twele  header-desktop d-none d-lg-block d-xl-block">
          ...
          <nav id="navbar_0_6" class="navbar navbar-expand-md navbar-dark navbar-0">
            <div class="navbar-lang">
              ...
              @if(count($currencies) > 1)
                <div class="dropdown">
                  <button class="btn dropdown-toggle color-34-top menu-16-color-black" type="button" style="padding: 10px 20px 10px 0px !important;">
  ...
  <div id="add35-hover" class="img-header35 demo-5-header-sec header-maxi bg-header-bar-35 header-maxi-twele" style="padding:0px !important;height:65px;top:14px !important">
    <div class="container-15">
      <div class="row">
          ...
          <a class="img-fluid-molla-main" href="{{ URL::to('/')}}" class="logo" data-toggle="" data-placement="bottom" title="@lang('website.logo')">
            ...
            @if($result['commonContent']['settings']['sitename_logo']=='logo')
              ...
              @if($imagepath->path_type == 'aws')
                <img style="vertical-align:super" class="img-fluid-molla" src="{{$result['commonContent']['settings']['website_logo']}}" alt="<?=stripslashes($result['commonContent']['settings']['website_name'])?>">
              @else
                <img style="vertical-align:super" class="img-fluid-molla" src="{{asset('').$result['commonContent']['settings']['website_logo']}}" alt="<?=stripslashes($result['commonContent']['settings']['website_name'])?>">
              @endif
            @endif
            </a>
        </div>
          ...
          <div class="navbar-collapse" >
            ...
            <?php 
              ...
              ->get();
                ...
                ?> 
                  <li class="nav-item dropdown menu-active-15-{{ $menuactive }} hover-menu-15 hover-menu-15-white" style="padding:0px !important;margin-right:20px !important">
                    <a class="nav-link font-500 menu-color-15" <?php echo $link; ?>>{{ $item->name }} <?php  if ($childs->isNotEmpty()){?> <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/></svg><?php } ?></i></a>
                ...
                <?php }} if(count($items) > 3){?>
                  ...
                  <li class="nav-item dropdown  hover-menu-15 hover-menu-15-white" style="padding:0px !important;margin-right:20px !important">
                    <a style="white-space:nowrap" class="nav-link font-500 menu-color-15" href="#">More <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
</svg></a>
                      <div class="dropdown-menu">
                      <?php
              ...
              <div class="row demo-5-row">
                  <form class="form-inline-search header15-form" action="{{ URL::to('/shop')}}" method="get">
                      ...
                      <div class="input-main">
                          <input autocomplete="off" required name="search" type="text" value="{{ app('request')->input('search') }}" class="search-input-15 typeheads" placeholder="Search Product ..... " style="color:#fff !important" required>
                          <div class="search_outer_con">
                            <div id="viewsearchproduct"></div>
                          </div>
                      </div>
                      <button type="submit" id="dropdownCartButton" class="btn search-button-main-17 common-fill-hover color-fill" > 
...
<a href="{{ URL::to('/wishlist')}}">
  ...
  <?php } ?>
    <?php }?>
                      ...
                      <div class="pro-header-right-options display-inline cart-left-wishlist cart-left-wishlist-11 text-center icon-39-color header-15-wishlists common-fill-hover color-fill">
                    ...
                    <ul class="pro-header-right-options display-inline header-15-cart-drop common-fill-hover color-fill">
                    <li class="dropdown head-cart-content" style="float:none;margin-left:0px">
                      @include('web.headers.cartButtons.cartButton15')
                    </li>
                  </ul>
                  @endif
                </div>
