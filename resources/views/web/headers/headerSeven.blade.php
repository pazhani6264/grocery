              ...
              <ul class="top-right-list">
                <li class="panel">
                  ...
                  <div class="block">
                      ...
                      <p>@lang('website.bannerLabel1Text')  {{Session::get('symbol_left')}}&nbsp;{{$result['commonContent']['setting'][82]->value}}&nbsp;{{Session::get('symbol_right')}}</p>
                  </div>
                </li>
                  ...
                  <form class="form-inline" action="{{ URL::to('/shop')}}" method="get">
                    <div class="search-field-module">      
                      ...
                      <input type="hidden" name="category" class="category-value" value="">
                            ...
                            <button class="btn btn-secondary swipe-to-top" type="submit" data-toggle="" 
