<style>
    .header-11-cart-drop .header-11-transform{
...
<div class="header-11-transform shopping-cart shopping-cart-empty dropdown-menu dropdown-menu-right cart-11" aria-labelledby="dropdownCartButton_1">
...
<div class="header-11-transform shopping-cart shopping-cart-empty dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
    <ul class="shopping-cart-items">
