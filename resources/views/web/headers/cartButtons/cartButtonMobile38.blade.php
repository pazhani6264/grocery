<style>
    .header-38-mobile-cart-drop .header-38-mobile-transform{
...
<button id="dropdownCartButton" class="btn dropdown-toggle text-center pr-0 tablet-cart" type="button" id="headerOneCartButton"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="text-transform:none"> 
    <div class="cart-left" style="position: relative;top: 5px !important;left:-15px">
  ...
  <path id="cart" d="M30.728,37.537a6.563,6.563,0,0,1,4.944-6.36H19.222a6.561,6.561,0,1,1-3.234,0H13.216l-.4-1.441L5.588,3.939H0V0H8.574l.4,1.439,7.224,25.8H39.281L46.6,9.932H15.8V5.994H52.544L41.889,31.177H38.906a6.561,6.561,0,1,1-8.178,6.36Zm3.281,0a3.28,3.28,0,1,0,3.279-3.281A3.284,3.284,0,0,0,34.01,37.537Zm-19.684,0a3.28,3.28,0,1,0,3.279-3.281A3.284,3.284,0,0,0,14.326,37.537Z"/>
      ...
      <span class="badge badge-secondary" style="top:5px !important">{{ $qunatity }}</span>
    </div>
    ...
    <div class="header-38-mobile-transform dropdown-menu dropdown-menu-right" aria-labelledby="headerOneCartButton">
