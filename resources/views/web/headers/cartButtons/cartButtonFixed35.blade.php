<style>
    .header-35-fixed-cart-drop .header-35-fixed-transform{
...
@endforeach
                              ...
                              <button class="btn  dropdown-toggle common-hover" type="button" id="dropdownCartButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="padding:0px;color:#fff;margin-top: 5px;
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 52.544 44.098">
  <path id="cart" d="M30.728,37.537a6.563,6.563,0,0,1,4.944-6.36H19.222a6.561,6.561,0,1,1-3.234,0H13.216l-.4-1.441L5.588,3.939H0V0H8.574l.4,1.439,7.224,25.8H39.281L46.6,9.932H15.8V5.994H52.544L41.889,31.177H38.906a6.561,6.561,0,1,1-8.178,6.36Zm3.281,0a3.28,3.28,0,1,0,3.279-3.281A3.284,3.284,0,0,0,34.01,37.537Zm-19.684,0a3.28,3.28,0,1,0,3.279-3.281A3.284,3.284,0,0,0,14.326,37.537Z"/>
                                ...
                                <span class="badge badge-secondary badge-cart-33 badge-wishlist-29-black" style="border-radius: 100%;width: 16px;height:16px;min-width:16px">{{ $qunatity }}</span>
        ...
        <span style="font-size:0.9rem;font-weight:400 !important;">{{Session::get('symbol_left')}}&nbsp;{{ number_format($total_amount*session('currency_value'),2) }}&nbsp;{{Session::get('symbol_right')}}</span>
                              ...
                              <div class="header-35-fixed-transform dropdown-menu dropdown-menu-right" aria-labelledby="dropdownCartButton">
...
<li>
        ...
        <li>
               ...
               <a class="btn btn-secondary btn-block swipe-to-top" href="{{ URL::to('/viewcart')}}">@lang('website.View Cart')</a>    
                              ...
                              <div class="header-35-fixed-transform dropdown-menu dropdown-menu-right" aria-labelledby="headerOneCartButton">
                                  <ul class="shopping-cart-items">
