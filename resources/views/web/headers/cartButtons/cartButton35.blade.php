<style>
    .header-35-cart-drop .header-35-transform{
    ...
    .header-twele .header-maxi .pro-header-right-options li > a, .header-twele .header-maxi .pro-header-right-options li button {
    position: relative;
    padding: 0;
    ...
    .header-twele .header-maxi .pro-header-right-options li > a .badge, .header-twele .header-maxi .pro-header-right-options li button .badge {
    position: absolute;
...
<button id="dropdownCartButton" class="btn dropdown-toggle common-hover" type="button" id="headerOneCartButton"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="display:inline-block"> 
    <div class="cart-left">
...
</svg> <span class="badge badge-secondary badge-cart-33 badge-wishlist-29-black">{{ $qunatity }}</span>
<div  style="margin-left:15px !important;display:inline-block;text-align:right">
        <span style="font-size:0.9rem;font-weight:400 !important;">{{Session::get('symbol_left')}}&nbsp;{{ number_format($total_amount*session('currency_value'),2) }}&nbsp;{{Session::get('symbol_right')}}</span>
    </div>
    </div>
...
<div class="header-35-transform shopping-cart shopping-cart-empty dropdown-menu dropdown-menu-right" aria-labelledby="dropdownCartButton_1">
...
<div class="header-35-transform shopping-cart shopping-cart-empty dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
    <ul class="shopping-cart-items">
