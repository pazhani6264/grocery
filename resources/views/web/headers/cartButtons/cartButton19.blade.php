<style>
    .header-19-cart-drop .header-19-transform{
...
<button id="dropdownCartButton" class="btn dropdown-toggle text-center common-hover" type="button" id="headerOneCartButton"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="text-transform:none;display:inline-block;margin-top:10px;"> 
    <div class="cart-left">
...
</svg><span class="badge badge-secondary badge-cart-33 ">{{ $qunatity }}</span>
...
<div class="header-19-transform shopping-cart shopping-cart-empty dropdown-menu dropdown-menu-right" aria-labelledby="dropdownCartButton_1">
...
<div class="header-19-transform shopping-cart shopping-cart-empty dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
    <ul class="shopping-cart-items">
