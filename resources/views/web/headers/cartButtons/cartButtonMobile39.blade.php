<style>
    .header-39-mobile-cart-drop .header-39-mobile-transform{
        transform: translate3d(-234px, 0px, 0px) !important;
    }
...
<button id="dropdownCartButton" class="btn dropdown-toggle text-center pr-0 tablet-cart common-hover common-fill-hover demo-34-s-label-color color-fill-white" type="button" id="headerOneCartButton"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="text-transform:none;padding:0px !important;"> 
...
<div class="header-39-mobile-transform shopping-cart shopping-cart-empty dropdown-menu dropdown-menu-right cart-11" aria-labelledby="dropdownCartButton_1">
    <ul class="shopping-cart-items">
        ...
        <li>
               ...
               <a style="right:0px !important" class="btn btn-secondary btn-block swipe-to-top" href="{{ URL::to('/viewcart')}}">@lang('website.View Cart')</a>    
       </li>
 </ul>
...
<div class="header-39-mobile-transform shopping-cart shopping-cart-empty dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
    <ul class="shopping-cart-items">
