<style>
    .header-34-cart-drop .header-34-transform{
...
<button id="dropdownCartButton" class="btn dropdown-toggle demo-29-margin text-center common-hover common-fill-hover fill-search" type="button" id="headerOneCartButton"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="text-transform:none;display:inline-block"> 
    <div class="cart-left">
...
<div class="header-34-transform shopping-cart shopping-cart-empty dropdown-menu dropdown-menu-right cart-11" aria-labelledby="dropdownCartButton_1">
...
<div class="header-34-transform shopping-cart shopping-cart-empty dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
    <ul class="shopping-cart-items">
