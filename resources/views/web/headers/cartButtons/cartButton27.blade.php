<style>
    .header-27-cart-drop .header-27-transform{
...
<button id="dropdownCartButton" class="btn dropdown-toggle text-center" type="button" id="headerOneCartButton"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="text-transform:none"> 
    <div class="cart-left">
     <span class="small-font-size color-13-top common-hover menu-16-color-black"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 52.544 44.098">
...
<div class="header-27-transform shopping-cart shopping-cart-empty dropdown-menu dropdown-menu-right cart-11" aria-labelledby="dropdownCartButton_1">
...
<div class="header-27-transform shopping-cart shopping-cart-empty dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
    <ul class="shopping-cart-items">
