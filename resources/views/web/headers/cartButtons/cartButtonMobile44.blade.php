...
<button id="dropdownCartButton" class="btn dropdown-toggle text-center pr-0 tablet-cart" type="button" id="headerOneCartButton"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="text-transform:none;padding:0px !important"> 
