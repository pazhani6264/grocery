<style>
    .header-19-mobile-cart-drop .header-19-mobile-transform{
...
<div class="header-19-mobile-transform shopping-cart shopping-cart-empty dropdown-menu dropdown-menu-right cart-11" aria-labelledby="dropdownCartButton_1">
    <ul class="shopping-cart-items">
        ...
        <li>
               ...
               <a class="btn btn-secondary btn-block swipe-to-top" style="right: 0;" href="{{ URL::to('/viewcart')}}">@lang('website.View Cart')</a>    
       </li>
 </ul>
...
<div class="header-19-mobile-transform shopping-cart shopping-cart-empty dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
    <ul class="shopping-cart-items">
