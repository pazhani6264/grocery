<style>
    .header-35-mobile-cart-drop .header-35-mobile-transform{
...
<div class="header-35-mobile-transform shopping-cart shopping-cart-empty dropdown-menu dropdown-menu-right cart-11" aria-labelledby="dropdownCartButton_1">
...
<div class="header-35-mobile-transform shopping-cart shopping-cart-empty dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
    <ul class="shopping-cart-items">
