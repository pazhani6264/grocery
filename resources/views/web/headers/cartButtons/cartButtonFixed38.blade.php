...
<?php $qunatity=0; ?>
                              ...
                              <button style="padding:0px !important" class="btn  dropdown-toggle" type="button" id="dropdownCartButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="padding:0px;color:#fff"> 
