...
<header id="headerMobileTwele" class="header-area header-mobile header-12 header-mobile-12 d-lg-none d-xl-none">
    <div class="header-mini bg-top-bar" style="width: 95%;margin: auto;border-bottom: 1px solid #ebebeb;">
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
                    ...
                    <div class="dropdown-content-mobile-12 dropdown-left" style="top:36px">
                ...
                @if(count($currencies) > 1)
                  <div class="dropdown-mobile-12 drop-left1 color-16-top">
                    <a class="dropbtn-mobile-12"> {{	session('currency_code')}} &nbsp; <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" fill="#bbb"/>
</svg> 
                    <div class="dropdown-content-mobile-12 dropdown-left" style="top:36px">
...
<a href="{{ URL::to('/wishlist')}}">
  ...
  <?php } ?>
                      ...
                      <?php if(auth()->guard('customer')->check() &&  auth()->guard('customer')->user()->phone_verified == '1'){ ?>
                        <?php } else { ?>
                          ...
                          if($result['commonContent']['settings']['view_login_button'] == 1){
                            ...
                            if($loginID->login == 4) { 
                            ?>
                               <a style="cursor:pointer" class="color-16-top login_modal" ><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24.552 26.999" style="margin-right:5px;">
                              <path id="profile" d="M22.1,27a9.828,9.828,0,0,0-9.732-9.819h-.174A9.828,9.828,0,0,0,2.457,27H0A12.294,12.294,0,0,1,7.467,15.7a8.591,8.591,0,1,1,9.618,0A12.294,12.294,0,0,1,24.552,27ZM6.142,8.582a6.134,6.134,0,1,0,6.134-6.134A6.143,6.143,0,0,0,6.142,8.582Z" fill="#777"/>
                              </svg>&nbsp;Login</a>
                            <?php } else if($loginID->login == 5){ ?>
                               <a style="cursor:pointer" class="color-16-top login_modal1" ><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24.552 26.999" style="margin-right:5px;">
                              <path id="profile" d="M22.1,27a9.828,9.828,0,0,0-9.732-9.819h-.174A9.828,9.828,0,0,0,2.457,27H0A12.294,12.294,0,0,1,7.467,15.7a8.591,8.591,0,1,1,9.618,0A12.294,12.294,0,0,1,24.552,27ZM6.142,8.582a6.134,6.134,0,1,0,6.134-6.134A6.143,6.143,0,0,0,6.142,8.582Z" fill="#777"/>
                              </svg>&nbsp;Login</a>
                            <?php } else if($loginID->login == 6){ ?>
                               <a style="cursor:pointer" class="color-16-top login_modal2" ><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24.552 26.999" style="margin-right:5px;">
                              <path id="profile" d="M22.1,27a9.828,9.828,0,0,0-9.732-9.819h-.174A9.828,9.828,0,0,0,2.457,27H0A12.294,12.294,0,0,1,7.467,15.7a8.591,8.591,0,1,1,9.618,0A12.294,12.294,0,0,1,24.552,27ZM6.142,8.582a6.134,6.134,0,1,0,6.134-6.134A6.143,6.143,0,0,0,6.142,8.582Z" fill="#777"/>
                              </svg>&nbsp;Login</a>
                            <?php } else if($loginID->login == 7){ ?>
                               <a style="cursor:pointer" class="color-16-top login_modal3" ><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24.552 26.999" style="margin-right:5px;">
                              <path id="profile" d="M22.1,27a9.828,9.828,0,0,0-9.732-9.819h-.174A9.828,9.828,0,0,0,2.457,27H0A12.294,12.294,0,0,1,7.467,15.7a8.591,8.591,0,1,1,9.618,0A12.294,12.294,0,0,1,24.552,27ZM6.142,8.582a6.134,6.134,0,1,0,6.134-6.134A6.143,6.143,0,0,0,6.142,8.582Z" fill="#777"/>
                              </svg>&nbsp;Login</a>
                            <?php } else if($loginID->login == 8){ ?>
                               <a style="cursor:pointer" class="color-16-top login_modal4" ><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24.552 26.999" style="margin-right:5px;">
                              <path id="profile" d="M22.1,27a9.828,9.828,0,0,0-9.732-9.819h-.174A9.828,9.828,0,0,0,2.457,27H0A12.294,12.294,0,0,1,7.467,15.7a8.591,8.591,0,1,1,9.618,0A12.294,12.294,0,0,1,24.552,27ZM6.142,8.582a6.134,6.134,0,1,0,6.134-6.134A6.143,6.143,0,0,0,6.142,8.582Z" fill="#777"/>
                              </svg>&nbsp;Login</a>
                          <?php } else { ?>
                          <a class="color-16-top" href="{{ URL::to('/login')}}" ><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24.552 26.999" style="margin-right:5px;">
                              <path id="profile" d="M22.1,27a9.828,9.828,0,0,0-9.732-9.819h-.174A9.828,9.828,0,0,0,2.457,27H0A12.294,12.294,0,0,1,7.467,15.7a8.591,8.591,0,1,1,9.618,0A12.294,12.294,0,0,1,24.552,27ZM6.142,8.582a6.134,6.134,0,1,0,6.134-6.134A6.143,6.143,0,0,0,6.142,8.582Z" fill="#777"/>
                              </svg>&nbsp;Login</a>
                        <?php } } }?>
                  </div>
    ...
    <div class="header-maxi mobile-12 bg-header-bar" style="height:70px !important">
      <div class="container">
                        ...
                        <div class="container">
                          <form class="form-inline-mobile-12" action="{{ URL::to('/shop')}}" method="get">
                            ...
                            <input   type="hidden" class="category_mobile_slug" name="categories_id" value="" /> 
                              <input autocomplete="off" required class="serach-input-mobile-12 typeheads_mobile" type="search" name="search" placeholder="@lang('website.Search entire store here')..."  value="{{ app('request')->input('search') }}">
  ...
  <g id="Layer_1" data-name="Layer 1" transform="translate(0 0)">
    <path id="Path_55427" data-name="Path 55427" d="M.216,25.052l6.72-6.72a11.27,11.27,0,1,1,1.591,1.591l-6.72,6.72A1.127,1.127,0,0,1,.216,25.052Zm15.427-4.833a9.007,9.007,0,1,0-9-9,9.007,9.007,0,0,0,9,9Z" transform="translate(0.07 0.07)" fill="#fff"/>
          ...
          <div class="col-2 pl-0">              
            <ul class="pro-header-right-options header-12-mobile-cart-drop common-fill-hover" id="resposive-header-cart">
              @include('web.headers.cartButtons.cartButtonMobile12')
            </ul> 
          </div>
          @endif
          </div>
