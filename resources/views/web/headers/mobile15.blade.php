...
<input type="hidden" id="mobheadergetvalue" value="15"/>
  ...
  <g id="Layer_1" data-name="Layer 1" transform="translate(0 0)">
    <path id="Path_55427" data-name="Path 55427" d="M.216,25.052l6.72-6.72a11.27,11.27,0,1,1,1.591,1.591l-6.72,6.72A1.127,1.127,0,0,1,.216,25.052Zm15.427-4.833a9.007,9.007,0,1,0-9-9,9.007,9.007,0,0,0,9,9Z" transform="translate(0.07 0.07)" fill="#fff"/>
                      ...
                      <?php if(auth()->guard('customer')->check() &&  auth()->guard('customer')->user()->phone_verified== '1'){ ?>
                       ...
                       <a href="{{url('wishlist')}}" class="common-hover main-manu btn">@lang('website.Wishlist')<span class="common-color">(<span class="total_wishlist">{{$result['commonContent']['total_wishlist']}}</span>)</span></a>
...
<a href="{{ URL::to('/wishlist')}}">
  ...
  <?php } ?>
    <?php }?>
              ...
              <div class="pro-header-right-options display-inline cart-left-wishlist cart-left-wishlist-11 text-center icon-39-color mobile-15-wisl common-fill-hover color-fill">
            ...
            <ul class="pro-header-right-options header-29-mobile-cart-drop mobile-15-cart common-fill-hover color-fill" id="resposive-header-cart">
              @include('web.headers.cartButtons.cartButtonMobile15')
            </ul> 
            @endif
          </div>
          </div>
...
<script>
  $(document).ready(function(){
      $("#close-btn").click(function(){
          $(".img-header-mobile").addClass("zindex-2");
      });
      $("#bar").click(function(){
          $(".img-header-mobile").removeClass("zindex-2");
      });
