...
.header-twele .dropdown-menu .dropdown-item {
...
<!-- //header style Twele -->
@include('web.headers.fixedHeader23') 
...
<div class="header-mini">
    <div class="container-fluid">
      <div class="row align-items-center">
        <div class="col-12">
          <nav id="navbar_0_6" class="navbar navbar-expand-md navbar-dark navbar-0" style="border-bottom:.1rem solid #ebebeb;">

          <ul class="navbar-nav" style="padding:10px 0px">
              <li class="nav-item mr-20" style="margin-left:5px">
                <a class="color-16-top common-fill-hover" href="tel:{{$result['commonContent']['setting'][11]->value}}">
              ...
              <div class="navbar-lang">
                ...
                @if(count($currencies) > 1)
                  <div class="dropdown" style="margin-right:0px;margin-left:30px;">
                    <button class="btn dropdown-toggle common-fill-hover color-16-top" type="button" >
          ...
          <div class="col-12 col-sm-7 col-md-6 col-lg-6">      
            <form class="form-inline" action="{{ URL::to('/shop')}}" method="get">   
              <div class="search-field-module srach-border-22">   
                ...
                <button style="width:200px;padding:1rem 20px;text-align:left" class="btn btn-secondary swipe-to-top  header-selection cate-button-22" type="button" id="headerOneCartButton"  
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/>
                ...
                <div class="search-field-wrap menu-22-border" style="position:relative;height:48px">
                    <input required autocomplete="off" type="text" name="search" class="typeheads" placeholder="@lang('website.Search entire store here')..." data-toggle="" data-placement="bottom" title="@lang('website.Search Products')" value="{{ app('request')->input('search') }}">
    ...
    <path id="Path_55427" data-name="Path 55427" d="M.216,25.052l6.72-6.72a11.27,11.27,0,1,1,1.591,1.591l-6.72,6.72A1.127,1.127,0,0,1,.216,25.052Zm15.427-4.833a9.007,9.007,0,1,0-9-9,9.007,9.007,0,0,0,9,9Z" transform="translate(0.07 0.07)" fill="#fff"/>
        ...
        <div class="col-12 col-sm-3" style="text-align:right">
                  ...
                  <a href="{{ URL::to('/compare')}}">
                    <div class="pro-header-right-options display-inline common-fill-hover cart-left-wishlist cart-left-wishlist-11 text-center common-hover" style="margin-right:20px !important">
...
<a href="{{ URL::to('/wishlist')}}">
  ...
  <?php } ?>
    <?php }?>
                    <div class="pro-header-right-options  common-fill-hover display-inline cart-left-wishlist cart-left-wishlist-11 text-center common-hover" style="margin-right:20px !important">
                    <svg class=" fill-color common-fill-hover" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 48.232 41.342">
  <g id="wishlist" transform="translate(0 -36.545)">
    <path id="Path_55409" data-name="Path 55409" d="M44.814,39.883q-3.419-3.338-9.447-3.338a10.733,10.733,0,0,0-3.4.578,13.76,13.76,0,0,0-3.229,1.561q-1.494.982-2.571,1.844a24.872,24.872,0,0,0-2.045,1.83,24.905,24.905,0,0,0-2.046-1.83q-1.077-.861-2.571-1.844a13.779,13.779,0,0,0-3.23-1.561,10.736,10.736,0,0,0-3.4-.578q-6.029,0-9.447,3.338T0,49.141a11.791,11.791,0,0,0,.633,3.714,16.292,16.292,0,0,0,1.44,3.257A23.82,23.82,0,0,0,3.9,58.736Q4.926,60.014,5.4,60.5a8.916,8.916,0,0,0,.74.7L22.932,77.4a1.689,1.689,0,0,0,2.369,0l16.768-16.15q6.164-6.163,6.164-12.111Q48.232,43.219,44.814,39.883Zm-5.087,18.84L24.116,73.768,8.479,58.7q-5.033-5.032-5.033-9.555a11.735,11.735,0,0,1,.578-3.849A7.518,7.518,0,0,1,5.5,42.641a7.11,7.11,0,0,1,2.194-1.6,9.725,9.725,0,0,1,2.53-.834,15.416,15.416,0,0,1,2.638-.215,7.741,7.741,0,0,1,3.015.686A13.761,13.761,0,0,1,18.854,42.4q1.359,1.037,2.329,1.938A20.908,20.908,0,0,1,22.8,45.992a1.764,1.764,0,0,0,2.638,0,20.851,20.851,0,0,1,1.615-1.655q.969-.9,2.328-1.938a13.757,13.757,0,0,1,2.975-1.722,7.74,7.74,0,0,1,3.015-.686A15.419,15.419,0,0,1,38,40.205a9.714,9.714,0,0,1,2.53.834,7.11,7.11,0,0,1,2.193,1.6,7.518,7.518,0,0,1,1.481,2.651,11.745,11.745,0,0,1,.578,3.849Q44.787,53.663,39.727,58.723Z" transform="translate(0 0)" />
                  ...
                  @if($result['commonContent']['settings']['view_cart_button'] == 1)
                    <ul class="pro-header-right-options display-inline header-23-cart-drop" style="float:right;margin-top:5px;margin-left:20px;margin-right:10px">
                      <li class="dropdown head-cart-content common-fill-hover common-hover">
                        @include('web.headers.cartButtons.cartButton23')
                      </li>
                    </ul>
                  @endif
                </div>
...
<div class="bg-header-22">
          ...
          <nav class="navbar navbar-expand-sm navbar-dark-11 menu-11-padding">
              ...
              <div class="collapse navbar-collapse menu-11-border" id="navbarCollapse">
                  <div class="navbar-nav width-100">
                      <div class="nav-item dropdown menu-11 width-100 cate-bg-color" style="padding:11px">
                          <a href="#" class="nav-link menu-hover-11" data-toggle="dropdown"><svg xmlns="http://www.w3.org/2000/svg" class="menu-23-fontsize" width="16" height="12" viewBox="0 0 36 27">
  <g id="hamburger_menu" transform="translate(0.307 0.307)">
    ...
    <rect id="Rectangle_5802"  data-name="Rectangle 5802" width="36" height="3" transform="translate(-0.307 23.693)" fill="#000"/>
                          ...
                          <a id="shopclcik" href="#" class="nav-link menu-hover-11 cate-color-22" data-toggle="dropdown"><svg xmlns="http://www.w3.org/2000/svg" class="menu-23-fontsize" width="16" height="15" viewBox="0 0 27.001 27">
  <path id="close" d="M101.218,98.832l10.619-10.619a1.688,1.688,0,1,0-2.387-2.387L98.832,96.445,88.212,85.826a1.688,1.688,0,0,0-2.387,2.387L96.445,98.832,85.826,109.451a1.688,1.688,0,1,0,2.387,2.387l10.619-10.619,10.619,10.619a1.688,1.688,0,0,0,2.387-2.387Z" transform="translate(-85.332 -85.332)" fill="#fff"/>
                          ...
                          <div class="dropdown-menu dropdown-menu-12 dropdown-menu-hoactive" style="width:100% !important;top:100% !important;padding:0px !important;z-index:99">
                    ...
                    ->get();
                      ...
                      ?> 
                        <li class="nav-item dropdown menu-active-13-{{ $menuactive }} hover-menu-13 hover-menu-13-white">
                          <a style="white-space:nowrap" class="nav-link fill-color-white common-fill-hover menu-16-color menu-16-color-white" <?php echo $link; ?>>{{ $item->name }} <?php  if ($childs->isNotEmpty()){?>  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/>
</svg> <?php } ?></a>
                          ...
                          <?php if ($childs->isNotEmpty()) { ?>
                            <div class="dropdown-menu">
                              ...
                              <div class="dropdown-submenu submenu1">
                                <a class="dropdown-item common-fill-hover"  <?php echo $sublink; ?>>
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/></svg><?php } ?></i></a>
                      ...
                      <?php }} if(count($items) > 4){?>
                        ...
                        <li class="nav-item dropdown common-fill-hover hover-menu-13 hover-menu-13-white">
                          <a style="white-space:nowrap" class="nav-link fill-color-white menu-16-color menu-16-color-white" href="#">More <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" />
</svg></a>
                            <div class="dropdown-menu">
                            <?php
                      ...
                      $menuactive = '';
                              ...
                              <div class="dropdown-submenu  submenu1">
                              <div class="dropdown-submenu  submenu1">
                                <a class="dropdown-item common-fill-hover"  <?php echo $link; ?>>
        ...
        <div class="col-12 col-sm-3">
            ...
            <?php if(strlen($result['commonContent']['settings']['head_offer_title']) <= 17) { ?>
              <a href="{{ $result['commonContent']['settings']['head_offer_url'] }}">
                <div class="head-11 text-white border-left common-fill"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 49.479 49.99">
...
jQuery(window).scroll(function() {
    ...
    if (topPos < 150) {
    $( ".dropdown-menu-12-fixed" ).removeClass("show");
    } 
  });
