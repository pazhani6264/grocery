<input type="hidden" id="mobheadergetvalue" value="17"/>
...
<header id="headerMobileTwele" class="header-area header-mobile header-mobile-12 d-lg-none d-xl-none">
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" />
                ...
                <div class="dropdown-mobile-12 drop-right">
                  <a class="dropbtn-mobile-12 color-16-top common-hover fill-color common-fill-hover">LINKS  &nbsp; <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)" />
</svg> </a>
...
<a class="color-16-top" href="{{ URL::to('/wishlist')}}">
  ...
  <?php } ?>
    <?php }?>
                        <i class="fa fa-heart-o"></i>&nbsp;&nbsp;MY WHISTLIST <span class="common-color">(<span class="total_wishlist">{{$result['commonContent']['total_wishlist']}}</span>)</span></a>
  ...
  <g id="Layer_1" data-name="Layer 1" transform="translate(0 0)">
    <path id="Path_55427" data-name="Path 55427" d="M.216,25.052l6.72-6.72a11.27,11.27,0,1,1,1.591,1.591l-6.72,6.72A1.127,1.127,0,0,1,.216,25.052Zm15.427-4.833a9.007,9.007,0,1,0-9-9,9.007,9.007,0,0,0,9,9Z" transform="translate(0.07 0.07)" fill="#fff"/>
          ...
          <div class="col-2 pl-0">              
            <ul class="pro-header-right-options header-17-mobile-cart-drop common-hover color-fill-phone common-fill-hover" id="resposive-header-cart">
              @include('web.headers.cartButtons.cartButtonMobile17')
            </ul> 
          </div>
          @endif
          </div>
