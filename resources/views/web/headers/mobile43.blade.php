...
<input type="hidden" id="mobheadergetvalue" value="43"/>
...
<a class="demo-18-wish-mhide" href="{{ URL::to('/wishlist')}}">
  <?php } else {?>
    <?php 
    $loginID = DB::table('current_theme')->first();
    if($loginID->login == 4) {
  ?>
    <a class="demo-18-wish-mhide login_modal" style="cursor:pointer"> 
  <?php } else if($loginID->login == 5){ ?>
    <a class="demo-18-wish-mhide login_modal1" style="cursor:pointer">     
  <?php } else if($loginID->login == 6){ ?>
    <a class="demo-18-wish-mhide login_modal2" style="cursor:pointer">   
  <?php } else if($loginID->login == 7){ ?>
    <a class="demo-18-wish-mhide login_modal3" style="cursor:pointer"> 
  <?php } else if($loginID->login == 8){ ?>
    <a class="demo-18-wish-mhide login_modal4" style="cursor:pointer"> 
  <?php } else { ?>
    <a class="demo-18-wish-mhide demo-18-wish-mhide" href="{{ URL::to('/wishlist')}}"> 
  <?php } ?>
    <?php }?>

                      <div class="pro-header-right-options display-inline cart-left-wishlist cart-left-wishlist-11 text-center common-fill-hover color-fill" style="margin-right:20px !important;vertical-align:super">
                      ...
                      <g id="wishlist" transform="translate(0 -36.545)">
                        ...
                        <span class="badge badge-secondary badge-wishlist-29"style="right: 13px;">{{ $result['commonContent']['total_wishlist'] }}</span>
                      </div>
                    </a>  
                    
                    @if($result['commonContent']['settings']['view_cart_button'] == 1)

            <ul class="pro-header-right-options header-29-mobile-cart-drop common-fill-hover color-fill" id="resposive-header-cart" style="display:inline-block;vertical-align:sub;">
              @include('web.headers.cartButtons.cartButtonMobile43')
            </ul> 
