...
.header-twele .header-navbar nav .navbar-collapse ul .nav-item .nav-link {
    padding: 1.1rem 20px 1.1rem 5px;
}
.header-twele .header-mini {
    min-height: 35px;
}
...
<div class="header-mini bg-top-bar-19">
      ...
      <div class="row align-items-center">
        <div class="col-12">
          <nav id="navbar_0_6" class="navbar navbar-expand-md navbar-dark navbar-0">
            ...
            <ul class="navbar-nav" style="padding:7px 0px">
                ...
                <?php if(auth()->guard('customer')->check() &&  auth()->guard('customer')->user()->phone_verified== '1'){ ?>
                  ...
                  <?php }else{ ?>
                    ...
                    ?>
                      ...
                      <path id="profile" d="M22.1,27a9.828,9.828,0,0,0-9.732-9.819h-.174A9.828,9.828,0,0,0,2.457,27H0A12.294,12.294,0,0,1,7.467,15.7a8.591,8.591,0,1,1,9.618,0A12.294,12.294,0,0,1,24.552,27ZM6.142,8.582a6.134,6.134,0,1,0,6.134-6.134A6.143,6.143,0,0,0,6.142,8.582Z"/></svg>&nbsp;<span>Login</span></a> </li>  
              ...
              <div class="navbar-lang">
                ...
                @if(count($currencies) > 1)
                  <div class="dropdown" style="margin-right:0px;margin-left:10px;">
                    <button class="btn dropdown-toggle color-16-top common-fill-hover fill-down-color" type="button" style="padding: 7px 0px 7px 10px!important;text-transform:initial">
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/>
                ...
                @if(count($languages) > 1)
                  <div class="dropdown" style="margin-right:0px;margin-left:15px;">
                      <button class="btn dropdown-toggle color-16-top common-fill-hover fill-down-color" type="button">
  ...
  <div class="header-maxi  bg-header-bar header-maxi-twele" style="height:83px">
    <div class="container">
      <div class="row align-items-center">
  ...
  <g id="Layer_1" data-name="Layer 1" transform="translate(0 0)">
    <path id="Path_55427" data-name="Path 55427" d="M.216,25.052l6.72-6.72a11.27,11.27,0,1,1,1.591,1.591l-6.72,6.72A1.127,1.127,0,0,1,.216,25.052Zm15.427-4.833a9.007,9.007,0,1,0-9-9,9.007,9.007,0,0,0,9,9Z" transform="translate(0.07 0.07)" />
        ...
        <div class="col-12 col-md-2 col-lg-2">
          <a style="margin-left:3rem" class="img-fluid-molla-main" href="{{ URL::to('/')}}" class="logo" data-toggle="" data-placement="bottom" title="@lang('website.logo')">
        ...
        <div class="col-12 col-sm-5">
              <div class="row">
                ...
                <div class="col-md-12" style="text-align:right">
                  ...
                  <ul class="pro-header-right-options display-inline header-19-cart-drop common-hover common-fill-hover fill-search">
                    <li class="dropdown head-cart-content" style="float:none;">
                      @include('web.headers.cartButtons.cartButton25')
                    </li>
                  </ul>
                  @endif
                </div>
