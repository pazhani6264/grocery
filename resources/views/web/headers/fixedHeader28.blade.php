<input type="hidden" id="fixheadergetvalue" value="28"/>
          ...
          <div class="header-sticky-inner  bg-sticky-bar">
            <div class="container-fluid">
                ...
                <div class="row align-items-center" style="margin-left:0px;margin-right:0px">
                    <div class="col-12 col-lg-1 pl-5">
                        <div class="logo">
              ...
              ->get();
                ...
                ?> 
                  <li class="nav-item dropdown menu-active-{{ $menuactive }} fixed-12-padding-black">
                    <a style="white-space: nowrap;" class="nav-link common-fill-hover demo-19-fill-down padding-0-black" <?php echo $link;?>>{{ $item->name }} <?php  if ($childs->isNotEmpty()){?> <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/></svg> <?php } ?></a>
                ...
                <?php }} if(count($items) > 4){?>
                  ...
                  <li class="nav-item dropdown fixed-12-padding-black">
                    <a style="white-space: nowrap;" class="nav-link common-fill-hover demo-19-fill-down padding-0-black" href="#">More <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/>
</svg></a>
                      <div class="dropdown-menu">
                      <?php
                  ...
                  <form class="form-inline-search header-28-form" action="{{ URL::to('/shop')}}" method="get">
                    <div class="input-main" id="searchbuttonsfixed">
                      ...
                      <div class="input-main" id="searchbuttonfixed" style="display:none">
                          <input autocomplete="off" required name="search" type="text" class="search-input typeheads_fixed header-28-search-input" value="{{ app('request')->input('search') }}" placeholder="Search Product ..... ">
                      ...
                      <svg id="search" class="cus-style-search" onclick="myFunctionfixed()" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 27 27">
...
<a href="{{ URL::to('/wishlist')}}">
  ...
  <?php } ?>
    <?php }?>
                  ...
                  <ul class="pro-header-right-options display-inline header-28-fixed-cart-drop" style="float:right;margin-top:3px;position: relative;">
                    <li class="dropdown head-cart-content" style="margin-left:0px">
                      @include('web.headers.cartButtons.cartButtonFixed28')
                    </li>
                  </ul>
                  @endif
                </div>
