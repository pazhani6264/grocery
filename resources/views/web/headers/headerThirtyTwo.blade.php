...
.color-white-above:hover .color-white {
    color: #fff !important;
    fill: #fff !important;
...
article:hover .footer-27-hover-trans {
    transform: translateY(30px) !important;
}
.product4.product article .content {
    background: #fff !important;
}
.ajax_product_27 article .thumb:hover {
    background-color: #fafafa !important;
}

.product9.product article .thumb{
...
<!-- //header style Twele -->
@include('web.headers.fixedHeader32') 
<header id="headerTwele" class="header-12-search header-area header-twele demo-27-header-section  header-desktop d-none d-lg-block d-xl-block">
<!--   
<div  class="header-mini bg-header-bar-35">
          ...
          <nav id="navbar_0_6" class="navbar navbar-expand-md navbar-dark navbar-0">
            <div class="navbar-lang">
              ...
              <div class="dropdown" style="margin-right:0px !important">
                  <button class="btn dropdown-toggle color-34-top menu-16-color-black" type="button" style="padding:8px 20px 8px 0px !important">
              ...
              @if(count($currencies) > 1)
                <div class="dropdown">
                  <button class="btn dropdown-toggle color-34-top menu-16-color-black" type="button" >
            ...
            <div class="navbar-collapse">
              ...
              <?php if(auth()->guard('customer')->check() &&  auth()->guard('customer')->user()->phone_verified== '1'){ ?>
                <li class="nav-item mr-20">
                      <a class="color-34-top menu-16-color-black" href="tel:{{$result['commonContent']['setting'][11]->value}}">
                  ...
                  <?php }else{ ?>
                    ...
                    <!-- <li class="nav-item"> <a class="color-34-top menu-16-color-black" href="{{ URL::to('/login')}}"><i class="fa fa-user-o"></i>&nbsp;@lang('website.Login')</a> </li>   
                    ...
                    if($result['commonContent']['settings']['view_login_button'] == 1){
                      ...
                      if($loginID->login == 4) {
                    ?>
                      <li class="nav-item login_modal"> <a class="color-34-top menu-16-color-black"><i class="fa fa-user-o"></i>&nbsp;@lang('website.Login')</a></li>    
                    <?php } else if($loginID->login == 5){ ?>
                      <li class="nav-item login_modal1"> <a class="color-34-top menu-16-color-black"><i class="fa fa-user-o"></i>&nbsp;@lang('website.Login')</a></li>       
                    <?php } else if($loginID->login == 6){ ?>
                      <li class="nav-item login_modal2"> <a class="color-34-top menu-16-color-black"><i class="fa fa-user-o"></i>&nbsp;@lang('website.Login')</a></li>      
                    <?php } else if($loginID->login == 7){ ?>
                      <li class="nav-item login_modal3"> <a class="color-34-top menu-16-color-black"><i class="fa fa-user-o"></i>&nbsp;@lang('website.Login')</a></li>    
                    <?php } else if($loginID->login == 8){ ?>
                      <li class="nav-item login_modal4"> <a class="color-34-top menu-16-color-black"><i class="fa fa-user-o"></i>&nbsp;@lang('website.Login')</a></li>         
                    <?php } else { ?>
                      <li class="nav-item"> <a class="color-34-top menu-16-color-black" href="{{ URL::to('/login')}}"><i class="fa fa-user-o"></i>&nbsp;@lang('website.Login')</a> </li>    
                    <?php } ?>
  ...
  <!-- <div class="header-maxi  bg-header-bar-15 header-maxi-twele"> -->
              ...
              ->get();
                ...
                ?> 
                  <li class="nav-item dropdown menu-active-30-{{ $menuactive }}" style="padding:15px 0px !important">
                    <a style="white-space:nowrap" class="nav-link demo-27-arrow-fill common-fill-hover font-500 menu-color-38 menu-16-color-black header-12-balck" <?php echo $link; ?>>{{ $item->name }} <?php  if ($childs->isNotEmpty()){?> <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
                    ...
                    <?php if ($childs->isNotEmpty()) { ?>
                      <div class="dropdown-menu">
                        ...
                        <div class="dropdown-submenu submenu1">
                          <a class="dropdown-item demo-27-arrow-fill common-fill-hover" <?php echo $sublink; ?>>
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/></svg><?php } ?></a>
                ...
                <?php }} if(count($items) > 3){?>
                  ...
                  <li class="nav-item dropdown " style="padding:15px 0px !important">
                    <a style="white-space:nowrap" class="nav-link demo-27-arrow-fill common-fill-hover font-500 menu-color-38 menu-16-color-black header-12-balck" href="#">More <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/></svg></a>
                      ...
                      $menuactive = '';
                        ...
                        ?>
                        <div class="dropdown-submenu submenu1">
                          <a class="dropdown-item demo-27-arrow-fill common-fill-hover"  <?php echo $link; ?>>
            ...
            <div class="col-12 col-sm-5" style="text-align:right">
                  ...
                  <!-- <form class="form-inline-search" action="{{ URL::to('/shop')}}" method="get">
                      ...
                      <div class="input-main">
                          <input autocomplete="off" name="search" type="text" value="{{ app('request')->input('search') }}" class="search-input-15 typeheads" placeholder="Search Product ..... ">
                  ...
                  <form id="search_form_submit" class="form-inline-search" action="{{ URL::to('/shop')}}" method="get" style="display:inline-block;position:relative">

                  <button id="dropdownCartButton" class="btn srach-18-butt" type="submit"> 
                  <svg id="search" class="cus-style-search-38 menu-16-color-black common-fill-hover color-fill" xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 27 27" >
  <g id="Layer_1" data-name="Layer 1" transform="translate(0 0)">
    <path id="Path_55427" data-name="Path 55427" d="M.216,25.052l6.72-6.72a11.27,11.27,0,1,1,1.591,1.591l-6.72,6.72A1.127,1.127,0,0,1,.216,25.052Zm15.427-4.833a9.007,9.007,0,1,0-9-9,9.007,9.007,0,0,0,9,9Z" transform="translate(0.07 0.07)"/>
                        ...
                        <div class="input-main srach-18-main-input" id="searchbutton">
                            <input autocomplete="off" required style="position:unset" name="search" value="{{ app('request')->input('search') }}"  type="text"  class="search-input-15 typeheads" placeholder="Search Product ..... ">
...
<a href="{{ URL::to('/wishlist')}}">
  ...
  <?php } ?>
    <?php }?>
                      <div class="pro-header-right-options display-inline cart-left-wishlist cart-left-wishlist-11 text-center icon-39-color margin-left-32 common-fill-hover color-fill" style="margin-right:20px !important;">
                    ...
                    <ul class="pro-header-right-options display-inline common-hover common-fill-hover color-fill header-32-cart-drop" style="float:right;margin-top:8px;">
                    <li class="dropdown head-cart-content" style="margin-left: 2px !important;">
                      @include('web.headers.cartButtons.cartButton32')
                    </li>
                  </ul>
                  @endif
                </div>
...
function myFunction_formsubmit()
{
