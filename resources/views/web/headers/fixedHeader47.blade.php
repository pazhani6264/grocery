...
.header-fixed .header-navbar nav .navbar-collapse ul .nav-item .nav-link:hover {
    color: #333 !important;
}
</style>
            ...
            <div class="">
              <div class="container-fluid">
                  <div class="row align-items-center">
                    ...
                    <div class="col-12 col-sm-10-head">
                      ...
                      $menuactive = '';
                                  ...
                                  ?> 
                                    <li class="nav-item dropdown menu-active-13-{{ $menuactive }} hover-menu-13 hover-menu-13-white">
                                      <a style="white-space:nowrap" class="nav-link  demo-26-header-dropdown-arrow common-fill-hover padding-22 menu-16-color-white" <?php echo $link; ?>>{{ $item->name }} <?php  if ($childs->isNotEmpty()){?> <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
                                      ...
                                      <?php if ($childs->isNotEmpty()) { ?>
                                        <div class="dropdown-menu">
                                          ...
                                          <div class="dropdown-submenu submenu1">
                                            <a class="dropdown-item demo-26-header-dropdown-arrow common-fill-hover"  <?php echo $sublink; ?>>
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/></svg><?php } ?></a>
                                  ...
                                  <?php }} if(count($items) > 5){?>
                                    ...
                                    <li class="nav-item dropdown  hover-menu-13 hover-menu-13-white">
                                      <a style="white-space:nowrap" class="nav-link demo-26-header-dropdown-arrow common-fill-hover  padding-22 menu-16-color-white" href="#">More <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/>
</svg></a>
                                        <div class="dropdown-menu">
                                        <?php
                      ...
                      $menuactive = '';
                                          ...
                                          ?>
                                          <div class="dropdown-submenu submenu1">
                                            <a class="dropdown-item demo-26-header-dropdown-arrow common-fill-hover"  <?php echo $link; ?>>
