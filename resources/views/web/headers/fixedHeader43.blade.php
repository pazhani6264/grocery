...
<input type="hidden" id="fixheadergetvalue" value="43"/>
          ...
          <div class="navbar-collapse" >
            ...
            <?php 
              ...
              ->get();
                ...
                ?> 
                  <li class="nav-item dropdown menu-active-{{ $menuactive }}  hover-menu-15-white" style="padding:0px !important">
                    <a style="white-space:nowrap" class="nav-link font-500 menu-color-43 common-fill-hover fill-down-color padding-15-fixed" <?php echo $link; ?>>{{ $item->name }} <?php  if ($childs->isNotEmpty()){?> &nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/></svg><?php } ?></a>
                ...
                <?php }} if(count($items) > 3){?>
                  ...
                  <li class="nav-item dropdown  hover-menu-15-white" style="padding:0px !important">
                    <a style="white-space:nowrap" class="nav-link font-500 menu-color-43 common-fill-hover fill-down-color padding-15-fixed" href="#">More &nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/>
</svg></a>
                      <div class="dropdown-menu">
                      <?php
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/></svg><?php } ?></a>
        ...
        <div class="col-12 col-sm-4">
              <div class="row">
                  <form class="form-inline-search header-24-form" action="{{ URL::to('/shop')}}" method="get" style="position: relative;">
                      <input type="hidden" class="category-value" name="categories_id" value="" /> 
                      <div class="input-main">
                          <input autocomplete="off" required name="search" type="text" value="{{ app('request')->input('search') }}" class="search-input-15 typeheads_fixed" placeholder="Search Product ..... ">
  ...
  <g id="Layer_1" data-name="Layer 1" transform="translate(0 0)">
    <path id="Path_55427" data-name="Path 55427" d="M.216,25.052l6.72-6.72a11.27,11.27,0,1,1,1.591,1.591l-6.72,6.72A1.127,1.127,0,0,1,.216,25.052Zm15.427-4.833a9.007,9.007,0,1,0-9-9,9.007,9.007,0,0,0,9,9Z" transform="translate(0.07 0.07)"/>
                  ...
                  <a href="{{ URL::to('/wishlist')}}">
                      <div class="pro-header-right-options display-inline cart-left-wishlist cart-left-wishlist-11 text-center common-fill-hover color-fill" style="margin-right:10px !important;margin-top:2px;">
                      ...
                      <g id="wishlist" transform="translate(0 -36.545)">
                        ...
                        <span class="total_wishlist badge badge-secondary badge-wishlist-29 badge-wishlist-29-black" style="top: -9px;left: -13px;">{{ $result['commonContent']['total_wishlist'] }}</span>
                      </div>
                    </a>
                  
                    @if($result['commonContent']['settings']['view_cart_button'] == 1)

                    <ul class="pro-header-right-options display-inline header-24-fixed-cart-drop common-fill-hover color-fill" style="float:right;margin-top:5px">
                    <li class="dropdown head-cart-content-fixed margin-left-24-fixed">
                      @include('web.headers.cartButtons.cartButtonFixed43')
                    </li>
                  </ul>
                  @endif
                </div>
