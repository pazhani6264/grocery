...
<style>
  body{
    ...
    /* background-image:  url({{url('/bg-27.jpg')}}); */
...
footer.footer.footer-molla.footer-black.footer-area.padding-top-15.footer-2.f23.footer-dark.d-none.d-lg-block.d-xl-block {
    margin-top: 0;
}
  .demo-19-fill-down
  {
...
.product-molla-32 article .thumb {
  background-color: #f0f0f0 !important;
}
.product9.product article:hover {
  -webkit-box-shadow: 0 5px 15px rgb(0 0 0 / 5%) !important;
    box-shadow: 0 5px 15px rgb(0 0 0 / 5%) !important;
}
...
.header-twele .header-maxi .search-field-module .search-field-wrap{
  height:44px;
}
.color-13-top {
    color: #ccc !important;
...
<!-- //header style Twele -->
@include('web.headers.fixedHeader27') 
<header id="headerTwele" class="header-11-search header-area header-twele  header-desktop d-none d-lg-block d-xl-block">
<div class="header-mini bg-top-bar-13">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <nav id="navbar_0_6" class="navbar navbar-expand-md navbar-dark navbar-0 nav-border-13">

            <ul class="navbar-nav">
              <li class="nav-item mr-20">
                <a class="color-14-top common-fill-hover demo-19-fill-down menu-16-color-black" href="tel:{{$result['commonContent']['setting'][11]->value}}">
              ...
              <div class="navbar-lang">
                ...
                @if(count($currencies) > 1)
                  <div class="dropdown" style="margin-right:0px;margin-left:20px;">
                    <button class="btn dropdown-toggle color-14-top common-fill-hover demo-19-fill-down menu-16-color-black" type="button" >
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/>
                    ...
                    <div class="dropdown-menu">
                      ...
                      <a onclick="myFunction2({{$currency->id}})" class="dropdown-item color-14-top" href="#">
                ...
                @if(count($languages) > 1)
                  <div class="dropdown" style="margin-right:0px;margin-left:20px;">
                      <button class="btn dropdown-toggle common-fill-hover demo-19-fill-down color-14-top menu-16-color-black" type="button" >
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/>
                      ...
                      <div class="dropdown-menu" >
                        ...
                        <a onclick="myFunction1({{$language->languages_id}})" class="dropdown-item color-14-top" href="#">                      
                          {{$language->name}}
                        </a>                   
                        @endforeach                   
                      </div>
              ...
              <?php if(auth()->guard('customer')->check() &&  auth()->guard('customer')->user()->phone_verified== '1'){ ?>
                  <!-- <li class="nav-item mr-20">
                      <a class="color-14-top menu-16-color-black" href="{{ URL::to('/wishlist')}}">
                        <i class="fa fa-heart-o"></i>&nbsp;&nbsp;MY WHISTLIST <span class="total_wishlist">( {{$result['commonContent']['total_wishlist']}} )</span>
                      </a>
                    </li> -->
                  <!-- <li class="nav-item" style="margin-right:0px;margin-left:20px;"> <a class="color-14-top menu-16-color-black" href="{{url('profile')}}" class="nav-link">@lang('website.Profile')</a> </li> -->
                  <li class="nav-item" style="margin-right:0px;margin-left:20px;"> <a class="color-14-top menu-16-color-black" href="{{url('compare')}}" class="nav-link">@lang('website.Compare')&nbsp;(<span id="compare">{{$count}}</span>)</a> </li>
                  <li class="nav-item" style="margin-right:0px;margin-left:20px;"> <a class="color-14-top menu-16-color-black" href="{{url('orders')}}" class="nav-link">@lang('website.Orders')</a> </li>
                  <li class="nav-item" style="margin-right:0px;margin-left:20px;"> <a class="color-14-top menu-16-color-black" href="{{url('shipping-address')}}" class="nav-link">@lang('website.Shipping Address')</a> </li>
                  <li class="nav-item" style="margin-right:0px;margin-left:20px;"> <a class="color-14-top menu-16-color-black" href="{{url('logout')}}" class="nav-link">@lang('website.Logout')</a> </li>
                  <?php }else{ ?>
                    ...
                    if($result['commonContent']['settings']['view_login_button'] == 1){
                      ...
                      if($loginID->login == 4) {
                    ?>
                      <li class="nav-item common-fill-hover login_modal" style="fill: #777;margin-left:20px;"> <a class="color-16-top common-fill-hover"  style="fill: #777;"><svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 24.552 26.999">
                    ...
                    <?php } else if($loginID->login == 5){ ?>
                      <li class="nav-item common-fill-hover login_modal1" style="fill: #777;margin-left:20px;"> <a class="color-16-top common-fill-hover"  style="fill: #777;"><svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 24.552 26.999">
                      <path id="profile" d="M22.1,27a9.828,9.828,0,0,0-9.732-9.819h-.174A9.828,9.828,0,0,0,2.457,27H0A12.294,12.294,0,0,1,7.467,15.7a8.591,8.591,0,1,1,9.618,0A12.294,12.294,0,0,1,24.552,27ZM6.142,8.582a6.134,6.134,0,1,0,6.134-6.134A6.143,6.143,0,0,0,6.142,8.582Z"/></svg>&nbsp;Login</a> </li>   
                    <?php } else if($loginID->login == 6){ ?>
                      <li class="nav-item common-fill-hover login_modal2" style="fill: #777;margin-left:20px;"> <a class="color-16-top common-fill-hover"  style="fill: #777;"><svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 24.552 26.999">
                      <path id="profile" d="M22.1,27a9.828,9.828,0,0,0-9.732-9.819h-.174A9.828,9.828,0,0,0,2.457,27H0A12.294,12.294,0,0,1,7.467,15.7a8.591,8.591,0,1,1,9.618,0A12.294,12.294,0,0,1,24.552,27ZM6.142,8.582a6.134,6.134,0,1,0,6.134-6.134A6.143,6.143,0,0,0,6.142,8.582Z"/></svg>&nbsp;Login</a> </li>   
                    <?php } else if($loginID->login == 7){ ?>
                      <li class="nav-item common-fill-hover login_modal3" style="fill: #777;margin-left:20px;"> <a class="color-16-top common-fill-hover"  style="fill: #777;"><svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 24.552 26.999">
                      <path id="profile" d="M22.1,27a9.828,9.828,0,0,0-9.732-9.819h-.174A9.828,9.828,0,0,0,2.457,27H0A12.294,12.294,0,0,1,7.467,15.7a8.591,8.591,0,1,1,9.618,0A12.294,12.294,0,0,1,24.552,27ZM6.142,8.582a6.134,6.134,0,1,0,6.134-6.134A6.143,6.143,0,0,0,6.142,8.582Z"/></svg>&nbsp;Login</a> </li> 
                    <?php } else if($loginID->login == 8){ ?>
                      <li class="nav-item common-fill-hover login_modal4" style="fill: #777;margin-left:20px;"> <a class="color-16-top common-fill-hover"  style="fill: #777;"><svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 24.552 26.999">
                      <path id="profile" d="M22.1,27a9.828,9.828,0,0,0-9.732-9.819h-.174A9.828,9.828,0,0,0,2.457,27H0A12.294,12.294,0,0,1,7.467,15.7a8.591,8.591,0,1,1,9.618,0A12.294,12.294,0,0,1,24.552,27ZM6.142,8.582a6.134,6.134,0,1,0,6.134-6.134A6.143,6.143,0,0,0,6.142,8.582Z"/></svg>&nbsp;Login</a> </li>      
                    <?php } else { ?>
                      <li class="nav-item common-fill-hover" style="fill: #777;margin-left:20px;"> <a class="color-16-top common-fill-hover" href="{{ URL::to('/login')}}" style="fill: #777;"><svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 24.552 26.999">
                      <path id="profile" d="M22.1,27a9.828,9.828,0,0,0-9.732-9.819h-.174A9.828,9.828,0,0,0,2.457,27H0A12.294,12.294,0,0,1,7.467,15.7a8.591,8.591,0,1,1,9.618,0A12.294,12.294,0,0,1,24.552,27ZM6.142,8.582a6.134,6.134,0,1,0,6.134-6.134A6.143,6.143,0,0,0,6.142,8.582Z"/></svg>&nbsp;Login</a> </li>     
                    <?php } } }?>
              </ul> 
  ...
  <div class="header-maxi   bg-header-bar-13 header-maxi-twele">
    <div class="container">
        ...
        <div class="col-12 col-md-3 col-lg-3">
          ...
          <div class="col-12 col-sm-7 col-md-6 col-lg-6">      
            <form class="form-inline" action="{{ URL::to('/shop')}}" method="get"> 
              <div class="search-field-module border-radius-main-27">     
                <div class="search-field-wrap search-field-wrap-11">
                <input type="hidden" class="category-value" name="categories_id" value="" /> 
                  <input  autocomplete="off" type="text" name="search" class="search-27 typeheads" placeholder="@lang('website.Search entire store here')..." data-toggle="" data-placement="bottom" title="@lang('website.Search Products')" value="{{ app('request')->input('search') }}">
                  <button class="btn  swipe-to-top common-fill-hover demo-19-fill-down  search-button-13" data-toggle="" 
...
<a href="{{ URL::to('/profile')}}">
  ...
  <?php } ?>
    <?php }?> 
                  <div class="pro-header-right-options display-inline cart-left-wishlist cart-left-wishlist-11 text-center" style="margin-right:20px !important">
                    <span class="small-font-size fill-white-color common-fill-hover color-13-top menu-16-color-black"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24.552 26.999">
...
<a href="{{ URL::to('/wishlist')}}">
  ...
  <?php } ?>
    <?php }?>
                  <div class="pro-header-right-options display-inline cart-left-wishlist cart-left-wishlist-11 text-center" style="margin-right:20px !important">
                  <span class="small-font-size color-13-top fill-white-color common-fill-hover menu-16-color-black">     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 48.232 41.342">
                ...
                <ul class="pro-header-right-options display-inline header-27-cart-drop fill-white-color common-fill-hover " style="float:right;margin-top:5px;margin-left: 20px;margin-right:10px">
                  <li class="dropdown head-cart-content">
                    @include('web.headers.cartButtons.cartButton27')
                  </li>
                </ul>
                @endif
              </div>
                    ...
                    ->get();
                      ...
                      ?> 
                        <li class="nav-item dropdown menu-active-13-{{ $menuactive }} hover-menu-13">
                          <a style="white-space:nowrap;text-transform:uppercase" class="nav-link common-fill-hover demo-19-fill-down " <?php echo $link; ?>>{{ $item->name }} <?php  if ($childs->isNotEmpty()){?> <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/>
</svg>  <?php } ?></a>
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/></svg><?php } ?></a>
                      ...
                      <?php }} if(count($items) > 5){?>
                        ...
                        <li class="nav-item dropdown  hover-menu-13">
                          <a style="white-space:nowrap;text-transform:uppercase" class="nav-link common-fill-hover demo-19-fill-down " href="#">More <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/>
</svg> </a>
                            <div class="dropdown-menu">
                            <?php
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/></svg><?php } ?></a>
        ...
        <div class="col-12 col-sm-3 border-left">
            ...
            <?php if(strlen($result['commonContent']['settings']['head_offer_title']) <= 17) { ?>
                ...
                <div class="head-11 color-13-clear"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 49.479 49.99">
