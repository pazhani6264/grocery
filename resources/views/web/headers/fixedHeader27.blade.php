        ...
        <header id="stickyHeader" class="header-fixed header-area header-sticky d-none">
          <div class="header-sticky-inner  bg-sticky-bar fh-27" >
                      ...
                      $menuactive = '';
                                  ...
                                  ?> 
                                    <li class="nav-item dropdown menu-active-13-{{ $menuactive }} hover-menu-13">
                                      <a style="white-space:nowrap" class="nav-link common-fill-hover demo-19-fill-down  fixed-header-11-nopadding" <?php echo $link; ?>>{{ $item->name }} <?php  if ($childs->isNotEmpty()){?> <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  ...
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/></svg><?php } ?></i></a>
                                  ...
                                  <?php }} if(count($items) > 5){?>
                                    ...
                                    <li class="nav-item dropdown  hover-menu-13">
                                      <a style="white-space:nowrap" class="nav-link common-fill-hover demo-19-fill-down fixed-header-11-nopadding" href="#">More <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 18 10.64">
  <path id="arrow" d="M11.115,12.235,18,19.44l7.2-7.2,1.8,1.64-9,9-9-9Z" transform="translate(-9 -12.235)"/>
</svg> </a>
                                        <div class="dropdown-menu">
                                        <?php
