  ...
  <nav aria-label="breadcrumb">
      <div class="container">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Get Reward</li>
          </ol>
      </div>
    </nav>
</div> 
      ...
      <div class="modal-content">
          ...
          @endif
            ...
            <a href="{{ URL::to('/epoint')}}"><button class="tablinks-loyality"><i class="fa fa-star" aria-hidden="true" style="margin-right: 2px;"></i> @lang('website.eran_points')</button></a>
              <a class="active" href="{{ URL::to('/gpoint')}}"><button class="tablinks-loyality"><i class="fa fa-gift" aria-hidden="true" style="margin-right: 2px;"></i> @lang('website.get_rewards')</button></a>
              <a href="{{ URL::to('/accpoint')}}"><button class="tablinks-loyality"><i class="fa fa-briefcase" aria-hidden="true" style="margin-right: 2px;"></i> @lang('website.account')</button></a>
