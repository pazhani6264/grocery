    ...
    <div class="container">
      ...
      <div class="modal-content">
          ...
          @endif
            ...
            <div class="tab">
              <a class="active" href="{{ URL::to('/epoint')}}"><button class="tablinks-loyality"><i class="fa fa-star" aria-hidden="true" style="margin-right: 2px;"></i> @lang('website.eran_points')</button></a>
