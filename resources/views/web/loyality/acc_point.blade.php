...
#loginmyModalre .modal-content {
  width: 100%;
  padding: 0px;
  min-height: 600px;
    height: auto;
}
#loginmyModalre .mobile-close-button
{
  display: inline-block;
    padding: 10px 10px 12px 16px;
    font-size: 1.1em;
...
#loginmyModalre .tablinks-loyality {
    display: block;
    color: #fff;
    text-decoration: none;
...
#loginmyModalre .tabcontent-loyality1 {
  width: 100%;
  
}
#loginmyModalre .modal-header {
  padding: 10px;
...
#loginmyModalre .sidebar-points-value {
  font-size: 1.2em;
    display: inline-block;
    margin-right: 5px;
    
}
#loginmyModalre .sidebar-points-text {
  font-size: 1.2em;
  }

  #loginmyModalre .sidebar-points{
    text-align: right;
    padding: 10px;
    color: #fff !important;
    width: 100%;
...
#loginmyModalre .table > thead > tr > th, .table > tbody > tr > th, .table > tfoot > tr > th, .table > thead > tr > td, .table > tbody > tr > td, .table > tfoot > tr > td {
    padding: 10px !important;
}

#loginmyModalre tr:nth-child(even) {
  background-color: #dddddd !important;
}
#loginmyModalre .table thead {
  background-color: #dddddd
}

#loginmyModalre .table {
    background: #fff;
    margin-top: 10px;
}
.notifications {
...
#loginmyModalre .table-responsive {
  height: 548px;
    overflow-y: scroll;
}
...
#loginmyModalre .sidebar-points-value-tab {
    font-size: 1.1em;
    padding: 12px 5px 0 0;
}


#loginmyModalre .sidebar-points-tab {
    display: inline-block;
    color: #fff;
    margin-right: 20px;
}
#loginmyModalre .tab-right-headcon
{
  display: inline-block;
    width: 45%;
    text-align: right;
...
<div class="container-fuild">
 ...
 <!--My Order Content -->
 <section id="loginmyModalre" class="order-one-content pro-content">
    <div class="container">
      <div class="row">
      ...
      <div class="modal-content">
          ...
          @endif -->
            ...
            <!-- <div class="tab">
              <a href="{{ URL::to('/epoint')}}"><button class="tablinks-loyality"><i class="fa fa-star" aria-hidden="true" style="margin-right: 2px;"></i> @lang('website.eran_points')</button></a>
              <a href="{{ URL::to('/gpoint')}}"><button class="tablinks-loyality"><i class="fa fa-gift" aria-hidden="true" style="margin-right: 2px;"></i> @lang('website.get_rewards')</button></a>
              <a class="active" href="{{ URL::to('/accpoint')}}"><button class="tablinks-loyality"><i class="fa fa-briefcase" aria-hidden="true" style="margin-right: 2px;"></i> @lang('website.account')</button></a>
              <a href="{{ URL::to('/helppoint')}}"><button class="tablinks-loyality"><i class="fa fa-question-circle" aria-hidden="true" style="margin-right: 2px;"></i> @lang('website.help')</button></a>
            </div>
          </div> -->
...
<!-- <div class="tab loyalty-mobile-header-tab loyality-mobile-tab close-tab">
          ...
          <div class="modal-page-con">
            ...
            <div  class="tabcontent-loyality1">
                ...
                <div class="table-responsive get-pointhistory">
                  <table class="table" id="account_table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <th style="font-weight:400">{{date('d/m/Y', strtotime($jeshistory->created_at)) }}</th>
                        <th style="font-weight:400">Activity</th>
                        <th style="font-weight:400">{{$jeshistory->description}}</th>
                        <th style="font-weight:400">{{$jeshistory->points}}</th>
                        <th style="font-weight:400"><span class="history-approved common-bg">APPROVED</span></th>
                      </tr>
                      @endforeach
                      @endif
                    </tbody>
