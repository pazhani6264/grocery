      ...
      <div class="modal-content">
          ...
          @endif
            ...
            <div class="tab">
              ...
              <a class="active" href="{{ URL::to('/helppoint')}}"><button class="tablinks-loyality"><i class="fa fa-question-circle" aria-hidden="true" style="margin-right: 2px;"></i> @lang('website.help')</button></a>
            </div>
          </div>
