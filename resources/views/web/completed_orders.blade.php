...
<div class="container-fuild">
        ...
        <div class="row">
          ...
          <div class="wallet-desktop-main mobile-display-none-web">
            ...
            <div class="wallet-desktop-content-main">
              ...
              <form name="changePhone" action="{{ URL::to('/order_filter_completed')}}" class="align-items-center form-validate" enctype="multipart/form-data"  method="get" style="padding:0px !important">
              @csrf
                <div class="order-search-main">
                  ...
                  <div class="order-search2 select-control-search">
                    <input type="hidden" name="orders_status" class="form-control-search" placeholder="Completed" readonly value="2">
            ...
            ?>
                  ...
                  <div id="material-tabs" class="order-main-tab" style="padding-left:17px;background:#f8f8f8">
                    ...
                    <a style="font-size:12px;margin-right:25px"  href="{{ URL::to('/pending_orders')}}" class="order-table-title-normal"><i class="fas fa-bug" style="margin-right: 5px;"></i> Pending <div class="table-count">{{ count($result['pending']) }}</div></a>
                    <a style="font-size:12px;margin-right:25px"  href="{{ URL::to('/complete_orders')}}" class="order-table-title-normal profile-table-title"><i class="fas fa-list" style="margin-right: 5px;"></i> Completed <div class="table-count table-count-active">{{ count($result['completedCount']) }}</div></a>
                  </div>
                  <div class="tab-content" style="padding: 0px 0px !important;">
                    ...
                    <div id="tab3">
                      ...
                      <div class="table-top-header-left">showing {{ $result['completed']->firstItem() }} - {{ $result['completed']->lastItem() }} 0f {{ count($result['completedCount']) }} results</div>
                      ...
                      <table id="example" class="table order-table">
                        ...
                        <tbody>
                          ...
                          @foreach( $result['completed'] as $orders)
                          ...
                          <td></td>
                            ...
                            <td style="display:table-cell;" class="">
                                  @if($orders->orders_status_id == '2')
                                    <div>
                                      <span class="badge badge-primary" style="padding:0px !important"><div class="dot-badge-completed"></div> {{$orders->orders_status}}</span><br>
                      ...
                      <div class="col-xs-12" style="float:right;">
                        {!! $result['completed']->appends(Request::except('page'))->links() !!}
                      </div>
            ...
            <div  style="background:#fff;margin-left:0px;">
              ...
              @csrf
                ...
                <div id="material-tabs-mobile" class="order-main-tab" style="padding-left:10px;background:#f8f8f8;border: 1px solid #dad2d2;">
                  ...
                  <a style="font-size:13px;margin-right:15px;letter-spacing: 0px;"  href="{{ URL::to('/pending_orders')}}" class="order-table-title-normal"><i class="fas fa-bug" style="margin-right: 5px;"></i> PENDING <div class="table-count">{{ count($result['pending']) }}</div></a>
                  <a style="font-size:13px;letter-spacing: 0px;"  href="{{ URL::to('/complete_orders')}}" class="order-table-title-normal profile-table-title"><i class="fas fa-list" style="margin-right: 5px;"></i> COMPLETED <div class="table-count">{{ count($result['completedCount']) }}</div></a>
                </div>
                <div class="tab-content" style="padding: 0px 0px !important;">
                  @if(session()->has('success') )
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                  ...
                  <div id="tab6">
                    <div class="table-top-header">
                      <div class="table-top-header-left-mobile">{{ $result['completed']->firstItem() }} - {{ $result['completed']->lastItem() }} 0f {{ count($result['completedCount']) }} results</div>
  ...
  <script type="text/javascript">
    ...
    window.location.href="complete_orders?{!! $result['varr'] !!}&pagecnt="+vals;
    }
  </script>
