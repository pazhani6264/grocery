...
<div id="getnewest_loading6" ></div>

<div id="getnewest_product6"></div>

<script>

getallproductBynewest6();
  function getallproductBynewest6() {
    var type = 'newest';
    var content ='';
      ...
      jQuery('#getnewest_loading6').html(content);

    jQuery.ajax({
        url: '{{ URL::to("/getallproductBynewest6")}}',
        headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
        type: "POST",
        data: 'type='+type,
          success: function (res) { 
            jQuery('#getnewest_loading6').html(' ');
            jQuery('#getnewest_product6').html(res);
            getquerynewest6slick();
...
function getquerynewest6slick(){
jQuery(document).ready(function () {
  (function (jQuery) {
    var tabCarousel = jQuery('.recent-carousel-js6');
