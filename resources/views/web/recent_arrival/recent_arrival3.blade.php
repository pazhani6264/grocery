...
.ra3 .product-molla-20 article .thumb{
  height: 217px;
}

.ra3 .product-molla-20 article .content{
  height: 143px;
}
...
.container.newarrival-slick-dots.general-product.p-0.top-sell-arrow3.ra3 {
    text-align: center;
}
}
...
<div id="getnewest_loading" ></div>
  ...
  <script>
    getallproductBynewest3();
    function getallproductBynewest3() {
      var type = '2'
      var content ='';
      ...
      jQuery.ajax({
          url: '{{ URL::to("/getallproductBynewest3")}}',
...
function getqueryrecent3(){
jQuery(document).ready(function () {
  (function (jQuery) {
    var tabCarousel = jQuery('.newarrival-carousel-js3');
...
$(document).ready(function() {
  ...
  $('.p24-slider-cat-recent3').hide();
  $('#p24-slider-cat-recent3-0').show();

  $('.p24-tabs-nav-recent3').on('click', function (event) {
    event.preventDefault();
    
    $('.p24-tab-active-recent3').removeClass('p24-tab-active-recent3 trendactive');
    $(this).addClass('p24-tab-active-recent3 trendactive');
    var id = $(this).attr('id');
    $('.p24-slider-cat-recent3').hide();
    $('#p24-slider-cat-recent3-'+id).show();
...
{
  (function (jQuery) {
  var tabCarousel = jQuery('#p24-slider-cat-recent3-'+id);
