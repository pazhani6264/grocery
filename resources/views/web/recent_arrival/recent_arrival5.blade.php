...
.recent5 .btn-more:focus, .recent5 .btn-more:hover {
    color: #fff;
...
<div id="getnewest_loading" ></div>
  ...
  <script>
    getallproductBynewest5();
    function getallproductBynewest5() {
      var type = '2'
      var content ='';
      ...
      jQuery.ajax({
          url: '{{ URL::to("/getallproductBynewest5")}}',
