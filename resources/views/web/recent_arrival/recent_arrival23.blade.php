...
.banners-content .recentarrival13 .container-fluid{
...
<div id="getnewest_loading" ></div>
  ...
  <script>
    getallproductBynewest23();
    function getallproductBynewest23() {
      var type = '2'
      var content ='';
      ...
      jQuery.ajax({
          url: '{{ URL::to("/getallproductBynewest23")}}',
...
function getrecentarrival23(){
jQuery(document).ready(function () {
  (function (jQuery) {
    var tabCarousel = jQuery('.trendpro-carousel-js23');
