        ...
        <div class="wallet-desktop-main mobile-display-none-web">
            ...
            <div class="wallet-desktop-content-main">
              ...
              <div style="border-bottom:1px solid #eaeceb;margin-top:5px;">
                <div class="order-main-left">
                  <h3 style="padding:10px 0px 20px 0px;text-align:left;">Appointment</h3>
                </div>
              ...
              <form name="changePhone" action="{{ URL::to('/appointment_filter')}}" class="align-items-center form-validate" enctype="multipart/form-data"  method="get" style="padding:0px !important">
              @csrf
          ...
          ?>
                  ...
                  <div id="material-tabs" class="order-main-tab" style="padding-left:17px;background:#f8f8f8">
                    <a style="font-size:12px;margin-right:25px"  href="{{ URL::to('/view_appointment')}}" class="order-table-title-normal profile-table-title"><i class="fas fa-home" style="margin-right: 5px;"></i>All <div class="table-count table-count-active">{{ count($result['appointment_count']) }}</div></a>
                  ...
                  <div class="tab-content" style="padding: 0px 0px !important;">
                    ...
                    <div id="tab1">
                      <div class="table-top-header">
                        <div class="table-top-header-left">showing {{ $result['appointment']->firstItem() }} - {{ $result['appointment']->lastItem() }} 0f {{ count($result['appointment_count']) }} results</div>
                      ...
                      <div class="col-xs-12" style="float:right">
                          {!! $result['appointment']->appends(Request::except('page'))->links() !!}
                      </div>
                    </div>
                  </div>
...
<div class="desktop-display-none-web">
            ...
            <div  style="background:#fff;margin-left:0px;">
              ...
              @csrf
                ...
                <div id="material-tabs-mobile" class="order-main-tab" style="padding-left:10px;background:#f8f8f8;border: 1px solid #dad2d2;">
                  <a style="font-size:13px;margin-right:15px;letter-spacing: 0px;"  href="{{ URL::to('/view_appointment')}}" class="order-table-title-normal profile-table-title"><i class="fas fa-home" style="margin-right: 5px;"></i>ALL <div class="table-count table-count-active">{{ count($result['appointment_count']) }}</div></a>
                ...
                <div class="tab-content" style="padding: 0px 0px !important;">
                  ...
                  <div id="tab4">
                    <div class="table-top-header">
                      <div class="table-top-header-left-mobile">{{ $result['appointment']->firstItem() }} - {{ $result['appointment']->lastItem() }} 0f {{ count($result['appointment_count']) }} results</div>
                        ...
                        <a  href="{{ URL::to('/view_appointment_detail/'.$resappointment->appID)}}">
                          ...
                          <a  href="{{ URL::to('/view_appointment_detail/'.$resappointment->appID)}}">
                            <div class="order-mobile-main-title">
                              ...
                              <div class="order-mobile-main-title-right">{{ $resappointment->amount }}</div>
                            </div>
  ...
  <script type="text/javascript">
    ...
    window.location.href="view_appointment?{!! $result['varr'] !!}&pagecnt="+vals;
    }
  </script>
