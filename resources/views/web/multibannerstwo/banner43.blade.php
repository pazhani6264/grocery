...
<div id="getmultibannertwo_43_loading"></div>

  <div id="getmultibannertwo_43_product"></div>
  ...
  <script>
    ...
    function getbanner_43() {
      ...
      jQuery('#getmultibannertwo_43_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_43_loading').html(' ');
              jQuery('#getmultibannertwo_43_product').html(res);
