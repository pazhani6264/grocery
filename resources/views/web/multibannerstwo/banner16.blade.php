...
<div id="getmultibannertwo_16_loading"></div>

  <div id="getmultibannertwo_16_product"></div>

  <script>
    getbanner_16();
    function getbanner_16() {
      var type = '4'
      var content ='';
      ...
      jQuery('#getmultibannertwo_16_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getbanner_16")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_16_loading').html(' ');
              jQuery('#getmultibannertwo_16_product').html(res);
