...
<div id="getmultibannertwo_70_loading"></div>

  <div id="getmultibannertwo_70_product"></div>
  ...
  <script>
    ...
    function getbanner_70() {
      ...
      jQuery('#getmultibannertwo_53_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_70_loading').html(' ');
              jQuery('#getmultibannertwo_70_product').html(res);
              getbanner70script();
