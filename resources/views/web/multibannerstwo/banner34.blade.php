...
<div id="getmultibannertwo_34_loading"></div>

  <div id="getmultibannertwo_34_product"></div>

  <script>
    getmultibannertwo_34();
    function getmultibannertwo_34() {
      var type = '4'
      var content ='';
      ...
      jQuery('#getmultibannertwo_34_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_34_loading').html(' ');
              jQuery('#getmultibannertwo_34_product').html(res);
