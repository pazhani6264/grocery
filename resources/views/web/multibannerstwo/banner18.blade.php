...
<div id="getmultibannertwo_18_loading"></div>

  <div id="getmultibannertwo_18_product"></div>

  <script>
    getbanner_18();
    function getbanner_18() {
      var type = '4'
      var content ='';
      ...
      jQuery('#getmultibannertwo_18_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getbanner_18")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_18_loading').html(' ');
              jQuery('#getmultibannertwo_18_product').html(res);
