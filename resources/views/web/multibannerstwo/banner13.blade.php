...
<div id="getmultibannertwo_13_loading"></div>

  <div id="getmultibannertwo_13_product"></div>
  ...
  <script>
    ...
    function getbanner_13() {
      ...
      jQuery('#getmultibannertwo_13_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_13_loading').html(' ');
              jQuery('#getmultibannertwo_13_product').html(res);
