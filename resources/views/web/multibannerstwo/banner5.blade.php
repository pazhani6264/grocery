...
<div id="getmultibannertwo_5_loading"></div>

  <div id="getmultibannertwo_5_product"></div>
  ...
  <script>
    ...
    function getbanner_5() {
      ...
      jQuery('#getmultibannertwo_5_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_5_loading').html(' ');
              jQuery('#getmultibannertwo_5_product').html(res);
