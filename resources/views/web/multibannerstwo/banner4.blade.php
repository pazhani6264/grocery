...
<div id="getmultibannertwo_4_loading"></div>

  <div id="getmultibannertwo_4_product"></div>

  <script>
    getbanner_4();
    function getbanner_4() {
      var type = '4'
      var content ='';
      ...
      jQuery('#getmultibannertwo_4_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getbanner_4")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_4_loading').html(' ');
              jQuery('#getmultibannertwo_4_product').html(res);
