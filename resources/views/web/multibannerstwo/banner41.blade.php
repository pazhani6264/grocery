...
<div id="getmultibannertwo_41_loading"></div>

  <div id="getmultibannertwo_41_product"></div>
  ...
  <script>
    ...
    function getbanner_41() {
      ...
      jQuery('#getmultibannertwo_41_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_41_loading').html(' ');
              jQuery('#getmultibannertwo_41_product').html(res);
              getmultibannertwo41script();
        ...
        function getmultibannertwo41script(){
