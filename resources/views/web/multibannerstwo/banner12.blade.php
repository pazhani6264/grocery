...
<div id="getmultibannertwo_12_loading"></div>

  <div id="getmultibannertwo_12_product"></div>

  <script>
    getbanner_12();
    function getbanner_12() {
      var type = '4'
      var content ='';
      ...
      jQuery('#getmultibannertwo_12_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getbanner_12")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_12_loading').html(' ');
              jQuery('#getmultibannertwo_12_product').html(res);
