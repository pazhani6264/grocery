...
<div id="getmultibannertwo_38_loading"></div>

  <div id="getmultibannertwo_38_product"></div>

  <script>
    getmultibannertwo_38();
    function getmultibannertwo_38() {
      var type = '4'
      var content ='';
      ...
      jQuery('#getmultibannertwo_38_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_38_loading').html(' ');
              jQuery('#getmultibannertwo_38_product').html(res);
