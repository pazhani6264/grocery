...
<div id="getmultibannertwo_17_loading"></div>

  <div id="getmultibannertwo_17_product"></div>
  ...
  <script>
    ...
    function getbanner_17() {
      ...
      jQuery('#getmultibannertwo_17_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_17_loading').html(' ');
              jQuery('#getmultibannertwo_17_product').html(res);
