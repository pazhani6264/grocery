...
<div id="getmultibannertwo_21_loading"></div>

  <div id="getmultibannertwo_21_product"></div>

  <script>
    getbanner_21();
    function getbanner_21() {
      var type = '4';
      var content ='';
      ...
      jQuery('#getmultibannertwo_21_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getbanner_21")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_21_loading').html(' ');
              jQuery('#getmultibannertwo_21_product').html(res);
