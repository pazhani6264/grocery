<!-- //banner six -->
<style>
    #getmultibannertwo_62_product .btn-outline-white {
    border: 2px solid;
    min-width: 140px;
...
#getmultibannertwo_62_product .btn-outline-white:hover, #getmultibannertwo_62_product .btn-outline-white:not(:disabled):not(.disabled).active, #getmultibannertwo_62_product .btn-outline-white:not(:disabled):not(.disabled):active, .show>.btn-outline-white.dropdown-toggle {
    color: #000 !important;
...
<div id="getmultibannertwo_62_loading"></div>

  <div id="getmultibannertwo_62_product"></div>

  <script>
    getmultibannertwo_62();
    function getmultibannertwo_62() {
      var type = '4'
      var content ='';
      ...
      jQuery('#getmultibannertwo_62_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_62_loading').html(' ');
              jQuery('#getmultibannertwo_62_product').html(res);
