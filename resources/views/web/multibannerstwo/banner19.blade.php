...
<div id="getmultibannertwo_19_loading"></div>

  <div id="getmultibannertwo_19_product"></div>
  ...
  <script>
    ...
    function getbanner_19() {
      ...
      jQuery('#getmultibannertwo_19_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_19_loading').html(' ');
              jQuery('#getmultibannertwo_19_product').html(res);
