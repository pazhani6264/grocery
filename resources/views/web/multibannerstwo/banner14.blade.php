...
<div id="getmultibannertwo_14_loading"></div>

  <div id="getmultibannertwo_14_product"></div>
  ...
  <script>
    ...
    function getbanner_14() {
      ...
      jQuery('#getmultibannertwo_14_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_14_loading').html(' ');
              jQuery('#getmultibannertwo_14_product').html(res);
