...
<div id="getmultibannertwo_9_loading"></div>

  <div id="getmultibannertwo_9_product"></div>

  <script>
    getbanner_9();
    function getbanner_9() {
      var type = '4'
      var content ='';
      ...
      jQuery('#getmultibannertwo_9_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getbanner_9")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_9_loading').html(' ');
              jQuery('#getmultibannertwo_9_product').html(res);
