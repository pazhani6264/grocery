...
<div id="getmultibannertwo_68_loading"></div>

  <div id="getmultibannertwo_68_product"></div>

  <script>
    getmultibannertwo_68();
    function getmultibannertwo_68() {
      var type = '4'
      var content ='';
      ...
      jQuery('#getmultibannertwo_68_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#ggetmultibannertwo_68_loading').html(' ');
              jQuery('#getmultibannertwo_68_product').html(res);
