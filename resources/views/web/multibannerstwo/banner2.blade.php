...
<div id="getmultibannertwo_2_loading"></div>

  <div id="getmultibannertwo_2_product"></div>
  ...
  <script>
    ...
    function getbanner_2() {
      ...
      jQuery('#getmultibannertwo_2_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_2_loading').html(' ');
              jQuery('#getmultibannertwo_2_product').html(res);
