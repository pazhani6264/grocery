...
<div id="getmultibannertwo_8_loading"></div>

  <div id="getmultibannertwo_8_product"></div>
  ...
  <script>
    ...
    function getbanner_8() {
      ...
      jQuery('#getmultibannertwo_8_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_8_loading').html(' ');
              jQuery('#getmultibannertwo_8_product').html(res);
