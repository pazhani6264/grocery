...
<div id="getmultibannertwo_15_loading"></div>

  <div id="getmultibannertwo_15_product"></div>
  ...
  <script>
    ...
    function getbanner_15() {
      ...
      jQuery('#getmultibannertwo_15_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_15_loading').html(' ');
              jQuery('#getmultibannertwo_15_product').html(res);
