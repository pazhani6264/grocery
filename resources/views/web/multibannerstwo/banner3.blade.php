...
<div id="getmultibannertwo_3_loading"></div>

  <div id="getmultibannertwo_3_product"></div>
  ...
  <script>
    ...
    function getbanner_3() {
      ...
      jQuery('#getmultibannertwo_3_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_3_loading').html(' ');
              jQuery('#getmultibannertwo_3_product').html(res);
