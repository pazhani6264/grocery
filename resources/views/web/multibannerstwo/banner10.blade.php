...
<div id="getmultibannertwo_10_loading"></div>

  <div id="getmultibannertwo_10_product"></div>
  ...
  <script>
    ...
    function getbanner_10() {
      ...
      jQuery('#getmultibannertwo_10_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_10_loading').html(' ');
              jQuery('#getmultibannertwo_10_product').html(res);
