...
<div id="getmultibannertwo_53_loading"></div>

  <div id="getmultibannertwo_53_product"></div>
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_53_loading').html(' ');
              jQuery('#getmultibannertwo_53_product').html(res);
              getbanner41script();
