...
<div id="getmultibannertwo_33_loading"></div>

  <div id="getmultibannertwo_33_product"></div>
  ...
  <script>
    ...
    function getbanner_33() {
      ...
      jQuery('#getmultibannertwo_33_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_33_loading').html(' ');
              jQuery('#getmultibannertwo_33_product').html(res);
