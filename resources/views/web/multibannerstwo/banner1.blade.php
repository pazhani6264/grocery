...
<div id="getmultibannertwo_1_loading"></div>

  <div id="getmultibannertwo_1_product"></div>

  <script>
    getbanner_1();
    function getbanner_1() {
      var type = '4'
      var content ='';
      ...
      jQuery('#getmultibannertwo_1_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getbanner_1")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_1_loading').html(' ');
              jQuery('#getmultibannertwo_1_product').html(res);
