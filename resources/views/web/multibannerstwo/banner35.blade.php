...
<div id="getmultibannertwo_35_loading"></div>

  <div id="getmultibannertwo_35_product"></div>

  <script>
    getmultibannertwo_35();
    function getmultibannertwo_35() {
      var type = '4'
      var content ='';
      ...
      jQuery('#getmultibannertwo_35_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_35_loading').html(' ');
              jQuery('#getmultibannertwo_35_product').html(res);
