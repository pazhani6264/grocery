...
<div id="getmultibannertwo_6_loading"></div>

  <div id="getmultibannertwo_6_product"></div>
  ...
  <script>
    ...
    function getbanner_6() {
      ...
      jQuery('#getmultibannertwo_6_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_6_loading').html(' ');
              jQuery('#getmultibannertwo_6_product').html(res);
