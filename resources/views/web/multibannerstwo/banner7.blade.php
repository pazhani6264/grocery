...
<div id="getmultibannertwo_7_loading"></div>

  <div id="getmultibannertwo_7_product"></div>

  <script>
    getbanner_7();
    function getbanner_7() {
      var type = '4'
      var content ='';
      ...
      jQuery('#getmultibannertwo_7_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getbanner_7")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_7_loading').html(' ');
              jQuery('#getmultibannertwo_7_product').html(res);
