...
<div id="getmultibannertwo_11_loading"></div>

  <div id="getmultibannertwo_11_product"></div>
  ...
  <script>
    ...
    function getbanner_11() {
      ...
      jQuery('#getmultibannertwo_11_loading').html(content);
      ...
      jQuery.ajax({
          ...
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getmultibannertwo_11_loading').html(' ');
              jQuery('#getmultibannertwo_11_product').html(res);
