      ...
      <div class="col-lg-4">
          <table class="table">
              <thead>
                <td align="center">
                  <div class="img-div">
                  @if($products['product_data'][0]->image_path_type == 'aws')
                ...
                <tr>
                  <td>
                    <div class="detail-buttons">
                        <a href="{{ URL::to('/product-detail/'.$products['product_data'][0]->products_slug)}}" class="btn btn-secondary swipe-to-top">View Details</a>
