...
.footer15  .input-group .form-control {
...
@endphp
<footer class="footer footer-molla footer-black  padding-top-32 footer-2 footer15 d-none d-lg-block d-xl-block footer-mb-100">
      ...
      <div class="row">
            ...
            <div class="widget-about-info">
              <div class="row">
                <div class="col-sm-6 col-md-4" style="padding-right:0px">
                  ...
                  <a class="footer-black-phone" href="tel:{{$result['commonContent']['setting'][11]->value}}">{{$result['commonContent']['setting'][11]->value}}</a>
                </div>
        ...
        <div class="col-sm-6 col-lg-2">
          <div class="widget widget-newsletter">
            ...
            <p style="line-height: 2;">Aliquam erat volutpat. Nam dui mi, tincidunt quis, accumsan.</p>
            <form class=" mailchimp-form" action="{{url('subscribeMail')}}">
              <div class="input-group">
                <input style="padding: 0.375rem 1rem;" type="email" name="email" class="form-control" placeholder="Enter your Email Address" aria-label="Email Adress" required="">
              <div class="input-group-append">
                <button class="btn btn-dark" id="mc-embedded-subscribe" type="submit"><i class="fa fa-arrow-right"></i></button>
              </div>
            </form>
          </div>
        </div>
