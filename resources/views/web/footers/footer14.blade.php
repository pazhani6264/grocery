...
.common-hover-white:hover{
  ...
  .footer14 .widget-list li {
    margin-bottom: 0.7rem;
    font-size: 0.9rem;
}
.footer14 .widget-list li > a {
    font-weight:400 !important;
}
.footer14 .widget-about p {
    font-weight:400 !important;
    font-size: 0.9rem;
    max-width:250px;
    line-height: 2em;
}
.footer14 .social-icon {
    justify-content: center;
    font-size: 1.1rem;
}
.footer14 .footer-copyright {
  font-size:0.9rem;
  }
...
@endphp
<footer class="footer footer-molla footer-black  footer-2 f14 footer14 d-none d-lg-block d-xl-block footer-mb-100">
  ...
  <div class="footer-bottom text-center">
    <div class="container">
      ...
      <div class="footerpayemnt-14" style="margin-top:40px">
      ...
      <p class="footer-copyright" style="text-align:center !important">Copyright © @lang('website.Copy Rights') <a style="color:#777;font-weight:400 !important" href="https://platinum24.net/" target="_blank">Platinum24, Inc</a> .All Rights Reserved.</p>
    </div>
  </div>
