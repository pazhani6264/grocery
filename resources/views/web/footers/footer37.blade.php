<style>
  .footer-2  .footer-bottom .container-fluid:before, .footer-2  .footer-bottom .container:before {
    content: "";
    display: block;
    height: 1px;
    position: absolute;
...
.footer-2  .footer-middle .container-fluid:before, .footer-2  .footer-middle .container:before {
    content: "";
    display: block;
    height: 1px;
    position: absolute;
...
@endphp
<footer class="footer footer-molla  footer-2  d-none d-lg-block d-xl-block footer-mb-100">

  <div class="footer-middle" style="position:relative">
      ...
      <div class="row">
        <div class="col-sm-12 col-lg-5">
          ...
          @if($result['commonContent']['settings']['sitename_logo']=='logo')
              ...
              @endif
            @endif
            <p style="line-height:2;max-width:35em">{{$result['commonContent']['setting'][111]->value}}</p>
            <div class="widget-about-info">
              <div class="row">
                <div class="col-sm-6 col-md-4">
                  <span class="widget-about-title">Got Question? Call us 24/7</span>
                  <a class="common-hover" style="font-size:20px;" href="tel:{{$result['commonContent']['setting'][11]->value}}">{{$result['commonContent']['setting'][11]->value}}</a>
                </div>
        ...
        <div class="col-sm-4 col-lg-2">
          <div class="widget">
            ...
            <ul class="widget-list">
              ...
              <li> <span><b><strong>Email : </strong></b></span> <br> <span style="width: 100%;"><a style="color:#777 !important" class="email-font" href="mailto:{{$result['commonContent']['setting'][3]->value}}">{{$result['commonContent']['setting'][3]->value}}</a> </span> </li>
            </ul>
          </div>
        </div>
  ...
  <div class="footer-bottom">
    <div class="container-fluid">
      <p class="footer-copyright">Copyright © @lang('website.Copy Rights') <a style="color:#777 !important" href="https://platinum24.net/" target="_blank">Platinum24, Inc</a> . All Rights Reserved.</p>
