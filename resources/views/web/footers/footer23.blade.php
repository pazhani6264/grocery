...
@endphp
<footer class="footer footer-molla footer-black footer-area padding-top-15 footer-2 f23 footer-dark d-none d-lg-block d-xl-block footer-mb-100" style="background-color:#222 !important">
  <div class="footer-middle">
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-6 col-lg-3">
          <div class="widget">
            <h4 class="widget-title" style="text-transform:uppercase">Information</h4>
        ...
        <div class="col-sm-6 col-lg-3">
          <div class="widget">
            <h4 class="widget-title" style="text-transform:uppercase">Customer Service</h4>
            <ul class="widget-list">
        ...
        <div class="col-sm-6 col-lg-3">
          <div class="widget">
            <h4 class="widget-title" style="text-transform:uppercase">My Account</h4>
            <ul class="widget-list">
