...
@endphp
<footer id="footerEight"  class="footer-area footer-eight footer-desktop d-none d-lg-block d-xl-block footer-mb-100">
      ...
      <div class="col-12 col-lg-3">
        <div class="contacts">
          ...
          <ul class="contact-list  pl-0 mb-0">
            ...
            <li> <i class="fas fa-location-arrow"></i><span style="width: 100%;">{{$result['commonContent']['setting'][4]->value}} {{$result['commonContent']['setting'][5]->value}} {{$result['commonContent']['setting'][6]->value}}, {{$result['commonContent']['setting'][7]->value}} {{$result['commonContent']['setting'][8]->value}}</span> </li>
