<style>
.mobile-footer16 .footer-bottom .social-icon {
  height:3rem;
}
.mobile-footer16 .footer-menu {
    margin-bottom: 1rem;
}
  </style>
...
<footer class="mobile-footer16 footer footer-molla footer-2 f16 footer-16 d-lg-none d-xl-none">
      ...
      <div class="row">
        <div class="col-sm-12 col-lg-6">
          ...
          @if($result['commonContent']['settings']['sitename_logo']=='logo')
              ...
              @endif
            @endif
            <p style="line-height:2;margin-bottom:2rem">{{$result['commonContent']['setting'][111]->value}}</p>
