...
@endphp
<footer class="footer footer-molla footer-black  padding-top-25 footer-2 f16 footer-16 d-none d-lg-block d-xl-block footer-mb-100">
              ...
              <div class="row">
                ...
                <div class="col-sm-6 col-md-7">
                  ...
                  <figure class="footer-payments">
                    <img src="{{asset('web/images/miscellaneous/payments.png')}}" alt="Payment methods" width="100%" height="20">
                  </figure>
                </div>
              </div>
            </div>
