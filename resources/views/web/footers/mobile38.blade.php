...
@endphp
<footer class="footer footer-molla footer-black footer-2 f12 footer-dark d-lg-none d-xl-none">

<section class="boxes-contents info-bg-6 text-center">
         <div class="container" style="padding-left:10px;">
         <div class="row" style="padding:3rem 0 2rem 0;">
         <?php 
          ...
          <div class="col-sm-6">
             <div class="info-box first slick demo-24-pad-info">
            <div class="panel">
            <?php if($info->type==1) { ?>
