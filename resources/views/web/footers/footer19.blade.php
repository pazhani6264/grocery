...
@endphp
<footer class="footer footer-molla  padding-top-15 footer-2 footer34 d-none d-lg-block d-xl-block footer-mb-100">
      ...
      <div class="row">
        <div class="col-sm-6 col-lg-3">
          ...
          @if($result['commonContent']['settings']['sitename_logo']=='logo')
              ...
              @endif
            @endif
            <p style="line-height:30px;text-align: justify;">{{$result['commonContent']['setting'][111]->value}}</p>
            <div class="widget-call"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 25.175 26.863">
...
</svg>Got Question? Call us 24/7<br>
