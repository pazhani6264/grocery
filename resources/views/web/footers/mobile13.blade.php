...
@endphp
<footer class="footer footer-molla footer-2 footer13 d-lg-none d-xl-none">
      ...
      <div class="row">
        <div class="col-sm-6 col-lg-3">
          ...
          @if($result['commonContent']['settings']['sitename_logo']=='logo')
            ...
            <div class="widget-call"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 25.175 26.863">
