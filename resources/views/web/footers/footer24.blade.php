...
.footer24 .subscribe input{
  padding:.8rem 0 .8rem 2.2rem;
}
.footer14 .heading-title{
  font-size:30px;
  color:#fff;
}
</style>
...
@endphp
<footer class="footer footer-molla footer-black footer-area footer-2 footer14 footer24 f24 d-none d-lg-block d-xl-block footer-mb-100">
