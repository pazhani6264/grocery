  ...
  @media only screen and (max-width: 992px)
{
  ...
  .footer-34-mobile-section {
    margin-top: 20px;
    margin-left: -40px;
    margin-left: calc(var(16px)*-1);
    margin-right: -40px;
    margin-right: calc(var(16px)*-1);
    padding: 20px 40px 0;
    padding: 20px var(16px) 0;
    border-top: 1px solid;
    border-top-color: #08409e;
}
.footer-34-blocks-mobile {
    display: flex;
    flex-wrap: wrap;
    justify-content: center;
}
.footer-34-block, .footer-34-block-mobile {
    max-width: none;
    flex: 1 1 50%;
}
  .footer-34-block[data-type=contact], .footer-34-block[data-type=payment] {
    flex: 1 0 100%;
}
  ...
  .footer-34-footer-newsletter form {
    width: 100%;
    margin: 20px auto 0;
}
  .padlr20
...
@endphp
<footer class="footer footer-molla footer-2 footer33 d-lg-none d-xl-none">
        ...
        <form action="{{url('subscribeMail')}}"  class="mailchimp-form padlr20 d-flex justify-content-end justify-content-center">
          ...
          <input style="height: calc(3rem + 5px);" type="email" name="email" class="form-control footer-34-input mr-0 font-weight-normal border-0" placeholder="Enter your Email" aria-label="Email Adress" required="">
            <div class="input-group-append">
              <button id="mc-embedded-subscribe" class="btn footer-34-btn-outer" type="submit"><i  class="fa fa-long-arrow-right mr-0 mt-0 subscribe-1-text-mobile"></i></button>
            </div>
