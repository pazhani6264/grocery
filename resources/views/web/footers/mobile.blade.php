...
<footer id="footerMobile" class="footer-area footer-mobile d-lg-none d-xl-none">
        ...
        <div class="col-12 col-md-4">
          <div class="single-footer">
            ...
            <ul class="contact-list  pl-0 mb-0">
              ...
              <li> <i class="fas fa-envelope"></i><span style="width: 100%;"> <a href="mailto:sales@brandbychoice.com">{{$result['commonContent']['setting'][3]->value}}</a> </span> </li>
  ...
  <button type="button" id="subscribe" class="btn btn-secondary fixedbutton" data-toggle="modal" style="border-top-left-radius: 5px;border-top-right-radius: 5px; padding: 10px 15px !important" data-target="
