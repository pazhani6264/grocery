...
@endphp
<footer class="footer footer-molla footer-2 footer14 footer24 f24 d-lg-none d-xl-none">
    ...
    <section class="subscribe" style="border-bottom:.1rem solid #444;padding-bottom:3rem">
      ...
      <form  class=" mailchimp-form" action="{{url('subscribeMail')}}" >
        <div class="input-group">
          ...
          <div class="input-group-append" style="margin:auto !important">
            <button class="btn btn-subscribe" id="mc-embedded-subscribe" type="submit" style="padding:12px !important">
              <span>Subscribe</span>
            </button>
          </div>
