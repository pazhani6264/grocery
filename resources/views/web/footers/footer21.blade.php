...
.footer-middle .container-fluid:before {
    content: "";
    display: block;
    height: 1px;
    position: absolute;
...
@endphp
<footer class="footer footer-molla  footer-2 f21 d-none d-lg-block d-xl-block footer-mb-100">
      ...
      <div class="row">
        <div class="col-sm-12 col-lg-5">
          ...
          @if($result['commonContent']['settings']['sitename_logo']=='logo')
              ...
              @endif
            @endif
            <p style="line-height:2;max-width:500px">{{$result['commonContent']['setting'][111]->value}}</p>
            <div class="widget-about-info">
              <div class="row">
                <div class="col-sm-6 col-md-4">
                  <span class="widget-about-title">Got Question? Call us 24/7</span>
                  <a class="phone-font-size" href="tel:{{$result['commonContent']['setting'][11]->value}}">{{$result['commonContent']['setting'][11]->value}}</a>
                </div>
                <div class="col-sm-6 col-md-7">
                  <span class="widget-about-title">Payment Method</span>
                  <figure class="footer-payments">
                    <img width="100%" src="{{asset('web/images/miscellaneous/payments.png')}}" alt="Payment methods" width="100%" height="20">
                  </figure>
                </div>
              </div>
            </div>
