...
@endphp
<footer class="footer footer-molla footer-area footer-2 footer13 d-none d-lg-block d-xl-block footer-mb-100">
      ...
      <div class="row">
        <div class="col-sm-6 col-lg-3">
          ...
          @if($result['commonContent']['settings']['sitename_logo']=='logo')
              ...
              @endif
            @endif
            <p style="text-align: justify;">{{$result['commonContent']['setting'][111]->value}}</p>
            <div class="widget-call common-fill"> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 25.175 26.863">
        ...
        <div class="col-sm-6 col-lg-3">
          <div class="widget">
            ...
            <ul class="widget-list">
              ...
              <li> <span style="width: 100%;"><b><strong>Email : </strong></b></span> <br> <span><a class="email-font" href="mailto:{{$result['commonContent']['setting'][3]->value}}">{{$result['commonContent']['setting'][3]->value}}</a> </span> </li>
            </ul>
          </div>
        </div>
      </div>
