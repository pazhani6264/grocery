...
@endphp
 <footer id="footerThree"  class="footer-area footer-three footer-desktop d-none d-lg-block d-xl-block footer-mb-100">
    <div class="container">
      <div class="row">
                      ...
                      <form class="form-inline mailchimp-form" action="{{url('subscribeMail')}}" >
                          <div class="search-field-module"> 
                            ...
                            <div class="search-field-wrap">
                              ...
                              <button type="submit" class="btn btn-secondary swipe-to-top" data-toggle="" 
