...
.footer32 .cta-horizontal-box .btn {
...
@endphp
<footer class="footer footer-molla footer-black footer-2 footer32 d-none d-lg-block d-xl-block footer-mb-100">

  <div class="cta cta-horizontal bg-32 cta-horizontal-box pt-1-5 pb-1-5">
    <div class="container">
            ...
            <div class="col-lg-6">
              <form action="{{url('subscribeMail')}}"  class="mailchimp-form d-flex justify-content-end justify-content-center">
                <div class="input-group">
                  <input type="email" name="email" class="form-control demo-33-sub-height mr-0 font-weight-normal border-0" placeholder="Enter your Email Address" aria-label="Email Adress" required="">
  ...
  <div class="footer-middle" style="padding-top:40px;border:none !important">
            ...
            <div class="widget-about-info">
              <div class="row">
                <div class="col-sm-6 col-md-6">
                  ...
                  <a class="" style="font-size:20px;" href="tel:{{$result['commonContent']['setting'][11]->value}}">{{$result['commonContent']['setting'][11]->value}}</a>
                </div>
                <div class="col-sm-6 col-md-6">
  ...
  <div class="footer-bottom">
    <div class="container-fluid">
      <p class="footer-copyright">Copyright © @lang('website.Copy Rights') <a href="https://platinum24.net/" target="_blank" style="color: #777;">Platinum24, Inc</a> . All Rights Reserved.</p>
