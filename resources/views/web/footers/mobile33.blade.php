        ...
        <div class="col-md-12">
          <div class="row align-items-center">
            <div class="col-lg-6 cta-txt text-lg-left text-center">
              <h3 class="cta-title text-comm-color my-2 mt-0">Join Our Newsletter</h3>
            ...
            <div class="col-lg-6">
              <form action="{{url('subscribeMail')}}"  class="mailchimp-form d-flex demo-33-sub-width-outer justify-content-end justify-content-center">
                <div class="input-group">
                  <input type="email" name="email" class="form-control mr-0 font-weight-normal demo-33-sub-height demo-33-sub-width  border-0" placeholder="Enter your Email Address" aria-label="Email Adress" required="">
