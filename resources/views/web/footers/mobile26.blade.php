...
@endphp
<footer class="footer footer-molla footer-2 footer26 d-lg-none d-xl-none">  
            ...
            <div class="widget-about-info">
              <div class="row">
                <div class="col-sm-6 col-md-4">
                  ...
                  <a class="text-white" style="font-size:17px;" href="tel:{{$result['commonContent']['setting'][11]->value}}">{{$result['commonContent']['setting'][11]->value}}</a>
                </div>
  ...
  <div class="footer-bottom">
    <div class="container-fluid">
      <p class="footer-copyright tabw-100">Copyright © 2021 Platinum Code Sdn Bhd . All Rights Reserved.</p>
