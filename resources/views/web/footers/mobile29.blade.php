...
@endphp
<footer class="footer footer-molla footer-2  footer29 f29 d-lg-none d-xl-none" style="background-color:#222 !important">
  <div class="footer-middle">
    ...
    <section class="subscribe ">
      ...
      <form class=" mailchimp-form" action="{{url('subscribeMail')}}" >
        ...
        <input style="border-top-left-radius:30px;border-bottom-left-radius:30px;width:50%;padding:1rem;" type="email" name="email" placeholder="@lang('website.Your email address here')" aria-label="Email Adress" required="">
          <div class="input-group-append">
          <button style="border-top-right-radius:30px;border-bottom-right-radius:30px;margin-top: 0px;padding: 1rem;" class="btn btn-subscribe text-comm-color" id="mc-embedded-subscribe" type="submit">
              <span>Subscribe</span>
            </button>
          </div>
      ...
      <div class="row footer-22-padd">
        <div class="col-sm-6 col-lg-3">
          <div class="widget widget-about">
            <h4 class="widget-title text-white">About P24</h4>
