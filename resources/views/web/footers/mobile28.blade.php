...
@endphp
<footer class="footer footer-molla footer-2 footer25 d-lg-none d-xl-none">

  <div class="footer-middle footer25-top-border">
      ...
      <div class="row">
        <div class="col-sm-12 col-lg-5">
          ...
          @if($result['commonContent']['settings']['sitename_logo']=='logo')
            ...
            <div class="widget-about-info col-12">
              <div class="row">
                <div class="col-6 col-sm-6 col-md-5">
                  <span class="widget-about-title">Got Question? Call us 24/7</span>
                  <a style="font-size:20px;color:#fff;" href="tel:{{$result['commonContent']['setting'][11]->value}}">{{$result['commonContent']['setting'][11]->value}}</a>
                </div>
                <div class="col-6 col-sm-6 col-md-7">
                  <span class="widget-about-title">Payment Method</span>
                  <figure class="footer-payments">
                    <img src="{{asset('web/images/miscellaneous/payments.png')}}" alt="Payment methods" width="100%" height="auto">
                  </figure>
                </div>
              </div>
            </div>
