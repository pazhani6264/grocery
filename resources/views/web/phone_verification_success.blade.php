            ...
            <div  style="background:#fff;padding-top: 10px;margin-left:18px;">
              ...
              <div class="tab-content" style="padding: 20px 10px !important;">
                ...
                <div id="tab3">
                 ...
                 <div class="profile-phone-ver-success-main btn-secondary">
                  <i class="fa fa-check tick-icon"></i>
                 </div>
                  <div class="profile-phone-ver-cont-success">Your new phone number {{ $cphone }} <br> verified Successfully</div>
                  <div class="profile-phone-ver-success">
                    <a href="{{ URL::to('/profile')}}"><button type="submit" class="profile-phone-ver-success-but btn-secondary">Done</button></a>
                  </div>
                </div>
              </div>
