...
.top12 .ajax_product_38 {
    margin-top: 0px;
    margin-bottom: 0px !important;
}


.top12 .top-sell-arrow3 .slick-slide {
    outline: none;
...
.top-carousel-js12 .banner .banner-content {
    left: 0;
}
.top-carousel-js12 .banner-content {
    padding: 115.6% 2rem 0;
}
.top-carousel-js12 .banner-title {
    font-size: 1.15rem;
    letter-spacing: -.01em;
}
.banner-title {
...
<div id="gettopselling_loading"></div>
  ...
  <script>
    getallproductBytopselling12();
    function getallproductBytopselling12() {
      var type = 'topselling'
      var content ='';
      ...
      jQuery.ajax({
          url: '{{ URL::to("/getallproductBytopselling12")}}',
...
function getquerytop12(){
/* jQuery(document).ready(function () {
  (function (jQuery) {
    var tabCarousel = jQuery('.top-carousel-js12');
...
$(document).ready(function() {
  ...
  $('.p24-slider-cat-top12').hide();
  $('#p24-slider-cat-top12-0').show();

  $('.p24-tabs-nav-top12').on('click', function (event) {
    event.preventDefault();
    
    $('.p24-tab-active-top12').removeClass('p24-tab-active-top12 trendactive');
    $(this).addClass('p24-tab-active-top12 trendactive');
    var id = $(this).attr('id');
    $('.p24-slider-cat-top12').hide();
    $('#p24-slider-cat-top12-'+id).show();
...
function callslider_script(id)
{
  ...
  (function (jQuery) {
  var tabCarousel = jQuery('#p24-slider-cat-top12-'+id);
