...
.demo-33-top-4-section .product-molla-33 {
    margin-bottom: 20px;
    margin-top: 0px;
}
...
.demo-33-top-4-section  .border-20 {
...
.demo-33-top-4-section .ajax_product_33 article .content {
...
<div id="gettopselling_9_loading"></div>

  <div id="gettopselling_9_product"></div>

  <script>
    getallproductBytopselling9();
    function getallproductBytopselling9() {
      var type = 'topselling'
      var content ='';
      ...
      jQuery('#gettopselling_9_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getallproductBytopselling9")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#gettopselling_9_loading').html(' ');
              jQuery('#gettopselling_9_product').html(res);
