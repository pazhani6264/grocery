...
<div id="gettabcontent_loading"></div>
  ...
  <script>
    ...
    function getalltabcontent() {
      var type = 'tab'
      var content ='';

      content +='  <section class="new-products-content pro-content" style="margin-top:30px;"><div class="container" style="background:#fff"><div class="products-area"><div class="row justify-content-center"><div class="col-12 col-lg-12"><div class="pro-heading-title mtb30 p-0"><h2  class="title_change">WELCOME TO STORE</h2><div class="content_loading"><div class="dot"></div><div class="dot"></div><div class="dot"></div></div></div></div></div></div></div></section>';
      jQuery('#gettabcontent_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getalltabcontent")}}',
...
$(document).ready(function() {
  ...
  $('.p24-slider-cat-tab1').hide();
  $('#p24-slider-cat-tab1-'+$cu_id).show();

  $('.p24-tabs-nav-tab1').on('click', function (event) {
    event.preventDefault();
   
    $('.p24-tab-active-tab1').removeClass('p24-tab-active-tab1 active show');
    $(this).addClass('p24-tab-active-tab1 active show');
  
    var id = $(this).attr('id');
    $('.p24-slider-cat-tab1').hide();
    $('#p24-slider-cat-tab1-'+id).show();
...
function callslider_script(id)
{
  ...
  (function (jQuery) {
  var tabCarousel = jQuery('#p24-slider-cat-tab1-'+id);
