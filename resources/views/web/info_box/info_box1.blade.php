...
<div id="getinfobox_1_loading" ></div>

  <div id="getinfobox_1_product"></div>

  <script>
    getinfobox_1();
    function getinfobox_1() {
      var type = '1'
      var content ='';
      ...
      jQuery('#getinfobox_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getinfobox_1")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getinfobox_1_loading').html(' ');
              jQuery('#getinfobox_1_product').html(res);
