...
<div id="getinfobox_10_loading" ></div>

  <div id="getinfobox_10_product"></div>

  <script>
    getinfobox_10();
    function getinfobox_10() {
      var type = '10'
      var content ='';
      ...
      jQuery('#getinfobox_10_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getinfobox_10")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getinfobox_10_loading').html(' ');
              jQuery('#getinfobox_10_product').html(res);
