...
<div id="getinfobox_13_loading" ></div>

  <div id="getinfobox_13_product"></div>

  <script>
    getinfobox_13();
    function getinfobox_13() {
      var type = '1'
      var content ='';
      ...
      jQuery('#getinfobox_13_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getinfobox_13")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getinfobox_13_loading').html(' ');
              jQuery('#getinfobox_13_product').html(res);
