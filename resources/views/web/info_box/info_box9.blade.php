...
<div id="getinfobox_9_loading" ></div>

  <div id="getinfobox_9_product"></div>

  <script>
    getinfobox_9();
    function getinfobox_9() {
      var type = '9'
      var content ='';
      ...
      jQuery('#getinfobox_9_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getinfobox_9")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getinfobox_9_loading').html(' ');
              jQuery('#getinfobox_9_product').html(res);
