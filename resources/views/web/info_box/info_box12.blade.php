...
<div id="getinfobox_12_loading" ></div>

  <div id="getinfobox_12_product"></div>

  <script>
    getinfobox_12();
    function getinfobox_12() {
      var type = '12'
      var content ='';
      ...
      jQuery('#getinfobox_12_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getinfobox_12")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getinfobox_12_loading').html(' ');
              jQuery('#getinfobox_12_product').html(res);
