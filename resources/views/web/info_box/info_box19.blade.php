...
.content_loading {
  ...
  .content_loading .dot:nth-child(2) {
    ...
    padding: 2rem 0px 1rem 0px;
      ...
      .banners-content #getinfobox_19_product .container-fluid {
        padding-left: 10px;
        padding-right: 10px;
      }
...
<div id="getinfobox_19_loading" ></div>

  <div id="getinfobox_19_product"></div>

  <script>
    getinfobox_19();
    function getinfobox_19() {
      var type = '10'
      var content ='';
      ...
      jQuery('#getinfobox_19_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getinfobox_19")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getinfobox_19_loading').html(' ');
              jQuery('#getinfobox_19_product').html(res);
