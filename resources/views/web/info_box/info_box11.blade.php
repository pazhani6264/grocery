...
<div id="getinfobox_11_loading" ></div>

  <div id="getinfobox_11_product"></div>

  <script>
    getinfobox_11();
    function getinfobox_11() {
      var type = '11'
      var content ='';
      ...
      jQuery('#getinfobox_11_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getinfobox_11")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getinfobox_11_loading').html(' ');
              jQuery('#getinfobox_11_product').html(res);
