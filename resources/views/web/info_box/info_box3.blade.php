...
<div id="getinfobox_3_loading" ></div>

  <div id="getinfobox_3_product"></div>

  <script>
    getinfobox_3();
    function getinfobox_3() {
      var type = '3'
      var content ='';
      ...
      jQuery('#getinfobox_3_loading').html(content);
      
      jQuery.ajax({
          url: '{{ URL::to("/getinfobox_3")}}',
          headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
          type: "POST",
          data: 'type='+type,
            success: function (res) { 
              jQuery('#getinfobox_3_loading').html(' ');
              jQuery('#getinfobox_3_product').html(res);
