...
<div id="getspecial_loading" ></div>

<div id="getspecial_product"></div>

<script>
  getallproductByspecial();
  function getallproductByspecial() {
    var type = 'special';
    var content ='';
      ...
      jQuery('#getspecial_loading').html(content);

    jQuery.ajax({
        url: '{{ URL::to("/getallproductByspecial")}}',
        headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
        type: "POST",
        data: 'type='+type,
          success: function (res) { 
            jQuery('#getspecial_loading').html(' ');
            jQuery('#getspecial_product').html(res);
