...
@media screen and (min-width: 1200px){
  ...
  @media screen and (max-width: 992px){
    ...
    .special8 .product article .thumb-size {
...
<script>
  getallproductByspecial8();
  function getallproductByspecial8() {
    var type = 'special';
    var content ='';
      ...
      jQuery.ajax({
          url: '{{ URL::to("/getallproductByspecial8")}}',
...
function getspecial8(){
jQuery(document).ready(function () {
  (function (jQuery) {
    var tabCarousel = jQuery('.special-carousel-js8');
