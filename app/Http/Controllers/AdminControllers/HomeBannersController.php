...
class HomeBannersController extends Controller
{
  ...
  public function display2(){
    ...
    //dd($result);
    $result['commonContent'] = $this->Setting->commonContent();
    return view("admin.settings.web.homebanners.index2",$title)->with('result', $result)->with('allimage', $allimage);
  }
  ...
  public function display3(){
    ...
    //dd($result);
    $result['commonContent'] = $this->Setting->commonContent();
    return view("admin.settings.web.homebanners.index3",$title)->with('result', $result)->with('allimage', $allimage);
  }
