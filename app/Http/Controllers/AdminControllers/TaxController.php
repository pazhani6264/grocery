...
class TaxController extends Controller
{
    ...
    public function taxindex(Request $request){
        ...
        $tax_type=$result['commonContent']['setting']['tax_class'];
        $tax_class = $this->Tax_class->paginator($tax_type);
    ...
    public function displaytaxrates(Request $request){
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        $tax_type=$result['commonContent']['setting']['tax_class'];
        $result['tax_rates'] = $this->Tax_rate->pagitnator($tax_type);
    ...
    public function addtaxrate(Request $request){
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        $tax_type=$result['commonContent']['setting']['tax_class'];
        $zones = $this->Countries->getter();
        $tax_class = $this->Tax_class->getter($tax_type);
        $result['zones'] = $zones;
