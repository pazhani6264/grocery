...
class DeliveryBoyController extends Controller
{
   ...
   /* public function __construct()
    ...
    public function processlogout(Request $request){
		$response = DeliveryBoy::processlogout($request);
		return($response) ;
	}	
    ...
    public function floatingCash(Request $request){		
		$response = DeliveryBoy::floatingCash($request);
		return($response) ;
	}

    public function settlementAmount(Request $request){		
		$response = DeliveryBoy::settlementAmount($request);
		return($response) ;
	}

    public function balanceAmount(Request $request){		
		$response = DeliveryBoy::balanceAmount($request);
		return($response) ;
	}
