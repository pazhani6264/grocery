...
class AlertController extends Controller
{
	...
	public function customer_email($order_id,$user_email)
    {
        $setting = $this->getSetting();
        ...
        $result = $this->getporder($order_id);
        $product=$result;
        $orderno = $setting['invoice_prefix'].$order_id;
	...
	public function getporder($online_id)
    {
        ...
        ->where('orders_products.orders_id', '=', $online_id)->where('image_type', '=', 'THUMBNAIL')->get();
    ...
    public function sendNotificationsCashier($token,$title,$message)
    {
        ...
        $extraNotificationData = ["message" => $notification,"moredata" =>'dd'];
         ...
         $headers = [
            'Authorization: key=' . 'AAAAJLXZvTI:APA91bF-3nr63O7Ku4HyJdjbEqkrOcfT6QL6J4I-Ky1eBvNQZxip6GdyrITsCtmO08hjH97874C9pDiucqMYtqX1swlyBhmr1hfkwM3fd_r4m_yFqB5a-NgDNDg_ktUlcZkN0ioP0nsH',
            'Content-Type: application/json'
        ];
