...
///////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function productCategories_old()
    {
        ...
        if ($categories) {
            ...
            foreach ($categories as $parents) {
                ...
                if (isset($parents->childs)) {
                    ...
                    $ul .= $this->childcat_old($parents->childs, $i, $parent_id, $div);
                    $ul .= '</div></div>';
                    $ul .= '</li>';
                } else {
                    $ul .= '</li>';
    ...
    private function childcat_old($childs, $i, $parent_id, $div)
    {
        $contents = '';
        foreach ($childs as $key => $child) {
            $dash = '';
            ...
            if (isset($child->childs)) {
                ...
                $k = $i + 1;
                $contents .= $this->childcat_old($child->childs, $k, $parent_id, 1);
                $cat = 'shop?category=' . $child->categories_slug;
                $contents .= '</div></div>';
            } elseif ($i > 0) {
            }
    ...
    public function productCategories_car()
    {
        $categories = $this->recursivecategories1();
        if ($categories) {
            $parent_id = 0;
            ...
            foreach ($categories as $parents) {
                ...
                $cat = 'shop?category=' . $parents->categories_slug;
                $ul .= '<li class="nav-item dropdown ' . $wrap_parent . ' ' . $dropright . '"><a class="nav-link dropdown-item" href="' . $cat . '" >
                <img class="img-fuild" src="' . $parents->icon . '">
                ' . substr($parents->categories_name, 0, 18) .$dots . '
                </a>
                '
                ...
                if (isset($parents->childs)) {
                    $i = 1;
                    $ul .= '<div class=" wrapper dropdown-menu pull-right wrap-left" > <ul class="dropdown-submenu submenu1">';
                    $ul .= $this->childcat_car($parents->childs, $i, $parent_id, $div);
                    $ul .= '</li></ul></div>';
                    $ul .= '</li>';
                } else {
                    $ul .= '</li>';
    ...
    private function childcat_car($childs, $i, $parent_id, $div)
    {
        $contents = '';
        foreach ($childs as $key => $child) {
            $dash = '';
            ...
            $contents .= '
            <li class="nav-item dropdown ' . $wrap_parent . ' ' . $dropright . '"><a class="dropdown-item" href="' . $cat . '">
                    <img class="img-fuild" src="' . $dash . $child->icon . '">
                    ' . $dash . $child->categories_name . '
                </a>'.$right_arrow.' ';
                
            if (isset($child->childs)) {
                $contents .= '<div class="wrapper dropdown-menu pull-right ">';
                $contents .= '<ul class="dropdown-submenus submenu1"><li class="nav-item dropdown">'; 
                $k = $i + 1;
                $contents .= $this->childcat_car21($child->childs, $k, $parent_id, 1);
                $cat = 'shop?category=' . $child->categories_slug;
                $contents .= '</li></ul></div>';
            } elseif ($i > 0) {
            }
    ...
    private function childcat_car21($childs, $i, $parent_id, $div)
    {
        $contents = '';
        foreach ($childs as $key => $child) {
            $dash = '';
            ...
            $contents .= '
            <li class="nav-item dropdown ' . $wrap_parent . ' ' . $dropright . '"><a class="dropdown-item newstyle" href="' . $cat . '">
                    <img class="img-fuild" src="' . $dash . $child->icon . '">
                    ' . $dash . $child->categories_name . '
                </a>'.$right_arrow.' ';
    ...
    public function productCategories_31()
    {
        $categories = $this->recursivecategories1();
        if ($categories) {
            $parent_id = 0;
            ...
            foreach ($categories as $parents) {
                ...
                if (isset($parents->childs)) {
                    $i = 1;
                    $ul .= '<div class=" wrapper dropdown-menu pull-right wrap-left" > <ul class="dropdown-submenu submenu1">';
                    $ul .= $this->childcat_31($parents->childs, $i, $parent_id, $div);
                    $ul .= '</li></ul></div>';
                    $ul .= '</li>';
                } else {
                    $ul .= '</li>';
    ...
    private function childcat_31($childs, $i, $parent_id, $div)
    {
        $contents = '';
        foreach ($childs as $key => $child) {
            $dash = '';
            ...
            if (isset($child->childs)) {
                ...
                $contents .= '<ul class="dropdown-submenus submenu1"><li class="nav-item dropdown">'; 
                $k = $i + 1;
                $contents .= $this->childcat_31($child->childs, $k, $parent_id, 1);
                $cat = 'shop?category=' . $child->categories_slug;
                $contents .= '</li></ul></div>';
            } elseif ($i > 0) {
            }
    ...
    public function productCategories1()
    {
        ...
        if ($categories) {
            ...
            foreach ($categories as $parents) {
                ...
                if (isset($parents->childs)) {
                    $i = 1;
                    $ul .= '<li> <div class="dropdown-submenu submenu1" style="left:16px;">';
    ...
    private function childcat1($childs, $i, $parent_id, $div)
    {
        ...
        foreach ($childs as $key => $child) {
            ...
            $contents .= '
                <a class="dropdown-item" href="' . $cat . '">
                    <img class="img-fuild" style="width: 16px; margin-right: 7px;" src="' . $dash . $child->icon . '">
                    ' . $dash . $child->categories_name . '
                </a>
            ';
            if (isset($child->childs)) {
    ...
    private function recursivecategories1()
    {
        $items = DB::table('categories')
            ->leftJoin('categories_description', 'categories_description.categories_id', '=', 'categories.categories_id')
            ->leftJoin('image_categories', 'categories.categories_icon', '=', 'image_categories.image_id')
            ->select('image_categories.path as icon', 'image_categories.path_type as image_path_type', 'categories.categories_id', 'categories_description.categories_name', 'categories.categories_slug', 'categories.parent_id')
            ->where('categories_description.language_id', '=', Session::get('language_id'))
            ->where('categories.categories_status', 1)
            ->groupBy('categories.categories_id')
            ->get();
    ...
    public function products_check($data)
    {
        ...
        if (!empty($data['filters'])) {
            ...
            $filteroptioncount =  explode(',', $data['filters']['options']);
            $filteroptionvaluecount =  explode(',', $data['filters']['option_value']);
            //$filteroptioncounts =  implode(',', $filteroptioncount);
           
            //print_r( $filteroptioncount);
            $categories->whereIn('products_attributes.options_id',$filteroptioncount )
                ->whereIn('products_attributes.options_values_id',$filteroptionvaluecount);
        }
    ...
    public function products_paginate($data)
    {
        ...
        //count
        $total_record = $categories->get();
        $products = $categories->paginate(15);
        $newproducts = $categories->paginate(15);
       ...
       // print_r(count($products));
        ...
        if (count($products) > 0) {
            ...
            $responseData = array('success' => '1', 'product_data' => $result, 'product_data_new' => $newproducts, 'message' => Lang::get('website.Returned all products'), 'total_record' => count($total_record));

        } else {
            $responseData = array('success' => '0', 'product_data' => $result, 'product_data_new' => $newproducts, 'message' => Lang::get('website.Empty record'), 'total_record' => count($total_record));
        }
 ...
 */
    ...
    public function getCollectionbyId($collection)
    {
        
        $main_collection = DB::table('collections')->leftJoin('collections_description', 'collections_description.collections_id', '=', 'collections.id')
        ->where('collections.id', $collection->id)->where('language_id', Session::get('language_id'))->first();
    ...
    public function filters($data)
    {
     ...
     public function products_pos_cart($data)
    {
     ...
     elseif ($type == "flashsale") {
        ...
        $categories->where('products.products_status', 1);
        $categories->whereIn('product_view', [0, 2]);
        $categories->orderBy($sortby, $order)->groupBy('products.products_id');
