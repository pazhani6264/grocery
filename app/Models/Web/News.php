...
class News extends Model
{
  public function getAllNews($data){
		...
		$categories = DB::table('news_to_news_categories')
			...
			$categories->select('news.*','image_categories.path as image_path', 'image_categories.path_type as image_path_type', 'news_description.*', 'news_to_news_categories.categories_id', 'news_categories_description.categories_name');
  ...
  public function getNewsCategories(){
		...
		$categories = DB::table('news_categories')
			...
			->select('news_categories.categories_id as id',
				 ...
				 'image_categories.path as news_image','image_categories.path_type as image_path_type'
				 )
