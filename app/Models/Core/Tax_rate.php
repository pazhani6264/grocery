...
class Tax_rate extends Model
{
    ...
    public function pagitnator($tax_type){
        $tax_rates = Tax_rate::sortable(['tax_rates_id'=>'ASC'])
            ->LeftJoin('countries','countries.countries_id', '=', 'tax_rates.tax_zone_id')
            ->LeftJoin('tax_class','tax_class.tax_class_id', '=', 'tax_rates.tax_class_id')
            ->where('tax_class.tax_type',$tax_type)
            ->select('tax_rates.tax_rates_id','tax_rates.tax_zone_id','tax_rates.tax_class_id','tax_rates.tax_priority','tax_rates.tax_rate','tax_description',
                'tax_rates.created_at','tax_rates.updated_at','countries.countries_id','countries.countries_name','tax_class.tax_class_title','tax_class.tax_class_description')
            ->paginate(20);
        return $tax_rates;
    }
    ...
    public function getter($tax_type){
        $tax_rates = Tax_rate::sortable(['tax_rates_id'=>'ASC'])
            ...
            ->LeftJoin('tax_class','tax_class.tax_class_id', '=', 'tax_rates.tax_class_id')
            ->where('tax_class.tax_type',$tax_type)
            ->select('tax_rates.tax_rates_id','tax_rates.tax_zone_id','tax_rates.tax_class_id','tax_rates.tax_priority','tax_rates.tax_rate','tax_description','tax_rates.created_at','tax_rates.updated_at','countries.countries_id','countries.countries_name','tax_class.tax_class_title','tax_class.tax_class_description')
            ->get();
        return $tax_rates;
    }
