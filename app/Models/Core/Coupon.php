...
class Coupon extends Model
{
    ...
    public function payment(){
        ...
        $payment = DB::table('payment_methods')
            ...
            ->select('name','payment_methods.payment_method')
            ->groupBy('payment_methods.payment_methods_id')
            ->get();
   ...
   public function getcoupon($id){
       ...
       ->leftJoin('image_categories as categoryTable','categoryTable.image_id', '=', 'coupons.image')
        ->select('coupons.*','categoryTable.path as imgpath')
        ->where('coupons.coupans_id', $id)->get();
        return $coupon;
   }
   ...
   public function getproduct(){
     ...
     public function couponupdate($coupans_id,$code,$description,$discount_type, $payment_type,$amount,$individual_use,
