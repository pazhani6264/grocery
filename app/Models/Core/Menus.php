...
class Menus extends Model
{
    ...
    public static function recursiveMenu()
    {
        ...
        if ($items->isNotEmpty()) {
            ...
            foreach ($menus as $parents) {
                ...
                <a data-toggle="tooltip" data-placement="bottom" title="Edit" href="editmenu/' . $parents->id . '" class="badge bg-light-blue edit-menu">
                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                </a>
                <button data-toggle="tooltip" data-placement="bottom" title="Delete" id="deleteProductId" products_id="' . $parents->id . '" class="badge bg-red delete-menu">
    ...
    public static function childcat($childs, $parent_id)
    {
        ...
        foreach ($childs as $key => $child) {
            ...
            <div class="ns-class">' . $status . '</div>
            <div class="ns-actions">
            <a data-toggle="tooltip" data-placement="bottom" title="Edit"  href="editmenu/' . $child->id . '" class="badge bg-light-blue edit-menu">
            <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
            </a>
            <button data-toggle="tooltip" data-placement="bottom" title="Delete"  id="deleteProductId" products_id="' . $child->id . '" class="badge bg-red delete-menu">
            <i class="fa fa-trash" aria-hidden="true" ></i>
            </button>
