      ...
      foreach($languages as $languages_data){
          ...
          if($i==0){
              ...
              $products_options_id = DB::table('products_options')->insertGetId([
                  ...
                  'options_required'   =>   $request->options_required,
                  'options_select_type'   =>   $request->options_select_type,
              ]);
    ...
    public function updateoptionsvalues($request){
      ...
      foreach($languages as $languages_data){
          ...
          if(count($checkExist)>0){
              ...
              DB::table('products_options_values')->where('products_options_values_id', '=', $products_options_values_id)->update([
                'products_options_values_name' => $req_options_values_name,
            ]);
            }else{
              $req_options_values_name = $request->$options_values_name;
              DB::table('products_options_values_descriptions')->insert([
