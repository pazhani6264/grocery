...
class Bannertwo extends Model
{
    ...
    public function fetchbanner($request,$uploadImage,$banners_url,$expiryDateFormate){
        ...
        $banner = DB::table('bannertwos')->insert([
    ...
    public function editbanners($request){
        ...
        $banners = DB::table('bannertwos')
            ...
            ->select('bannertwos.*','categoryTable.path')
    ...
    public function updatebanner($request,$uploadImage,$banners_url,$expiryDateFormate){
        ...
        $bannersUpdate = DB::table('bannertwos')->where('banners_id', $request->id)->update([
    ...
    public function deletebanners($request){
      $deletebanners =  DB::table('bannertwos')->where('banners_id', $request->banners_id)->delete();
