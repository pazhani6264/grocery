...
class News extends Model
{
    ...
    public function insert($request)
    {
        ...
        if ($request->image_icone !== null) {
            $thumbImage = $request->image_icone;
        } else {
            $thumbImage = '';
        }
        ...
        $news_id = DB::table('news')->insertGetId([
            ...
            'news_thumb_image' => $thumbImage,
            'created_at' => $date_added,
            'news_type' => $request->blog_style,
    ...
    public function GetNewsById($news_id)
    {
        ...
        $news = DB::table('news')
            ...
            ->select('news.*', 'image_categories.path as path','thumb.path as thumb_path')
